...
std::map<ptr32, c_h1_string_list_definition*> string_list_definitions;

c_h1_string_list_definition::c_h1_string_list_definition(const char* guerilla_data, const s_h1_string_list_definition& string_list_definition) :
	options(),
...
c_h1_string_list_definition* get_string_list_definition(const char* guerilla_data, ptr32 virtual_address)
{
	...
	string_list_definition = new(string_list_definition) c_h1_string_list_definition(guerilla_data, *_string_list_definition);
