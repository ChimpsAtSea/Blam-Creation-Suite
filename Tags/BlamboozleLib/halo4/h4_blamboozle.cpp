...
)
{
	...
	c_h4_tag_block* tag_block_definition = reinterpret_cast<c_h4_tag_block*>(tracked_malloc(sizeof(c_h4_tag_block)));
	...
	const s_h4_tag_api_interop_definition* definition_header)
{
	...
	c_h4_tag_interop* tag_api_interop_definition = reinterpret_cast<c_h4_tag_interop*>(tracked_malloc(sizeof(c_h4_tag_interop)));
	...
	const s_h4_tag_resource_definition* definition_header)
{
	...
	c_h4_tag_resource* tag_resource_definition = reinterpret_cast<c_h4_tag_resource*>(tracked_malloc(sizeof(c_h4_tag_resource)));
...
)
{
	...
	c_h4_tag_struct* tag_struct_definition = reinterpret_cast<c_h4_tag_struct*>(tracked_malloc(sizeof(c_h4_tag_struct)));
...
)
{
	...
	c_h4_tag_enum* tag_enum_definition = reinterpret_cast<c_h4_tag_enum*>(tracked_malloc(sizeof(c_h4_tag_enum)));
...
c_h4_tag_reference* c_h4_blamboozle::get_tag_reference_definition(const char* h4_data, const s_h4_tag_reference_definition* definition_header, unsigned long definition_address)
{
	...
	c_h4_tag_reference* tag_reference_definition = reinterpret_cast<c_h4_tag_reference*>(tracked_malloc(sizeof(c_h4_tag_reference)));
