...
c_mandrill_halo_script_editor::c_mandrill_halo_script_editor(c_mandrill_cache_file_gui_tab& parent_tab, c_cache_file& cache_file) :
	c_mandrill_gui_tab("Script Editor", "Halo Script Editor"),
