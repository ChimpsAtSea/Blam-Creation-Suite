...
e_shader_profile c_mandrill_shader_tool_gui_tab::accepted_shader_profiles[] =
{
...
c_mandrill_shader_tool_gui_tab::~c_mandrill_shader_tool_gui_tab()
{

}

void c_mandrill_shader_tool_gui_tab::render_source_code_editor_gui()
{
...
void c_mandrill_shader_tool_gui_tab::render_preview_disassembly()
{
...
void c_mandrill_shader_tool_gui_tab::render_runtime_disassembly()
{
...
std::string c_mandrill_shader_tool_gui_tab::disassemble_shader(const char* hlsl_bytecode_data, size_t hlsl_bytecode_size)
{
...
void c_mandrill_shader_tool_gui_tab::render_shader_profile_selection_gui()
{
...
void c_mandrill_shader_tool_gui_tab::render_source_code_editor_configuration_header_column_gui()
{
...
void c_mandrill_shader_tool_gui_tab::render_preview_disassembly_configuration_header_column_gui()
{
	ImGui::NextColumn();
}

void c_mandrill_shader_tool_gui_tab::render_runtime_disassembly_configuration_header_column_gui()
{
...
void c_mandrill_shader_tool_gui_tab::render_text_editor_status_bar_gui()
{
...
void c_mandrill_shader_tool_gui_tab::render_tab_contents_gui()
{
	ImGui::Columns(3);
...
void c_mandrill_shader_tool_gui_tab::compile_source()
{
	source_code = source_code_editor_display.GetText();
	compile_source_thread_subroutine();
}

void c_mandrill_shader_tool_gui_tab::compile_source_subroutine() const
{
...
void c_mandrill_shader_tool_gui_tab::disassemble_runtime_subroutine() const
{
	if (selected_render_method_template_tag_interface)
	{
