...
c_halo1_cache_cluster::c_halo1_cache_cluster(c_halo1_cache_file_reader** cache_readers, unsigned long cache_reader_count, s_engine_platform_build engine_platform_build) :
...
c_halo1_cache_cluster::~c_halo1_cache_cluster()
{
...
BCS_RESULT c_halo1_cache_cluster::get_debug_reader(c_halo1_cache_file_reader& cache_reader, c_halo1_debug_reader*& debug_reader)
{
...
BCS_RESULT c_halo1_cache_cluster::get_tag_reader(c_halo1_cache_file_reader& cache_reader, c_halo1_tag_reader*& tag_reader)
{
...
BCS_RESULT c_halo1_cache_cluster::get_resource_reader(c_halo1_cache_file_reader& cache_reader, c_halo1_resource_reader*& resource_reader)
{
...
BCS_RESULT c_halo1_cache_cluster::get_localization_reader(c_halo1_cache_file_reader& cache_reader, c_halo1_localization_reader*& localization_reader)
{
...
BCS_RESULT c_halo1_cache_cluster::get_cache_readers(c_cache_file_reader* const*& cache_readers, unsigned long& cache_reader_count) const
{
...
BCS_RESULT c_halo1_cache_cluster::get_cache_readers(c_halo1_cache_file_reader* const*& cache_readers, unsigned long& cache_reader_count) const
{
...
BCS_RESULT c_halo1_cache_cluster::get_debug_reader(c_cache_file_reader& cache_reader, c_debug_reader*& debug_reader)
{
	return get_debug_reader(*static_cast<c_halo1_cache_file_reader*>(&cache_reader), *reinterpret_cast<c_halo1_debug_reader**>(&debug_reader));
}

BCS_RESULT c_halo1_cache_cluster::get_tag_reader(c_cache_file_reader& cache_reader, c_tag_reader*& tag_reader)
{
	return get_tag_reader(*static_cast<c_halo1_cache_file_reader*>(&cache_reader), *reinterpret_cast<c_halo1_tag_reader**>(&tag_reader));
}

BCS_RESULT c_halo1_cache_cluster::get_resource_reader(c_cache_file_reader& cache_reader, c_resource_reader*& resource_reader)
{
	return get_resource_reader(*static_cast<c_halo1_cache_file_reader*>(&cache_reader), *reinterpret_cast<c_halo1_resource_reader**>(&resource_reader));
}

BCS_RESULT c_halo1_cache_cluster::get_localization_reader(c_cache_file_reader& cache_reader, c_localization_reader*& localization_reader)
{
	return get_localization_reader(*static_cast<c_halo1_cache_file_reader*>(&cache_reader), *reinterpret_cast<c_halo1_localization_reader**>(&localization_reader));
}
