...
class c_halo1_debug_reader : public c_debug_reader
{
public:
	c_halo1_debug_reader(c_halo1_cache_cluster& cache_cluster, c_halo1_cache_file_reader& cache_reader);
	~c_halo1_debug_reader();
