...
BCS_RESULT c_halo4_tag_instance::get_data(const void*& out_tag_instance_data) const
{
...
BCS_RESULT c_halo4_tag_instance::get_cache_file_tag_index(unsigned long& out_cache_file_tag_index) const
{
