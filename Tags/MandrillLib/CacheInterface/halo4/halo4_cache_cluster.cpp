...
c_halo4_cache_cluster::c_halo4_cache_cluster(c_halo4_cache_file_reader** cache_readers, unsigned long cache_reader_count, s_engine_platform_build engine_platform_build) :
...
BCS_RESULT c_halo4_cache_cluster::get_cache_readers(c_cache_file_reader* const*& cache_readers, unsigned long& cache_reader_count) const
{
...
BCS_RESULT c_halo4_cache_cluster::get_cache_readers(c_halo4_cache_file_reader* const*& cache_readers, unsigned long& cache_reader_count) const
{
