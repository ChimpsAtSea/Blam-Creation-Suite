...
c_halo5_cache_file::c_halo5_cache_file(const std::wstring& map_filepath) :
	c_cache_file(map_filepath, _engine_type_halo5, _platform_type_pc)
{
...
char* c_halo5_cache_file::get_tag_data(const s_tag_data& tag_data) const
{
	return nullptr;
}

char* c_halo5_cache_file::get_tag_block_data(const s_tag_block& tag_block) const
{
	return nullptr;
}
...
const char* c_halo5_cache_file::get_tag_path(uint32_t tag_index) const
{
	return nullptr;
}
...
void* c_halo5_cache_file::get_internal_tag_instance_impl(uint32_t tag_index) const
{
	return nullptr;
}
