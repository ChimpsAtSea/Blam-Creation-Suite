...
c_halo2_cache_file::c_halo2_cache_file(const std::wstring& map_filepath) :
	c_cache_file(map_filepath, _engine_type_halo2, _platform_type_pc)
{
...
char* c_halo2_cache_file::get_tag_block_data(const s_tag_block& tag_block) const
{
	return nullptr;
}
...
unsigned long c_halo2_cache_file::get_group_tag_by_tag_index(uint32_t tag_index) const
{
