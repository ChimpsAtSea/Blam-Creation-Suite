...
namespace halo3
{
	...
	{
		char __unknown4E4[0x2B08];

		unsigned long footer_signature;
	};
	static constexpr size_t k_halo3_cache_file_header_size = sizeof(s_cache_file_header);
	static_assert(sizeof(s_cache_file_header) == 0x3000);
