	...
	halo3odst_cache_file_tags_header(nullptr)
{
	...
	cache_file_tag_groups = reinterpret_cast<s_cache_file_tag_group*>(tags_buffer + convert_virtual_address(halo3odst_cache_file_tags_header->tag_groups.address));
	...
	cache_file_tag_instances = reinterpret_cast<s_cache_file_tag_instance*>(tags_buffer + convert_virtual_address(halo3odst_cache_file_tags_header->tag_instances.address));
