...
{
#pragma pack(push, 1)
	struct s_halo4_cache_file_header : blamlib::s_cache_file_header
	{
...
#pragma pack(pop)
	...
	struct s_cache_file_header : s_halo4_cache_file_header
	{
		int32_t unknown34[(0x1E000 - (sizeof(s_halo4_cache_file_header) + 4)) / 4];
