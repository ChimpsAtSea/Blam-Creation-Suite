	...
	file_table_index_buffer()
{
	...
	long string_id_index_buffer_relative_offset = string_id_index_buffer_offset - buffers_info.debug_section_buffer.offset;
	...
	long string_id_buffer_relative_offset = string_id_string_storage_offset - buffers_info.debug_section_buffer.offset;
	...
	string_id_buffer = static_cast<char*>(tracked_aligned_malloc(halo3_cache_interface_tracked_memory, string_id_string_storage_size, sizeof(__m128i)));
	...
	long file_table_index_buffer_relative_offset = file_table_indices_offset - buffers_info.debug_section_buffer.offset;
	...
	long file_table_buffer_relative_offset = file_table_offset - buffers_info.debug_section_buffer.offset;
	...
	file_table_buffer = static_cast<char*>(tracked_aligned_malloc(halo3_cache_interface_tracked_memory, file_table_length, sizeof(__m128i)));
...
BCS_RESULT c_halo3_debug_reader::string_id_to_string(unsigned long string_id_index, unsigned long string_id_namespace, unsigned long string_id_length, const char*& string)
{
...
BCS_RESULT c_halo3_debug_reader::get_tag_filepath(unsigned long tag_index, const char*& filepath)
{
	BCS_RESULT rs = BCS_S_OK;
...
BCS_RESULT c_halo3_debug_reader::string_id_to_index(string_id stringid, unsigned long& string_index)
{
...
BCS_RESULT c_halo3_debug_reader::string_id_to_index(unsigned long string_id_index, unsigned long string_id_namespace, unsigned long string_id_length, unsigned long& string_index)
{
	...
	case _platform_type_xbox_360:
	{
		...
		{
			for (unsigned long namespace_index = 0; namespace_index < string_id_namespace; namespace_index++) // #TODO: pre calculate this table
			{
