...
template<> void byteswap_inplace(halo3::s_cache_file_tag_global_instance& tag_global_instance)
{
	byteswap_inplace(tag_global_instance.group_tag);
	byteswap_inplace(tag_global_instance.datum_index);
}

template<> void byteswap_inplace(halo3::s_cache_file_tag_interop& tag_interop)
{
