...
BCS_RESULT c_halo3_tag_instance::get_tag_data(const void*& out_tag_instance_data) const
{
...
BCS_RESULT c_halo3_tag_instance::get_cache_file_tag_index(unsigned long& out_cache_file_tag_index) const
{
