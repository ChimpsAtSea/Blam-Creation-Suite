...
public:
	...
	uint32_t get_tag_group_block_index() const;
	uint32_t get_string_data_size() const;
	uint32_t get_string_offset_count() const;
	uint32_t get_string_list_count() const;
	uint32_t get_custom_block_index_search_names_count() const;
	uint32_t get_data_definition_name_count() const;
	uint32_t get_array_definition_count() const;
	uint32_t get_field_type_count() const;
	uint32_t get_field_count() const;
	uint32_t get_block_definition_count() const;
	uint32_t get_struct_definition_count() const;
	uint32_t get_resource_definition_count() const;
	uint32_t get_interop_definition_count() const;
	uint32_t get_aggregate_definition_count() const;
