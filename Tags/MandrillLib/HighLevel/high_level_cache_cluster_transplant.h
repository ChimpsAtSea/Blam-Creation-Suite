...
//
//public:
//	BCS_RESULT get_global_tag_by_low_level_tag_instance(c_tag_instance& tag_instance, h_tag_instance*& tag);
//	BCS_RESULT get_tag_by_low_level_tag_instance(c_cache_file_reader& cache_file_reader, c_tag_instance& tag_instance, h_tag_instance*& tag);
//	BCS_RESULT get_tag_by_group_and_filename(h_group& group, const char* filename, h_tag_instance*& tag);
//	BCS_RESULT get_tag_group(tag group_tag, h_tag_group*& group);
//	
...
//	using t_groups = std::vector<h_tag_group*>;
