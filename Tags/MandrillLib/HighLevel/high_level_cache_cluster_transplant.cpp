...
//	//{
//	//	h_tag_instance* high_level_tag = tag_interface_to_high_level(tag_interface);
//
...
//
//	//	h_tag_instance& high_level_tag = tag_pair.high_level_tag;
...
//}
//
//BCS_RESULT c_high_level_cache_cluster_transplant::get_global_tag_by_low_level_tag_instance(c_tag_instance& tag_instance, h_tag_instance*& tag)
//{
//	BCS_RESULT rs = BCS_S_OK;
//
...
//}
//
//BCS_RESULT c_high_level_cache_cluster_transplant::get_tag_by_low_level_tag_instance(c_cache_file_reader& cache_file_reader, c_tag_instance& tag_instance, h_tag_instance*& tag)
//{
//	BCS_RESULT rs = BCS_S_OK;
...
//}
//
//BCS_RESULT c_high_level_cache_cluster_transplant::get_tag_by_group_and_filename(h_group& group, const char* filename, h_tag_instance*& tag)
//{
//	return BCS_E_FAIL;
//}
//
...
//			}
//
//			h_tag_instance& high_level_tag = group->create_tag_instance(tag_instance_name);
//
...
//			h_tag_instance& high_level_tag = *transplant_instance.high_level;
//
...
//				//h_tag_instance* tag_reference_high_level_tag = get_high_level_tag_by_tag_interface(tag_reference_tag_interface);
//
...
//}
//
//BCS_RESULT c_high_level_cache_cluster_transplant::get_tag_group(tag group_tag, h_tag_group*& tag_group)
//{
//	for (h_tag_group* current_tag_group : groups)
//	{
