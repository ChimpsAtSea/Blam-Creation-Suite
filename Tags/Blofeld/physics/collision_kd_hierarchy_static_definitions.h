...
namespace blofeld
{
	...
	extern s_tag_struct_definition collision_kd_hierarchy_static_hash_table_headers_block_block_struct;
	extern s_tag_block_definition collision_kd_hierarchy_static_hash_table_headers_block_block;
	extern s_tag_struct_definition collision_kd_hierarchy_static_nodes_block_block_struct;
	extern s_tag_block_definition collision_kd_hierarchy_static_nodes_block_block;
	extern s_tag_struct_definition collision_kd_hierarchy_static_in_use_masks_block_block_struct;
	extern s_tag_block_definition collision_kd_hierarchy_static_in_use_masks_block_block;
	extern s_tag_struct_definition super_node_mappings_block$3_block_struct;
	extern s_tag_block_definition super_node_mappings_block$3_block;
	extern s_tag_struct_definition cluster_table_block_block_struct;
