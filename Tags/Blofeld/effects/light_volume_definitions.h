...
namespace blofeld
{
	...
	extern s_tag_struct_definition light_volume_precompiled_vert_block_block_struct;
	extern s_tag_block_definition light_volume_precompiled_vert_block_block;
	extern s_tag_struct_definition light_volume_definition_block_block_struct;
