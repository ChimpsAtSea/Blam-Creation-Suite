...
namespace blofeld
{
	...
	extern s_tag_struct_definition ai_deafening_encoded_pas_block_block_struct;
	extern s_tag_block_definition ai_deafening_encoded_pas_block_block;
	extern s_tag_struct_definition encoded_room_distances_block_block_struct;
	extern s_tag_block_definition encoded_room_distances_block_block;
	extern s_tag_struct_definition game_portal_to_door_occluder_block_block_struct;
	extern s_tag_block_definition game_portal_to_door_occluder_block_block;
	extern s_tag_struct_definition bsp_cluster_to_room_bounds_block_struct;
	extern s_tag_block_definition bsp_cluster_to_room_bounds_block;
	extern s_tag_struct_definition bsp_cluster_to_room_indices_block_struct;
