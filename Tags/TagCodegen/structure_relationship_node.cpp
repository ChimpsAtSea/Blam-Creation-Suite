...
std::vector<const blofeld::s_tag_block_definition*> c_structure_relationship_node::sorted_block_definitions;
std::unordered_set<const blofeld::s_tag_block_definition*> c_structure_relationship_node::unsorted_block_definitions;
std::vector<const blofeld::s_tag_struct_definition*> c_structure_relationship_node::sorted_block_struct_definitions;
std::unordered_set<const blofeld::s_tag_struct_definition*> c_structure_relationship_node::unsorted_block_struct_definitions;
...
void c_structure_relationship_node::create_sorted_tag_block_definitions()
{
	...
	std::sort(sorted_block_definitions.begin(), sorted_block_definitions.end(), [](const blofeld::s_tag_block_definition* a, const blofeld::s_tag_block_definition* b) -> bool
		{
			std::string _a = a->name;
			std::string _b = a->name;
			return _a > _b;
	...
	for (const blofeld::s_tag_block_definition* tag_block_definition : c_structure_relationship_node::sorted_block_definitions)
	{
	...
	std::sort(sorted_block_struct_definitions.begin(), sorted_block_struct_definitions.end(), [](const blofeld::s_tag_struct_definition* a, const blofeld::s_tag_struct_definition* b) -> bool
		{
			std::string _a = a->name;
			std::string _b = a->name;
			return _a > _b;
