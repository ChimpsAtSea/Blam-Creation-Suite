...
bool custom_structure_codegen(
	...
	std::stringstream& s,
	const char* tabs,
	const c_blamlib_string_parser* field_formatter,
...
#define CODEGEN_HELPER_HIGH_LEVEL(field_name, type, variable_name) \
	...
	CODEGEN_HELPER_STRUCT(blofeld::cache_file_resource_fixup_location_block_block_struct)
	{
	...
	CODEGEN_HELPER_STRUCT(blofeld::cache_file_resource_data_block_block_struct)
	{
