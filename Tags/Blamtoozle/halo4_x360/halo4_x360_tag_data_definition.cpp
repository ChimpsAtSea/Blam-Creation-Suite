...
uint32_t c_halo4_x360_tag_data_definition::get_flags()
{
	return data_definition.flags;
}

uint32_t c_halo4_x360_tag_data_definition::get_alignment_bits()
{
	return data_definition.alignment_bit;
}

uint32_t c_halo4_x360_tag_data_definition::get_maximum_element_count()
{
