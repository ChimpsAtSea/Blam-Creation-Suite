...
unsigned long c_halo4_x360_tag_field::get_padding()
{
	return padding;
}

unsigned long c_halo4_x360_tag_field::get_skip_length()
{
	return skip_length;
}
...
blofeld::e_field_id c_halo4_x360_tag_field::get_field_id()
{
