...
template<> void byteswap_inplace(s_halo4_x360_tag_field& value)
{
...
c_halo4_x360_tag_field::c_halo4_x360_tag_field(c_halo4_x360_tag_definition_manager& _tag_definition_manager, ptr32 _definition_address) :
...
const char* c_halo4_x360_tag_field::get_explanation()
{
	return explanation;
}

bool c_halo4_x360_tag_field::get_tag_field_attributed_definition(blofeld::e_tag_field_attributed_definition& out_tag_field_attributed_definition)
{
...
bool c_halo4_x360_tag_field::get_tag_field_custom_type(blofeld::e_tag_field_custom_type& out_tag_field_custom_type)
{
...
bool c_halo4_x360_tag_field::get_tag_field_id(blofeld::e_field_id& out_field_id)
{
...
c_blamtoozle_tag_block_definition* c_halo4_x360_tag_field::get_block_definition()
{
	return block_definition;
}

c_blamtoozle_tag_reference_definition* c_halo4_x360_tag_field::get_tag_reference_definition()
{
	return tag_reference_definition;
}

c_blamtoozle_tag_struct_definition* c_halo4_x360_tag_field::get_struct_definition()
{
	return struct_definition;
}

c_blamtoozle_tag_array_definition* c_halo4_x360_tag_field::get_array_definition()
{
	return array_definition;
}

c_blamtoozle_string_list_definition* c_halo4_x360_tag_field::get_string_list_definition()
{
	return string_list_definition;
}

c_blamtoozle_tag_resource_definition* c_halo4_x360_tag_field::get_tag_resource_definition()
{
	return tag_resource_definition;
}

c_blamtoozle_tag_data_definition* c_halo4_x360_tag_field::get_data_definition()
{
	return data_definition;
}

c_blamtoozle_tag_api_interop_definition* c_halo4_x360_tag_field::get_api_interop_definition()
{
	return api_interop_definition;
}

c_blamtoozle_tag_block_index_custom_search_definition* c_halo4_x360_tag_field::get_block_index_custom_search_definition()
{
