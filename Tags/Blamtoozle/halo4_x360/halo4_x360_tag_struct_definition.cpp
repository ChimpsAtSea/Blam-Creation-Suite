...
template<> void byteswap_inplace(s_halo4_x360_tag_memory_attributes& value)
{
	byteswap_inplace(value.memory_type);
	byteswap_inplace(value.usage_flags);
}

template<> void byteswap_inplace(s_halo4_x360_byte_swap_definition& value)
{
...
template<> void byteswap_inplace(s_halo4_x360_tag_struct_runtime& value)
{
	byteswap_inplace(value.original_fields);
	byteswap_inplace(value.byte_swap_definition);
	byteswap_inplace(value.cache_file_byte_swap_definition);
	...
	byteswap_inplace(value._unknown);
	byteswap_inplace(value.descendent_definition);
}

template<> void byteswap_inplace(s_halo4_x360_tag_struct_legacy& value)
{
...
template<> void byteswap_inplace(s_halo4_x360_tag_struct_definition& value)
{
...
c_halo4_x360_tag_struct_definition::c_halo4_x360_tag_struct_definition(c_halo4_x360_tag_definition_manager& _tag_definition_manager, ptr32 _definition_address) :
	c_blamtoozle_tag_struct_definition(_tag_definition_manager),
	definition_address(_definition_address),
	struct_definition(tag_definition_manager.read_structure<s_halo4_x360_tag_struct_definition>(_definition_address)),
...
const char* c_halo4_x360_tag_struct_definition::get_name()
{
	return name;
}

const char* c_halo4_x360_tag_struct_definition::get_code_symbol_name()
{
	return code_symbol_name.c_str();
}

const char* c_halo4_x360_tag_struct_definition::get_structure_type_name()
{
...
const char* c_halo4_x360_tag_struct_definition::get_file_path()
{
	return file_path;
}
...
c_flags<blofeld::e_tag_field_set_bit> c_halo4_x360_tag_struct_definition::get_field_set_bits()
{
	c_flags<blofeld::e_tag_field_set_bit> result;

	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_unknown0))
	{
		result.set(blofeld::_tag_field_set_unknown0_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_unknown1))
	{
		result.set(blofeld::_tag_field_set_unknown1_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_has_inlined_children_with_placement_new_bit))
	{
		result.set(blofeld::_tag_field_set_has_inlined_children_with_placement_new_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_unknown3))
	{
		result.set(blofeld::_tag_field_set_unknown3_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_unknown4))
	{
	...
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_unknown7))
	{
		result.set(blofeld::_tag_field_set_unknown7_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_unknown8))
	{
		result.set(blofeld::_tag_field_set_unknown8_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_delete_recursively_bit))
	{
		result.set(blofeld::_tag_field_set_delete_recursively_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_postprocess_recursively_bit))
	{
		result.set(blofeld::_tag_field_set_postprocess_recursively_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_is_memcpyable_bit))
	{
		result.set(blofeld::_tag_field_set_is_memcpyable_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_unknown12))
	{
		result.set(blofeld::_tag_field_set_unknown12_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_has_resources))
	{
		result.set(blofeld::_tag_field_set_has_resources_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_unknown14))
	{
		result.set(blofeld::_tag_field_set_unknown14_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_unknown15))
	{
		result.set(blofeld::_tag_field_set_unknown15_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_has_level_specific_fields_bit))
	{
		result.set(blofeld::_tag_field_set_has_level_specific_fields_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_can_memset_to_initialize_bit))
	{
		result.set(blofeld::_tag_field_set_can_memset_to_initialize_bit, true);
	}
	if (struct_definition.runtime.flags.test(_halo4_x360_tag_field_set_unknown18))
	{
