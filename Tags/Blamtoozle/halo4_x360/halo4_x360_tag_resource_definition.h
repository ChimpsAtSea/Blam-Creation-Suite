...
static_assert(k_halo4_x360_tag_resource_definition_size == 32);

class c_halo4_x360_tag_resource_definition :
	public c_blamtoozle_tag_resource_definition
{
protected:
	c_halo4_x360_tag_resource_definition(c_halo4_x360_tag_definition_manager& tag_definition_manager, ptr32 definition_address);
	c_halo4_x360_tag_resource_definition(const c_halo4_x360_tag_resource_definition&) = delete;
	c_halo4_x360_tag_resource_definition(c_halo4_x360_tag_resource_definition&&) = delete;
	~c_halo4_x360_tag_resource_definition();
...
protected:
	...
	s_halo4_x360_tag_resource_definition resource_definition;
