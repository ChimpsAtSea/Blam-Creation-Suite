...
template<> void byteswap_inplace(s_halo1_tools_pc64_tag_field& value)
{
...
c_halo1_tools_pc64_tag_field::c_halo1_tools_pc64_tag_field(c_halo1_tools_pc64_tag_definition_manager& _tag_definition_manager, ptr32 _definition_address) :
	c_blamtoozle_tag_field(_tag_definition_manager),
	definition_address(_definition_address),
	field_definition(tag_definition_manager.read_structure<s_halo1_tools_pc64_tag_field>(_definition_address)),
	field_type(halo1_tools_pc64_field_type_to_generic_field_type(field_definition.field_type)),
	...
	explanation()
{
	if (field_definition.field_type == _halo1_tools_pc64_field_array_start)
	{
...
std::string const& c_halo1_tools_pc64_tag_field::get_raw_name()
{
	return raw_name;
}

std::string const& c_halo1_tools_pc64_tag_field::get_name()
{
	return name.c_str();
}

std::string const& c_halo1_tools_pc64_tag_field::get_description()
{
	return description.c_str();
}

std::string const& c_halo1_tools_pc64_tag_field::get_units()
{
	return units.c_str();
}

std::string const& c_halo1_tools_pc64_tag_field::get_limits()
{
	return limits.c_str();
}

std::string const& c_halo1_tools_pc64_tag_field::get_limits_legacy()
{
	return limits_legacy.c_str();
}

std::vector<std::string> const& c_halo1_tools_pc64_tag_field::get_old_names()
{
	return old_names;
}

blofeld::f_tag_field_flags c_halo1_tools_pc64_tag_field::get_field_flags()
{
	return flags;
}

blofeld::e_field c_halo1_tools_pc64_tag_field::get_field_type()
{
	return field_type;
}

uint32_t c_halo1_tools_pc64_tag_field::get_padding()
{
	return padding;
}

uint32_t c_halo1_tools_pc64_tag_field::get_skip_length()
{
	return skip_length;
}

const char* c_halo1_tools_pc64_tag_field::get_explanation()
{
	return explanation;
}

bool c_halo1_tools_pc64_tag_field::get_tag_field_attributed_definition(blofeld::e_tag_field_attributed_definition& out_tag_field_attributed_definition)
{
...
bool c_halo1_tools_pc64_tag_field::get_tag_field_custom_type(blofeld::e_tag_field_custom_type& out_tag_field_custom_type)
{
...
bool c_halo1_tools_pc64_tag_field::get_tag_field_id(blofeld::e_field_id& out_field_id)
{
...
c_blamtoozle_tag_block_definition* c_halo1_tools_pc64_tag_field::get_block_definition()
{
	return block_definition;
}

c_blamtoozle_tag_reference_definition* c_halo1_tools_pc64_tag_field::get_tag_reference_definition()
{
	return tag_reference_definition;
}

c_blamtoozle_tag_struct_definition* c_halo1_tools_pc64_tag_field::get_struct_definition()
{
	return struct_definition;
}

c_blamtoozle_tag_array_definition* c_halo1_tools_pc64_tag_field::get_array_definition()
{
	return array_definition;
}

c_blamtoozle_string_list_definition* c_halo1_tools_pc64_tag_field::get_string_list_definition()
{
	return string_list_definition;
}

c_blamtoozle_tag_resource_definition* c_halo1_tools_pc64_tag_field::get_tag_resource_definition()
{
	return nullptr;
}

c_blamtoozle_tag_data_definition* c_halo1_tools_pc64_tag_field::get_data_definition()
{
	return data_definition;
}

c_blamtoozle_tag_api_interop_definition* c_halo1_tools_pc64_tag_field::get_api_interop_definition()
{
	return nullptr;
}

c_blamtoozle_tag_block_index_custom_search_definition* c_halo1_tools_pc64_tag_field::get_block_index_custom_search_definition()
{
