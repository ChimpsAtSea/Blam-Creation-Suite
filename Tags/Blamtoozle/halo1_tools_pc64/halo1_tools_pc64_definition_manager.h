...
{
public:
	c_halo1_tools_pc64_tag_definition_manager(const wchar_t* minidump_file_path);
	virtual ~c_halo1_tools_pc64_tag_definition_manager();
...
protected:
	...
	std::vector<c_halo1_tools_pc64_string_list_definition*>& string_list_definitions;
	std::vector<c_halo1_tools_pc64_tag_data_definition*>& tag_data_definitions;
	std::vector<c_halo1_tools_pc64_tag_block_index_custom_search_definition*>& block_index_custom_search_definitions;
	...
	std::map<ptr64, c_halo1_tools_pc64_string_list_definition*>& string_list_definitions_lookup;
	std::map<ptr64, c_halo1_tools_pc64_tag_data_definition*>& tag_data_definitions_lookup;
	std::map<ptr64, c_halo1_tools_pc64_tag_block_index_custom_search_definition*>& block_index_custom_search_definitions_lookup;
