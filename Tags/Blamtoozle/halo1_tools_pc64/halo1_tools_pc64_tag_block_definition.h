...
struct s_halo1_tools_pc64_tag_block_definition
{
...
constexpr size_t k_halo1_tools_pc64_tag_block_definition_size = sizeof(s_halo1_tools_pc64_tag_block_definition);
static_assert(k_halo1_tools_pc64_tag_block_definition_size == 52);

class c_halo1_tools_pc64_tag_block_definition :
	public c_blamtoozle_tag_block_definition
{
protected:
	c_halo1_tools_pc64_tag_block_definition(c_halo1_tools_pc64_tag_definition_manager& tag_definition_manager, ptr32 definition_address);
	c_halo1_tools_pc64_tag_block_definition(const c_halo1_tools_pc64_tag_block_definition&) = delete;
	c_halo1_tools_pc64_tag_block_definition(c_halo1_tools_pc64_tag_block_definition&&) = delete;
	virtual ~c_halo1_tools_pc64_tag_block_definition();
