...
struct s_halo2_tools_pc32_tag_block_definition
{
	...
	unsigned long versioning_structure_definitions_count;
...
{
protected:
	c_halo2_tools_pc32_tag_block_definition(c_halo2_tools_pc32_tag_definition_manager& tag_definition_manager, ptr32 definition_address);
	c_halo2_tools_pc32_tag_block_definition(const c_halo2_tools_pc32_tag_block_definition&) = delete;
	c_halo2_tools_pc32_tag_block_definition(c_halo2_tools_pc32_tag_block_definition&&) = delete;
	virtual ~c_halo2_tools_pc32_tag_block_definition();
...
protected:
	...
	s_halo2_tools_pc32_tag_block_definition block_definition;
	c_halo2_tools_pc32_tag_struct_definition* struct_definition;
	std::vector<c_halo2_tools_pc32_tag_struct_definition*> versioning_struct_definitions;
