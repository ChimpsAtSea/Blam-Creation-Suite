...
template<> void byteswap_inplace(s_halo2_tools_pc32_tag_reference_definition& value)
{
...
c_halo2_tools_pc32_tag_reference_definition::c_halo2_tools_pc32_tag_reference_definition(c_halo2_tools_pc32_tag_definition_manager& _tag_definition_manager, ptr32 _definition_address) :
	c_blamtoozle_tag_reference_definition(_tag_definition_manager),
	definition_address(_definition_address),
	reference_definition(tag_definition_manager.read_structure<s_halo2_tools_pc32_tag_reference_definition>(_definition_address)),
	name(),
	code_symbol_name()
{
	...
	if (reference_definition.flags.test(_halo2_tools_pc32_tag_reference_flag_not_a_dependency))
	{
		tag_reference_flags.set(blofeld::_tag_reference_flag_not_a_dependency, true);
	}
	if (reference_definition.flags.test(_halo2_tools_pc32_tag_reference_flag_dont_resolve_in_editor))
	{
		tag_reference_flags.set(blofeld::_tag_reference_flag_dont_resolve_in_editor, true);
	}
	if (reference_definition.flags.test(_halo2_tools_pc32_tag_reference_flag_resolved_manually))
	{
		tag_reference_flags.set(blofeld::_tag_reference_flag_resolved_manually, true);
	}
	if (reference_definition.flags.test(_halo2_tools_pc32_tag_reference_flag_resolved_by_game))
	{
		tag_reference_flags.set(blofeld::_tag_reference_flag_resolved_by_game, true);
	}
	if (reference_definition.flags.test(_halo2_tools_pc32_tag_reference_flag_not_a_resource_dependency))
	{
		tag_reference_flags.set(blofeld::_tag_reference_flag_not_a_resource_dependency, true);
	}
	if (reference_definition.flags.test(_halo2_tools_pc32_tag_reference_flag_dependency_for_cache_file_sharing))
	{
		tag_reference_flags.set(blofeld::_tag_reference_flag_dependency_for_cache_file_sharing, true);
	}
	if (reference_definition.flags.test(_halo2_tools_pc32_tag_reference_flag_reference_ignored_by_bundle_builder))
	{
		tag_reference_flags.set(blofeld::_tag_reference_flag_reference_ignored_by_bundle_builder, true);
	}
}

c_halo2_tools_pc32_tag_reference_definition::~c_halo2_tools_pc32_tag_reference_definition()
{

}

const char* c_halo2_tools_pc32_tag_reference_definition::get_name()
{
	return name.c_str();
}

const char* c_halo2_tools_pc32_tag_reference_definition::get_code_symbol_name()
{
	return code_symbol_name.c_str();
}

c_flags<blofeld::e_tag_reference_flags> c_halo2_tools_pc32_tag_reference_definition::get_tag_reference_flags()
{
