...
struct s_halo2_tools_pc32_tag_field
{
	c_enum<e_halo2_tools_pc32_field, unsigned long> field_type;
	ptr32 name_address;
	ptr32 definition_address;
	c_enum<blofeld::e_field_id, unsigned long> field_id;
};
constexpr size_t k_halo2_tools_pc32_tag_field_size = sizeof(s_halo2_tools_pc32_tag_field);
static_assert(k_halo2_tools_pc32_tag_field_size == 16);
...
class c_halo2_tools_pc32_tag_api_interop_definition;

class c_halo2_tools_pc32_tag_field :
	public c_blamtoozle_tag_field
{
public:
	c_halo2_tools_pc32_tag_field(c_halo2_tools_pc32_tag_definition_manager& tag_definition_manager, ptr32 definition_address);
	c_halo2_tools_pc32_tag_field(const c_halo2_tools_pc32_tag_field&) = delete;
	c_halo2_tools_pc32_tag_field(c_halo2_tools_pc32_tag_field&&) = delete;
	virtual ~c_halo2_tools_pc32_tag_field();
	...
	s_halo2_tools_pc32_tag_field field_definition;
	blofeld::e_field field_type;
	const char* name;
	const void* definition;

	c_halo2_tools_pc32_tag_block_definition* block_definition;
	c_halo2_tools_pc32_tag_reference_definition* tag_reference_definition;
	c_halo2_tools_pc32_tag_struct_definition* struct_definition;
	c_halo2_tools_pc32_tag_array_definition* array_definition;
	c_halo2_tools_pc32_string_list_definition* string_list_definition;
	c_halo2_tools_pc32_tag_data_definition* data_definition;
