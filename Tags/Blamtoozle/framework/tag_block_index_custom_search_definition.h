...
{
public:
	c_blamtoozle_tag_block_index_custom_search_definition(c_blamtoozle_tag_definition_manager& tag_definition_manager);
	...
	virtual ~c_blamtoozle_tag_block_index_custom_search_definition();
