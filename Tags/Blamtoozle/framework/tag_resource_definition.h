...
{
public:
	BCS_SHARED c_blamtoozle_tag_resource_definition(c_blamtoozle_tag_definition_manager& tag_definition_manager);
	...
	BCS_SHARED virtual ~c_blamtoozle_tag_resource_definition();
