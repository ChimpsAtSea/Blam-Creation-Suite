...
std::string const& c_reach_x360_tag_field::get_name()
{
	return name;
}

std::string const& c_reach_x360_tag_field::get_description()
{
	return description;
}

std::string const& c_reach_x360_tag_field::get_units()
{
	return units;
}

std::string const& c_reach_x360_tag_field::get_limits()
{
	return limits;
}

std::string const& c_reach_x360_tag_field::get_limits_legacy()
{
	return limits_legacy;
}

std::vector<std::string> const& c_reach_x360_tag_field::get_old_names()
{
	return old_names;
}
...
blofeld::f_tag_field_flags c_reach_x360_tag_field::get_field_flags()
{
	return flags;
}
...
bool c_reach_x360_tag_field::get_tag_field_attributed_definition(blofeld::e_tag_field_attributed_definition& out_tag_field_attributed_definition)
{
...
bool c_reach_x360_tag_field::get_tag_field_custom_type(blofeld::e_tag_field_custom_type& out_tag_field_custom_type)
{
...
bool c_reach_x360_tag_field::get_tag_field_id(blofeld::e_field_id& out_field_id)
{
