...
void c_reach_x360_tag_definition_manager::traverse(ptr32 group_table_address, unsigned long num_tag_layouts)
{
...
c_reach_x360_tag_struct_definition& c_reach_x360_tag_definition_manager::eval_struct(ptr32 definition_address)
{
	...
	{
		c_reach_x360_tag_struct_definition* existing_definition = dynamic_cast<c_reach_x360_tag_struct_definition*>(tag_type_definition_iterator->second);
		ASSERT(existing_definition != nullptr);
		return *existing_definition;
	}

	c_reach_x360_tag_struct_definition* tag_type_definition = reinterpret_cast<c_reach_x360_tag_struct_definition*>(tracked_malloc(sizeof(c_reach_x360_tag_struct_definition)));

	tag_struct_definitions_lookup[definition_address] = tag_type_definition;
	tag_struct_definitions.push_back(tag_type_definition);

	tag_type_definition = new(tag_type_definition) c_reach_x360_tag_struct_definition(*static_cast<c_reach_x360_tag_definition_manager*>(this), definition_address);
