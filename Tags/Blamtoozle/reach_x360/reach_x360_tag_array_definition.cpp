...
template<> void byteswap_inplace(s_reach_x360_tag_array_definition& value)
{
...
c_reach_x360_tag_array_definition::c_reach_x360_tag_array_definition(c_reach_x360_tag_definition_manager& _tag_definition_manager, ptr32 _definition_address) :
	c_blamtoozle_tag_array_definition(_tag_definition_manager),
	definition_address(_definition_address),
	array_definition(tag_definition_manager.read_structure<s_reach_x360_tag_array_definition>(_definition_address)),
...
c_reach_x360_tag_array_definition::~c_reach_x360_tag_array_definition()
{

}

const char* c_reach_x360_tag_array_definition::get_name()
{
	return name;
}

const char* c_reach_x360_tag_array_definition::get_code_symbol_name()
{
...
const char* c_reach_x360_tag_array_definition::get_element_count_string()
{
	return element_count_string;
}

c_blamtoozle_tag_struct_definition& c_reach_x360_tag_array_definition::get_struct_definition()
{
