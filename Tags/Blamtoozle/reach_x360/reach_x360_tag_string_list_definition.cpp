...
template<> void byteswap_inplace(s_reach_x360_string_list_definition& value)
{
...
template<> void byteswap_inplace(s_reach_x360_string_list_entry_definition& value)
{
	byteswap_inplace(value.option_address);
}

c_reach_x360_string_list_definition::c_reach_x360_string_list_definition(c_reach_x360_tag_definition_manager& _tag_definition_manager, ptr32 _definition_address) :
	c_blamtoozle_string_list_definition(_tag_definition_manager),
	definition_address(_definition_address),
	string_list_definition(tag_definition_manager.read_structure<s_reach_x360_string_list_definition>(_definition_address)),
...
c_reach_x360_string_list_definition::~c_reach_x360_string_list_definition()
{

}

const char* c_reach_x360_string_list_definition::get_name()
{
	return name;
}

const char* c_reach_x360_string_list_definition::get_code_symbol_name()
{
	return code_symbol_name.c_str();
}

const char* c_reach_x360_string_list_definition::get_file_path()
{
	return file_path;
}
