...
protected:
	...
	std::map<ptr64, c_reach_x360_string_list_definition*>& string_list_definitions_lookup;
	...
	std::map<ptr64, c_reach_x360_tag_block_index_custom_search_definition*>& block_index_custom_search_definitions_lookup;
};
