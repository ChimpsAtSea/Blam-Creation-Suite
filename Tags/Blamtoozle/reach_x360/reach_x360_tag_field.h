...
{
	c_enum<e_reach_x360_field, unsigned int> field_type;
	ptr32 name_address;
	ptr32 definition_address;
	unsigned int field_id;
};
constexpr size_t k_reach_x360_tag_field_size = sizeof(s_reach_x360_tag_field);
static_assert(k_reach_x360_tag_field_size == 16);
...
{
public:
	c_reach_x360_tag_field(c_reach_x360_tag_definition_manager& tag_definition_manager, ptr32 definition_address);
	c_reach_x360_tag_field(const c_reach_x360_tag_field&) = delete;
	c_reach_x360_tag_field(c_reach_x360_tag_field&&) = delete;
	virtual ~c_reach_x360_tag_field();
	...
	s_reach_x360_tag_field field_definition;
	...
	c_reach_x360_tag_resource_definition* tag_resource_definition;
