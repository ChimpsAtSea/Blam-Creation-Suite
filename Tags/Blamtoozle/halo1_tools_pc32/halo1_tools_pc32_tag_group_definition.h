...
struct s_halo1_tools_pc32_tag_group_definition
{
	ptr32 name_address;
	unsigned long flags;
	tag group_tag;
...
constexpr size_t k_halo1_tools_pc32_tag_group_size = sizeof(s_halo1_tools_pc32_tag_group_definition);
static_assert(k_halo1_tools_pc32_tag_group_size == 96);

class c_halo1_tools_pc32_tag_group_definition :
	public c_blamtoozle_tag_group_definition
{
protected:
	c_halo1_tools_pc32_tag_group_definition(c_halo1_tools_pc32_tag_definition_manager& tag_definition_manager, ptr32 definition_address);
	c_halo1_tools_pc32_tag_group_definition(const c_halo1_tools_pc32_tag_group_definition&) = delete;
	c_halo1_tools_pc32_tag_group_definition(c_halo1_tools_pc32_tag_group_definition&&) = delete;
	~c_halo1_tools_pc32_tag_group_definition();
...
protected:
	...
	s_halo1_tools_pc32_tag_group_definition group_definition;
	const char* name;
	std::string code_symbol_name;
	std::string group_tag_macro_name;
	c_halo1_tools_pc32_tag_block_definition* tag_block_definition;
};
