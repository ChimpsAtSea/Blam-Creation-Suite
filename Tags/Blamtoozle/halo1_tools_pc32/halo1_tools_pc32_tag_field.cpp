...
template<> void byteswap_inplace(s_halo1_tools_pc32_tag_field& value)
{
...
c_halo1_tools_pc32_tag_field::c_halo1_tools_pc32_tag_field(c_halo1_tools_pc32_tag_definition_manager& _tag_definition_manager, ptr32 _definition_address) :
	...
	field_type(halo1_tools_pc32_field_type_to_generic_field_type(field_definition.field_type)),
	...
	explanation()
{
	if (field_definition.field_type == _halo1_tools_pc32_field_array_start)
	{
...
c_halo1_tools_pc32_tag_field::~c_halo1_tools_pc32_tag_field()
{

}

const char* c_halo1_tools_pc32_tag_field::get_name()
{
	return name;
}

blofeld::e_field c_halo1_tools_pc32_tag_field::get_field_type()
{
	return field_type;
}

unsigned long c_halo1_tools_pc32_tag_field::get_padding()
{
	return padding;
}

unsigned long c_halo1_tools_pc32_tag_field::get_skip_length()
{
	return skip_length;
}

const char* c_halo1_tools_pc32_tag_field::get_explanation()
{
	return explanation;
}

blofeld::e_field_id c_halo1_tools_pc32_tag_field::get_field_id()
{
	return field_definition.field_id;
}

c_blamtoozle_tag_block_definition* c_halo1_tools_pc32_tag_field::get_block_definition()
{
	return block_definition;
}

c_blamtoozle_tag_reference_definition* c_halo1_tools_pc32_tag_field::get_tag_reference_definition()
{
	return tag_reference_definition;
}

c_blamtoozle_tag_struct_definition* c_halo1_tools_pc32_tag_field::get_struct_definition()
{
	return struct_definition;
}

c_blamtoozle_tag_array_definition* c_halo1_tools_pc32_tag_field::get_array_definition()
{
	return array_definition;
}

c_blamtoozle_string_list_definition* c_halo1_tools_pc32_tag_field::get_string_list_definition()
{
	return string_list_definition;
}

c_blamtoozle_tag_resource_definition* c_halo1_tools_pc32_tag_field::get_tag_resource_definition()
{
	return nullptr;
}

c_blamtoozle_tag_data_definition* c_halo1_tools_pc32_tag_field::get_data_definition()
{
	return data_definition;
}

c_blamtoozle_tag_api_interop_definition* c_halo1_tools_pc32_tag_field::get_api_interop_definition()
{
	return nullptr;
}

c_blamtoozle_tag_block_index_custom_search_definition* c_halo1_tools_pc32_tag_field::get_block_index_custom_search_definition()
{
