...
c_halo1_tools_pc32_tag_array_struct_definition::c_halo1_tools_pc32_tag_array_struct_definition(c_halo1_tools_pc32_tag_definition_manager& _tag_definition_manager, ptr32 _definition_address) :
...
c_halo1_tools_pc32_tag_array_struct_definition::~c_halo1_tools_pc32_tag_array_struct_definition()
{

}

const char* c_halo1_tools_pc32_tag_array_struct_definition::get_display_name()
{
	return display_name;
}

const char* c_halo1_tools_pc32_tag_array_struct_definition::get_name()
{
	return name;
}

const char* c_halo1_tools_pc32_tag_array_struct_definition::get_code_symbol_name()
{
	return code_symbol_name.c_str();
}

const char* c_halo1_tools_pc32_tag_array_struct_definition::get_structure_type_name()
{
	return code_type_name.c_str();
}

unsigned long c_halo1_tools_pc32_tag_array_struct_definition::get_alignment_bits()
{
	// #TODO: calculate this
	return 0;
...
blofeld::s_tag_persistent_identifier& c_halo1_tools_pc32_tag_array_struct_definition::get_persistent_identifier()
{
	static blofeld::s_tag_persistent_identifier id;
	return id;
}

c_flags<blofeld::e_tag_field_set_bit> c_halo1_tools_pc32_tag_array_struct_definition::get_field_set_bits()
{
