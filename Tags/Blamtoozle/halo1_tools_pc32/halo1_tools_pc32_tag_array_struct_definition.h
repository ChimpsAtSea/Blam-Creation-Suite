...
{
protected:
	c_halo1_tools_pc32_tag_array_struct_definition(c_halo1_tools_pc32_tag_definition_manager& tag_definition_manager, ptr32 definition_address);
	c_halo1_tools_pc32_tag_array_struct_definition(const c_halo1_tools_pc32_tag_array_struct_definition&) = delete;
	c_halo1_tools_pc32_tag_array_struct_definition(c_halo1_tools_pc32_tag_array_struct_definition&&) = delete;
	~c_halo1_tools_pc32_tag_array_struct_definition();
