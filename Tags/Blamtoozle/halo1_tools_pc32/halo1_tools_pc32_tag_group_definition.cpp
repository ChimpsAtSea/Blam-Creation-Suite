...
template<> void byteswap_inplace(s_halo1_tools_pc32_tag_group_definition& value)
{
...
c_halo1_tools_pc32_tag_group_definition::c_halo1_tools_pc32_tag_group_definition(c_halo1_tools_pc32_tag_definition_manager& _tag_definition_manager, ptr32 _definition_address) :
	c_blamtoozle_tag_group_definition(_tag_definition_manager),
	definition_address(_definition_address),
	group_definition(tag_definition_manager.read_structure<s_halo1_tools_pc32_tag_group_definition>(_definition_address)),
...
c_halo1_tools_pc32_tag_group_definition::~c_halo1_tools_pc32_tag_group_definition()
{

}

void c_halo1_tools_pc32_tag_group_definition::traverse()
{
...
const char* c_halo1_tools_pc32_tag_group_definition::get_name()
{
	return name;
}

const char* c_halo1_tools_pc32_tag_group_definition::get_code_symbol_name()
{
	return code_symbol_name.c_str();
}

const char* c_halo1_tools_pc32_tag_group_definition::get_group_tag_macro_name()
{
	return group_tag_macro_name.c_str();
}

tag c_halo1_tools_pc32_tag_group_definition::get_group_tag()
{
	return group_definition.group_tag;
}

tag c_halo1_tools_pc32_tag_group_definition::get_parent_group_tag()
{
	return group_definition.parent_group_tag;
}

c_blamtoozle_tag_block_definition& c_halo1_tools_pc32_tag_group_definition::get_block_definition()
{
