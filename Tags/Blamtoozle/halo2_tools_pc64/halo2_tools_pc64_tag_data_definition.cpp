...
template<> void byteswap_inplace(s_halo2_tools_pc64_tag_data_definition& value)
{
...
c_halo2_tools_pc64_tag_data_definition::c_halo2_tools_pc64_tag_data_definition(c_halo2_tools_pc64_tag_definition_manager& _tag_definition_manager, ptr32 _definition_address) :
	c_blamtoozle_tag_data_definition(_tag_definition_manager),
	definition_address(_definition_address),
	data_definition(tag_definition_manager.read_structure<s_halo2_tools_pc64_tag_data_definition>(_definition_address)),
...
c_halo2_tools_pc64_tag_data_definition::~c_halo2_tools_pc64_tag_data_definition()
{

}

const char* c_halo2_tools_pc64_tag_data_definition::get_name()
{
	return name;
}

const char* c_halo2_tools_pc64_tag_data_definition::get_code_symbol_name()
{
	return code_symbol_name.c_str();
}

unsigned long c_halo2_tools_pc64_tag_data_definition::get_flags()
{
	return data_definition.flags;
}

unsigned long c_halo2_tools_pc64_tag_data_definition::get_alignment_bits()
{
	return data_definition.alignment_bit;
}

unsigned long c_halo2_tools_pc64_tag_data_definition::get_maximum_element_count()
{
	return data_definition.maximum_element_count;
}

const char* c_halo2_tools_pc64_tag_data_definition::get_maximum_element_count_string()
{
