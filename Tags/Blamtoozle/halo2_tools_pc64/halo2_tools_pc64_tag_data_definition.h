...
struct s_halo2_tools_pc64_tag_data_definition
{
	ptr32 name_address;
	unsigned long flags;
...
constexpr size_t k_halo2_tools_pc64_tag_data_definition_size = sizeof(s_halo2_tools_pc64_tag_data_definition);
static_assert(k_halo2_tools_pc64_tag_data_definition_size == 44);

class c_halo2_tools_pc64_tag_data_definition :
	public c_blamtoozle_tag_data_definition
{
protected:
	c_halo2_tools_pc64_tag_data_definition(c_halo2_tools_pc64_tag_definition_manager& tag_definition_manager, ptr32 definition_address);
	c_halo2_tools_pc64_tag_data_definition(const c_halo2_tools_pc64_tag_data_definition&) = delete;
	c_halo2_tools_pc64_tag_data_definition(c_halo2_tools_pc64_tag_data_definition&&) = delete;
	~c_halo2_tools_pc64_tag_data_definition();
...
protected:
	...
	s_halo2_tools_pc64_tag_data_definition data_definition;
	const char* name;
