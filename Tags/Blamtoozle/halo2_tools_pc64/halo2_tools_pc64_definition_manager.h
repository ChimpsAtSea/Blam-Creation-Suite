...
class c_halo2_tools_pc64_tag_array_struct_definition;
class c_halo2_tools_pc64_tag_array_definition;
class c_halo2_tools_pc64_string_list_definition;
class c_halo2_tools_pc64_tag_data_definition;
class c_halo2_tools_pc64_tag_block_index_custom_search_definition;
class c_halo2_tools_pc64_tag_field;

class c_halo2_tools_pc64_tag_definition_manager :
...
public:
	...
	friend c_halo2_tools_pc64_tag_reference_definition;
	friend c_halo2_tools_pc64_tag_struct_definition;
	friend c_halo2_tools_pc64_tag_array_definition;
	friend c_halo2_tools_pc64_string_list_definition;
...
protected:
	c_halo2_tools_pc64_tag_block_definition& eval_block(ptr32 definition_address);
	c_halo2_tools_pc64_tag_reference_definition& eval_tag_reference(ptr32 definition_address);
	c_halo2_tools_pc64_tag_struct_definition& eval_struct(ptr32 definition_address);
	c_halo2_tools_pc64_tag_array_struct_definition& eval_array_struct(ptr32 definition_address);
	c_halo2_tools_pc64_tag_array_definition& eval_array(ptr32 definition_address);
	c_halo2_tools_pc64_string_list_definition& eval_string_list(ptr32 definition_address);
	c_halo2_tools_pc64_tag_data_definition& eval_data(ptr32 definition_address);
	c_halo2_tools_pc64_tag_block_index_custom_search_definition& eval_block_index_custom_search(ptr32 definition_address);

	std::vector<c_halo2_tools_pc64_tag_group_definition*>& tag_group_definitions;
