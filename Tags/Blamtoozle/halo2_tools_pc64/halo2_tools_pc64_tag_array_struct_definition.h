...
{
protected:
	c_halo2_tools_pc64_tag_array_struct_definition(c_halo2_tools_pc64_tag_definition_manager& tag_definition_manager, ptr32 definition_address);
	c_halo2_tools_pc64_tag_array_struct_definition(const c_halo2_tools_pc64_tag_array_struct_definition&) = delete;
	c_halo2_tools_pc64_tag_array_struct_definition(c_halo2_tools_pc64_tag_array_struct_definition&&) = delete;
	~c_halo2_tools_pc64_tag_array_struct_definition();
