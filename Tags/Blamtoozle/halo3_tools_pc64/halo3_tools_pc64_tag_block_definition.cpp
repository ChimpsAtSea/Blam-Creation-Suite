...
template<> void byteswap_inplace(s_halo3_tools_pc64_tag_block_definition& value)
{
...
c_halo3_tools_pc64_tag_block_definition::c_halo3_tools_pc64_tag_block_definition(c_halo3_tools_pc64_tag_definition_manager& _tag_definition_manager, ptr64 _definition_address) :
	c_blamtoozle_tag_block_definition(_tag_definition_manager),
	definition_address(_definition_address),
	block_definition(tag_definition_manager.read_structure<s_halo3_tools_pc64_tag_block_definition>(_definition_address)),
...
c_halo3_tools_pc64_tag_block_definition::~c_halo3_tools_pc64_tag_block_definition()
{

}

const char* c_halo3_tools_pc64_tag_block_definition::get_display_name()
{
	return display_name;
}

const char* c_halo3_tools_pc64_tag_block_definition::get_name()
{
	return name;
}

const char* c_halo3_tools_pc64_tag_block_definition::get_code_symbol_name()
{
	return code_symbol_name.c_str();
}

unsigned long c_halo3_tools_pc64_tag_block_definition::get_max_count()
{
	return block_definition.max_count;
}

const char* c_halo3_tools_pc64_tag_block_definition::get_max_count_string()
{
	return max_count_string;
}

c_blamtoozle_tag_struct_definition& c_halo3_tools_pc64_tag_block_definition::get_struct_definition()
{
	return struct_definition;
}

void c_halo3_tools_pc64_tag_block_definition::associate_tag_group_definition(c_blamtoozle_tag_group_definition* tag_group_definition)
{
	c_blamtoozle_tag_block_definition::associate_tag_group_definition(tag_group_definition);
	make_code_symbol_name();
}

void c_halo3_tools_pc64_tag_block_definition::make_code_symbol_name()
{
