...
{
public:
	BCS_SHARED c_halo3_tools_pc64_tag_definition_manager(const wchar_t* minidump_file_path);
	BCS_SHARED virtual ~c_halo3_tools_pc64_tag_definition_manager();
...
protected:
	...
	std::vector<c_halo3_tools_pc64_string_list_definition*>& tag_string_list_definitions;
	...
	std::vector<c_halo3_tools_pc64_tag_block_index_custom_search_definition*>& tag_block_index_custom_search_definitions;
	...
	std::map<ptr64, c_halo3_tools_pc64_string_list_definition*>& tag_string_list_definitions_lookup;
	...
	std::map<ptr64, c_halo3_tools_pc64_tag_block_index_custom_search_definition*>& tag_block_index_custom_search_definitions_lookup;
};
