...
template<> void byteswap_inplace(s_halo3_tools_pc64_tag_array_definition& value)
{
...
c_halo3_tools_pc64_tag_array_definition::c_halo3_tools_pc64_tag_array_definition(c_halo3_tools_pc64_tag_definition_manager& _tag_definition_manager, ptr64 _definition_address) :
	c_blamtoozle_tag_array_definition(_tag_definition_manager),
	definition_address(_definition_address),
	array_definition(tag_definition_manager.read_structure<s_halo3_tools_pc64_tag_array_definition>(_definition_address)),
...
c_halo3_tools_pc64_tag_array_definition::~c_halo3_tools_pc64_tag_array_definition()
{

}

const char* c_halo3_tools_pc64_tag_array_definition::get_name()
{
	return name;
}

const char* c_halo3_tools_pc64_tag_array_definition::get_code_symbol_name()
{
	return code_symbol_name.c_str();
}

unsigned long c_halo3_tools_pc64_tag_array_definition::get_element_count()
{
	return array_definition.element_count;
}

const char* c_halo3_tools_pc64_tag_array_definition::get_element_count_string()
{
	return element_count_string;
}

c_blamtoozle_tag_struct_definition& c_halo3_tools_pc64_tag_array_definition::get_struct_definition()
{
