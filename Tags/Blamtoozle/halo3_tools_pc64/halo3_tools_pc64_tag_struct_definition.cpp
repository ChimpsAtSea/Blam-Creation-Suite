...
unsigned long c_halo3_tools_pc64_tag_struct_definition::get_structure_size()
{
	return struct_definition.type.structure_size;
}

const char* c_halo3_tools_pc64_tag_struct_definition::get_structure_size_string()
{
