...
template<> void byteswap_inplace(s_halo3_tools_pc64_tag_reference_definition& value)
{
...
c_halo3_tools_pc64_tag_reference_definition::c_halo3_tools_pc64_tag_reference_definition(c_halo3_tools_pc64_tag_definition_manager& _tag_definition_manager, ptr64 _definition_address) :
	c_blamtoozle_tag_reference_definition(_tag_definition_manager),
	definition_address(_definition_address),
	reference_definition(tag_definition_manager.read_structure<s_halo3_tools_pc64_tag_reference_definition>(_definition_address)),
	name(),
	code_symbol_name()
{
	...
	{
		ptr64 group_tags_address = reference_definition.group_tags_address;
...
const char* c_halo3_tools_pc64_tag_reference_definition::get_name()
{
	return name.c_str();
}

const char* c_halo3_tools_pc64_tag_reference_definition::get_code_symbol_name()
{
	return code_symbol_name.c_str();
}

c_flags<blofeld::e_tag_reference_flags> c_halo3_tools_pc64_tag_reference_definition::get_tag_reference_flags()
{
