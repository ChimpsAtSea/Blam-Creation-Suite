...
{
	return eval_definition<c_halo3_tools_pc64_tag_definition_manager>(definition_address, tag_string_list_definitions, tag_string_list_definitions_lookup);
}
...
{
	return eval_definition<c_halo3_tools_pc64_tag_definition_manager>(definition_address, tag_block_index_custom_search_definitions, tag_block_index_custom_search_definitions_lookup);
}
