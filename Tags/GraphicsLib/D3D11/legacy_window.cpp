...
//{
//	void* process_module;
//	if (BCS_SUCCEEDED(get_process_module(process_module)))
//	{
//		e_bcs_resource_type window_icon_to_resource_type[] =
//		{
//			_bcs_resource_type_icon_application,
//			_bcs_resource_type_icon_blam_creation_suite,
//			_bcs_resource_type_icon_mandrill,
//		};
//		static_assert(_countof(window_icon_to_resource_type) == k_number_of_window_icons);
//
//		e_bcs_resource_type resource_type = window_icon_to_resource_type[window_icon];
//		resources_get_resource_icon_handle(resource_type, icon_handle);
//	}
//
//	SetProcessDPIAware();
//
...
//
//	width_integer = static_cast<unsigned long>(__max(1, rect.right - rect.left));
//	height_integer = static_cast<unsigned long>(__max(1, rect.bottom - rect.top));
