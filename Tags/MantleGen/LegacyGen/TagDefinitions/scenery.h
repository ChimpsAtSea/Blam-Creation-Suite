...
struct nicename("scenery") tag_group('scen') s_scenery_definition_legacy
{
	...
	{
		/*nicename("Cut-Out")*/ _pathfinding_policy_cut_out = 0ui16,
		/*nicename("Static")*/ _pathfinding_policy_static = 1ui16,
	...
	{
		/*nicename("Per-Vertex")*/ _lightmapping_policy_per_vertex = 0ui16,
		/*nicename("Per-Pixel (Not Implemented)")*/ _lightmapping_policy_per_pixel_not_implemented = 1ui16,
	...
	{
		/*nicename("Physically Simulates")*/ _flags1_physically_simulates = 1ui16 << 0ui16,
