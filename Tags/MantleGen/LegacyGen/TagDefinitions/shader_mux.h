...
struct nicename("shader_mux") tag_group('rmmx') s_shader_mux_definition_legacy
{
	...
	int32_t __unknown13;
	string_id_legacy nicename("Material 1") material_1;
	string_id_legacy nicename("Material 2") material_2;
	string_id_legacy nicename("Material 3") material_3;
	string_id_legacy nicename("Material 4") material_4;
	string_id_legacy nicename("Material 5") material_5;
	string_id_legacy nicename("Material 6") material_6;
	string_id_legacy nicename("Material 7") material_7;
	string_id_legacy nicename("Material 8") material_8;
	...
	int16_t nicename("Global Material Index 4") global_material_index_4;
	int16_t nicename("Global Material Index 5") global_material_index_5;
	int16_t nicename("Global Material Index 6") global_material_index_6;
	int16_t nicename("Global Material Index 7") global_material_index_7;
	int16_t nicename("Global Material Index 8") global_material_index_8;
