...
struct nicename("sound_scenery") tag_group('ssce') s_sound_scenery_definition_legacy
{
	...
	float nicename("Cone Angle min") cone_angle_min;
	float nicename("Cone Angle max") cone_angle_max;
};
