...
struct nicename("device_control") tag_group('ctrl') s_device_control_definition_legacy
{
	...
	s_tag_reference_legacy nicename("On") on_reference;
	s_tag_reference_legacy nicename("Off") off_reference;
	s_tag_reference_legacy nicename("Deny") deny_reference;
};
