...
{
	blofeld::s_tag_group const& group = get_blofeld_group_definition();
	return group.name;
}
...
{
	blofeld::s_tag_group const& tag_group = group != nullptr ? group->tag_group : get_blofeld_group_definition();
