...
namespace blofeld
{
	...
	extern s_tag_struct_definition multilingual_unicode_string_reference_block_block_struct;
	extern s_tag_block_definition multilingual_unicode_string_reference_block_block;
	extern s_tag_struct_definition string_substitution_pair_block_block_struct;
