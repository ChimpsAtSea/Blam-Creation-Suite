...
namespace blofeld
{
	...
	{
		FIELD_EXPLANATION_EX("underwater propagation globals", nullptr, FIELD_FLAG_NONE, ""),
		...
		SOUND_OLD_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION_EX("sub priority", nullptr, FIELD_FLAG_NONE, "Used to compare individual sounds in the same class. Higher means more important. (Negative means do not use.)"),
		{ _field_real, "sub priority" },
		FIELD_EXPLANATION_EX("import properties", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_PAD_EX("runtime pad", nullptr, FIELD_FLAG_UNKNOWN3, 4),
		...
		SOUND_MIX_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION_EX("first person surround mix", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_struct, "first person surround mix", &sound_surround_mix_struct },
		FIELD_EXPLANATION_EX("ambient surround mix", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_struct, "ambient surround mix", &sound_surround_mix_struct },
		FIELD_EXPLANATION_EX("global mix", nullptr, FIELD_FLAG_NONE, ""),
		...
		SOUND_PITCH_RANGE_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("KCTSDWPP", nullptr, FIELD_FLAG_UNKNOWN3, 2),
		...
		FIELD_PAD_EX("YAMTVB", nullptr, FIELD_FLAG_UNKNOWN3, 4),
		...
		FIELD_PAD_EX("asdf", nullptr, FIELD_FLAG_NONE, 2),
	...
	{
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_sound_player),
		...
		SOUND_PERMUTATION_RAW_INFO_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("ZHDGBHWS", nullptr, FIELD_FLAG_NONE, 1),
		...
		SOUND_PERMUTATION_MARKER_BLOCK_ID)
	{
		...
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_unknown_player),
		{ _field_terminator }
	};
		...
		SOUND_DIALOGUE_CONSTANTS_STRUCT_DEFINITION_ID)
	{
		...
		{ _field_real, "often" },
		FIELD_PAD_EX("VBEZIIDOF", nullptr, FIELD_FLAG_NONE, 24),
		{ _field_terminator }
	};
	...
	{
		FIELD_EXPLANATION_EX("attenuation distances", nullptr, FIELD_FLAG_NONE, "these settings vary how the sound fades as you move closer or further away from it."),
	...
	{
		FIELD_EXPLANATION_EX("default obstruction settings", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_struct, "obstruction settings", &global_sound_lowpass_block },
		FIELD_EXPLANATION_EX("default occlusion settings", nullptr, FIELD_FLAG_NONE, ""),
		...
		SOUND_GLOBAL_MIX_STRUCT_ID)
	{
		...
		FIELD_EXPLANATION_EX("surround center mix", nullptr, FIELD_FLAG_NONE, "for sounds that have \"use center speaker unspatialized\" checked when outputting in surround"),
		{ _field_struct, "surround center mix", &sound_center_mix_struct },
		FIELD_EXPLANATION_EX("stereo center mix", nullptr, FIELD_FLAG_NONE, "for sounds that have \"use center speaker unspatialized\" checked when outputting in stereo"),
		{ _field_struct, "stereo center mix", &sound_center_mix_struct },
		FIELD_EXPLANATION_EX("radio surround center mix", nullptr, FIELD_FLAG_NONE, "for the radio effect when outputting in surround"),
		{ _field_struct, "radio surround center mix", &sound_center_mix_struct },
		FIELD_EXPLANATION_EX("radio stereo center mix", nullptr, FIELD_FLAG_NONE, "for the radio effect when outputting in stereo"),
		{ _field_struct, "radio stereo center mix", &sound_center_mix_struct },
		FIELD_EXPLANATION_EX("more sound lovin'", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_real, "stereo unspatialized gain", nullptr, "dB" },
		{ _field_real, "quad route to lfe gain", nullptr, "dB" },
		FIELD_EXPLANATION_EX("last minute values", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("debugging stuff", nullptr, FIELD_FLAG_NONE, ""),
