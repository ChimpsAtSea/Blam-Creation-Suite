...
namespace blofeld
{
		...
		SOUND_CLASS_BLOCK_STRUCT_ID)
	{
		...
		FIELD_PAD_EX("sadf", nullptr, FIELD_FLAG_NONE, 3),
		FIELD_EXPLANATION_EX("air propagation", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("underwater propagation", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("lowpass wetmixes", nullptr, FIELD_FLAG_NONE, ""),
		FIELD_CUSTOM_EX("equipment lowpass", "sets the lowpass wet mix when an equiment is active", FIELD_FLAG_NONE, _field_id_slider_editor),
		...
		FIELD_CUSTOM_EX("environment forced lowpass", "sets the lowpass wet mix when an environment forced lowpass is active", FIELD_FLAG_NONE, _field_id_slider_editor),
		...
		FIELD_CUSTOM_EX("effect lowpass", "sets the lowpass wet mix when a lowpass effect is active", FIELD_FLAG_NONE, _field_id_slider_editor),
		{ _field_real, "effect lowpass", "sets the lowpass wet mix when a lowpass effect is active", "wetmix", _field_id_slider_editor },
		FIELD_EXPLANATION_EX("ducking", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_PAD_EX("B", nullptr, FIELD_FLAG_NONE, 3),
