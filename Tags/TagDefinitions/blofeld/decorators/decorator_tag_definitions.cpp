...
namespace blofeld
{
		...
		DECORATOR_SET_STRUCT_DEFINITION_ID)
	{
		...
		{ _field_tag_reference, "Base", MAKE_ALT_NAMES("render model"), FIELD_FLAG_READ_ONLY, &render_model_reference },
		{ _field_tag_reference, "Lod2", MAKE_ALT_NAMES("render model_lod1"), FIELD_FLAG_READ_ONLY, &render_model_reference },
		{ _field_tag_reference, "Lod3", MAKE_ALT_NAMES("render model_lod2"), FIELD_FLAG_READ_ONLY, &render_model_reference },
		{ _field_tag_reference, "Lod4", MAKE_ALT_NAMES("render model_lod3"), FIELD_FLAG_READ_ONLY, &render_model_reference },
		...
		{ _field_real, "decimate to", "0 means all the way removed. 100 means nothing", MAKE_ALT_NAMES("max decimation percentage"), FIELD_FLAG_UNKNOWN0 },
