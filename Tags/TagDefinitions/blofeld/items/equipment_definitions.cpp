...
namespace blofeld
{
		...
		EQUIPMENTABILITYDATUM_ID)
	{
		...
		FIELD_EXPLANATION_EX("Energy", nullptr, FIELD_FLAG_NONE, "All these fields are additive, meaning a negative number will reduce energy and a positive one will increase energy.  Every piece of equipment starts at 1.0 energy"),
		...
		FIELD_CUSTOM_EX("Type Definitions", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		...
		EQUIPMENTABILITYTYPEAISPAWNERBLOCK_ID)
	{
		...
		{ _field_real, "spawn velocity", "WU/sec" },
		{ _field_enum, "type", &equipment_spawner_spawn_type },
		FIELD_PAD_EX("RFD", nullptr, FIELD_FLAG_NONE, 2),
		...
		EQUIPMENTABILITYTYPEINVINCIBILITYBLOCK_ID)
	{
		...
		FIELD_PAD_EX("invincibility material pad", nullptr, FIELD_FLAG_NONE, 2),
	...
	{
		FIELD_SKIP_EX("radius", nullptr, FIELD_FLAG_NONE, 4),
	...
	{
		FIELD_EXPLANATION_EX("Appearance Traits", nullptr, FIELD_FLAG_NONE, "Traits that affect the AI\'s appearance"),
		...
		EQUIPMENTABILITYTYPESTASISFIELDBLOCK_ID)
	{
		{ _field_long_flags, "flags", &repulsor_field_flags },
		{ _field_real, "radius", nullptr, "wu" },
		FIELD_CUSTOM_EX("Time Dilation Values", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		FIELD_EXPLANATION_EX("Time Dilation", nullptr, FIELD_FLAG_NONE, "The effective rate at which time passes for objects in the field.  Values below 0.45 screw up jumping."),
		...
		EQUIPMENTABILITYTYPEBALLLIGHTNINGBLOCK_ID)
	{
		...
		FIELD_EXPLANATION_EX("Ball Lightning", nullptr, FIELD_FLAG_NONE, "Damage effect that passes from one biped to nearby bipeds, recursively"),
		...
		EQUIPMENTABILITYTYPEDADDYBLOCK_ID)
	{
		...
		FIELD_PAD_EX("dada", nullptr, FIELD_FLAG_NONE, 2),
	...
	{
		FIELD_PAD_EX("haha", nullptr, FIELD_FLAG_NONE, 1),
		{ _field_terminator }
	};
	...
	{
		FIELD_EXPLANATION_EX("Teleporter", nullptr, FIELD_FLAG_NONE, "This causes you to warp forward.  It\'ll trace the path with an effect at the specified speed, then spawn you at the end of it."),
		{ _field_byte_flags, "flags", &teleporterFlags },
		FIELD_PAD_EX("blurgh", nullptr, FIELD_FLAG_NONE, 3),
		...
		FIELD_CUSTOM_EX("Search Vector", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		FIELD_EXPLANATION_EX("Look Vector Weight", nullptr, FIELD_FLAG_NONE, "If \"force along aim vector\" isn\'t checked, the start vector will be your motion vector, plus some amount of weight for where you\'re looking, if you\'re moving along your look vector."),
		...
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_field_group_end),
		FIELD_CUSTOM_EX("Probes", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		FIELD_EXPLANATION_EX("Probe", nullptr, FIELD_FLAG_NONE, "If \"disable extra probes\" isn\'t checked, we\'ll do a fan of rays vertically from our central vector, with one probe horizontally on either side of each of those rays."),
		...
		FIELD_EXPLANATION_EX("Collision", nullptr, FIELD_FLAG_NONE, "If \"hide unit during transit\" isn\'t checked, we\'ll add a cow-catcher collision volume on the front and change the collision damage type."),
		{ _field_block, "cow catcher parameters", &equipmentAbilityPartCowCatcherBlock_block },
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_field_group_end),
		{ _field_terminator }
	};
		...
		EQUIPMENTABILITYTYPEAUTOTURRETBLOCK_ID)
	{
		...
		FIELD_PAD_EX("atf", nullptr, FIELD_FLAG_NONE, 3),
		...
		EQUIPMENTABILITYTYPEVISIONMODEBLOCK_ID)
	{
		...
		FIELD_PAD_EX("vmbf", nullptr, FIELD_FLAG_NONE, 3),
		...
		EQUIPMENTABILITYTYPEREMOTESTRIKEBLOCK_ID)
	{
		...
		FIELD_PAD_EX("rso", nullptr, FIELD_FLAG_NONE, 3),
		{ _field_terminator }
	};
		...
		EQUIPMENTABILITYTYPEEQUIPMENTHACKERBLOCK_ID)
	{
		...
		FIELD_PAD_EX("grue", nullptr, FIELD_FLAG_NONE, 3),
		...
		EQUIPMENT_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_CUSTOM_EX("AI", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		FIELD_EXPLANATION_EX("AI", nullptr, FIELD_FLAG_NONE, "Settings which the AI use to know how they should react to this equipment"),
		...
		FIELD_PAD_EX("LKSHFDIJ", nullptr, FIELD_FLAG_NONE, 3),
