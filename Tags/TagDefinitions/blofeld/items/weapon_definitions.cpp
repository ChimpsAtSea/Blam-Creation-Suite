...
namespace blofeld
{
	...
	TAG_GROUP_INHERIT(weapon, WEAPON_TAG, item, ITEM_TAG)
	{
		...
		{ _field_explanation, "aim swim indexing" },
	...
	{
		{ _field_explanation, "melee damage parameters" },
	...
	TAG_BLOCK(weapon_barrels, k_weapon_barrel_count)
	{
		...
		{ _field_explanation, "prediction properties" },
		...
		{ _field_explanation, "firing error" },
	...
	TAG_BLOCK(weaponScaleshotStruct, 1)
	{
		...
		{ _field_explanation, "power levels" },
	...
	TAG_STRUCT(weapon_barrel_projectile_accuracy_penalty_struct)
	{
		...
		{ _field_explanation, "barrel_error penalty functions" },
