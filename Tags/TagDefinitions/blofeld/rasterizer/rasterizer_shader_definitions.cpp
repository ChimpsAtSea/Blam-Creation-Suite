...
namespace blofeld
{
	...
	#define COMPUTE_SHADER_STRUCT_DEFINITION_ID { 0x60FD71E9, 0xC5654B09, 0xBE6F6918, 0x7C935A75 }
	TAG_BLOCK(
		compute_shader_block,
		"compute_shader_block",
		1,
		"c_rasterizer_compute_shader",
		SET_UNKNOWN0 | SET_UNKNOWN5 | SET_DELETE_RECURSIVELY | SET_POSTPROCESS_RECURSIVELY | SET_HAS_LEVEL_SPECIFIC_FIELDS,
		TAG_MEMORY_ATTRIBUTES(MEMORY_ALLOCATION_NODE, TAG_MEMORY_USAGE_READ_ONLY),
		COMPUTE_SHADER_STRUCT_DEFINITION_ID)
	{
		...
		{ _field_dword_integer, "version", FIELD_FLAG_READ_ONLY },
		{ _field_block, "compiled shaders", &compiled_compute_shader_block },
		{ _field_terminator }
	};
	...
	#define COMPILED_COMPUTE_SHADER_BLOCK_ID { 0x3543DB1D, 0x836C4843, 0xB307E446, 0x83BD276F }
	TAG_BLOCK(
		compiled_compute_shader_block,
		"compiled_compute_shader_block",
		10*k_kilo,
		"c_rasterizer_compiled_compute_shader",
		SET_UNKNOWN0 | SET_UNKNOWN1 | SET_UNKNOWN5 | SET_DELETE_RECURSIVELY | SET_POSTPROCESS_RECURSIVELY | SET_HAS_LEVEL_SPECIFIC_FIELDS,
		TAG_MEMORY_ATTRIBUTES(MEMORY_ALLOCATION_NODE, TAG_MEMORY_USAGE_WRITEABLE),
	...
	#define COMPUTE_ENTRY_POINT_BLOCK_ID { 0x1E202E95, 0x06BA407D, 0x9B57749D, 0xC19E5EF2 }
	TAG_BLOCK(
