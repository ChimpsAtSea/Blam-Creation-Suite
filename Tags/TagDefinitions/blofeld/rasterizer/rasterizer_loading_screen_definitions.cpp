...
namespace blofeld
{
		...
		LOAD_SCREEN_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION("Model parameters", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION("Camera parameters", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION("Particles", nullptr, FIELD_FLAG_NONE, "The following control particle behavior"),
		...
		FIELD_EXPLANATION("Generated data", nullptr, FIELD_FLAG_NONE, "the following are generated from running the tool generate-loadscreen command on this tag."),
