...
namespace blofeld
{
		...
		EXPLICIT_SHADER_REFS_BLOCK_ID)
	{
		...
		{ _version_mode_less, _engine_type_halo4, 1 },
		...
		RASTERIZER_GLOBALS_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION_EX("Lighting layer debug mode albedo override", nullptr, FIELD_FLAG_NONE, "By default the engine uses linear 50% grey\nSet a non-black color to override this debug color\n"),
