...
namespace blofeld
{
	...
	TAG_STRUCT(rasterizer_globals_struct_definition)
	{
		...
		{ _field_explanation, "Lighting layer debug mode albedo override", "By default the engine uses linear 50% grey\nSet a non-black color to override this debug color\n" },
