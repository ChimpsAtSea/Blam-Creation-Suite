...
namespace blofeld
{
	...
	{
		{ _field_legacy, _field_long_flags, "options", &global_bitmap_flags },
		{ _field_legacy, _field_tag_reference, "default bitmaps", &bitmap_reference$11 },
		{ _field_legacy, _field_terminator }
	};

	V5_TAG_BLOCK(material_textures_refs_block, 16)
	{
		{ _field_legacy, _field_tag_reference, "material textures", &global_bitmap_reference },
		{ _field_legacy, _field_terminator }
	};
	...
	V5_TAG_BLOCK(explicit_shader_refs_block, 256)
	{
		...
		{ _field_legacy, _field_tag_reference, "explicit vertex shader", &explicit_shader_refs_block_explicit_vertex_shader_reference },
		{ _field_legacy, _field_tag_reference, "explicit pixel shader^", &explicit_shader_refs_block_explicit_pixel_shader_reference },
	...
	{
		{ _field_legacy, _field_explanation, "default bitmaps:", "0:  ............... default 2D texture (white)\n1:  ............... default normal map (no bump)\n2:  ............... default cube map (error pattern)\n3:  ............... color bars\n4:  ............... black 2D texture\n5:  ............... transparent black 2D texture\n6:  ............... gray 2D texture\n7:  ............... auto exposure weight\n8:  ............... auto exposure weight (4x3)\n9:  ............... stencil dither pattern\n10: ............... smooth noise warp\n11: ............... ripple pattern\n12: ............... rain ripple\n13: ............... unsigned noise\n14: ............... MLAA area map\n15: ............... red 2D texture\n16: ............... green 2D texture\n17: ............... blue 2D texture\n18: ............... cyan 2D texture\n19: ............... dxt5 atlas texture\n20: ............... dxn atlas texture\n" },
		{ _field_legacy, _field_block, "default bitmaps", &default_textures_refs_block_block },
		{ _field_legacy, _field_explanation, "material textures:", "0: ............... lightmap falloff sharpening\n6: ............... Approximate specular curve\n" },
		{ _field_legacy, _field_block, "material textures", &material_textures_refs_block_block },
		...
		{ _field_legacy, _field_tag_reference, "Active Camo Distortion Texture", &global_bitmap_reference },

		{ _field_legacy, _field_tag_reference, "default performance throttles", &global_performance_throttles_reference },
		{ _field_legacy, _field_tag_reference, "Logo Texture", &global_bitmap_reference },

		{ _field_legacy, _field_version_greater, _engine_type_halo3, 2 },
		{ _field_legacy, _field_tag_reference, "Cheap Particle Type Library", &cheap_particle_type_library_reference$2 },
		{ _field_legacy, _field_tag_reference, "Emblem Library", &global_emblem_library_parameters_reference },

		{ _field_legacy, _field_version_less_or_equal, _engine_type_haloreach, 1 },
		{ _field_legacy, _field_long_integer, "unknown@" },

		{ _field_legacy, _field_explanation, "Motion blur parameters:", "max blur:............  max amount to blur, as a percentage of the screen\nblur scale:..........  scales blur for a given velocity\ncenter falloff:....... reduces motion blur around the screen center (larger values give smaller reduction regions...)\nexpected dt:.......... expected time per tick, in seconds (used to correct motion blur in fast/slow frames)\n" },
		{ _field_legacy, _field_real, "max blur{max blur x}:[0 - 0.2]#max amount to blur, as a percentage of the screen" },
		{ _field_legacy, _field_real, "blur scale{blur scale x}:[0 - 0.5]#scales blur for a given velocity" },
		{ _field_legacy, _field_real, "center falloff x:[0 - 20]#larger values make smaller areas of no blur" },
		{ _field_legacy, _field_real, "center falloff y:[0 - 20]#larger values make smaller areas of no blur" },
		{ _field_legacy, _field_explanation, "screen space light parameters:", "" },
		{ _field_legacy, _field_real, "cheap albedo blend#for all screen space light without shader reference" },
		...
		{ _field_legacy, _field_explanation, "Lighting layer debug mode albedo override", "By default the engine uses linear 50% grey\nSet a non-black color to override this debug color\n" },
		{ _field_legacy, _field_real_rgb_color, "lighting layer albedo color#the floating point values are linear and what the shader will sample for albedo" },
		{ _field_legacy, _field_tag_reference, "Hologram Camera FX", &global_camera_fx_settings_reference },
		{ _field_legacy, _field_tag_reference, "Global load screen model", &global_loadscreen_reference },
		{ _field_legacy, _field_real, "Global load screen gradient coordinate" },
		{ _field_legacy, _field_tag_reference, "airprobe render model", &render_model_reference$8 },
