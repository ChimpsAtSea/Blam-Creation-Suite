...
namespace blofeld
{
	...
	extern s_tag_struct_definition bitmap_texture_interop_resource_struct_struct_definition;
	extern s_tag_struct_definition stitchable_bitmap_texture_interop_resource_struct_struct_definition;
	extern s_tag_struct_definition bitmap_texture_interleaved_interop_resource_struct_struct_definition;
