...
namespace blofeld
{
	...
	extern s_tag_struct_definition imposter_mode_node_block_block_struct;
	extern s_tag_block_definition imposter_mode_node_block_block;
	extern s_tag_struct_definition render_model_permutation_block_block_struct;
	extern s_tag_block_definition render_model_permutation_block_block;
	extern s_tag_struct_definition render_model_region_block_block_struct;
	extern s_tag_block_definition render_model_region_block_block;
	extern s_tag_block_definition imposter_model_block_block;
	extern s_tag_struct_definition render_model_node_block_block_struct;
	extern s_tag_block_definition render_model_node_block_block;
	extern s_tag_struct_definition render_model_marker_block_block_struct;
	extern s_tag_block_definition render_model_marker_block_block;
	extern s_tag_struct_definition render_model_marker_group_block_block_struct;
	extern s_tag_block_definition render_model_marker_group_block_block;
	extern s_tag_struct_definition instance_node_map_mapping_block_block_struct;
	extern s_tag_block_definition instance_node_map_mapping_block_block;
	extern s_tag_struct_definition volume_samples_block_block_struct;
	extern s_tag_block_definition volume_samples_block_block;
	extern s_tag_struct_definition default_node_orientations_block_block_struct;
	extern s_tag_block_definition default_node_orientations_block_block;
	extern s_tag_struct_definition RenderModelNodeIndexBlock_block_struct;
	extern s_tag_block_definition RenderModelNodeIndexBlock_block;
	extern s_tag_struct_definition RenderModelBoneGroupBlock_block_struct;
