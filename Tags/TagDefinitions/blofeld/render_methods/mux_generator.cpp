...
namespace blofeld
{
		...
		MUX_GENERATOR_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION("TARGETS", nullptr, FIELD_FLAG_NONE, "these will be filled out automatically if you don\'t specify them\nthese are the tags that will be modified by this mux generator\n"),
