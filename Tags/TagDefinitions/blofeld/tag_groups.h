...
namespace blofeld
{
	extern const s_tag_group* tag_groups_halo1[];
	extern const s_tag_group* tag_groups_stubbs[];
	extern const s_tag_group* tag_groups_halo2[];
	extern const s_tag_group* tag_groups_halo3[];
	extern const s_tag_group* tag_groups_halo3odst[];
	extern const s_tag_group* tag_groups_eldorado[];
	extern const s_tag_group* tag_groups_haloreach[];
	extern const s_tag_group* tag_groups_halo4[];
	extern const s_tag_group* tag_groups_gen3_xbox360[];
	extern const s_tag_group* tag_groups_groundhog[];
		
	extern const s_tag_group** tag_groups[k_number_of_engine_types];
} // namespace blofeld
