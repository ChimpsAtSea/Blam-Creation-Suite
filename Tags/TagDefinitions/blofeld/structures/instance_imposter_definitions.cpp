...
namespace blofeld
{
	...
	{
		{ _field_legacy, _field_short_integer, "group index" },
		{ _field_legacy, _field_char_integer, "subpart_index" },
		{ _field_legacy, _field_byte_flags, "flags", &instance_imposter_element_flags_definition },
	...
	V5_TAG_BLOCK(instance_imposter_checksum_block, k_maximum_instance_geometry_instances_per_structure_bsp)
	{
		...
		{ _field_legacy, _field_long_integer, "import checksum" },
		{ _field_legacy, _field_long_integer, "transform checksum" },
		...
		{ _field_legacy, _field_short_integer, "imposter version" },
		{ _field_legacy, _field_char_integer, "imposter policy" },
		{ _field_legacy, _field_pad, "padefefrdapad", 1 },
	...
	{
		{ _field_legacy, _field_long_flags, "flags", &instance_imposter_flags_definition },
		{ _field_legacy, _field_string_id, "bsp name" },
		{ _field_legacy, _field_long_integer, "checksum" },
		{ _field_legacy, _field_string_id, "source metadata path" },
		{ _field_legacy, _field_block, "instances", &instance_imposter_block_block },
		{ _field_legacy, _field_block, "instance checksums", &instance_imposter_checksum_block_block },
		{ _field_legacy, _field_custom, "atlas info" },
		{ _field_legacy, _field_short_integer, "atlas tile resolution" },
		{ _field_legacy, _field_char_integer, "atlas x tile count" },
		{ _field_legacy, _field_char_integer, "atlas y tile count" },
		{ _field_legacy, _field_tag_reference, "atlas texture", &global_bitmap_reference },
		{ _field_legacy, _field_custom },
		{ _field_legacy, _field_custom, "mesh data" },
