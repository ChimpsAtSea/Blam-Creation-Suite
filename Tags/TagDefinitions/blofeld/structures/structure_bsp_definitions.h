...
namespace blofeld
{
	...
	extern s_tag_struct_definition scenario_structure_bsp_block_struct_definition; // scenario_structure_bsp_block

	extern s_tag_struct_definition haloreach_sbsp_unknown_block_struct_definition;
