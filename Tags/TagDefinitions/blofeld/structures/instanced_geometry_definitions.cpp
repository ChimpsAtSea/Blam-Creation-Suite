...
namespace blofeld
{
	...
	V5_TAG_BLOCK(global_render_model_instance_placement_block, k_maximum_instance_placements_per_render_model)
	{
		...
		{ _field_legacy, _field_long_block_index, "node_index*" },
	...
	V5_TAG_BLOCK(structure_bsp_instanced_geometry_instances_block, k_maximum_instance_geometry_instances_per_structure_bsp)
	{
		...
		{ _field_legacy, _field_real_vector_3d, "up" },
		{ _field_legacy, _field_real_point_3d, "position" },
		{ _field_legacy, _field_short_block_index, "instance definition*" },
		{ _field_legacy, _field_word_flags, "flags", &instanced_geometry_flags },

		{ _field_legacy, _field_version_greater, _engine_type_haloreach },
		{ _field_legacy, _field_long_flags, "Light Channels:", &channelDefinitionFlags },

		{ _field_legacy, _field_short_integer, "mesh_index" },
		{ _field_legacy, _field_short_integer, "compression_index" },

		{ _field_legacy, _field_long_integer, "seam bit vector 0" },
		{ _field_legacy, _field_long_integer, "seam bit vector 1" },
		{ _field_legacy, _field_long_integer, "seam bit vector 2" },
		{ _field_legacy, _field_long_integer, "seam bit vector 3" },

		{ _field_legacy, _field_real, "bounds x0!" },
		{ _field_legacy, _field_real, "bounds x1!" },
		{ _field_legacy, _field_real, "bounds y0!" },
		{ _field_legacy, _field_real, "bounds y1!" },
		{ _field_legacy, _field_real, "bounds z0!" },
		{ _field_legacy, _field_real, "bounds z1!" },

		{ _field_legacy, _field_real_point_3d, "world bounding sphere center!" },
		{ _field_legacy, _field_real, "world bounding sphere radius!" },
		{ _field_legacy, _field_real, "imposter transition complete distance!" },

		{ _field_legacy, _field_version_greater, _engine_type_haloreach, 1 },
		{ _field_legacy, _field_real, "imposter brightness!" },

		{ _field_legacy, _field_long_integer, "checksum*" },

		{ _field_legacy, _field_char_enum, "pathfinding policy*", &instanced_geometry_pathfinding_policy_enum },
		{ _field_legacy, _field_char_enum, "lightmapping policy*", &instanced_geometry_lightmapping_policy_enum },
		{ _field_legacy, _field_char_enum, "imposter policy*", &instanced_geometry_imposter_policy_enum },
		{ _field_legacy, _field_pad, "SDFSDFE", 1 },

		{ _field_legacy, _field_version_greater, _engine_type_haloreach, 3 },
		{ _field_legacy, _field_char_enum, "streaming priority*", &instanced_geometry_streamingpriority_enum },
		{ _field_legacy, _field_pad, "strpad", 1 },
		{ _field_legacy, _field_short_integer, "cubemap 0 bitmap index" },

		{ _field_legacy, _field_real, "lightmap resolution scale" },
		...
		{ _field_legacy, _field_short_integer, "group_index!" },
		{ _field_legacy, _field_short_integer, "group_list_index!" },
		...
		{ _field_legacy, _field_version_greater, _engine_type_haloreach, 1 },
		{ _field_legacy, _field_long_string, "source file name*" },
	...
	{
		{ _field_legacy, _field_long_integer, "checksum*" },
		{ _field_legacy, _field_long_flags, "flags*", &instanced_geometry_definition_flags },
		{ _field_legacy, _field_short_integer, "mesh index" },
		{ _field_legacy, _field_short_integer, "compression index" },
		{ _field_legacy, _field_real, "global lightmap resolution scale" },
		{ _field_legacy, _field_short_integer, "external_index" },
		{ _field_legacy, _field_pad, "useme", 2 },
		{ _field_legacy, _field_terminator }
	};
	...
	V5_TAG_STRUCT(structureIOHavokDataBlock_struct)
	{
		...
		{ _field_legacy, _field_long_integer, "RuntimeDeserializedBody Pointer*!" },
		{ _field_legacy, _field_long_integer, "RuntimeDeserializedData Pointer*!" },
		{ _field_legacy, _field_long_integer, "Prefab Index*!" },
		{ _field_legacy, _field_data, "Serialized Havok Data*" },
		{ _field_legacy, _field_block, "Serialized Per Collision Type Havok Geometry", &SerializedHavokGeometryDataBlock_block },
		{ _field_legacy, _field_real_point_3d, "Shapes bounds min!*" },
		{ _field_legacy, _field_real_point_3d, "Shapes bounds max!*" },
		{ _field_legacy, _field_terminator }
	};
	...
	{
		{ _field_legacy, _field_data, "Serialized Havok Data*" },
		{ _field_legacy, _field_data, "Serialized Static Havok Data*" },
		{ _field_legacy, _field_long_integer, "collision type" },
		{ _field_legacy, _field_long_integer, "RuntimeDeserializedBody Pointer*!" },
		{ _field_legacy, _field_long_integer, "RuntimeDeserializedData Pointer*!" },
		{ _field_legacy, _field_terminator }
	};
