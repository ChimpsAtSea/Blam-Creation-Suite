...
namespace blofeld
{
	V5_TAG_GROUP(structure_design, STRUCTURE_DESIGN_TAG)
	{
		...
		{ _field_legacy, _field_struct, "physics", &global_structure_physics_design_struct_struct_definition },
		{ _field_legacy, _field_struct, "planar fog set", &planar_fog_set_definition_struct_struct_definition },
		{ _field_legacy, _field_custom, "rain" },
		...
		{ _field_legacy, _field_block, "rain_blocker mopp code block!*", &mopp_code_definition_block_block },
