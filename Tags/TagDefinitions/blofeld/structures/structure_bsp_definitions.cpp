...
namespace blofeld
{
		...
		SCENARIO_STRUCTURE_BSP_STRUCT_DEFINITION_ID)
	{
		...
		{ _version_mode_equal, _engine_type_halo3 },
		...
		{ _field_legacy, _field_block, "unknown", &haloreach_sbsp_unknown_block },
		...
		{ _version_mode_less_or_equal, _engine_type_haloreach, 1 },
		{ _field_legacy, _field_block, "unknown@", &g_null_block }, // unknown, potentially 
		...
		{ _version_mode_less, _engine_type_haloreach, 2 }, // #TODO: this data is pure speculation, these might not even be tag blocks!!!
		...
		{ _version_mode_less, _engine_type_haloreach, 1 }, // #TODO: this data is pure speculation!!!
		{ _field_legacy, _field_block, "unknown@", &g_null_block },

		{ _version_mode_less_or_equal, _engine_type_haloreach, 1 }, // #TODO: this data is pure speculation!!!
		{ _field_legacy, _field_block, "unknown@", &g_null_block },
		...
		STRUCTURE_BSP_CLUSTER_BLOCK_STRUCT_ID)
	{
		...
		{ _version_mode_less, _engine_type_haloreach, 33 },
		{ _field_legacy, _field_long_integer, "unknown" },
		{ _field_legacy, _field_long_integer, "unknown" },
