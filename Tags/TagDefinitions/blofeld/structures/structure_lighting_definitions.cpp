...
namespace blofeld
{
	...
	V5_TAG_BLOCK(structure_lighting_generic_light_definition_block, SHORT_MAX)
	{
		...
		{ _field_legacy, _field_int64_integer, "Definition Identifier!" },
		{ _field_legacy, _field_struct, "Midnight_Light_Parameters", &midnight_light_struct_struct_definition },
		{ _field_legacy, _field_long_integer, "Source File Identifier!" },
		{ _field_legacy, _field_explanation, "Static Only Parameters", "" },
		{ _field_legacy, _field_real, "indirect amplification factor" },
		{ _field_legacy, _field_real, "jitter sphere radius" },
		{ _field_legacy, _field_real, "jitter angle" },
		{ _field_legacy, _field_enum, "jitter quality", &structure_lighting_generic_light_jitter_quality_enum },
		{ _field_legacy, _field_char_enum, "sun", &midnight_boolean_enum_definition },
		{ _field_legacy, _field_char_enum, "indirect only", &midnight_boolean_enum_definition },
		{ _field_legacy, _field_long_flags, "flags", &structure_lighting_generic_light_flags },
		{ _field_legacy, _field_char_enum, "static analytic", &midnight_boolean_enum_definition },
		{ _field_legacy, _field_pad, "pdd", 3 },
	...
	V5_TAG_BLOCK(structure_lighting_generic_light_instance_block, SHORT_MAX)
	{
		...
		{ _field_legacy, _field_int64_integer, "Light Definition ID!" },
		{ _field_legacy, _field_int64_integer, "Light Instance ID!" },
		{ _field_legacy, _field_long_integer, "Light Definition Index!" },
		{ _field_legacy, _field_long_integer, "Maya Source Hash!" },
		{ _field_legacy, _field_tag_reference, "runtime definition!", &Tag::Reference<struct dynamic_light_definition>::s_defaultDefinition },

		{ _field_legacy, _field_version_less_or_equal, _engine_type_haloreach, 1 },
		{ _field_legacy, _field_long_integer, "unknown" },

		{ _field_legacy, _field_long_enum, "light mode", &structure_lighting_light_mode_enum },
		...
		{ _field_legacy, _field_real, "fade out distance" },
		{ _field_legacy, _field_real, "fade start distance" },
		...
		{ _field_legacy, _field_long_integer, "Shadow Geometry Checksum" },
		{ _field_legacy, _field_pad, "pdd", 4 },
	...
	{
		{ _field_legacy, _field_real_rgb_color, "specular color normal" },
		{ _field_legacy, _field_real, "specular steepness" },
		{ _field_legacy, _field_real_rgb_color, "specular color gazing" },
		{ _field_legacy, _field_real, "specular coeff" },
		{ _field_legacy, _field_real, "diffuse coeff" },
		{ _field_legacy, _field_real, "roughness offset" },
		{ _field_legacy, _field_real, "albedo blend" },
		{ _field_legacy, _field_terminator }
	};
	...
	V5_TAG_STRUCT(scenario_structure_lighting_info_struct_definition)
	{
		...
		{ _field_legacy, _field_block, "generic light definitions", &structure_lighting_generic_light_definition_block_block },
		{ _field_legacy, _field_block, "generic light instances", &structure_lighting_generic_light_instance_block_block },
		...
		{ _field_legacy, _field_block, "screen space light shader override", &screen_space_light_shader_override_block_block },
		{ _field_legacy, _field_block, "cinematic light instances", &structureLightingCinematicLightInstanceBlock_block },
		{ _field_legacy, _field_struct, "Sun Intensity Multiplier", &light_scalar_function_struct_struct_definition },
		{ _field_legacy, _field_terminator }
	};
	...
	{
		{ _field_legacy, _field_int64_integer, "Light Instance ID!" },
		{ _field_legacy, _field_long_block_index, "Light Definition Index" },
		{ _field_legacy, _field_long_block_index, "Light Instance Index" },
		{ _field_legacy, _field_array, "Active Shots", &g_cinematicShotFlagArray_array },
		{ _field_legacy, _field_block, "Linked Objects", &structureLightingCinematicObjectBlock_block },
