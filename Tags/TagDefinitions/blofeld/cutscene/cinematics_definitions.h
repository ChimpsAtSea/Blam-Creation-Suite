...
namespace blofeld
{
	...
	extern s_tag_struct_definition cinematic_block_struct_definition; // cinematic_block
	...
	extern s_tag_struct_definition cinematic_transition_block_struct_definition; // cinematic_transition_block
