...
namespace blofeld
{
	...
	extern s_tag_struct_definition cinematic_shot_playback_data_block_block_struct;
	extern s_tag_block_definition cinematic_shot_playback_data_block_block;
	extern s_tag_struct_definition cinematic_scene_reference_block_block_struct;
	extern s_tag_block_definition cinematic_scene_reference_block_block;
	extern s_tag_struct_definition scene_object_attachment_block_block_struct;
	extern s_tag_block_definition scene_object_attachment_block_block;
	extern s_tag_struct_definition cinematic_scene_object_block_block_struct;
	extern s_tag_block_definition cinematic_scene_object_block_block;
	extern s_tag_struct_definition cinematic_shot_lighting_block_block_struct;
	extern s_tag_block_definition cinematic_shot_lighting_block_block;
	extern s_tag_struct_definition cinematic_shot_clip_subject_block_block_struct;
	extern s_tag_block_definition cinematic_shot_clip_subject_block_block;
	extern s_tag_struct_definition cinematic_shot_clip_block_block_struct;
	extern s_tag_block_definition cinematic_shot_clip_block_block;
	extern s_tag_struct_definition cinematic_shot_music_block_block_struct;
	extern s_tag_block_definition cinematic_shot_music_block_block;
	extern s_tag_struct_definition cinematic_shot_object_function_keyframe_block_block_struct;
	extern s_tag_block_definition cinematic_shot_object_function_keyframe_block_block;
	extern s_tag_struct_definition cinematic_shot_object_function_block_block_struct;
	extern s_tag_block_definition cinematic_shot_object_function_block_block;
	extern s_tag_struct_definition cinematic_shot_screen_effect_block_block_struct;
	extern s_tag_block_definition cinematic_shot_screen_effect_block_block;
	extern s_tag_struct_definition cinematic_shot_user_input_constraints_block_block_struct;
	extern s_tag_block_definition cinematic_shot_user_input_constraints_block_block;
	extern s_tag_struct_definition cinematicShotTextureMovieBlock_block_struct;
	extern s_tag_block_definition cinematicShotTextureMovieBlock_block;
	extern s_tag_struct_definition cinematic_shot_block_block_struct;
	extern s_tag_block_definition cinematic_shot_block_block;
	extern s_tag_struct_definition cinematicStructureLightingBlock_block_struct;
	...
	extern s_tag_struct_definition cinematic_shot_dialogue_block_block_struct;
	extern s_tag_block_definition cinematic_shot_dialogue_block_block;
	extern s_tag_struct_definition cinematic_shot_effect_block_block_struct;
	extern s_tag_block_definition cinematic_shot_effect_block_block;
	extern s_tag_struct_definition cinematic_shot_custom_script_block_block_struct;
	extern s_tag_block_definition cinematic_shot_custom_script_block_block;
	extern s_tag_struct_definition cinematic_shot_frame_block_block_struct;
	extern s_tag_block_definition cinematic_shot_frame_block_block;
	extern s_tag_struct_definition cinematic_shot_frame_dynamic_block_block_struct;
	extern s_tag_block_definition cinematic_shot_frame_dynamic_block_block;
	extern s_tag_struct_definition cinematic_shot_frame_constant_block_block_struct;
	extern s_tag_block_definition cinematic_shot_frame_constant_block_block;
	extern s_tag_struct_definition cinematicDataShotBlock_block_struct;
	extern s_tag_block_definition cinematicDataShotBlock_block;
	extern s_tag_struct_definition cinematic_extra_camera_frame_block_block_struct;
	extern s_tag_block_definition cinematic_extra_camera_frame_block_block;
	extern s_tag_struct_definition cinematic_extra_camera_shot_block_block_struct;
	extern s_tag_block_definition cinematic_extra_camera_shot_block_block;
	extern s_tag_struct_definition cinematic_shot_extra_camera_block_block_struct;
	...
	extern s_tag_struct_definition cinematic_transition_global_gain_block_block_struct;
	extern s_tag_block_definition cinematic_transition_global_gain_block_block;
	extern s_tag_struct_definition cinematic_transition_sound_class_gain_block_block_struct;
	extern s_tag_block_definition cinematic_transition_sound_class_gain_block_block;
	extern s_tag_struct_definition cinematic_transition_sound_reference_block_block_struct;
	extern s_tag_block_definition cinematic_transition_sound_reference_block_block;
	extern s_tag_struct_definition cinematic_transition_looping_sound_reference_block_block_struct;
	extern s_tag_block_definition cinematic_transition_looping_sound_reference_block_block;
	extern s_tag_struct_definition cinematic_transition_looping_sound_state_block_block_struct;
	extern s_tag_block_definition cinematic_transition_looping_sound_state_block_block;
	extern s_tag_struct_definition cinematic_characters_block_block_struct;
	extern s_tag_block_definition cinematic_characters_block_block;
	extern s_tag_struct_definition cinematics_globals_block_block_struct;
	...
	extern s_tag_struct_definition scenario_cinematics_block_block_struct;
	...
	extern s_tag_array_definition g_cinematicShotFlagArray_haloreach_array;
	...
	extern s_tag_struct_definition cinematic_scene_struct_definition_struct_definition; // tag group
	extern s_tag_struct_definition cinematic_scene_data_struct_definition_struct_definition; // tag group
	extern s_tag_struct_definition cinematicSceneDataObjectBlock_struct_struct_definition;
	extern s_tag_struct_definition camera_frame_struct_struct_definition;
	extern s_tag_struct_definition camera_frame_dynamic_struct_struct_definition;
	extern s_tag_struct_definition camera_frame_constant_struct_struct_definition;
	extern s_tag_struct_definition cinematic_transition_element_block_struct_definition;
	extern s_tag_struct_definition cinematic_transition_global_fade_block_struct_definition;
	extern s_tag_struct_definition scenario_cutscene_title_struct_struct_definition;

	extern const char* scenario_cutscene_camera_flags_strings[];
	extern s_string_list_definition scenario_cutscene_camera_flags;
	extern const char* scenario_cutscene_camera_types_strings[];
	extern s_string_list_definition scenario_cutscene_camera_types;
	extern const char* text_justification_enum_definition_strings[];
	extern s_string_list_definition text_justification_enum_definition;
	extern const char* text_vertical_justification_enum_definition_strings[];
	extern s_string_list_definition text_vertical_justification_enum_definition;
	extern const char* cinematic_channel_type_enum_strings[];
	extern s_string_list_definition cinematic_channel_type_enum;
	extern const char* shot_flags_definition_strings[];
	extern s_string_list_definition shot_flags_definition;
	extern const char* cinematic_shot_lighting_flags_definition_strings[];
	extern s_string_list_definition cinematic_shot_lighting_flags_definition;
	extern const char* scene_object_flags_strings[];
	extern s_string_list_definition scene_object_flags;
	extern const char* cinematic_coop_type_flags_strings[];
	extern s_string_list_definition cinematic_coop_type_flags;
	extern const char* scene_object_attachment_flags_strings[];
	extern s_string_list_definition scene_object_attachment_flags;
	extern const char* music_flags_enum_strings[];
	extern s_string_list_definition music_flags_enum;
	extern const char* textureMovieFlags_strings[];
	extern s_string_list_definition textureMovieFlags;
	extern const char* cinematic_shot_effect_flags_strings[];
	extern s_string_list_definition cinematic_shot_effect_flags;
	extern const char* sceneShotEffectState_strings[];
	extern s_string_list_definition sceneShotEffectState;
	extern const char* cinematicShotScreenEffectFlags_strings[];
	extern s_string_list_definition cinematicShotScreenEffectFlags;
	extern const char* cinematic_shot_object_function_flags_strings[];
	extern s_string_list_definition cinematic_shot_object_function_flags;
	extern const char* cinematic_extra_camera_frame_flags_strings[];
	extern s_string_list_definition cinematic_extra_camera_frame_flags;
	extern const char* cinematic_shot_custom_script_flags_strings[];
	extern s_string_list_definition cinematic_shot_custom_script_flags;
	extern const char* sceneShotSettingsFlags_strings[];
	extern s_string_list_definition sceneShotSettingsFlags;
	extern const char* scene_reset_object_lighting_enum_strings[];
	extern s_string_list_definition scene_reset_object_lighting_enum;
	extern const char* cinematic_transition_looping_sound_alternate_flags_strings[];
	extern s_string_list_definition cinematic_transition_looping_sound_alternate_flags;
	extern const char* cinematic_transition_looping_sound_layer_flags_strings[];
	extern s_string_list_definition cinematic_transition_looping_sound_layer_flags;
	extern const char* cinematic_flags_strings[];
	extern s_string_list_definition cinematic_flags;
	extern const char* scenario_cinematics_flags_strings[];
