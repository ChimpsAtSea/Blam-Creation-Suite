...
namespace blofeld
{
		...
		DIRECTIONALLIGHTRIGBLOCK_ID)
	{
		...
		FIELD_CUSTOM_EX("Theta", nullptr, FIELD_FLAG_NONE, _field_id_slider_editor),
		{ _field_real, "Theta", _field_id_slider_editor },
		FIELD_CUSTOM_EX("Phi", nullptr, FIELD_FLAG_NONE, _field_id_slider_editor),
	...
	{
		FIELD_EXPLANATION_EX("Scriptable Light Rig", nullptr, FIELD_FLAG_NONE, ""),
	...
	{
		FIELD_EXPLANATION_EX("Character Light Rig", nullptr, FIELD_FLAG_NONE, ""),
		FIELD_CUSTOM_EX("Environment vmf lobe weight", nullptr, FIELD_FLAG_NONE, _field_id_slider_editor),
		{ _field_real, "Environment vmf lobe weight", _field_id_slider_editor },
		{ _field_real_rgb_color, "Rig fill color" },
		FIELD_CUSTOM_EX("Rig fill scale", nullptr, FIELD_FLAG_NONE, _field_id_slider_editor),
		...
		FIELD_CUSTOM_EX("Rig vmf lobe intensity", nullptr, FIELD_FLAG_NONE, _field_id_slider_editor),
		{ _field_real, "Rig vmf lobe intensity", _field_id_slider_editor },
		FIELD_CUSTOM_EX("Rig vmf lobe theta", nullptr, FIELD_FLAG_NONE, _field_id_slider_editor),
		{ _field_real, "Rig vmf lobe theta", _field_id_slider_editor },
		FIELD_CUSTOM_EX("Rig vmf lobe phi", nullptr, FIELD_FLAG_NONE, _field_id_slider_editor),
		{ _field_real, "Rig vmf lobe phi", _field_id_slider_editor },
		FIELD_CUSTOM_EX("Rig vmf lobe scale", nullptr, FIELD_FLAG_NONE, _field_id_slider_editor),
		{ _field_real, "Rig vmf lobe scale", _field_id_slider_editor },
		FIELD_CUSTOM_EX("Rig vmf lobe vs fill scale", nullptr, FIELD_FLAG_NONE, _field_id_slider_editor),
