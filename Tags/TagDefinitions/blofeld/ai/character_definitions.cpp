...
namespace blofeld
{
		...
		CHARACTER_VARIANTS_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("VN", nullptr, FIELD_FLAG_NONE, 2),
		...
		CHARACTER_GENERAL_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("post-combat-position-padding", nullptr, FIELD_FLAG_NONE, 2),
		...
		CHARACTER_PROTO_SPAWN_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("post-proto-spawn-padding", nullptr, FIELD_FLAG_NONE, 2),
		{ _field_terminator }
	};
		...
		CHARACTER_EMOTIONS_SITUATIONAL_DANGER_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("obligatory pad", nullptr, FIELD_FLAG_NONE, 2),
	...
	{
		FIELD_PAD_EX("YJQV", nullptr, FIELD_FLAG_NONE, 4),
		...
		CHARACTER_PERCEPTION_BLOCK_STRUCT_ID)
	{
		...
		FIELD_CUSTOM_EX("Normal active-camo perception", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		{ _field_struct, "normal active camo perception", &active_camo_perception_properties },
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_field_group_end),
		FIELD_CUSTOM_EX("Legendary active-camo perception", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
	...
	{
		FIELD_CUSTOM_EX("Default", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		{ _field_struct, "Default", &character_hop_struct },
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_field_group_end),
		FIELD_CUSTOM_EX("Passive", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		{ _field_struct, "Passive", &character_hop_struct },
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_field_group_end),
		FIELD_CUSTOM_EX("Aggressive", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		...
		CHARACTER_MOVEMENT_BLOCK_ID)
	{
		...
		FIELD_EXPLANATION_EX("Danger Zone Avoidance", nullptr, FIELD_FLAG_NONE, "These values govern how we should avoid danger zones (like grenades and vehicles). If their sum is less than 1 then neither action will occur and instead we\'ll just try to walk out of the way with that remaining probability."),
		...
		FIELD_PAD_EX("RQEMJY", nullptr, FIELD_FLAG_NONE, 2),
		...
		FIELD_CUSTOM_EX("Throttle and inertia", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		...
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_field_group_end),
		FIELD_CUSTOM_EX("Movement Facing", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		FIELD_EXPLANATION_EX("Movement Facing", nullptr, FIELD_FLAG_NONE, "Characters using composite animations can choose to align their facing with their aim-target or their destination. These settings control how the facing is determined."),
	...
	{
		FIELD_EXPLANATION_EX("Inertial pause settings", nullptr, FIELD_FLAG_NONE, "These values tell the actor to remain stationary for the specified number of ticks if he changes his direction of movement by at least \'change angle\'. Specifying an angle of 0 means pause this much every time you get to your destination."),
	...
	{
		{ _field_real, "chance" },
		FIELD_EXPLANATION_EX("MAPPING", nullptr, FIELD_FLAG_NONE, "Movement type -> stance"),
	...
	{
		FIELD_EXPLANATION_EX("Jaime, don't touch this", nullptr, FIELD_FLAG_NONE, "Ever."),
		...
		CHARACTER_SWARM_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("PEVUDXUKY", nullptr, FIELD_FLAG_NONE, 2),
		...
		CHARACTER_FIRING_POINT_EVALUATOR_BLOCK_STRUCT_ID)
	{
		...
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_default),
		FIELD_EXPLANATION_EX("DESIGNERS BEWARE", nullptr, FIELD_FLAG_NONE, "If you want to screw the AI up, here\'s a great place to start. Please try not to."),
	...
	{
		FIELD_EXPLANATION_EX("EVALUATOR", nullptr, FIELD_FLAG_NONE, "The firing point evaluation properties for a single evaluator. Treat with great care and respect."),
	...
	{
		FIELD_EXPLANATION_EX("Difficulty Limits", nullptr, FIELD_FLAG_NONE, "Per difficulty values to limit the number of guys in particular behaviours"),
		...
		CHARACTER_COVER_BLOCK_ID)
	{
		...
		FIELD_EXPLANATION_EX("Hologram conditions", nullptr, FIELD_FLAG_NONE, "The following fields dictate how hologram equipment is used by AI in cover."),
		...
		FIELD_EXPLANATION_EX("Cover conditions", nullptr, FIELD_FLAG_NONE, "The following fields dictate the conditions under which we will go into cover."),
		...
		FIELD_CUSTOM_EX("Aggresive/Defensive cover properties", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		...
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_field_group_end),
		FIELD_EXPLANATION_EX("Other", nullptr, FIELD_FLAG_NONE, ""),
		...
		CHARACTER_SEARCH_BLOCK_ID)
	{
		...
		FIELD_EXPLANATION_EX("Uncover", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_real_bounds, "Uncover distance bounds", "Distance of uncover point from target. Hard lower limit, soft upper limit." },
		FIELD_EXPLANATION_EX("Investigate", nullptr, FIELD_FLAG_NONE, "Orphan offset: Offset from the orphan pos along the orphan hint vector that we will investigate to. Positive value means we are predicting where the target is going, negative value means that we would like to stand back a bit and look along the orphan vector."),
		...
		FIELD_EXPLANATION_EX("Performances", nullptr, FIELD_FLAG_NONE, ""),
		...
		CHARACTER_PRESEARCH_BLOCK_ID)
	{
		...
		FIELD_CUSTOM_EX("Child Weights", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
	...
	{
		FIELD_PAD_EX("ZTG", nullptr, FIELD_FLAG_NONE, 4),
	...
	{
		FIELD_EXPLANATION_EX("DEFAULT TIMINGS", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_struct, "default", &character_bunker_timings_struct },
		FIELD_EXPLANATION_EX("FIGHT TIMINGS", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_struct, "fight", &character_bunker_timings_struct },
		FIELD_EXPLANATION_EX("COVER TIMINGS", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_struct, "cover", &character_bunker_timings_struct },
		FIELD_EXPLANATION_EX("GUARD TIMINGS", nullptr, FIELD_FLAG_NONE, ""),
		...
		CHARACTER_ENGINEER_BLOCK_ID)
	{
		...
		FIELD_EXPLANATION_EX("Detonation Thresholds", nullptr, FIELD_FLAG_NONE, "If shield vitality AND body vitality fall below the thresholds below, detonate"),
		...
		CHARACTER_WEAPONS_BLOCK_ID)
	{
		...
		FIELD_EXPLANATION_EX("Combat ranges", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Behavior", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Weapon drop when killed", nullptr, FIELD_FLAG_NONE, ""),
		...
		CHARACTER_GRENADES_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("YZNPI", nullptr, FIELD_FLAG_NONE, 2),
		...
		FIELD_EXPLANATION_EX("Grenade drop when killed", nullptr, FIELD_FLAG_NONE, ""),
		...
		CHARACTER_VEHICLE_BLOCK_ID)
	{
		...
		FIELD_EXPLANATION_EX("Flying Avoidance", nullptr, FIELD_FLAG_NONE, ""),
		...
		{ _field_real, "avoidance volume turn penalty distance", "The maximum distance penalty applied to an avoidance volume search path if we're facing away from the path. 1000 wu good for space, 5 wu good for ground.", "wus" },
		FIELD_EXPLANATION_EX("Vehicle flags", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_long_flags, "vehicle flags", &vehicle_flags },
		FIELD_EXPLANATION_EX("Hover Perturbation New", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Hover Perturbation Fallback", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Steering", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Throttle", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Combat", nullptr, FIELD_FLAG_NONE, ""),
		...
		{ _field_enum, "obstacle ignore size", &obstacle_ignore_enum },
		FIELD_PAD_EX("I", nullptr, FIELD_FLAG_NONE, 2),
		...
		CHARACTER_FLYING_MOVEMENT_BLOCK_STRUCT_ID)
	{
		{ _field_tag_reference, "vehicle", FIELD_FLAG_INDEX, &unit_reference$2 },
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_default),
		FIELD_EXPLANATION_EX("Vector Weights", nullptr, FIELD_FLAG_NONE, "Think of this as firing point evaluation; how much do we want to weight each of the various vectors affecting our movement in space."),
		...
		FIELD_EXPLANATION_EX("Area Selection", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Idle", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_real_bounds, "idle time", "How long before reselecting a destination while idling.", "seconds" },
		FIELD_EXPLANATION_EX("Cover", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Volume Avoidance", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Approach", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Evasion", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Flocking", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Tailing", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Strafing", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Attitude Control", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Shooting", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_angle, "shooting cone angle", "The angle of the shooting cone along the vehicle facing.", "degrees" },
		FIELD_EXPLANATION_EX("Evasive Maneuvers", nullptr, FIELD_FLAG_NONE, ""),
		...
		CHARACTER_MORPH_BLOCK_ID)
	{
		...
		FIELD_EXPLANATION_EX("Tank guy", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Stealth dude", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Ranged bloke", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("General", nullptr, FIELD_FLAG_NONE, ""),
	...
	{
		FIELD_EXPLANATION_EX("Equipment Use", nullptr, FIELD_FLAG_NONE, "How should I use this equipment?"),
		...
		FIELD_EXPLANATION_EX("Skip Fraction", nullptr, FIELD_FLAG_NONE, "Given that we have decided to use this equipment, should we do so? (0= always use it, 1= never use it). Heroic skip fraction is the average of normal and legendary chances."),
	...
	{
		FIELD_EXPLANATION_EX("Stimulus Response", nullptr, FIELD_FLAG_NONE, "Here you can define a character tag which will be applied on top of this one when the named stimulus is present on a character.In the case of multiple stimulus with character tag responses being present, the first listed will be used."),
	...
	{
		FIELD_EXPLANATION_EX("Pain Reactions", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Defensive Reactions", nullptr, FIELD_FLAG_NONE, ""),
	...
	{
		FIELD_EXPLANATION_EX("combotron parent props", nullptr, FIELD_FLAG_NONE, ""),
	...
	{
		FIELD_EXPLANATION_EX("combotron child props (anything that can socket into a rook)", nullptr, FIELD_FLAG_NONE, ""),
	...
	{
		FIELD_EXPLANATION_EX("dismemberment props", nullptr, FIELD_FLAG_NONE, ""),
	...
	{
		FIELD_CUSTOM_EX("Smooth Throttle", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		{ _field_enum, "settings options", &character_smooth_movement_settings_options },
		FIELD_EXPLANATION_EX("Override Settings", nullptr, FIELD_FLAG_NONE, "The following setting are applied when the Override option is chosen"),
		FIELD_PAD_EX("csts_pad_2", nullptr, FIELD_FLAG_NONE, 2),
	...
	{
		FIELD_CUSTOM_EX("Smooth Stopping", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		{ _field_enum, "settings options", &character_smooth_movement_settings_options },
		FIELD_EXPLANATION_EX("Override Settings", nullptr, FIELD_FLAG_NONE, "The following setting are applied when the Override option is chosen"),
		FIELD_PAD_EX("csst_pad_2", nullptr, FIELD_FLAG_NONE, 2),
