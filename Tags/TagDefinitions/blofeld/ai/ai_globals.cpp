...
namespace blofeld
{
		...
		AI_GLOBALS_DATA_BLOCK_STRUCT_ID)
	{
		...
		FIELD_PAD_EX("jump leap placeholder", nullptr, FIELD_FLAG_NONE, 4),
		...
		FIELD_PAD_EX("another leap placeholder", nullptr, FIELD_FLAG_NONE, 4),
		...
		FIELD_EXPLANATION_EX("PATHFINDING SEARCH RANGES", nullptr, FIELD_FLAG_NONE, "The maximum ranges to which firing point evaluations will do pathfinding searches. INCREASING THESE VALUES WILL ALMOST CERTAINLY HAVE A NEGATIVE IMPACT ON PERFORMANCE."),
		...
		FIELD_EXPLANATION_EX("RESURRECTION", nullptr, FIELD_FLAG_NONE, "A few properties to help define when it is safe for a mission critical character to ressurect."),
		...
		FIELD_EXPLANATION_EX("TELEPORTATION", nullptr, FIELD_FLAG_NONE, "A few properties to help define when it is safe for a mission critical character to teleport."),
		...
		FIELD_EXPLANATION_EX("CLUMP THROTTLING", nullptr, FIELD_FLAG_NONE, "Some values to help you control how much guys will throttle when they want to stick with the rest of their squad."),
		...
		FIELD_EXPLANATION_EX("SQUAD PATROLLING", nullptr, FIELD_FLAG_NONE, "Parameters related to squad patrolling."),
		...
		FIELD_EXPLANATION_EX("KUNGFU CONTROL", nullptr, FIELD_FLAG_NONE, "These parameters control how the kung-fu circle works (i.e. when tasks have kungfu-count associated with them)"),
		{ _field_real, "kungfu deactivation delay", "When a task is disallowed from shooting, turn it off after this delay", "seconds" },
		FIELD_CUSTOM_EX("Presearch Child Counts (0 means no limit)", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		...
		FIELD_CUSTOM_EX("Search Pattern Specification", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		...
		FIELD_PAD_EX("MOOOOOOO", nullptr, FIELD_FLAG_NONE, 2),
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_field_group_end),
		{ _field_terminator }
	};
	...
	{
		FIELD_EXPLANATION_EX("Vision Traits", nullptr, FIELD_FLAG_NONE, "Traits that affect the AI\'s vision"),
	...
	{
		FIELD_EXPLANATION_EX("Sound Traits", nullptr, FIELD_FLAG_NONE, "Traits that affect the AI\'s sound awareness"),
	...
	{
		FIELD_EXPLANATION_EX("Luck Traits", nullptr, FIELD_FLAG_NONE, "Traits that affect the AI\'s luck"),
	...
	{
		FIELD_EXPLANATION_EX("Grenade Traits", nullptr, FIELD_FLAG_NONE, "Traits that affect the AI\'s grenade use"),
