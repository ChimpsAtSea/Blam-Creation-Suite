...
namespace blofeld
{
	...
	{
		{ _field_legacy, _field_string_id, "variant designation#3-letter designation for the character^" },
		{ _field_legacy, _field_tag_reference, "sound", &sound_reference },
		{ _field_legacy, _field_string_id, "sound effect" },
	...
	V5_TAG_BLOCK(mission_dialogue_lines_block, k_max_lines_per_scenario)
	{
		...
		{ _field_legacy, _field_block, "variants", &mission_dialogue_variants_block_block },
	...
	V5_TAG_BLOCK(ai_scene_trigger_block, 1)
	{
		...
		{ _field_legacy, _field_pad, "NJBJMKU", 2 },
	...
	{
		{ _field_legacy, _field_string_id, "variant designation^" },
		{ _field_legacy, _field_terminator }
	};
	...
	{
		{ _field_legacy, _field_string_id, "name^" },
		{ _field_legacy, _field_enum, "group", &role_group_enum },
		{ _field_legacy, _field_pad, "XZUW", 2 },
		{ _field_legacy, _field_useless_pad },
		{ _field_legacy, _field_block, "role variants", &ai_scene_role_variants_block_block },
		{ _field_legacy, _field_terminator }
	};
	...
	{
		{ _field_legacy, _field_string_id, "name^" },
		{ _field_legacy, _field_long_flags, "flags", &scene_flags },
		{ _field_legacy, _field_block, "trigger conditions", &ai_scene_trigger_block_block },
		{ _field_legacy, _field_useless_pad },
		{ _field_legacy, _field_block, "roles", &ai_scene_role_block_block },
		{ _field_legacy, _field_terminator }
	};

	V5_TAG_BLOCK(ai_scenario_mission_dialogue_block, 1)
	{
		{ _field_legacy, _field_tag_reference, "mission dialogue", &ai_mission_dialogue_reference },
		{ _field_legacy, _field_terminator }
	};

	V5_TAG_STRUCT(ai_mission_dialogue_struct_definition)
	{
		{ _field_legacy, _field_block, "lines", &mission_dialogue_lines_block_block },
		{ _field_legacy, _field_terminator }
	};
