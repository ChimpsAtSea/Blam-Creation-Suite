...
namespace blofeld
{
		...
		USER_HINT_PARALLELOGRAM_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("KJHIUF", nullptr, FIELD_FLAG_NONE, 2),
		{ _field_terminator }
	};
		...
		USER_HINT_CLIMB_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("post-forced-hoist-height", nullptr, FIELD_FLAG_NONE, 2),
		{ _field_terminator }
	};
		...
		USER_HINT_WELL_POINT_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("CNXLP", nullptr, FIELD_FLAG_NONE, 2),
		...
		USER_HINT_SPLINE_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("post-bsp-pad", nullptr, FIELD_FLAG_NONE, 2),
		...
		USER_HINT_SPLINE_CONTROL_POINT_BLOCK_STRUCT_ID)
	{
		...
		FIELD_PAD_EX("post-flags-pad", nullptr, FIELD_FLAG_NONE, 2),
		...
		USER_HINT_SPLINE_INTERSECT_POINT_BLOCK_STRUCT_ID)
	{
		...
		FIELD_PAD_EX("post-volume-index-pad", nullptr, FIELD_FLAG_NONE, 2),
		{ _field_real_point_3d, "point" },
		{ _field_real_vector_3d, "tangent" },
		{ _field_terminator }
	};
		...
		USER_HINT_NAVMESH_AREA_BLOCK_STRUCT_ID)
	{
		...
		FIELD_EXPLANATION_EX("Max CONVEX Border Simplify Area", nullptr, FIELD_FLAG_NONE, "This controls the amount of simplification applied to internal segments and convex boundary segments"),
		{ _field_real, "Max CONVEX Border Simplify Area" },
		FIELD_EXPLANATION_EX("Max Border Distance Error", nullptr, FIELD_FLAG_NONE, "When simplifying internal segments and convex boundary segments, this controls the maximum projected distance by which the simplified segment can deviate from the unsimplified segment"),
		{ _field_real, "Max Border Distance Error" },
		FIELD_EXPLANATION_EX("Max CONCAVE Border Simplify Area", nullptr, FIELD_FLAG_NONE, "This controls the amount of simplification applied to concave boundary segments"),
		{ _field_real, "Max CONCAVE Border Simplify Area" },
		FIELD_EXPLANATION_EX("Max Walkable Slope", nullptr, FIELD_FLAG_NONE, "Maximum slope AI will traverse (degrees). Don\'t touch unless necessary."),
		{ _field_real, "Max Walkable Slope" },
		FIELD_EXPLANATION_EX("Cosine angle merge control", nullptr, FIELD_FLAG_NONE, "Faces will only be merged if the cosine of the angle between their normals is greater than this."),
		{ _field_real, "Cosine angle merge control" },
		FIELD_EXPLANATION_EX("Hole replacement area", nullptr, FIELD_FLAG_NONE, "Holes with area less than this are candidates for conversion to quads"),
		{ _field_real, "Hole replacement area" },
		FIELD_EXPLANATION_EX("Partition size", nullptr, FIELD_FLAG_NONE, "The maximum number of faces that can be included in a partition. Basically, don\'t change this."),
		{ _field_long_integer, "Partition size" },
		FIELD_EXPLANATION_EX("Loop shrink factor", nullptr, FIELD_FLAG_NONE, "The area of any partition loop will not be reduced by more than this fraction"),
	...
	{
		{ _field_short_block_index, "geometry index", FIELD_FLAG_READ_ONLY, &user_hint_line_segment_block },
		FIELD_PAD_EX("JLOU", nullptr, FIELD_FLAG_NONE, 2),
		{ _field_terminator }
	};
