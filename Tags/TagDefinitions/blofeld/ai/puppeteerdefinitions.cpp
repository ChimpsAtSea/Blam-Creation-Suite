...
namespace blofeld
{
	...
	TAG_BLOCK(PuppetActionBlock, MAX_ACTIONS_PER_PUPPET)
	{
		...
		{ _field_struct, "path", &PuppetActionPathStruct_struct_definition },
	...
	TAG_BLOCK(PuppetSubActionBlock, MAX_SUB_ACTIONS_PER_PUPPET)
	{
		...
		{ _field_struct, "branch", &PuppetSubActionBranchStruct_struct_definition },
		{ _field_struct, "script", &PuppetSubActionScriptStruct_struct_definition },
		{ _field_long_string, "comment" },
