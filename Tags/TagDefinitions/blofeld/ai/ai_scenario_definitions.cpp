...
namespace blofeld
{
	...
	{
		{ _field_legacy, _field_tag_reference, "reference^", &character_reference$6 },
		{ _field_legacy, _field_terminator }
	};

	V5_TAG_BLOCK(ai_recording_reference_block, 128)
	{
		{ _field_legacy, _field_string, "recording name^" },
		{ _field_legacy, _field_pad, "INYRGOR", 8 },
		{ _field_legacy, _field_terminator }
	};

	V5_TAG_BLOCK(big_battle_creature_palette_block, MAXIMUM_SCENARIO_OBJECT_PALETTE_ENTRIES_PER_BLOCK)
	{
		{ _field_legacy, _field_tag_reference, "reference^", &big_battle_creature_reference },
		{ _field_legacy, _field_terminator }
	};
