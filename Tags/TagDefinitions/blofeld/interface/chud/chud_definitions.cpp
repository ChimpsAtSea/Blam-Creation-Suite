...
namespace blofeld
{
	...
	V5_TAG_BLOCK(chdt_compiled_widget_data_block, 65536)
	{
		...
		{ _field_legacy, _field_long_flags, "input variable triggers", &chdt_input_variable_triggers_definition },
	...
	V5_TAG_BLOCK(chdt_text_widgets_block, 65536)
	{
		...
		{ _field_legacy, _field_tag_reference, "render data template", &chud_widget_render_data_reference },
		{ _field_legacy, _field_block, "render data", &chdt_render_data_block_block },
		{ _field_legacy, _field_word_flags, "flags", &chdt_flags_definition },
