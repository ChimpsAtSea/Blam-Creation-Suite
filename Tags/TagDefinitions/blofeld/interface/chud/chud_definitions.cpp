...
namespace blofeld
{
	...
	V5_TAG_BLOCK(chad_texture_coords_animation_block, 65536)
	{
		...
		{ _field_legacy, _field_real, "movement 1 y" },
		{ _field_legacy, _field_real, "movement 2 x" },
		{ _field_legacy, _field_real, "movement 2 y" },
		{ _field_legacy, _field_terminator }
	};
	...
	V5_TAG_BLOCK(chad_position_animation_block, 65536)
	{
		...
		{ _field_legacy, _field_real, "position y" },
		{ _field_legacy, _field_real, "position z" },
		{ _field_legacy, _field_terminator }
	};
	...
	V5_TAG_BLOCK(chad_rotation_animation_block, 65536)
	{
		...
		{ _field_legacy, _field_angle, "y angle" },
		{ _field_legacy, _field_angle, "z angle" },
		{ _field_legacy, _field_terminator }
	};
	...
	V5_TAG_BLOCK(chad_size_animation_block, 65536)
	{
		...
		{ _field_legacy, _field_real, "stretch y" },
		{ _field_legacy, _field_terminator }
	};
	...
	V5_TAG_STRUCT(chad_struct_definition)
	{
		...
		{ _field_legacy, _field_long_integer, "unknown animation block" },
		{ _field_legacy, _field_long_integer, "unknown animation block" },
		{ _field_legacy, _field_real, "number of frames" },
	...
	{
		{ _field_legacy, _field_char_enum, "special hud type", &chdt_special_hud_type_definition },
		{ _field_legacy, _field_byte_flags, "unknown", &chdt_unknown_definition },
		{ _field_legacy, _field_byte_integer, "unknown index?" },
		{ _field_legacy, _field_byte_flags, "unknown", &chdt_unknown_definition },
		{ _field_legacy, _field_real, "animation 1 frame count" },
		{ _field_legacy, _field_real, "animation 2 frame count" },
		{ _field_legacy, _field_real, "animation 3 frame count" },
		{ _field_legacy, _field_real, "animation 4 frame count" },
		{ _field_legacy, _field_real, "animation 5 frame count" },
		{ _field_legacy, _field_enum, "input", &chdt_input_definition },
		{ _field_legacy, _field_enum, "range input", &chdt_input_definition },
		{ _field_legacy, _field_long_flags, "input variable triggers", &chdt_input_variable_triggers2_definition },
		{ _field_legacy, _field_char_enum, "second state-block start value", &chdt_second_state_block_start_value_definition },
		{ _field_legacy, _field_char_enum, "third state-block start value", &chdt_second_state_block_start_value_definition },
		{ _field_legacy, _field_short_integer, "0" },
		{ _field_legacy, _field_short_integer, "1" },
		{ _field_legacy, _field_short_integer, "2" },
		{ _field_legacy, _field_short_integer, "3" },
		{ _field_legacy, _field_short_integer, "4" },
		{ _field_legacy, _field_short_integer, "5" },
		{ _field_legacy, _field_short_integer, "6" },
		{ _field_legacy, _field_short_integer, "7" },
		{ _field_legacy, _field_short_integer, "8" },
		{ _field_legacy, _field_short_integer, "9" },
		{ _field_legacy, _field_short_integer, "10" },
		{ _field_legacy, _field_short_integer, "11" },
		{ _field_legacy, _field_short_integer, "12" },
		{ _field_legacy, _field_short_integer, "13" },
		{ _field_legacy, _field_short_integer, "14" },
		{ _field_legacy, _field_short_integer, "15" },
		{ _field_legacy, _field_short_integer, "16" },
		{ _field_legacy, _field_short_integer, "17" },
		{ _field_legacy, _field_short_integer, "18" },
		{ _field_legacy, _field_short_integer, "19" },
		{ _field_legacy, _field_short_integer, "20" },
		{ _field_legacy, _field_short_integer, "21" },
		{ _field_legacy, _field_short_integer, "22" },
		{ _field_legacy, _field_short_integer, "23" },
		{ _field_legacy, _field_short_integer, "24" },
		{ _field_legacy, _field_short_integer, "25" },
		{ _field_legacy, _field_short_integer, "26" },
		{ _field_legacy, _field_short_integer, "27" },
		{ _field_legacy, _field_short_integer, "28" },
		{ _field_legacy, _field_terminator }
	};
	V5_TAG_BLOCK(chdt_triggers_block, 65536)
	{
		{ _field_legacy, _field_byte_flags, "flag", &chdt_flag_definition },
	...
	{
		{ _field_legacy, _field_byte_flags, "unknown", &chdt_unknown_definition },
		{ _field_legacy, _field_char_enum, "anchor", &chdt_anchor_definition },
		{ _field_legacy, _field_short_integer, "unknown" },
	...
	{
		{ _field_legacy, _field_byte_flags, "animation 1 flags", &chdt_animation_flags_definition },
		{ _field_legacy, _field_char_enum, "animation 1 function", &chdt_animation_function_definition },
		{ _field_legacy, _field_short_integer, "unknown" },
		{ _field_legacy, _field_tag_reference, "animation 1", &chud_animation_reference },
		{ _field_legacy, _field_byte_flags, "animation 2 flags", &chdt_animation_flags_definition },
		{ _field_legacy, _field_char_enum, "animation 2 function", &chdt_animation_function_definition },
		{ _field_legacy, _field_short_integer, "unknown" },
		{ _field_legacy, _field_tag_reference, "animation 2", &chud_animation_reference },
		{ _field_legacy, _field_byte_flags, "animation 3 flags", &chdt_animation_flags_definition },
		{ _field_legacy, _field_char_enum, "animation 3 function", &chdt_animation_function_definition },
		{ _field_legacy, _field_short_integer, "unknown" },
		{ _field_legacy, _field_tag_reference, "animation 3", &chud_animation_reference },
		{ _field_legacy, _field_byte_flags, "animation 4 flags", &chdt_animation_flags_definition },
		{ _field_legacy, _field_char_enum, "animation 4 function", &chdt_animation_function_definition },
		{ _field_legacy, _field_short_integer, "unknown" },
		{ _field_legacy, _field_tag_reference, "animation 4", &chud_animation_reference },
		{ _field_legacy, _field_byte_flags, "animation 5 flags", &chdt_animation_flags_definition },
		{ _field_legacy, _field_char_enum, "animation 5 function", &chdt_animation_function_definition },
		{ _field_legacy, _field_short_integer, "unknown" },
		{ _field_legacy, _field_tag_reference, "animation 5", &chud_animation_reference },
		{ _field_legacy, _field_terminator }
	};
	V5_TAG_BLOCK(chdt_render_data_block, 65536)
	{
		{ _field_legacy, _field_char_enum, "shader index", &chdt_shader_index_definition },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		...
		{ _field_legacy, _field_real, "local scalar a" },
		{ _field_legacy, _field_real, "local scalar b" },
		{ _field_legacy, _field_real, "local scalar c" },
		{ _field_legacy, _field_real, "local scalar d" },
		{ _field_legacy, _field_enum, "output color a", &chdt_output_color_definition },
		{ _field_legacy, _field_enum, "output color b", &chdt_output_color_definition },
		{ _field_legacy, _field_enum, "output color c", &chdt_output_color_definition },
		{ _field_legacy, _field_enum, "output color d", &chdt_output_color_definition },
		{ _field_legacy, _field_enum, "output color e", &chdt_output_color_definition },
		{ _field_legacy, _field_enum, "output color f", &chdt_output_color_definition },
		{ _field_legacy, _field_enum, "output scalar a", &chdt_output_scalar_definition },
		{ _field_legacy, _field_enum, "output scalar b", &chdt_output_scalar_definition },
		{ _field_legacy, _field_enum, "output scalar c", &chdt_output_scalar_definition },
		{ _field_legacy, _field_enum, "output scalar d", &chdt_output_scalar_definition },
		{ _field_legacy, _field_enum, "output scalar e", &chdt_output_scalar_definition },
		{ _field_legacy, _field_enum, "output scalar f", &chdt_output_scalar_definition },
		{ _field_legacy, _field_long_integer, "unknown" },
		{ _field_legacy, _field_long_integer, "unknown" },
		{ _field_legacy, _field_short_integer, "unknown" },
		{ _field_legacy, _field_short_integer, "unknown" },
	...
	V5_TAG_BLOCK(chdt_bitmap_widgets_block, 65536)
	{
		...
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_rectangle_2d, "manual texture coordinates#this defines the visible rectangle for the bitmap if the bit of the same name is set. for ammo counters, l/r should be a multiple of 8, and t/b a multiple of 12." },
		{ _field_legacy, _field_terminator }
	};
	...
	V5_TAG_BLOCK(chdt_hud_widgets_block, 65536)
	{
		...
		{ _field_legacy, _field_short_integer, "unknown" },
		{ _field_legacy, _field_short_integer, "unknown" },
		{ _field_legacy, _field_char_enum, "second state-block starting value", &chdt_second_state_block_start_value_definition },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_word_flags, "input variable triggers", &chdt_input_variable_triggers_definition },
		{ _field_legacy, _field_explanation, "Compiled States (HUD Widgets)", "Uses this format:"
	...
	V5_TAG_BLOCK(chgd_hud_sounds_block, 65536)
	{
		...
		{ _field_legacy, _field_long_flags, "latched to", &latched_to_flags_definition },
		{ _field_legacy, _field_real, "Scale" },
		{ _field_legacy, _field_terminator }
	};
	V5_TAG_BLOCK(chgd_hud_attributes_block, 65536)
	{
		{ _field_legacy, _field_byte_flags, "resolution flags", &resolution_flags_definition },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
		...
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "horizontal roll" },
		{ _field_legacy, _field_real, "vertical bow" },
		{ _field_legacy, _field_real, "inverse horizontal roll" },
		{ _field_legacy, _field_real, "inverse vertical bow" },
		{ _field_legacy, _field_real, "horizontal roll 2" },
		{ _field_legacy, _field_real, "vertical bow 2" },
		{ _field_legacy, _field_real, "horizontal twist" },
		{ _field_legacy, _field_real, "vertical twist" },
		{ _field_legacy, _field_real, "horizontal twist 2" },
		{ _field_legacy, _field_real, "vertical twist 2" },
		{ _field_legacy, _field_real, "vertical scale" },
		{ _field_legacy, _field_real, "vertical twist 3" },
		{ _field_legacy, _field_real, "horizontal skew" },
		{ _field_legacy, _field_real, "vertical flip" },
		{ _field_legacy, _field_real, "inverse horizontal skew" },
		{ _field_legacy, _field_real, "vertical flip 2" },
		{ _field_legacy, _field_real, "hud offset x" },
		{ _field_legacy, _field_real, "hud offset y" },
		{ _field_legacy, _field_long_integer, "resolution width" },
		{ _field_legacy, _field_long_integer, "resolution height" },
		{ _field_legacy, _field_real, "motion sensor offset x" },
		{ _field_legacy, _field_real, "motion sensor offset y" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "motion sensor radius" },
		{ _field_legacy, _field_real, "motion sensor scale" },
		{ _field_legacy, _field_long_integer, "unknown" },
		{ _field_legacy, _field_long_integer, "unknown" },
		{ _field_legacy, _field_long_integer, "unknown" },
		{ _field_legacy, _field_long_integer, "unknown" },
		...
		{ _field_legacy, _field_long_integer, "unknown" },
		{ _field_legacy, _field_long_integer, "unknown" },
		{ _field_legacy, _field_real, "horizontal scale" },
		{ _field_legacy, _field_real, "vertical scale" },
		{ _field_legacy, _field_real, "horizontal stretch" },
		{ _field_legacy, _field_real, "vertical stretch" },
		{ _field_legacy, _field_real, "notification offset x" },
		{ _field_legacy, _field_real, "notification offset y" },
		{ _field_legacy, _field_real, "state left/right offset y" },
		{ _field_legacy, _field_real, "state center offset y" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "state scale" },
		{ _field_legacy, _field_real, "notification scale" },
		{ _field_legacy, _field_real, "notification line spacing" },
		{ _field_legacy, _field_long_integer, "notification line count modifier" },
		{ _field_legacy, _field_terminator }
	};
	V5_TAG_BLOCK(chgd_waypoint_blips_block, 65536)
	{
		{ _field_legacy, _field_string_id, "title" },
		{ _field_legacy, _field_string_id, "description" },
		{ _field_legacy, _field_char_enum, "icon", &icon_enum_definition },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_short_integer, "unknown" },
		{ _field_legacy, _field_real_argb_color, "primary color" },
		{ _field_legacy, _field_real_argb_color, "secondary color" },
		{ _field_legacy, _field_terminator }
	};
	V5_TAG_BLOCK(chgd_hud_globals_block, 65536)
	{
		{ _field_legacy, _field_long_enum, "biped", &biped_enum_definition },
		{ _field_legacy, _field_real_argb_color, "0 [HUD disabled]" },
		{ _field_legacy, _field_real_argb_color, "1 [HUD primary]" },
		{ _field_legacy, _field_real_argb_color, "2 [HUD foreground]" },
		{ _field_legacy, _field_real_argb_color, "3 [HUD warning]" },
		{ _field_legacy, _field_real_argb_color, "4 [neutral reticule]" },
		{ _field_legacy, _field_real_argb_color, "5 [hostile reticule]" },
		{ _field_legacy, _field_real_argb_color, "6 [friendly reticule]" },
		{ _field_legacy, _field_real_argb_color, "7" },
		{ _field_legacy, _field_real_argb_color, "8" },
		{ _field_legacy, _field_real_argb_color, "9" },
		{ _field_legacy, _field_real_argb_color, "10" },
		{ _field_legacy, _field_real_argb_color, "11" },
		{ _field_legacy, _field_real_argb_color, "12" },
		{ _field_legacy, _field_real_argb_color, "13" },
		{ _field_legacy, _field_real_argb_color, "14" },
		{ _field_legacy, _field_real_argb_color, "15" },
		{ _field_legacy, _field_real_argb_color, "16" },
		{ _field_legacy, _field_real_argb_color, "17" },
		{ _field_legacy, _field_real_argb_color, "18" },
		{ _field_legacy, _field_real_argb_color, "19" },
		{ _field_legacy, _field_real_argb_color, "20" },
		{ _field_legacy, _field_real_argb_color, "21" },
		{ _field_legacy, _field_real_argb_color, "22" },
		{ _field_legacy, _field_real_argb_color, "23" },
		{ _field_legacy, _field_real_argb_color, "24" },
		{ _field_legacy, _field_real_argb_color, "25" },
		{ _field_legacy, _field_real_argb_color, "26" },
		{ _field_legacy, _field_real_argb_color, "27" },
		{ _field_legacy, _field_real_argb_color, "28" },
		{ _field_legacy, _field_real_argb_color, "29" },
		{ _field_legacy, _field_real_argb_color, "30" },
		{ _field_legacy, _field_real_argb_color, "31" },
		{ _field_legacy, _field_data, "32" },
		{ _field_legacy, _field_data, "33" },
		{ _field_legacy, _field_data, "34" },
		{ _field_legacy, _field_data, "35" },
		{ _field_legacy, _field_data, "36" },
		{ _field_legacy, _field_data, "37" },
		{ _field_legacy, _field_data, "38" },
		{ _field_legacy, _field_data, "39" },
		{ _field_legacy, _field_data, "40" },
		{ _field_legacy, _field_data, "41" },
		{ _field_legacy, _field_real, "blip above threshold max" },
		...
		{ _field_legacy, _field_tag_reference, "plasma grenade swap sound", &global_sound_reference },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_tag_reference, "damage microtexture", &global_bitmap_reference },
		{ _field_legacy, _field_real, "microtexture tile scale" },
		{ _field_legacy, _field_real, "microtexture screen fraction" },
		{ _field_legacy, _field_real, "microtexture inner intensity" },
		{ _field_legacy, _field_real, "microtexture center screen fraction" },
		{ _field_legacy, _field_real, "microtexture outer intensity" },
		{ _field_legacy, _field_tag_reference, "unknown", &global_bitmap_reference },
		{ _field_legacy, _field_tag_reference, "directional arrow", &global_bitmap_reference },
		{ _field_legacy, _field_tag_reference, "directional fast forward arrow", &global_bitmap_reference },
		{ _field_legacy, _field_tag_reference, "unknown", &global_bitmap_reference },
		{ _field_legacy, _field_tag_reference, "unknown", &global_bitmap_reference },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
		...
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_data, "unknown" },
		{ _field_legacy, _field_tag_reference, "waypoints", &global_bitmap_reference },
		{ _field_legacy, _field_tag_reference, "scoreboard HUD", &chud_reference },
		{ _field_legacy, _field_tag_reference, "uber scoreboard HUD", &chud_reference },
		{ _field_legacy, _field_tag_reference, "metagame scoreboard HUD", &chud_reference },
		{ _field_legacy, _field_tag_reference, "survival scoreboard HUD", &chud_reference },
		{ _field_legacy, _field_tag_reference, "theater HUD", &chud_reference },
		{ _field_legacy, _field_tag_reference, "forge HUD", &chud_reference },
		{ _field_legacy, _field_tag_reference, "HUD strings", &global_multilingual_unicode_string_list_reference },
		{ _field_legacy, _field_tag_reference, "medals", &global_bitmap_reference },
		{ _field_legacy, _field_tag_reference, "medal HUD animation", &chud_animation_reference },
		{ _field_legacy, _field_tag_reference, "cortana channel", &unknown_reference },
		{ _field_legacy, _field_tag_reference, "unknown", &unknown_reference },
		{ _field_legacy, _field_tag_reference, "unknown", &unknown_reference },
		{ _field_legacy, _field_tag_reference, "tracker noise flash response", &unknown_reference },
		{ _field_legacy, _field_tag_reference, "tracker noise flash sound", &unknown_reference },
		{ _field_legacy, _field_real, "grenade scematics spacing" },
		{ _field_legacy, _field_real, "equipment scematic offset y" },
		{ _field_legacy, _field_real, "dual equipment scematic offset y" },
		{ _field_legacy, _field_real, "unknown equipment related" },
		{ _field_legacy, _field_real, "unknown equipment related" },
		{ _field_legacy, _field_real, "scoreboard leader offset y" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "waypoint scale" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real_argb_color, "color" },
		{ _field_legacy, _field_real, "minor threshold" },
		{ _field_legacy, _field_real, "major threshold" },
	...
	{
		{ _field_legacy, _field_tag_reference, "vertex shader", &global_vertex_shader_reference },
		{ _field_legacy, _field_tag_reference, "pixel shader", &global_pixel_shader_reference },
		{ _field_legacy, _field_terminator }
	};
	...
	{
		{ _field_legacy, _field_string_id, "Display String" },
		{ _field_legacy, _field_short_integer, "Max Display Time" },
		{ _field_legacy, _field_short_integer, "Display Count" },
		{ _field_legacy, _field_short_integer, "Disappear Delay" },
		{ _field_legacy, _field_short_integer, "Redisplay Delay" },
		{ _field_legacy, _field_real, "Display Delay" },
		{ _field_legacy, _field_word_flags, "flags", &player_training_flags_definition },
		{ _field_legacy, _field_short_integer, "Unknown" },
		{ _field_legacy, _field_terminator }
	};
	...
	{
		{ _field_legacy, _field_long_integer, "trigger index" },
		{ _field_legacy, _field_string, "type" },
		{ _field_legacy, _field_terminator }
	};
	...
	V5_TAG_STRUCT(chgd_struct_definition)
	{
		...
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_real, "campaign medal scale" },
		{ _field_legacy, _field_real, "campaign medal spacing" },
		{ _field_legacy, _field_real, "campaign medal offset x" },
		{ _field_legacy, _field_real, "campaign medal offset y" },
		{ _field_legacy, _field_real, "metagame scoreboard top y" },
		{ _field_legacy, _field_real, "metagame scoreboard spacing" },
		{ _field_legacy, _field_tag_reference, "unknown", &unknown_reference },
		{ _field_legacy, _field_long_integer, "unknown@" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_real, "medium sensor blip scale" },
		{ _field_legacy, _field_real, "small sensor blip scale" },
		{ _field_legacy, _field_real, "large sensor blip scale" },
		{ _field_legacy, _field_real, "vehicle sensor range" },
		{ _field_legacy, _field_real, "sensor angle" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
		...
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_tag_reference, "motion sensor triangulation field", &global_bitmap_reference },
		{ _field_legacy, _field_tag_reference, "motion sensor blip", &global_bitmap_reference },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		...
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "alpha?" },
		{ _field_legacy, _field_real, "r?" },
		{ _field_legacy, _field_real, "g?" },
		{ _field_legacy, _field_real, "b?" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_long_integer, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
		...
		{ _field_legacy, _field_long_integer, "unknown" },
		{ _field_legacy, _field_long_integer, "unknown" },
		{ _field_legacy, _field_tag_reference, "unknown waypoint bitmap", &global_bitmap_reference },
		{ _field_legacy, _field_byte_integer, "sequence index" },
		{ _field_legacy, _field_byte_integer, "sprite index" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		...
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_byte_integer, "unknown" },
		{ _field_legacy, _field_explanation, "state triggers list (the below block, sorted)",
	...
	STRINGS(chdt_input_variable_triggers2_definition)
	{
		"value 0",
		"value 1",
		"value 2",
	...
	STRING_LIST(chdt_input_variable_triggers2_definition, chdt_input_variable_triggers2_definition_strings, _countof(chdt_input_variable_triggers2_definition_strings));
