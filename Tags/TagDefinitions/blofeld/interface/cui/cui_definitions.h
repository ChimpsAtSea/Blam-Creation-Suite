...
namespace blofeld
{
	...
	extern s_tag_struct_definition template_instantiation_block_definition_block_struct;
	extern s_tag_block_definition template_instantiation_block_definition_block;
	extern s_tag_struct_definition component_definition_block_struct;
	extern s_tag_block_definition component_definition_block;
	extern s_tag_struct_definition component_index_block_definition_block_struct;
	extern s_tag_block_definition component_index_block_definition_block;
	extern s_tag_struct_definition property_long_value_block_struct;
	extern s_tag_block_definition property_long_value_block;
	extern s_tag_struct_definition property_real_value_block_struct;
	extern s_tag_block_definition property_real_value_block;
	extern s_tag_struct_definition property_string_id_value_block_struct;
	extern s_tag_block_definition property_string_id_value_block;
	extern s_tag_struct_definition propertyComponentPtrValue_block_struct;
	extern s_tag_block_definition propertyComponentPtrValue_block;
	extern s_tag_struct_definition property_tag_reference_value_block_struct;
	extern s_tag_block_definition property_tag_reference_value_block;
	extern s_tag_struct_definition property_text_value_block_struct;
	extern s_tag_block_definition property_text_value_block;
	extern s_tag_struct_definition property_argb_color_value_block_struct;
	extern s_tag_block_definition property_argb_color_value_block;
	extern s_tag_struct_definition component_properties_definition_block_struct;
	extern s_tag_block_definition component_properties_definition_block;
	extern s_tag_struct_definition animation_property_keyframe_real_value_block_struct;
	extern s_tag_block_definition animation_property_keyframe_real_value_block;
	extern s_tag_struct_definition animation_component_real_property_block_struct;
	extern s_tag_block_definition animation_component_real_property_block;
	extern s_tag_struct_definition animation_property_keyframe_argb_color_value_block_struct;
	extern s_tag_block_definition animation_property_keyframe_argb_color_value_block;
	extern s_tag_struct_definition animation_component_argb_color_property_block_struct;
	extern s_tag_block_definition animation_component_argb_color_property_block;
	extern s_tag_struct_definition animation_component_definition_block_struct;
	extern s_tag_block_definition animation_component_definition_block;
	extern s_tag_struct_definition animation_definition_block_struct;
	extern s_tag_block_definition animation_definition_block;
	extern s_tag_struct_definition overlay_definition_block_struct;
	extern s_tag_block_definition overlay_definition_block;
	extern s_tag_struct_definition property_editor_only_definition_block_struct;
	extern s_tag_block_definition property_editor_only_definition_block;
	extern s_tag_struct_definition component_editor_only_definition_block_struct;
	extern s_tag_block_definition component_editor_only_definition_block;
	extern s_tag_struct_definition animation_editor_only_definition_block_struct;
	extern s_tag_block_definition animation_editor_only_definition_block;
	extern s_tag_struct_definition overlay_editor_only_definition_block_struct;
	extern s_tag_block_definition overlay_editor_only_definition_block;
	extern s_tag_struct_definition property_binding_block_struct;
	extern s_tag_block_definition property_binding_block;
	extern s_tag_struct_definition binding_conversion_long_comparison_block_definition_block_struct;
	extern s_tag_block_definition binding_conversion_long_comparison_block_definition_block;
	extern s_tag_struct_definition static_data_column_block_struct;
	extern s_tag_block_definition static_data_column_block;
	extern s_tag_block_definition static_data_row_block;
	extern s_tag_struct_definition static_data_table_block_struct;
	extern s_tag_block_definition static_data_table_block;
	extern s_tag_struct_definition expression_step_block_struct;
	extern s_tag_block_definition expression_step_block;
	extern s_tag_struct_definition expression_block_struct;
	extern s_tag_block_definition expression_block;
	extern s_tag_struct_definition encapsulatedProperties_block_struct;
	extern s_tag_block_definition encapsulatedProperties_block;
	extern s_tag_block_definition cui_logic_block_block;
	extern s_tag_struct_definition string_file_references_block_struct;
	...
	extern s_tag_struct_definition animation_scalar_function_struct_definition;
	extern s_tag_struct_definition static_data_struct_struct_definition;
