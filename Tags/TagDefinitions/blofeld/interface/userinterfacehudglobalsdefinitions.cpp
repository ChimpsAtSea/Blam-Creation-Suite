...
namespace blofeld
{
	...
	{
		FIELD_EXPLANATION("Motion sensor globals", nullptr, FIELD_FLAG_NONE, "Misc settings for the motion sensor"),
		...
		FIELD_EXPLANATION("Fanfare and Messaging globals", nullptr, FIELD_FLAG_NONE, "Misc settings for fanfares and messages"),
		...
		FIELD_EXPLANATION("Remote motion sensor globals", nullptr, FIELD_FLAG_NONE, "Misc settings for the remote motion sensor"),
		...
		FIELD_EXPLANATION("Damage globals", nullptr, FIELD_FLAG_NONE, "HUD damage settings"),
		...
		FIELD_EXPLANATION("Reticule globals", nullptr, FIELD_FLAG_NONE, "Settings for the weapon reticules"),
		...
		FIELD_EXPLANATION("Sounds", nullptr, FIELD_FLAG_NONE, "misc global audio stuff"),
		{ _field_tag_reference, "banned vehicle entrance sound", &global_sound_and_looping_sound_reference },
		FIELD_EXPLANATION("High Contrast globals", nullptr, FIELD_FLAG_NONE, "Settings controlling the high contrast hud rendering"),
		{ _field_byte_flags, "High Contrast Flags", &high_contrast_flags },
		FIELD_PAD("pad1", nullptr, FIELD_FLAG_NONE, 3),
		FIELD_EXPLANATION("Dynamic Contrast Settings", nullptr, FIELD_FLAG_NONE, "Settings controlling the dynamic contrast"),
		...
		FIELD_EXPLANATION("Double Draw Settings", nullptr, FIELD_FLAG_NONE, "Settings controlling the double draw"),
		...
		FIELD_EXPLANATION("Text", nullptr, FIELD_FLAG_NONE, "Text-related settings"),
		...
		FIELD_EXPLANATION("Player Training", nullptr, FIELD_FLAG_NONE, ""),
