...
namespace blofeld
{
	...
	TAG_BLOCK(animation_pool_block, k_max_animations_per_graph)
	{
		...
		{ _field_explanation, "PCA Group Link" },
		{ _field_string_id, "pca group name" },
		{ _field_explanation, "Shared Animation Data" },
	...
	TAG_BLOCK(new_animation_function_overlay_block, k_animation_maximum_function_overlays)
	{
		...
		{ _field_explanation, "Frame Ratio or Playback Speed" },
		{ _field_custom },
	...
	TAG_BLOCK(vehicle_suspension_block, k_max_vehicle_suspensions)
	{
		...
		{ _field_explanation, "Destroyed Suspension" },
	...
	{
		{ _field_explanation, "Group Settings" },
		{ _field_block, "PCA Groups", &PCAGroupSettingsBlock_block },
		{ _field_explanation, "PCA Animation Tag" },
	...
	{
		{ _field_explanation, "CODEC-SPECIFIC DATA" },
