...
namespace blofeld
{
	...
	TAG_BLOCK(multiplayer_object_block, k_maximum_multiplayer_object_blocks)
	{
		...
		{ _field_explanation, "BOUNDARY SHADER - DEFAULT", "These are default shaders used for boundary geometry" },
		...
		{ _field_explanation, "BOUNDARY SHADER - SPHERE", "These are custom shaders used for spherical boundary geometry" },
		...
		{ _field_explanation, "BOUNDARY SHADER - CYLINDER", "These are custom shaders used for cylindrical boundary geometry" },
		...
		{ _field_explanation, "BOUNDARY SHADER - BOX", "These are custom shaders used for box boundary geometry" },
	...
	TAG_STRUCT(object_struct_definition)
	{
		...
		{ _field_version_less, {_engine_type_haloreach} },
		{ _field_word_flags, "flags", &object_definition_flags },
		...
		{ _field_version_less, {_engine_type_haloreach} },
		{ _field_real, "acceleration scale:[0,+inf]" },
		...
		{ _field_struct, "object abandonment", &object_abandonment_struct_struct_definition },
		{ _field_custom },
