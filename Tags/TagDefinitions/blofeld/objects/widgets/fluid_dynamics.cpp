...
namespace blofeld
{
		...
		FLUID_DYNAMICS_SQUIRTER_BLOCK_ID)
	{
		...
		FIELD_SKIP_EX("JKISKKJS", nullptr, FIELD_FLAG_NONE, 48),
		...
		FLUID_DYNAMICS_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_PAD_EX("FIRWW", nullptr, FIELD_FLAG_NONE, 40),
		...
		FIELD_PAD_EX("SKT", nullptr, FIELD_FLAG_NONE, 2),
		FIELD_PAD_EX("DBNFAM", nullptr, FIELD_FLAG_NONE, 76),
		{ _field_short_integer, "number of tracers" },
		FIELD_PAD_EX("FQ", nullptr, FIELD_FLAG_NONE, 2),
		{ _field_real_bounds, "tracer time multipier range" },
		{ _field_real, "tracer max velocity influence scale", "1-32" },
		FIELD_PAD_EX("NYUBJV", nullptr, FIELD_FLAG_NONE, 36),
		...
		FIELD_PAD_EX("DNF", nullptr, FIELD_FLAG_NONE, 28),
		{ _field_block, "particle effects", &particle_system_definition_block_new_block },
		FIELD_PAD_EX("ZJSKRR", nullptr, FIELD_FLAG_NONE, 20),
		...
		FIELD_EXPLANATION_EX("Cylinder map", nullptr, FIELD_FLAG_NONE, ""),
		...
		G_SINGLE_SCALAR_FUNCTION_EVALUATION_STRUCT_ID)
	{
		...
		FIELD_PAD_EX("LOHRT", nullptr, FIELD_FLAG_NONE, 16),
		{ _field_terminator }
	};
