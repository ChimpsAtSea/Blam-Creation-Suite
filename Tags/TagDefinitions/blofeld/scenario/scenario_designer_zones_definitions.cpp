...
namespace blofeld
{
		...
		SCENARIO_DESIGNER_ZONE_BLOCK_ID)
	{
		...
		FIELD_CUSTOM_EX("vehicle", nullptr, FIELD_FLAG_NONE, _field_id_block_index_flags),
		{ _field_block, "vehicle", &vehicle_block_index_flags_block },
		FIELD_CUSTOM_EX("weapon", nullptr, FIELD_FLAG_NONE, _field_id_block_index_flags),
		{ _field_block, "weapon", &weapon_block_index_flags_block },
		FIELD_CUSTOM_EX("equipment", nullptr, FIELD_FLAG_NONE, _field_id_block_index_flags),
		{ _field_block, "equipment", &equipment_block_index_flags_block },
		FIELD_CUSTOM_EX("scenery", nullptr, FIELD_FLAG_NONE, _field_id_block_index_flags),
		{ _field_block, "scenery", &scenery_block_index_flags_block },
		FIELD_CUSTOM_EX("machine", nullptr, FIELD_FLAG_NONE, _field_id_block_index_flags),
		{ _field_block, "machine", &machine_block_index_flags_block },
		FIELD_CUSTOM_EX("terminal", nullptr, FIELD_FLAG_NONE, _field_id_block_index_flags),
		...
		FIELD_CUSTOM_EX("sound_scenery", nullptr, FIELD_FLAG_NONE, _field_id_block_index_flags),
		{ _field_block, "sound_scenery", &sound_scenery_block_index_flags_block },
		FIELD_CUSTOM_EX("crate", nullptr, FIELD_FLAG_NONE, _field_id_block_index_flags),
		{ _field_block, "crate", &crate_block_index_flags_block },
		FIELD_CUSTOM_EX("creature", nullptr, FIELD_FLAG_NONE, _field_id_block_index_flags),
		{ _field_block, "creature", &creature_block_index_flags_block },
		FIELD_CUSTOM_EX("giant", nullptr, FIELD_FLAG_NONE, _field_id_block_index_flags),
		{ _field_block, "giant", &giant_block_index_flags_block },
		FIELD_CUSTOM_EX("effect_scenery", nullptr, FIELD_FLAG_NONE, _field_id_block_index_flags),
		{ _field_block, "effect_scenery", &effect_scenery_block_index_flags_block },
		FIELD_CUSTOM_EX("character", nullptr, FIELD_FLAG_NONE, _field_id_block_index_flags),
