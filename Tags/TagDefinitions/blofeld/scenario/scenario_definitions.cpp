...
namespace blofeld
{
	...
	V5_TAG_BLOCK(scenario_unknown_block, 65536) // CUSTOM
	{
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
		{ _field_legacy, _field_real, "unknown" },
	...
	TAG_REFERENCE(scenario_hs_source_reference_block_reference, HSC_TAG);

	V5_TAG_BLOCK(scenario_hs_source_reference_block, k_maximum_hs_source_files_per_scenario)
	{
		{ _field_legacy, _field_tag_reference, "reference*", &scenario_hs_source_reference_block_reference },
		{ _field_legacy, _field_terminator }
	};
	...
	V5_TAG_BLOCK(scenario_unknown_object_reference_block, 65536) // CUSTOM
	{
		{ _field_legacy, _field_struct, "object ID*!", & scenario_object_id_struct },
