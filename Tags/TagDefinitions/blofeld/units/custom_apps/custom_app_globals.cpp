...
namespace blofeld
{
		...
		CUSTOM_APP_BLOCK_ID)
	{
		...
		FIELD_EXPLANATION_EX("Locked flag", nullptr, FIELD_FLAG_NONE, "If you lock an app that you currently have installed and then XSync, the game may assert.  If so, relaunch and you\'ll be fine.  It\'s nothing to worry about."),
		{ _field_byte_flags, "flags", &custom_app_flags$2 },
		FIELD_PAD_EX("woooo", nullptr, FIELD_FLAG_NONE, 3),
		FIELD_EXPLANATION_EX("Player Traits", nullptr, FIELD_FLAG_NONE, "Player traits that are applied to the player when they have this app."),
		{ _field_block, "player traits", &game_engine_player_traits_block },
		FIELD_EXPLANATION_EX("Damage Type Modifiers", nullptr, FIELD_FLAG_NONE, "Damage modifiers per damage type."),
		...
		CUSTOM_APP_GLOBALS_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION_EX("Update Frequency", nullptr, FIELD_FLAG_NONE, "The players can enter the Custom App menu at any time during a game and change their apps.  This enum determines when those changes take effect, in terms of gameplay effects."),
		{ _field_enum, "custom app update frequency", &custom_app_update_frequencies },
		FIELD_PAD_EX("wahoo", nullptr, FIELD_FLAG_NONE, 2),
