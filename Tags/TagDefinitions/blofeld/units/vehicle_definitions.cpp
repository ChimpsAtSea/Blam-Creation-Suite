...
namespace blofeld
{
	...
	TAG_BLOCK(alien_scout_block, 1)
	{
		...
		{ _field_explanation, "specific types" },
	...
	TAG_BLOCK(alien_fighter_block, 1)
	{
		...
		{ _field_real, "slide deceleration" },
		{ _field_real, "slide accel against direction#acceleration when trying to throttle against current slide direction" },
		{ _field_explanation, "torque scale" },
		{ _field_real, "flying torque scale#big vehicles need to scale this down.  0 defaults to 1, which is generally a good value." },
		{ _field_explanation, "fixed gun offset" },
	...
	TAG_BLOCK(vtol_block, 1)
	{
		...
		{ _field_explanation, "lift arm pivot" },
		...
		{ _field_explanation, "interpolation parameters" },
		{ _field_real, "interpolation speed domain" },
		{ _field_explanation, "funciton explanation" },
		...
		{ _field_explanation, "prop rotation" },
	...
	TAG_BLOCK(space_fighter_block, 1)
	{
		...
		{ _field_explanation, "soft ceiling turn back" },
		...
		{ _field_explanation, "thrust params" },
		...
		{ _field_explanation, "dive params" },
		{ _field_real, "minimum dive angle" },
		{ _field_real, "maximum dive angle" },
		{ _field_explanation, "strafe params" },
		{ _field_real, "strafe boost power" },
		{ _field_explanation, "wingtip params" },
	...
	TAG_STRUCT(human_tank_struct)
	{
		...
		{ _field_explanation, "forward differential" },
		...
		{ _field_explanation, "reverse differential" },
	...
	{
		{ _field_explanation, "steering overdampening" },
	...
	TAG_STRUCT(flight_surface_struct)
	{
		...
		{ _field_explanation, "normal force" },
		{ _field_real, "q" },
		{ _field_real, "k" },
