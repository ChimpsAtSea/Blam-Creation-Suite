...
namespace blofeld
{
	...
	{
		{ _field_legacy, _field_real, "minimum velocity:wu/s#this death program will be selected if the biped\'s velocity is above this number^" },
		{ _field_legacy, _field_long_enum, "death program", &death_program_result_enum },
		{ _field_legacy, _field_real, "death program scale#input to the death program to scale the result (only affects ragdolls)" },
		{ _field_legacy, _field_string_id, "death animation stance#Override stance that contains the death animations for this gait speed when using animate then ragdoll option." },
	...
	V5_TAG_BLOCK(death_program_damage_reporting_block, k_maximum_death_program_damage_types)
	{
		...
		{ _field_legacy, _field_block, "velocity", &death_program_velocity_gate_block_block },
		{ _field_legacy, _field_terminator }
	};

	V5_TAG_BLOCK(death_program_special_block, k_maximum_death_program_special_types)
	{
		{ _field_legacy, _field_long_enum, "special type^", &object_damage_aftermath_special_damage_type_enum },
		{ _field_legacy, _field_block, "damage type", &death_program_damage_reporting_block_block },
		{ _field_legacy, _field_terminator }
	};
