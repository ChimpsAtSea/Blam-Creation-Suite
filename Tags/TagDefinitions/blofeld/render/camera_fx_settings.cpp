...
namespace blofeld
{
	...
	{
		{ _field_explanation, "AUTO EXPOSURE SENSITIVITY" },
	...
	{
		{ _field_explanation, "HIGHLIGHT BLOOM" },
		{ _field_word_flags, "flags", &camera_fx_parameter_flags_no_auto_adjust },
	...
	{
		{ _field_explanation, "INHERENT BLOOM" },
		{ _field_word_flags, "flags", &camera_fx_parameter_flags_no_auto_adjust },
		{ _field_pad, "ERIRLE", 2 },
	...
	{
		{ _field_explanation, "SELF-ILLUM BLOOM" },
		{ _field_word_flags, "flags", &camera_fx_parameter_flags_no_auto_adjust },
		{ _field_pad, "ERIRLE", 2 },
	...
	{
		{ _field_explanation, "BLOOM INTENSITY" },
		{ _field_word_flags, "flags", &camera_fx_parameter_flags_no_auto_adjust },
	...
	{
		{ _field_explanation, "BLOOM LARGE COLOR" },
		{ _field_word_flags, "flags", &camera_fx_parameter_flags_no_auto_adjust },
		{ _field_pad, "KKROFI", 2 },
	...
	{
		{ _field_explanation, "BLOOM MEDIUM COLOR" },
		{ _field_word_flags, "flags", &camera_fx_parameter_flags_no_auto_adjust },
		{ _field_pad, "LEORPP", 2 },
	...
	{
		{ _field_explanation, "BLOOM SMALL COLOR" },
		{ _field_word_flags, "flags", &camera_fx_parameter_flags_no_auto_adjust },
	...
	{
		{ _field_explanation, "SELF ILLUM EXPOSURE" },
		{ _field_word_flags, "flags", &camera_fx_parameter_flags_no_auto_adjust },
	...
	{
		{ _field_explanation, "SELF ILLUM CHANGE" },
		{ _field_word_flags, "flags", &camera_fx_parameter_flags_no_auto_adjust },
	...
	{
		{ _field_explanation, "Color Grading" },
		{ _field_word_flags, "flags", &camera_fx_parameter_flags_no_auto_adjust },
	...
	{
		{ _field_explanation, "Filmic Tone Curve" },
