...
namespace blofeld
{
		...
		DIFFICULTY_BLOCK_ID)
	{
		...
		FIELD_PAD("$", nullptr, FIELD_FLAG_NONE, 16),
		FIELD_PAD("$$", nullptr, FIELD_FLAG_NONE, 16),
		...
		FIELD_PAD("$$$$$$$$", nullptr, FIELD_FLAG_NONE, 16),
		FIELD_PAD("$$$$$$$$$", nullptr, FIELD_FLAG_NONE, 16),
		FIELD_PAD("Q", nullptr, FIELD_FLAG_NONE, 84),
		{ _field_terminator }
	};
	...
	{
		FIELD_EXPLANATION("vitality", nullptr, FIELD_FLAG_NONE, "scale values for enemy health and shield settings"),
		...
		FIELD_EXPLANATION("movement", nullptr, FIELD_FLAG_NONE, "scale values for enemy movement properties"),
		...
		FIELD_EXPLANATION("evasion", nullptr, FIELD_FLAG_NONE, "scale values for enemy evasion settings"),
		...
		FIELD_EXPLANATION("shooting", nullptr, FIELD_FLAG_NONE, "scale values for enemy shooting settings"),
		...
		FIELD_EXPLANATION("projectile", nullptr, FIELD_FLAG_NONE, "scale values for enemy projectile settings"),
