...
namespace blofeld
{
		...
		GAME_ENGINE_EVENT_BLOCK_STRUCT_ID)
	{
		...
		FIELD_EXPLANATION_EX("SOUND PRIORITIZATION", nullptr, FIELD_FLAG_NONE, "A data-driven way to choose between halo 3 mp\'s always-queue behavior vs. odst firefight\'s always-suppress-older-multikills behavior."),
		...
		FIELD_EXPLANATION_EX("SOUND PAIR CULLING", nullptr, FIELD_FLAG_NONE, "A way to say flag taken + flag dropped = silence."),
