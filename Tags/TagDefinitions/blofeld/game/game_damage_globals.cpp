...
namespace blofeld
{
		...
		DAMAGE_GLOBALS_BLOCK_ID)
	{
		...
		{ _field_tag_reference, "terminal velocity damage", MAKE_ALT_NAMES("distance damage"), &global_damage_reference },
		{ _field_tag_reference, "default damage response", "fall back if none is specified in damage effect tags", MAKE_ALT_NAMES("damage response"), &global_damage_response_definition_reference },
