...
namespace blofeld
{
	...
	V5_TAG_GROUP_FROM_BLOCK(survival_mode_globals, SURVIVAL_MODE_GLOBALS_TAG, survival_mode_globals_block_block );

	V5_TAG_BLOCK_FROM_STRUCT(survival_mode_wave_templates, k_global_wave_templates_count, survival_mode_wave_templates_struct_struct_definition );

	V5_TAG_BLOCK_FROM_STRUCT(survival_mode_globals_block, 1, survival_mode_globals_struct_definition_struct_definition );
