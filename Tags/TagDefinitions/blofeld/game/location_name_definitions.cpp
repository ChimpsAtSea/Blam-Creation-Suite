...
namespace blofeld
{
	...
	{
		{ _field_legacy, _field_block, "location names", &location_name_block_block },
		{ _field_legacy, _field_tag_reference, "location name string list", &global_multilingual_unicode_string_list_reference },
		{ _field_legacy, _field_terminator }
	};
