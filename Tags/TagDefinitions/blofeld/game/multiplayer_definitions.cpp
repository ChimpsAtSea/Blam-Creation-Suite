...
namespace blofeld
{
		...
		MULTIPLAYER_CONSTANTS_BLOCK_ID)
	{
		...
		{ _field_legacy, _field_block, "weapons", &multiplayer_constants_weapon_block },
		{ _field_legacy, _field_block, "vehicles", &multiplayer_constants_vehicle_block },
		{ _field_legacy, _field_block, "projectiles", &multiplayer_constants_projectile_block },
