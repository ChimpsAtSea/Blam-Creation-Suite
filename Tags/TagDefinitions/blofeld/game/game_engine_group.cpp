...
namespace blofeld
{
		...
		GAME_ENGINE_RESPAWN_OPTIONS_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("woman bound for glory, why you leaving me again?", nullptr, FIELD_FLAG_NONE, 2),
		{ _field_terminator }
	};
		...
		GAMEENGINEFIREFIGHTPLAYERGOALPROPERTIESBLOCK_ID)
	{
		...
		FIELD_PAD_EX("BLAH", nullptr, FIELD_FLAG_NONE, 2),
		{ _field_terminator }
	};
		...
		GAME_ENGINE_SURVIVAL_VARIANT_BLOCK_ID)
	{
		...
		FIELD_CUSTOM_EX("bonus round", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		...
		GAME_ENGINE_SURVIVAL_ROUND_PROPERTIES_BLOCK_ID)
	{
		...
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_field_group_end),
		FIELD_CUSTOM_EX("primary wave", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
		{ _field_struct, "primary waves", &game_engine_survival_wave_properties_struct },
		FIELD_CUSTOM_EX(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_field_group_end),
		FIELD_CUSTOM_EX("boss wave", nullptr, FIELD_FLAG_NONE, _field_id_field_group_begin),
	...
	{
		FIELD_EXPLANATION_EX("Game Engine Settings", nullptr, FIELD_FLAG_NONE, "This contains the definitions for the built-in custom multiplayer game variants"),
		...
		GAME_ENGINE_SURVIVAL_WAVE_PROPERTIES_STRUCT_ID)
	{
		...
		FIELD_PAD_EX("VJKNMFEN", nullptr, FIELD_FLAG_NONE, 2),
	...
	STRINGS(game_engine_survival_generator_count)
	{
		"None",
		"1 Generator",
		"2 Generators",
	...
	STRING_LIST(game_engine_survival_generator_count, game_engine_survival_generator_count_strings, _countof(game_engine_survival_generator_count_strings));
