...
namespace blofeld
{
		...
		MATERIALS_BLOCK_ID)
	{
		...
		FIELD_PAD_EX("RMBP1", nullptr, FIELD_FLAG_NONE, 2),
	...
	{
		FIELD_EXPLANATION_EX("when this material is encounted under a material of this type ...", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_string_id, "underwater material" },
		FIELD_EXPLANATION_EX("... we report it as this material", nullptr, FIELD_FLAG_NONE, ""),
	...
	{
		FIELD_EXPLANATION_EX("when rained on, we report this material", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_string_id, "wet material" },
		{ _field_short_integer, "runtime proxy material index", FIELD_FLAG_UNKNOWN0 | FIELD_FLAG_READ_ONLY },
		FIELD_PAD_EX("wpb1", nullptr, FIELD_FLAG_NONE, 2),
		{ _field_terminator }
	};
		...
		MATERIAL_PHYSICS_PROPERTIES_STRUCT_ID)
	{
		...
		FIELD_EXPLANATION_EX("Drag", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_EXPLANATION_EX("Floatation", nullptr, FIELD_FLAG_NONE, "objects of this flotation category have this density relative to being in this material (1.0f==neutral)"),
		FIELD_PAD_EX("default", nullptr, FIELD_FLAG_NONE, 4),
		{ _field_real, "super floater" },
		{ _field_real, "floater" },
		{ _field_real, "neutral" },
		{ _field_real, "sinker" },
		{ _field_real, "super sinker" },
		FIELD_PAD_EX("none", nullptr, FIELD_FLAG_NONE, 4),
		{ _field_terminator }
	};
