...
namespace blofeld
{
	...
	{
		{ _field_legacy, _field_char_enum, "currency type#Type of currency given by this reward.", &currencyTypeEnumDefinition },
		{ _field_legacy, _field_pad, "CRB_PAD1", 1 },
		{ _field_legacy, _field_short_integer, "reward value" },
	...
	V5_TAG_BLOCK(commendationAggregator, CommendationAggregator::k_commendationAggregatorMaxCount)
	{
		...
		{ _field_legacy, _field_block, "rewards", &commendationRewardBlock_block },
		{ _field_legacy, _field_char_integer, "sequence index" },
		{ _field_legacy, _field_pad, "CA_PAD1", 3 },
		{ _field_legacy, _field_short_integer, "medal sprite index" },
		{ _field_legacy, _field_short_integer, "game type sprite index" },
		{ _field_legacy, _field_block, "prerequisites{contributing commendations}", &commendationAggregatorDependent_block },
		{ _field_legacy, _field_terminator }
	};
	...
	{
		{ _field_legacy, _field_string_id, "level name^" },
		{ _field_legacy, _field_short_integer, "progress ticks to level#number of ticks to reach this level" },
		{ _field_legacy, _field_short_integer, "progress display interval#number of ticks between displaying progress toast; 0=never display progress, 1=display every tick, 2=every other, etc." },
		{ _field_legacy, _field_string_id, "achievement" },
		{ _field_legacy, _field_block, "level up rewards#rewards given for reaching this level", &commendationRewardBlock_block },
		{ _field_legacy, _field_terminator }
	};
	...
	V5_TAG_BLOCK(commendationBlock, CommendationDefinition::k_maximumCommendationDefinitions)
	{
		...
		{ _field_legacy, _field_byte_flags, "flags", &commendationFlags },
		{ _field_legacy, _field_pad, "CB_PAD0", 3 },
		{ _field_legacy, _field_char_enum, "category", &commendationCategoryEnum },
		{ _field_legacy, _field_char_enum, "subcategory", &commendationSubcategoryEnum },
		{ _field_legacy, _field_char_integer, "sequence index" },
		{ _field_legacy, _field_pad, "CB_PAD1", 1 },
		{ _field_legacy, _field_short_integer, "medal sprite index" },
		{ _field_legacy, _field_short_integer, "game type sprite index" },
		{ _field_legacy, _field_custom, "unlock prerequisites" },
		{ _field_legacy, _field_struct, "prerequisites", &PurchasePrerequisitesUnifiedDefinitionBlock_struct_definition },
		{ _field_legacy, _field_custom },
		{ _field_legacy, _field_block, "levels", &commendationLevelBlock_block },
	...
	{
		{ _field_legacy, _field_block, "lists", &commendationAggregator_block },
		{ _field_legacy, _field_terminator }
	};

	V5_TAG_STRUCT(commendationAggregatorDependent_struct)
	{
		{ _field_legacy, _field_char_enum, "type", &aggregatorDependentTypeEnumDefinition },
	...
	{
		{ _field_legacy, _field_tag_reference, "commendation aggregators", &Tag::Reference<struct CommendationAggregatorList>::s_defaultDefinition },
		...
		{ _field_legacy, _field_tag_reference, "medal aggregators", &Tag::Reference<struct MedalCommendationAggregatorList>::s_defaultDefinition },
		{ _field_legacy, _field_tag_reference, "commendation text", &global_multilingual_unicode_string_list_reference },
		{ _field_legacy, _field_short_integer, "progress display time{progression display time}:seconds" },
		{ _field_legacy, _field_short_integer, "complete display time{callout display time}:seconds" },

		{ _field_legacy, _field_block, "commendations", &commendationBlock_block },
		{ _field_legacy, _field_terminator }
	};
