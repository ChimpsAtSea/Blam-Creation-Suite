...
namespace blofeld
{
	...
	V5_TAG_BLOCK(game_completion_rewards_definition_block, eCT_count)
	{
		...
		{ _field_version_greater, _engine_type_haloreach }, // #TODO: Unsure if this is 100% correct
		...
		{ _field_block, "apm falloff curve{cpm falloff curve}#amount per minute falloff curve; used to provide diminishing returns for longer play time", &game_completion_rewards_falloff_point_block_block },
		{ _field_terminator }
	};
	...
	V5_TAG_STRUCT(game_completion_rewards_globals_struct_definition)
	{
		...
		{ _field_block, "unknown#rewards given for unknown", &game_completion_rewards_multiplayer_block_block },
