...
namespace blofeld
{
	...
	V5_TAG_BLOCK(rewardDefinitionBlock, RewardGlobalDefinition::k_maximum_count)
	{
		...
		{ _field_legacy, _field_char_enum, "type", &rewardTypeEnum },
		{ _field_legacy, _field_pad, "PJB1", 3 },
		{ _field_legacy, _field_block, "rewards", &rewardBlock_block },
	...
	{
		{ _field_legacy, _field_block, "reward definitions{cookie awards}", &rewardDefinitionBlock_block },
		{ _field_legacy, _field_terminator }
	};
