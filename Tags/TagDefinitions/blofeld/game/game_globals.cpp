...
namespace blofeld
{
		...
		GLOBALS_STRUCT_DEFINITION_ID)
	{
		...
		{ _field_block, "DEPRECATED", MAKE_ALT_NAMES("ai globals"), FIELD_FLAG_UNKNOWN0 | FIELD_FLAG_READ_ONLY, &ai_globals_data_block, _field_id_slap },
		...
		{ _field_block, "damage", MAKE_ALT_NAMES("falling damage"), &damage_globals_block },
