...
namespace blofeld
{
		...
		SPAWNSETTINGS_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION_EX("Spawn Randomization", nullptr, FIELD_FLAG_NONE, "Values that affect randomization of respawn point selection\nRuntime will use the largest of \'% best weight to use\' and \'Min absolute weight range\'"),
		...
		FIELD_EXPLANATION_EX("ENEMY BIAS", nullptr, FIELD_FLAG_NONE, "This is a larger cylinder, with a size set specifically for the size of the map. It has a weak negative weight which falls to zero towards the outer radius. It serves to bias players away from spawning near enemies, or in enemy held areas."),
		...
		FIELD_EXPLANATION_EX("SELECTED ALLY BIAS", nullptr, FIELD_FLAG_NONE, "Same as ALLY BIAS, but used when the ally is selected in the dead-camera."),
		...
		FIELD_EXPLANATION_EX("DEAD TEAMMATE BIAS", nullptr, FIELD_FLAG_NONE, "Dead teammate influences are cylinders centered upon the body of a dead teammate (or the player’s own dead body)."),
		...
		{ _field_legacy, _field_block, "@unknown falloff function#Multiplier applied to weight (domain is full weight radius to fall-off radius, range should be 0 to 1).", &spawn_influence_weight_falloff_function_block },
		...
		FIELD_EXPLANATION_EX("WEAPON INFLUENCERS", nullptr, FIELD_FLAG_NONE, "These influencers are induced by weapons either weilded or carried in the player\'s backpack"),
		{ _field_block, "weapon influencers", &weaponSpawnInfluenceBlock_block },
		FIELD_EXPLANATION_EX("VEHICLE INFLUENCERS", nullptr, FIELD_FLAG_NONE, "These influencers are induced by vehicles."),
		{ _field_block, "vehicle influencers", &vehicleSpawnInfluenceBlock_block },
		FIELD_EXPLANATION_EX("PROJECTILE INFLUENCERS", nullptr, FIELD_FLAG_NONE, "These influencers are induced by projectiles."),
		{ _field_block, "projectile influencers", &projectileSpawnInfluenceBlock_block },
		FIELD_EXPLANATION_EX("EQUIPMENT INFLUENCERS", nullptr, FIELD_FLAG_NONE, "These influencers are induced by equipment."),
