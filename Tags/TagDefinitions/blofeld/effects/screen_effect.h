...
namespace blofeld
{
	...
	extern c_versioned_string_list area_screen_effect_global_hidden_flags_definition_strings;
	extern s_string_list_definition area_screen_effect_global_hidden_flags_definition;
	extern c_versioned_string_list area_screen_effect_flags_definition_strings;
	extern s_string_list_definition area_screen_effect_flags_definition;
	extern c_versioned_string_list area_screen_effect_hidden_flags_definition_strings;
