...
namespace blofeld
{
	...
	V5_TAG_BLOCK(tracerDefinitionBlock, TracerSystemDefinition::k_maxTracers)
	{
		...
		{ _field_legacy, _field_string_id, "tracer name^" },
		{ _field_legacy, _field_byte_flags, "flags", &tracerFlags },
		...
		{ _field_legacy, _field_pad, "tracpad", 1 },
		...
		{ _field_legacy, _field_struct, "profile lifespan#seconds", &tracerProperty_real_Struct_struct_definition },
		{ _field_legacy, _field_struct, "profile self acceleration#world units per second-squared", &tracerProperty_real_vector3d_Struct_struct_definition },
		{ _field_legacy, _field_struct, "length#world units", &tracerProperty_real_Struct_struct_definition },
		{ _field_legacy, _field_struct, "offset#world units", &tracerProperty_real_Struct_struct_definition },
		{ _field_legacy, _field_struct, "profile size#world units", &tracerProperty_real_Struct_struct_definition },
		{ _field_legacy, _field_struct, "profile density#profiles per world unit", &tracerProperty_real_Struct_struct_definition },
		{ _field_legacy, _field_struct, "profile offset#world units", &tracerProperty_real_point2d_Struct_struct_definition },
		{ _field_legacy, _field_struct, "profile rotation#degrees", &tracerProperty_real_Struct_struct_definition },
		{ _field_legacy, _field_struct, "profile rotation rate#degrees per second", &tracerProperty_real_Struct_struct_definition },
		{ _field_legacy, _field_custom },
		{ _field_legacy, _field_custom, "Tracer Appearance" },
		...
		{ _field_legacy, _field_custom },
		{ _field_legacy, _field_real_vector_2d, "uv tiling:u lengthwise, v crosswise#u is tiles/world unit, v is absolute tiles" },
		{ _field_legacy, _field_real_vector_2d, "uv scrolling:tiles per second" },
		{ _field_legacy, _field_real, "angle fade range:degrees#radial (from tracer axis) degrees beyond beginning angle over which tracer fades" },
		{ _field_legacy, _field_real, "angle fade begin:degrees#radial (from tracer axis) degrees away from face-on where fade begins" },
	...
	{
		{ _field_legacy, _field_long_flags, "tracer system flags", &tracerSystemFlags },
		{ _field_legacy, _field_explanation, "far lod", "These don\'t actually do anything unless you use \"tracer lod\" in one of your curves." },
		{ _field_legacy, _field_real, "far lod start" },
		{ _field_legacy, _field_real, "far lod end" },
		{ _field_legacy, _field_real, "far lod start value" },
		{ _field_legacy, _field_real, "far lod end value" },
		{ _field_legacy, _field_block, "tracers", &tracerDefinitionBlock_block },
		{ _field_legacy, _field_terminator }
	};

	V5_TAG_STRUCT(tracerProperty_real_Struct)
	{
		{ _field_legacy, _field_char_enum, "Input Variable", &tracerStateInputEnum },
		{ _field_legacy, _field_char_enum, "Range Variable", &tracerStateInputEnum },
		{ _field_legacy, _field_char_enum, "Output Modifier", &tracerStateOutputModEnum },
		{ _field_legacy, _field_char_enum, "Output Modifier Input", &tracerStateInputEnum },
		{ _field_legacy, _field_custom },
	...
	V5_TAG_STRUCT(tracerProperty_real_point2d_Struct)
	{
		...
		{ _field_legacy, _field_word_integer, "runtime m_flags!" },
		{ _field_legacy, _field_pad, "DSFDSGLKJ", 2 },
		{ _field_legacy, _field_real_vector_2d, "Starting interpolant" },
		{ _field_legacy, _field_real_vector_2d, "Ending interpolant" },
		{ _field_legacy, _field_terminator }
	};
