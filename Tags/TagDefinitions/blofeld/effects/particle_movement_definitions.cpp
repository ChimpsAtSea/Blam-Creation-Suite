...
namespace blofeld
{
	...
	{
		{ _field_legacy, _field_long_integer, "parameter id" },
		{ _field_legacy, _field_struct, "property", &particle_property_scalar_struct_new_struct_definition },
		{ _field_legacy, _field_terminator }
	};

	V5_TAG_BLOCK(particle_controller, c_particle_movement_definition::k_type_count + 2)
	{
		{ _field_legacy, _field_enum, "type", &particle_movement_type },
		{ _field_legacy, _field_byte_flags, "flags!", &particle_controller_flags },
		{ _field_legacy, _field_pad, "KNTXOMS", 1 },
		{ _field_legacy, _field_block, "parameters", &particle_controller_parameters_block },
		{ _field_legacy, _field_long_integer, "runtime m_constant_parameters!" },
	...
	{
		{ _field_legacy, _field_tag_reference, "template", &particle_movement_definition },
		{ _field_legacy, _field_word_flags, "flags", &particle_movement_flags },
		{ _field_legacy, _field_char_integer, "collision controller index!" },
		{ _field_legacy, _field_char_integer, "turbulence controller index!" },

		{ _field_legacy, _field_version_greater, _engine_type_haloreach, 2 },
		{ _field_legacy, _field_char_integer, "global force controller index!" },
		{ _field_legacy, _field_pad, "pphys", 3 },

		{ _field_legacy, _field_block, "movements", &particle_controller_block },
		{ _field_legacy, _field_tag_reference, "turbulence texture", &global_bitmap_reference },
		{ _field_legacy, _field_terminator }
	};
