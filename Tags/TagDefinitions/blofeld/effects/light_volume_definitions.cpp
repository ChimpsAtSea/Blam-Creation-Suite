...
namespace blofeld
{
	...
	TAG_BLOCK(light_volume_definition_block, c_light_volume_system_definition::k_max_light_volume)
	{
		...
		{ _field_struct, "length", &light_volume_property_real_struct_definition },
		{ _field_struct, "offset", &light_volume_property_real_struct_definition },
		{ _field_struct, "profile_density", &light_volume_property_real_struct_definition },
		{ _field_struct, "profile_length", &light_volume_property_real_struct_definition },
		{ _field_struct, "profile_thickness", &light_volume_property_real_struct_definition },
		{ _field_struct, "profile_color", &light_volume_property_real_rgb_color_struct_definition },
		{ _field_struct, "profile_alpha", &light_volume_property_real_struct_definition },
		{ _field_struct, "profile_intensity", &light_volume_property_real_struct_definition },
		{ _field_custom },
