...
namespace blofeld
{
	...
	{
		{ _field_legacy, _field_long_enum, "priority type^*", &global_effect_priority_enum },
		{ _field_legacy, _field_explanation, "SET ONE OF THE FOLLOWING", "Whichever is larger will be used" },
		{ _field_legacy, _field_dword_integer, "absolute count" },
		{ _field_legacy, _field_real, "relative percentage:/ 100" },
		{ _field_legacy, _field_dword_integer, "How many available at this priority*!" },
		{ _field_legacy, _field_terminator }
	};

	V5_TAG_BLOCK(effect_component_holdbacks_block, k_effect_holdback_type_max)
	{
		{ _field_legacy, _field_long_enum, "holdback type^*", &effect_holdback_type_enum },
		{ _field_legacy, _field_dword_integer, "overall budget*#from code" },
		{ _field_legacy, _field_block, "priorities", &effect_component_holdback_block_block },
		{ _field_legacy, _field_terminator }
	};

	V5_TAG_BLOCK(effect_global_spawn_effects_block, 1)
	{
		{ _field_legacy, _field_tag_reference, "biped spawn effect", &global_effect_reference },
		{ _field_legacy, _field_tag_reference, "vehicle spawn effect", &global_effect_reference },
		{ _field_legacy, _field_tag_reference, "weapon spawn effect", &global_effect_reference }, 

		{ _field_legacy, _field_version_greater, _engine_type_haloreach },
		{ _field_legacy, _field_tag_reference, "first person player spawn effect", &global_effect_reference },
	...
	V5_TAG_STRUCT(effect_globals_struct_definition)
	{
		...
		{ _field_legacy, _field_block, "multiplayer", &effect_global_spawn_effects_block_block },
		{ _field_legacy, _field_block, "survival", &effect_global_spawn_effects_block_block },
		{ _field_legacy, _field_block, "campaign", &effect_global_spawn_effects_block_block },
