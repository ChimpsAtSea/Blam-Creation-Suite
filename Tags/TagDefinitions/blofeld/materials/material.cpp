...
namespace blofeld
{
		...
		MATERIAL_STRUCT_DEFINITION_ID)
	{
		...
		{ _field_block, "postprocess definition", FIELD_FLAG_UNKNOWN0, &material_postprocess_block },
		...
		MATERIAL_POSTPROCESS_BLOCK_ID)
	{
		...
		{ _field_struct, "physics material 0", FIELD_FLAG_UNKNOWN0, &material_type_struct },
		{ _field_struct, "physics material 1", FIELD_FLAG_UNKNOWN0, &material_type_struct },
		{ _field_struct, "physics material 2", FIELD_FLAG_UNKNOWN0, &material_type_struct },
		{ _field_struct, "physics material 3", FIELD_FLAG_UNKNOWN0, &material_type_struct },
		{ _field_terminator }
	};
