...
namespace blofeld
{
	...
	{
		{ _field_legacy, _field_tag_reference, "tag reference", &dependency_reference_definition },
	...
	{
		{ _field_legacy, _field_block, "dependency list", &one_dependency_block_definition_block },
		{ _field_legacy, _field_terminator }
	};
