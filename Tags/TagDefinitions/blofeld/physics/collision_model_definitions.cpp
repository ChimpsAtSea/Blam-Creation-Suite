...
namespace blofeld
{
	...
	{
		{ _field_legacy, _field_long_integer, "import_info_checksum*!" },
		{ _field_legacy, _field_block, "errors*", &global_error_report_categories_block_block },
		{ _field_legacy, _field_long_flags, "flags*", &collision_model_flags },
		{ _field_legacy, _field_block, "materials*", &collision_model_material_block_block },
		{ _field_legacy, _field_block, "regions*", &collision_model_region_block_block },
		{ _field_legacy, _field_block, "cookie cutters*", &collision_model_region_block_block },
		{ _field_legacy, _field_block, "pathfinding spheres*", &collision_model_pathfinding_sphere_block_block },
		{ _field_legacy, _field_block, "nodes*", &collision_model_node_block_block },

		{ _field_legacy, _field_version_less_or_equal, _engine_type_haloreach },
		{ _field_legacy, _field_long_integer, "unknown@" },

		{ _field_legacy, _field_version_greater, _engine_type_haloreach },
		{ _field_legacy, _field_pageable, "regions resource", &collision_model_resource_struct_struct_definition },
	...
	V5_TAG_BLOCK(collision_model_permutation_block, MAXIMUM_PERMUTATIONS_PER_MODEL_REGION)
	{
		...
		{ _field_legacy, _field_short_integer, "resourceBspOffset*!" },
		{ _field_legacy, _field_short_integer, "resourceBspCount*!" },

		{ _field_legacy, _field_block, "bsps*", &collision_model_bsp_block_block },
		{ _field_legacy, _field_block, "bsp_physics*", &collision_bsp_physics_block_block },
	...
	{
		{ _field_legacy, _field_string_id, "name^*" },
		{ _field_legacy, _field_block, "permutations*", &collision_model_permutation_block_block },
		{ _field_legacy, _field_terminator }
	};
	...
	V5_TAG_BLOCK(collision_model_pathfinding_sphere_block, MAXIMUM_PATHFINDING_SPHERES_PER_COLLISION_MODEL)
	{
		...
		{ _field_legacy, _field_word_flags, "flags", &pathfinding_sphere_flags },
	...
	{
		{ _field_legacy, _field_string_id, "name^*" },
		{ _field_legacy, _field_pad, "PFPPD", 2 },
	...
	{
		{ _field_legacy, _field_short_integer, "node index*" },
		{ _field_legacy, _field_pad, "KXGCEIEI", 2 },
		{ _field_legacy, _field_useless_pad },
		{ _field_legacy, _field_struct, "bsp*", &global_collision_bsp_struct_struct_definition },
		{ _field_legacy, _field_terminator }
	};

	V5_TAG_STRUCT(collision_model_resource_struct)
	{
		{ _field_legacy, _field_block, "bsps", &collision_model_resource_bsp_block_block },
		{ _field_legacy, _field_terminator }
	};
