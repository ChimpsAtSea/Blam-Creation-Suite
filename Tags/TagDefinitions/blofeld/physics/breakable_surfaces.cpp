...
namespace blofeld
{
		...
		BREAKABLE_SURFACE_STRUCT_DEFINITION_ID)
	{
		...
		{ _field_real_bounds, "AoE damage vitality", "not actually in use yet...", FIELD_FLAG_UNKNOWN0 },
