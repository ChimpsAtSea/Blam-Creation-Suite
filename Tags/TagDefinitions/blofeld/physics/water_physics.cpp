...
namespace blofeld
{
	...
	{
		{ _field_legacy, _field_string_id, "material^" },
		{ _field_legacy, _field_struct, "drag", &water_physics_drag_properties_struct_struct_definition },
		{ _field_legacy, _field_terminator }
	};

	V5_TAG_BLOCK(water_physics_hull_surface_definition_block, s_water_physics_model::k_maximum_hull_surfaces_count)
	{
		{ _field_legacy, _field_word_flags, "flags", &water_physics_hull_surface_definition_flags },
		{ _field_legacy, _field_pad, "pad0", 2 },
		{ _field_legacy, _field_custom },
		{ _field_legacy, _field_string_id, "marker name^" },
		{ _field_legacy, _field_real, "radius" },
		{ _field_legacy, _field_block, "drag", &water_physics_material_override_block },
		{ _field_legacy, _field_terminator }
	};
	...
	{
		{ _field_legacy, _field_custom, "Pressure" },
		{ _field_legacy, _field_struct, "pressure", &physics_force_function_struct_struct_definition },
		{ _field_legacy, _field_custom },
		{ _field_legacy, _field_custom, "Suction" },
		{ _field_legacy, _field_struct, "suction", &physics_force_function_struct_struct_definition },
		{ _field_legacy, _field_custom },
		{ _field_legacy, _field_real, "linear damping" },
		{ _field_legacy, _field_real, "angular damping" },
		{ _field_legacy, _field_terminator }
	};
	...
	{
		{ _field_legacy, _field_custom },
		{ _field_legacy, _field_struct, "velocity to pressure", &mapping_function_struct_definition },
		{ _field_legacy, _field_real, "max velocity:wu/s" },
		{ _field_legacy, _field_terminator }
	};
