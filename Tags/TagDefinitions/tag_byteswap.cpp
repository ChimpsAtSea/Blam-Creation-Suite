...
template<> void byteswap<s_tag_data>(s_tag_data& value)
{
	byteswap(value.size);
...
template<> void byteswap<s_tag_interop>(s_tag_interop& value)
{
...
template<> void byteswap<c_datum_handle>(c_datum_handle& value)
{
	byteswap(*reinterpret_cast<unsigned long*>(&value));
}

template<> void byteswap<s_tag_resource>(s_tag_resource& value)
{
...
template<> void byteswap<c_old_string_id>(c_old_string_id& value)
{
	byteswap(value.value);
}
