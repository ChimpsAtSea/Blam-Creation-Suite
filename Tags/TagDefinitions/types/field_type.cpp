...
{
	XXH64_hash_t hash = xxh64(tag_field_type, strlen(tag_field_type));

	t_tag_field_to_field_type_hashmap::const_iterator it = k_tag_field_to_field_type_hashmap.find(hash);
	if (it == k_tag_field_to_field_type_hashmap.end())
	{
		return BCS_E_NOT_FOUND;
	}
