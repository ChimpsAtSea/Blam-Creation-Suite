...
s_tag_block_definition symbol = s_tag_block_definition(#symbol, pretty_name, __FILE__, __LINE__, [](s_engine_platform_build engine_platform_build) { using namespace blofeld; return static_cast<unsigned long>(max_count); }, #max_count, symbol##_struct_definition ); \
...
s_tag_block_definition symbol = s_tag_block_definition(#symbol, pretty_name, __FILE__, __LINE__, [](s_engine_platform_build engine_platform_build) { using namespace blofeld; return static_cast<unsigned long>(max_count); }, #max_count, struct_definition );
...
s_tag_block_definition tag_block_name = { STRINGIFY(tag_block_name), STRINGIFY(tag_block_name), __FILE__, __LINE__, [](s_engine_platform_build engine_platform_build) { using namespace blofeld; return static_cast<unsigned long>(block_count); }, #block_count, CONCAT(tag_block_name, _struct_definition) }; \
...
s_tag_block_definition block_name = { STRINGIFY(block_name), STRINGIFY(block_name), __FILE__, __LINE__, [](s_engine_platform_build engine_platform_build) { return static_cast<unsigned long>(block_count); }, #block_count, struct_name };
