...
s_tag_block_definition symbol = s_tag_block_definition(#symbol, pretty_name, __FILE__, __LINE__, [](s_engine_platform_build engine_platform_build) { using namespace blofeld; return static_cast<uint32_t>(max_count); }, #max_count, symbol##_struct_definition ); \
...
extern s_tag_field symbol##_struct_definition_fields[]; \
s_tag_struct_definition symbol##_struct_definition = s_tag_struct_definition(#symbol "_struct_definition", #symbol "_struct_definition", struct_name, __FILE__, __LINE__, runtime_flags, memory_attributes, persistent_identifier, symbol##_struct_definition_fields, __VA_ARGS__); \
s_tag_array_definition symbol = { #symbol, pretty_name, __FILE__, __LINE__, [](s_engine_platform_build engine_platform_build) { using namespace blofeld; return static_cast<uint32_t>(count); }, #count, symbol##_struct_definition }; \
s_tag_field symbol##_struct_definition_fields[] =
...
//s_tag_block_definition symbol##_block = s_tag_block_definition(#symbol "_block", #symbol "_block", __FILE__, __LINE__, [](s_engine_platform_build engine_platform_build) { using namespace blofeld; return static_cast<uint32_t>(max_count); }, #max_count, symbol##_struct_definition ); \
...
s_tag_array_definition symbol = { #symbol, pretty_name, __FILE__, __LINE__, [](s_engine_platform_build engine_platform_build) { using namespace blofeld; return static_cast<uint32_t>(count); }, #count, struct_definition };
...
s_tag_array_definition CONCAT(tag_array_name, _array) = { STRINGIFY(tag_array_name)"_array", STRINGIFY(tag_array_name)"_array", __FILE__, __LINE__, [](s_engine_platform_build engine_platform_build) { return static_cast<uint32_t>(array_count); }, #array_count, CONCAT(tag_array_name, _struct_definition) }; \
V5_TAG_STRUCT(tag_array_name)

#define V5_TAG_ARRAY_FROM_STRUCT(tag_array_name, array_count, tag_array_struct) \
s_tag_array_definition CONCAT(tag_array_name, _array) = { STRINGIFY(tag_array_name)"_array", STRINGIFY(tag_array_name)"_array", __FILE__, __LINE__, [](s_engine_platform_build engine_platform_build) { return static_cast<uint32_t>(array_count); }, #array_count, tag_array_struct }
