...
namespace macaque
{
		...
		SOUND_CLASS_BLOCK_STRUCT_ID)
	{
		...
		FIELD_PAD("sadf", nullptr, 3),
		FIELD_EXPLANATION("air propagation", nullptr, ""),
		{ _field_real, "air reverb gain", "how much reverb applies to this sound class", "dB", _field_id_decibels },
		...
		{ _field_real, "override speaker gain", "dB", _field_id_decibels },
		{ _field_struct, "distance parameters", &sound_distance_parameters_struct },
		FIELD_CUSTOM(nullptr, nullptr, _field_id_default),
		{ _field_real_bounds, "gain bounds", "dB", _field_id_decibels },
		FIELD_EXPLANATION("lowpass wetmixes", nullptr, ""),
		FIELD_CUSTOM("equipment lowpass", "sets the lowpass wet mix when an equiment is active", _field_id_slider_editor),
		{ _field_real, "equipment lowpass", "sets the lowpass wet mix when an equiment is active", "wetmix", _field_id_slider_editor },
		FIELD_CUSTOM("environment forced lowpass", "sets the lowpass wet mix when an environment forced lowpass is active", _field_id_slider_editor),
		{ _field_real, "environment forced lowpass", "sets the lowpass wet mix when an environment forced lowpass is active", "wetmix", _field_id_slider_editor },
		FIELD_CUSTOM("effect lowpass", "sets the lowpass wet mix when a lowpass effect is active", _field_id_slider_editor),
		...
		{ _field_real, "cutscene ducking", "dB", _field_id_decibels },
		...
		{ _field_real, "scripted dialog ducking", "dB", _field_id_decibels },
		...
		{ _field_real, "equipment channel ducking", "dB", _field_id_decibels },
		...
		{ _field_real, "between rounds ducking", "dB", _field_id_decibels },
