...
namespace macaque
{
		...
		USER_INTERFACE_GLOBALS_DEFINITION_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION("Shared Globals", nullptr, "This is a reference to the ui shared globals tag"),
		{ _field_tag_reference, "shared globals", &g_user_interface_shared_globals_reference },
		FIELD_EXPLANATION("Multiplayer Variant Settings Interface", nullptr, "This blob defines the ui for setting multiplayer game variant parameters"),
		{ _field_tag_reference, "mp variant settings ui", &g_multiplayer_variant_settings_interface_reference },
		FIELD_EXPLANATION("Game Hopper Localization Strings", nullptr, "This is for the loc game hopper strings"),
		{ _field_tag_reference, "game hopper descriptions", &global_multilingual_unicode_string_list_reference },
		FIELD_EXPLANATION("Screen Widgets", nullptr, "These are the HaloX screen widgets"),
		...
		FIELD_EXPLANATION("PGCR Categories Definitions", nullptr, "This is a reference to the tag storing the categories we want to display in the PGCR"),
		{ _field_tag_reference, "pgcr categories definitions", &pgcr_enemy_to_category_mapping_definition_reference },
		FIELD_EXPLANATION("PGCR Damage Types Definitions", nullptr, "This is a reference to the tag storing details about damage types for display in the PGCR"),
		...
		USER_INTERFACE_SHARED_GLOBALS_DEFINITION_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION("Color presets", nullptr, "Colors are defined here and used in text widgets throughout the UI.  Specify a string_id here and the same one in a text widget.  If you don\'t specify one in a text widget, you\'ll use the first entry here."),
		{ _field_block, "color presets", &color_presets_block },
		FIELD_EXPLANATION("Tint colors", nullptr, "These colors are used for tinting widgets by team or player color."),
		{ _field_block, "tint colors", &tint_colors_block },
		FIELD_EXPLANATION("Emblem counts", nullptr, "This lets us define how many images are in the emblem image bitmaps without opening them."),
		{ _field_short_integer, "Primary emblem count" },
		{ _field_short_integer, "Secondary emblem count" },
		FIELD_EXPLANATION("User interface sounds", nullptr, "Default sound effects for various UI actions"),
		...
		FIELD_EXPLANATION("Player Portrait Model Names", nullptr, "These specify the name of a scenario-placed biped to be used for the Player Portrait Appearance model\nEnter the scenario-placed biped (non-AI) name in the \'spartan biped name\' and \'elite biped name\' field"),
		{ _field_string_id, "spartan portrait biped name" },
		{ _field_string_id, "elite portrait biped name" },
		FIELD_EXPLANATION("UI Navigation speed", nullptr, "This controls tabbing around the UI.  The tab delay is how fast you move around normally. \nTab fast wait is how long the UI waits till using the tab fast delay instead of the tab delay."),
		...
		FIELD_EXPLANATION("Spinner tab speed", nullptr, "This is an alternate control for tabbing speed in the spinner.\nThe input (x) is the time the stick has been held down.\nThe output (y) is the time between tab events."),
		FIELD_CUSTOM(nullptr, nullptr, _field_id_default),
