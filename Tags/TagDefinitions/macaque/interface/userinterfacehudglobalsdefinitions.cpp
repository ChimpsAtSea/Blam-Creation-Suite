...
namespace macaque
{
	...
	{
		FIELD_EXPLANATION("Motion sensor globals", nullptr, "Misc settings for the motion sensor"),
		...
		FIELD_EXPLANATION("Fanfare and Messaging globals", nullptr, "Misc settings for fanfares and messages"),
		...
		FIELD_EXPLANATION("Remote motion sensor globals", nullptr, "Misc settings for the remote motion sensor"),
		...
		FIELD_EXPLANATION("Damage globals", nullptr, "HUD damage settings"),
		...
		FIELD_EXPLANATION("Reticule globals", nullptr, "Settings for the weapon reticules"),
		...
		FIELD_EXPLANATION("Sounds", nullptr, "misc global audio stuff"),
		{ _field_tag_reference, "banned vehicle entrance sound", &global_sound_and_looping_sound_reference },
		FIELD_EXPLANATION("High Contrast globals", nullptr, "Settings controlling the high contrast hud rendering"),
		{ _field_byte_flags, "High Contrast Flags", &high_contrast_flags },
		FIELD_PAD("pad1", nullptr, 3),
		FIELD_EXPLANATION("Dynamic Contrast Settings", nullptr, "Settings controlling the dynamic contrast"),
		...
		FIELD_EXPLANATION("Double Draw Settings", nullptr, "Settings controlling the double draw"),
		...
		FIELD_EXPLANATION("Text", nullptr, "Text-related settings"),
