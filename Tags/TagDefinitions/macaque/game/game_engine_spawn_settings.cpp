...
namespace macaque
{
		...
		SPAWNSETTINGS_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION("ENEMY FORBID", nullptr, "This is a tight cylinder around the player with a strong negative weight. It serves to protect players from spawning close to an enemy, or having and enemy spawn close to them."),
		{ _field_real, "ef full weight radius", nullptr, "wu" },
		{ _field_real, "ef fall-off radius", nullptr, "wu" },
		{ _field_block, "ef falloff function", &spawn_influence_weight_falloff_function_block },
		{ _field_real, "ef upper height", nullptr, "wu" },
		{ _field_real, "ef lower height", nullptr, "wu" },
		{ _field_real, "ef weight" },
		FIELD_EXPLANATION("ENEMY BIAS", nullptr, "This is a larger cylinder, with a size set specifically for the size of the map. It has a weak negative weight which falls to zero towards the outer radius. It serves to bias players away from spawning near enemies, or in enemy held areas."),
		{ _field_real, "eb full weight radius", nullptr, "wu" },
		{ _field_real, "eb fall-off radius", nullptr, "wu" },
		{ _field_block, "eb falloff function", &spawn_influence_weight_falloff_function_block },
		{ _field_real, "eb upper height", nullptr, "wu" },
		{ _field_real, "eb lower height", nullptr, "wu" },
		{ _field_real, "eb weight" },
		FIELD_EXPLANATION("ALLY BIAS", nullptr, "This is a larger cylinder, with a size set specifically for the size of the map. It has a weak positive weight which falls to zero towards the outer radius. It serves to bias players towards spawning with allies, or in areas which are controlled by friendly players."),
		{ _field_real, "ab full weight radius", nullptr, "wu" },
		{ _field_real, "ab fall-off radius", nullptr, "wu" },
		{ _field_block, "ab falloff function", &spawn_influence_weight_falloff_function_block },
		{ _field_real, "ab upper height", nullptr, "wu" },
		{ _field_real, "ab lower height", nullptr, "wu" },
		{ _field_real, "ab weight" },
		FIELD_EXPLANATION("SELECTED ALLY BIAS", nullptr, "Same as ALLY BIAS, but used when the ally is selected in the dead-camera."),
		{ _field_real, "sab full weight radius", nullptr, "wu" },
		{ _field_real, "sab fall-off radius", nullptr, "wu" },
		{ _field_block, "sab falloff function", &spawn_influence_weight_falloff_function_block },
		{ _field_real, "sab upper height", nullptr, "wu" },
		{ _field_real, "sab lower height", nullptr, "wu" },
		{ _field_real, "sab weight" },
		FIELD_EXPLANATION("DEAD TEAMMATE BIAS", nullptr, "Dead teammate influences are cylinders centered upon the body of a dead teammate (or the player’s own dead body)."),
		{ _field_real, "dt full weight radius", nullptr, "wu" },
		{ _field_real, "dt fall-off radius", nullptr, "wu" },
		{ _field_block, "dt falloff function", &spawn_influence_weight_falloff_function_block },
		...
		FIELD_EXPLANATION("DROP POD BIAS", nullptr, "Drop pods influences are cylinders centered on unclaimed ordnance."),
		{ _field_real, "Drop Pod full weight radius", nullptr, "wu" },
		{ _field_real, "Drop Pod fall-off radius", nullptr, "wu" },
		{ _field_block, "Drop Pod falloff function", &spawn_influence_weight_falloff_function_block },
		{ _field_real, "Drop Pod upper height", nullptr, "wu" },
		{ _field_real, "Drop Pod lower height", nullptr, "wu" },
		{ _field_real, "Drop Pod weight" },
		FIELD_EXPLANATION("PLAYER AUTO TURRET BIAS", nullptr, "Auto Turret influences are cylinders centered on players\' auto turrets."),
		{ _field_real, "Auto Turret full weight radius", nullptr, "wu" },
		{ _field_real, "Auto Turret fall-off radius", nullptr, "wu" },
		{ _field_block, "Auto Turret falloff function", &spawn_influence_weight_falloff_function_block },
		...
		FIELD_EXPLANATION("WEAPON INFLUENCERS", nullptr, "These influencers are induced by weapons either weilded or carried in the player\'s backpack"),
		{ _field_block, "weapon influencers", &weaponSpawnInfluenceBlock_block },
		FIELD_EXPLANATION("VEHICLE INFLUENCERS", nullptr, "These influencers are induced by vehicles."),
		{ _field_block, "vehicle influencers", &vehicleSpawnInfluenceBlock_block },
		FIELD_EXPLANATION("PROJECTILE INFLUENCERS", nullptr, "These influencers are induced by projectiles."),
		{ _field_block, "projectile influencers", &projectileSpawnInfluenceBlock_block },
		FIELD_EXPLANATION("EQUIPMENT INFLUENCERS", nullptr, "These influencers are induced by equipment."),
