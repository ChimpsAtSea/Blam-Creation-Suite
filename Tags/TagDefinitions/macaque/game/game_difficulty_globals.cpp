...
namespace macaque
{
	...
	TAG_BLOCK(
		...
		DIFFICULTY_BLOCK_ID)
	{
		FIELD_EXPLANATION("health", nullptr, "scale values for enemy health and damage settings"),
		...
		FIELD_PAD("$", nullptr, 16),
		FIELD_PAD("$$", nullptr, 16),
		FIELD_EXPLANATION("ranged fire", nullptr, "difficulty-affecting values for enemy ranged combat settings"),
		...
		FIELD_PAD("$$$", nullptr, 16),
		FIELD_EXPLANATION("grenades", nullptr, "difficulty-affecting values for enemy grenade behavior"),
		...
		FIELD_PAD("$$$$$", nullptr, 16),
		FIELD_PAD("$$$$$$", nullptr, 16),
		FIELD_EXPLANATION("placement", nullptr, "difficulty-affecting values for enemy placement"),
		...
		FIELD_EXPLANATION("vehicles", nullptr, "difficulty-affecting values for vehicle driving/combat"),
	...
	{
		FIELD_EXPLANATION("vitality", nullptr, "scale values for enemy health and shield settings"),
		...
		FIELD_EXPLANATION("movement", nullptr, "scale values for enemy movement properties"),
		...
		FIELD_EXPLANATION("evasion", nullptr, "scale values for enemy evasion settings"),
		...
		FIELD_EXPLANATION("shooting", nullptr, "scale values for enemy shooting settings"),
		...
		FIELD_EXPLANATION("projectile", nullptr, "scale values for enemy projectile settings"),
