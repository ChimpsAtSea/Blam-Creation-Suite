...
namespace macaque
{
		...
		DIFFICULTY_BLOCK_ID)
	{
		...
		FIELD_PAD("$$", nullptr, 16),
		{ _field_explanation, "ranged fire", "difficulty-affecting values for enemy ranged combat settings" },
		...
		FIELD_PAD("$$$", nullptr, 16),
		{ _field_explanation, "grenades", "difficulty-affecting values for enemy grenade behavior" },
		...
		FIELD_PAD("$$$$$", nullptr, 16),
		FIELD_PAD("$$$$$$", nullptr, 16),
		{ _field_explanation, "placement", "difficulty-affecting values for enemy placement" },
		...
		{ _field_explanation, "vehicles", "difficulty-affecting values for vehicle driving/combat" },
		...
		COOP_DIFFICULTY_BLOCK_STRUCT_ID)
	{
		...
		{ _field_explanation, "movement", "scale values for enemy movement properties" },
		...
		{ _field_explanation, "evasion", "scale values for enemy evasion settings" },
		...
		{ _field_explanation, "shooting", "scale values for enemy shooting settings" },
		...
		{ _field_explanation, "projectile", "scale values for enemy projectile settings" },
