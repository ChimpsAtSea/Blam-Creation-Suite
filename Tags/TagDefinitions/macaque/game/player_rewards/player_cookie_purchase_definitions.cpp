...
namespace macaque
{
		...
		COOKIEPURCHASEAPPEARANCEDEFINITIONBLOCK_ID)
	{
		...
		FIELD_CUSTOM("Prerequisites for visibility", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM("Prerequisites for purchasability", _custom_field_function_group_begin),
	...
	{
		FIELD_CUSTOM("Purchase Families", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Appearance Items", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Loadout Items", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Ordnance Items", _custom_field_function_group_begin),
