...
namespace macaque
{
	...
	{
		{ _field_long_integer, "hkReferencedObject vtable*~!", nullptr, 'nuke' },
		{ _field_short_integer, "size*~!" },
		{ _field_short_integer, "count*~!" },
		{ _field_long_integer, "hkpCollidableCollidableFilter vtable*~!", nullptr, 'nuke' },
		{ _field_long_integer, "hkpShapeCollectionFilter vtable*~!", nullptr, 'nuke' },
		{ _field_long_integer, "hkpRayShapeCollectionFilter vtable*~!", nullptr, 'nuke' },
		{ _field_long_integer, "hkpRayCollidableFilter vtable*~!", nullptr, 'nuke' },
