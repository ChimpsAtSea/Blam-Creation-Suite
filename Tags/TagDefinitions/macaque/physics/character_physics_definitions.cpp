...
namespace macaque
{
		...
		CHARACTER_PHYSICS_STRUCT_ID)
	{
		...
		{ _field_useless_pad },
		{ _field_block, "dead sphere shapes*#don\'t be an asshole, edit something else!", &spheres_block },
		{ _field_block, "pill shapes*#don\'t be an asshole, edit something else!", &pills_block },
		{ _field_block, "sphere shapes*#don\'t be an asshole, edit something else!", &spheres_block },
		{ _field_block, "list sphere shapes*#don\'t be an asshole, edit something else!", &spheres_block },
		{ _field_block, "list shapes*#don\'t be an asshole, edit something else!", &lists_block },
		{ _field_block, "list shape childInfos*#don\'t be an asshole, edit something else!", &list_shapes_block },
