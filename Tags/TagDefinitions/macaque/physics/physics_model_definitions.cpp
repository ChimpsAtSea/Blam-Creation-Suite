...
namespace macaque
{
		...
		4)
	{
		...
		{ _field_long_integer, "Runtime Shape Pointer*~!", nullptr, 'nuke' },
		...
		4)
	{
		...
		{ _field_long_integer, "another field pointer skip!~", nullptr, 'nuke' },
		{ _field_long_integer, "plane equations size*" },
		{ _field_long_integer, "plane equations capacity*!" },
		{ _field_long_integer, "connectivity*!", nullptr, 'nuke' },
		...
		MOPPSERIALIZEDHAVOKDATABLOCK_ID)
	{
		...
		{ _field_long_integer, "Runtime Deserialized Shape Pointer*~!", nullptr, 'nuke' },
