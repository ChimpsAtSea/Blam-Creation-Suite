...
namespace macaque
{
		...
		MIDNIGHT_LIGHT_STRUCT_ID)
	{
		...
		{ _field_struct, "Intensity:[0-1+]", &light_scalar_function_struct },
		...
		{ _field_struct, "Outer Cone End:[0-160 degrees]#Angle size of spotlight.", &light_scalar_function_struct },
		...
		{ _field_struct, "Rotation:[0-360 degrees]", &light_scalar_function_struct },
