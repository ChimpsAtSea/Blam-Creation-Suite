...
namespace macaque
{
		...
		DAMAGE_EFFECT_STRUCT_DEFINITION_ID)
	{
		...
		{ _field_real, "alt instantaneous acceleration", "This field can be used for an alternative acceleration if the corresponding flags are set, e.g. check vehicle->flags.vehicle wants reduced weapon impulse when airborne" },
		...
		{ _field_real_fraction, "soft ping pain screen scale", "The maximum amount to apply the pain screen pose overlay" },
		{ _field_useless_pad, "" },
		...
		{ _field_real, "minimum energy level", "like above, TOL reset minimum equipment energy to this" },
