...
namespace macaque
{
	...
	{
		FIELD_EXPLANATION("parameters", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_PAD("EUJRJIT", nullptr, FIELD_FLAG_NONE, 32),
		{ _field_old_string_id, "marker" },
		FIELD_EXPLANATION("cell birth", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_real_fraction, "cell birth chance", nullptr, nullptr, "[0,1]" },
		FIELD_PAD("HXYEZXXRO", nullptr, FIELD_FLAG_NONE, 32),
		FIELD_EXPLANATION("gene mutation", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_long_integer, "cell gene mutates 1 in", nullptr, "times" },
		{ _field_long_integer, "virus gene mutations 1 in", nullptr, "times" },
		FIELD_PAD("AM", nullptr, FIELD_FLAG_NONE, 32),
		FIELD_EXPLANATION("cell infection", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_PAD("GCKNPCPT", nullptr, FIELD_FLAG_NONE, 2),
		...
		FIELD_PAD("SGUUFL", nullptr, FIELD_FLAG_NONE, 32),
		FIELD_EXPLANATION("initial state", nullptr, FIELD_FLAG_NONE, ""),
		...
		FIELD_PAD("YKYHDOBT", nullptr, FIELD_FLAG_NONE, 32),
		FIELD_EXPLANATION("detail texture", nullptr, FIELD_FLAG_NONE, ""),
		{ _field_real_fraction, "detail texture change chance", nullptr, nullptr, "[0,1]" },
		FIELD_PAD("GPMSPRZN", nullptr, FIELD_FLAG_NONE, 32),
		...
		FIELD_PAD("BXHH", nullptr, FIELD_FLAG_NONE, 2),
		{ _field_tag_reference, "detail texture", &global_bitmap_reference },
		FIELD_EXPLANATION("mask texture", nullptr, FIELD_FLAG_NONE, ""),
		FIELD_PAD("VPK", nullptr, FIELD_FLAG_NONE, 32),
		{ _field_tag_reference, "mask bitmap", &global_bitmap_reference },
		FIELD_PAD("BW", nullptr, FIELD_FLAG_NONE, 240),
		{ _field_terminator }
	};
