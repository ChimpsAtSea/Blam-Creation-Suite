...
namespace macaque
{
	...
	{
		FIELD_EXPLANATION("GAME ENGINE INCLUSION", nullptr, "Set which game engines you desire this object to appear in"),
		{ _field_byte_flags, "game engine flags", &global_game_engine_type_flags },
		FIELD_EXPLANATION("TYPE AND FLAGS", nullptr, "Type pertains to how you want the game engine to handle this object\nCertain flags applicable only to certain object types, should be self evident"),
		...
		FIELD_EXPLANATION("GOAL & RESPAWN ZONE OBJECT BOUNDARY", nullptr, "These fields are only used for goal area objects with boundaries, and for respawn zones"),
		...
		FIELD_EXPLANATION("SPAWNED OBJECT", nullptr, "If this object is intended to spawn something, the object it spawns should be specified here"),
		{ _field_tag_reference, "spawned object", &object_reference },
		{ _field_string_id, "NYI boundary material" },
		FIELD_EXPLANATION("BOUNDARY SHADER - DEFAULT", nullptr, "These are default shaders used for boundary geometry"),
		...
		FIELD_EXPLANATION("BOUNDARY SHADER - SPHERE", nullptr, "These are custom shaders used for spherical boundary geometry"),
		...
		FIELD_EXPLANATION("BOUNDARY SHADER - CYLINDER", nullptr, "These are custom shaders used for cylindrical boundary geometry"),
		...
		FIELD_EXPLANATION("BOUNDARY SHADER - BOX", nullptr, "These are custom shaders used for box boundary geometry"),
