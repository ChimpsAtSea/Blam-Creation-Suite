...
namespace macaque
{
		...
		AI_GLOBALS_DATA_BLOCK_STRUCT_ID)
	{
		...
		FIELD_CUSTOM("Presearch Child Counts (0 means no limit)", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM("Search Pattern Specification", _custom_field_function_group_begin),
