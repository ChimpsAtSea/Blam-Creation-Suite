...
namespace macaque
{
		...
		AI_GLOBALS_DATA_BLOCK_STRUCT_ID)
	{
		...
		FIELD_CUSTOM("Presearch Child Counts (0 means no limit)", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		FIELD_CUSTOM("Search Pattern Specification", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
