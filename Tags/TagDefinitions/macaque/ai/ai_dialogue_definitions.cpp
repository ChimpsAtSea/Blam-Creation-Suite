...
namespace macaque
{
		...
		AI_DIALOGUE_GLOBALS_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION("Spartan nearby search distance", nullptr, "this is used when checking if the player is with other spartan ais."),
		{ _field_real, "spartan nearby search distance", "defaults to 7 wu", "wu" },
		FIELD_EXPLANATION("Face friendly player distance", nullptr, "when talking to friendly players within this distance, if not in combat, we will turn to face them."),
		{ _field_real, "face friendly player distance", "0: disable facing behavior", "wu" },
		FIELD_EXPLANATION("Space dialogue effect", nullptr, "at some point this will be moved into the patterns block..."),
