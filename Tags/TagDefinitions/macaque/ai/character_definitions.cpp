...
namespace macaque
{
		...
		CHARACTER_PERCEPTION_BLOCK_STRUCT_ID)
	{
		...
		FIELD_CUSTOM("Normal active-camo perception", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM("Legendary active-camo perception", _custom_field_function_group_begin),
	...
	{
		FIELD_CUSTOM("Default", _custom_field_function_group_begin),
		{ _field_struct, "Default", &character_hop_struct },
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Passive", _custom_field_function_group_begin),
		{ _field_struct, "Passive", &character_hop_struct },
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Aggressive", _custom_field_function_group_begin),
		...
		CHARACTER_MOVEMENT_BLOCK_ID)
	{
		...
		FIELD_CUSTOM("Throttle and inertia", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM("Phasing", _custom_field_function_group_begin),
		{ _field_real, "phase chance" },
		{ _field_real, "phase delay seconds#don\'t attempt again before given time since last phase" },
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Movement Facing", _custom_field_function_group_begin),
		...
		CHARACTER_COVER_BLOCK_ID)
	{
		...
		FIELD_CUSTOM("Aggresive/Defensive cover properties", _custom_field_function_group_begin),
		...
		CHARACTER_PRESEARCH_BLOCK_ID)
	{
		...
		FIELD_CUSTOM("Child Weights", _custom_field_function_group_begin),
	...
	{
		FIELD_CUSTOM("Smooth Throttle", _custom_field_function_group_begin),
	...
	{
		FIELD_CUSTOM("Smooth Stopping", _custom_field_function_group_begin),
		{ _field_enum, "settings options", &character_smooth_movement_settings_options },
		{ _field_explanation, "Override Settings", "The following setting are applied when the Override option is chosen" },
