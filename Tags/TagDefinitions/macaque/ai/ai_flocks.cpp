...
namespace macaque
{
		...
		FLOCK_STRUCT_DEFINITION_ID)
	{
		...
		{ _field_real, "forward weight", "weight given to boid's desire to fly straight ahead", nullptr, "[0..1]" },
		{ _field_real, "leveling force weight", "weight given to boids desire to fly level", nullptr, "[0..1]" },
		{ _field_real, "destination weight", "weight given to boid's desire to fly towards its sinks", nullptr, "[0..1]" },
		...
		{ _field_real, "target weight", "weight given to boid's desire to attack fly after their target, if they have one", nullptr, "[0..1]" },
		...
		{ _field_real, "random offset weight", "weight given to boid's random heading offset", nullptr, "[0..1]" },
		...
		{ _field_real, "avoidance weight", "weight given to boid's desire to avoid collisions with other boids, when within the avoidance radius", nullptr, "[0..1]" },
		{ _field_real, "avoidance radius", "distance that a boid tries to maintain from another", "world units" },
		{ _field_real, "alignment weight", "weight given to boid's desire to align itself with neighboring boids", nullptr, "[0..1]" },
		{ _field_real, "position weight", "weight given to boid's desire to be near flock center", nullptr, "[0..1]" },
