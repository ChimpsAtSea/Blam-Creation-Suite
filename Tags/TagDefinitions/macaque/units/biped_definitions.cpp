...
namespace macaque
{
		...
		BIPED_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_CUSTOM("$$$ BIPED $$$", _custom_field_function_group_begin),
	...
	{
		FIELD_CUSTOM("wall-leaping", _custom_field_function_group_begin),
	...
	{
		FIELD_CUSTOM("vaulting", _custom_field_function_group_begin),
	...
	{
		FIELD_CUSTOM("grab biped", _custom_field_function_group_begin),
	...
	{
		FIELD_CUSTOM("grab object", _custom_field_function_group_begin),
	...
	{
		FIELD_CUSTOM("ground fitting", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("pivot-on-foot", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Ground fitting pelvis elevation settings", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Ledge Push", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Foot locking", _custom_field_function_group_begin),
	...
	{
		FIELD_CUSTOM("Movement Hip Leaning", _custom_field_function_group_begin),
