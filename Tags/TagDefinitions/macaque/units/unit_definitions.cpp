...
namespace macaque
{
		...
		UNIT_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_CUSTOM("$$$ UNIT $$$", _custom_field_function_group_begin),
		...
		{ _field_tag_reference, "seat acceleration", &spring_acceleration_reference },
		FIELD_CUSTOM("pings", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM("stun", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM("aiming/looking", _custom_field_function_group_begin),
		...
		{ _field_pad, "PAD", 2 },
		FIELD_CUSTOM("melee damage", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM("standard grenade throw", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("sprinting grenade throw", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("primary weapon toss", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM("open/close", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("EMP Disabling", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Boost", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM("Birthing", _custom_field_function_group_begin),
	...
	{
		FIELD_CUSTOM("Unit Camera", _custom_field_function_group_begin),
		...
		UNIT_CAMERA_ACCELERATION_DISPLACEMENT_FUNCTION_STRUCT_ID)
	{
		...
		{ _field_real, "maximum value#for linear velocity; this is wu/s\nfor linear acceleration; this is the fraction of the seat acceleration\nfor angular velocity; this is deg/s", nullptr, 'fn**' },
		{ _field_real, "camera scale (axial)#scale factor used when this acceleration component is along the axis of the forward vector of the camera", nullptr, 'fn**' },
		{ _field_real, "camera scale (perpendicular)#scale factor used when this acceleration component is perpendicular to the camera", nullptr, 'fn**' },
		{ _field_terminator }
	};
