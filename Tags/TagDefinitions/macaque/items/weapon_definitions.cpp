...
namespace macaque
{
		...
		WEAPON_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION(nullptr, nullptr, "All weapons should have \'primary trigger\' and \'secondary trigger\' markers as appropriate.\nBlurred permutations are called \'$primary-blur\' and \'$secondary-blur\'."),
		...
		FIELD_EXPLANATION("weapon aim assist", "DEPRECATED -- this will go away in favor of aim assist modes below", "DEPRECATED -- this will go away in favor of aim assist modes below"),
		...
		FIELD_EXPLANATION("aim swim indexing", nullptr, "swim index 0 used when unzoomed, index 1 is for first zoom level, index 2 is 2nd zoom, etc."),
		...
		FIELD_EXPLANATION("scaleshot", nullptr, "Allows the weapon to scale up and fire different projectiles based upon how many hits you get etc."),
	...
	{
		FIELD_EXPLANATION("melee damage parameters", nullptr, "damage pyramid angles: defines the frustum from the camera that the melee-attack uses to find targets\ndamage pyramid depth: how far the melee attack searches for a target"),
		...
		WEAPON_BARRELS_ID)
	{
		...
		FIELD_EXPLANATION("prediction properties", nullptr, "what the behavior of this barrel is in a predicted network game"),
		...
		FIELD_EXPLANATION("firing error", nullptr, "full error look pitch rate controlls how fast you can turn \nwith full error, yaw is implied from pitch. 0==130.\nfor reference, profile sensitivities are set to:\n1: 40\n3: 60\n9: 130\n"),
	...
	{
		{ _field_real_point_2d, "Point offset", "x-y offset - +x is right, +y is up", FIELD_FLAG_INDEX },
		{ _field_terminator }
	};
	...
	{
		{ _field_real_fraction, "charge fraction", "charging fraction at which the weapon should additionally fire a shot.", FIELD_FLAG_INDEX },
		{ _field_terminator }
	};
		...
		WEAPONSCALESHOTSTRUCT_ID)
	{
		...
		FIELD_EXPLANATION("power levels", nullptr, "IMPORTANT: put these in increasing order, by \"minimum power level\".  I claim no responsibility for weird behavior if they\'re out of order."),
		...
		WEAPON_BARREL_PROJECTILE_ACCURACY_PENALTY_STRUCT_ID)
	{
		...
		FIELD_EXPLANATION("barrel_error penalty functions", nullptr, "barrel_error = barrel_error + penaltyfunction(barrel_error)\nWhere input value \'X\' produces output value \'Y\'\n"),
