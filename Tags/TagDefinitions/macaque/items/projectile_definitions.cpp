...
namespace macaque
{
	...
	{
		FIELD_EXPLANATION("default result", nullptr, "(if the potential result, below, fails to happen)"),
		...
		PROJECTILE_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION("tethering", nullptr, "A detonating tethered projectile attached to an object will use the \'super\' versions of damage ie \'super attached detonation damage\' instead of \'attached detonation damage\'."),
		...
		FIELD_EXPLANATION("physics", nullptr, "damage range low is unused unless \'distance based damage scaling uses damage range low bounds\' flag is true."),
		...
		{ _field_block, "old material responses", FIELD_FLAG_UNKNOWN0, &old_projectile_material_response_block },
