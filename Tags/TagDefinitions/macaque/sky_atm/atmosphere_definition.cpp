...
namespace macaque
{
		...
		ATMOSPHERE_FOG_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_CUSTOM("Sky Fog", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		FIELD_CUSTOM("Ground Fog", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		{ _field_struct, "ground fog", &solo_fog_parameters_struct_definition },
		FIELD_CUSTOM(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_function_group_end),
		FIELD_CUSTOM("Ceiling Fog BEWARE", nullptr, FIELD_FLAG_UNKNOWN0, _field_id_function_group_begin),
		{ _field_struct, "ceiling fog", &solo_fog_parameters_struct_definition },
		FIELD_CUSTOM(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_function_group_end),
		FIELD_CUSTOM("Fog Light", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		FIELD_CUSTOM("Volume Fog", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		{ _field_struct, "volume fog", &VolumeFogParametersDefinition },
		FIELD_CUSTOM(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_function_group_end),
		FIELD_CUSTOM("Light Shafts", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
