...
namespace macaque
{
		...
		PERFORMANE_THROTTLE_BLOCK_ID)
	{
		...
		FIELD_CUSTOM("Object settings", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM("IO settings", _custom_field_function_group_begin),
		{ _field_real, "IO fade modifier#scales down the distances at which IOs imposter" },
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Dynamic light settings", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Shadow settings", _custom_field_function_group_begin),
