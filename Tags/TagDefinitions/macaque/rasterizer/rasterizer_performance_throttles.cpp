...
namespace macaque
{
		...
		PERFORMANE_THROTTLE_BLOCK_ID)
	{
		...
		{ _field_real, "effect lod distance scale" },
		FIELD_CUSTOM("Object settings", nullptr, _field_id_function_group_begin),
		...
		FIELD_CUSTOM("IO settings", nullptr, _field_id_function_group_begin),
		{ _field_real, "IO fade modifier", "scales down the distances at which IOs imposter" },
		FIELD_CUSTOM(nullptr, nullptr, _field_id_function_group_end),
		FIELD_CUSTOM("Dynamic light settings", nullptr, _field_id_function_group_begin),
		{ _field_long_integer, "max forward dynamic lights", "will quickly fade gpu lights when we try to render more than this many:0 = off" },
		{ _field_real, "forward dynamic light fade distance scale", "scales the size used for distance-fade (set smaller to make it fade earlier)" },
		...
		FIELD_CUSTOM(nullptr, nullptr, _field_id_function_group_end),
		FIELD_CUSTOM("Shadow settings", nullptr, _field_id_function_group_begin),
