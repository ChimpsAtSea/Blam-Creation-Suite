...
namespace macaque
{
	...
	extern s_tag_struct_definition global_pixel_shader; // global_pixel_shader_block
	...
	extern s_tag_struct_definition global_vertex_shader; // global_vertex_shader_block
	...
	extern s_tag_struct_definition pixel_shader; // pixel_shader_block
	...
	extern s_tag_struct_definition vertex_shader; // vertex_shader_block
