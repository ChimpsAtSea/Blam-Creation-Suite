...
namespace macaque
{
		...
		RASTERIZER_GLOBALS_STRUCT_DEFINITION_ID)
	{
		...
		{ _field_real, "max blur", "max amount to blur, as a percentage of the screen", nullptr, "[0 - 0.2]" },
		{ _field_real, "blur scale", "scales blur for a given velocity", nullptr, "[0 - 0.5]" },
