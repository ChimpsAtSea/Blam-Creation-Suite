...
namespace macaque
{
		...
		RASTERIZER_GLOBALS_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION("Lighting layer debug mode albedo override", nullptr, "By default the engine uses linear 50% grey\nSet a non-black color to override this debug color\n"),
