...
namespace macaque
{
		...
		SCENARIO_SCENERY_BLOCK_ID)
	{
		...
		{ _field_short_block_index, "type", nullptr, 'type' },
		FIELD_CUSTOM(nullptr, _custom_field_filter),
	...
	{
		{ _field_long_integer, "unique id*", nullptr, 'obj#' },
		{ _field_short_block_index, "origin bsp index*", nullptr, 'obj#' },
	...
	{
		FIELD_CUSTOM(nullptr, _custom_field_object_editor),
		{ _field_long_flags, "placement flags", &object_location_placement_flags },
		{ _field_real_point_3d, "position", nullptr, 'poin' },
		{ _field_real_euler_angles_3d, "rotation", nullptr, 'orie' },
		{ _field_real, "scale", nullptr, 'scal' },
		{ _field_block, "node orientations!*", &scenario_object_node_orientations_block },
	...
	{
		{ _field_string_id, "variant name", nullptr, 'vari' },
	...
	{
		FIELD_CUSTOM(nullptr, _custom_field_pathfinding),
		...
		SCENARIO_CONTROL_STRUCT_ID)
	{
		...
		{ _field_short_integer, "DON\'T TOUCH THIS!*", nullptr, 'ugh@' },
