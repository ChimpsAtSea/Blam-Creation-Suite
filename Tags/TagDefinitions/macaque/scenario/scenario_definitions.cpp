...
namespace macaque
{
		...
		SCENARIO_STRUCTURE_BSP_REFERENCE_BLOCK_STRUCT_ID)
	{
		...
		FIELD_EXPLANATION("Size Class", nullptr, "Tells lightmapper desired res for structure bitmaps.\nNumbers in parens are final sizes after compression"),
		...
		SCENARIO_SKY_REFERENCE_BLOCK_ID)
	{
		...
		{ _field_tag_reference, "cloud texture", &global_bitmap_reference },
		{ _field_short_block_index, "name", &scenario_object_names_block },
		FIELD_PAD("post-name-pad", nullptr, 2),
		{ _field_long_block_flags, "active on bsps", &scenario_structure_bsp_reference_block },
		{ _field_terminator }
	};
		...
		SCENARIO_ZONE_SET_BLOCK_ID)
	{
		...
		{ _field_tag_reference, "cinematic soundbank", &global_soundbank_reference },
		{ _field_real_rgb_color, "sky clear color", "linear color, must check override flag above to use" },
		FIELD_PAD("pad4", nullptr, 4),
		{ _field_terminator }
	};
		...
		SCENARIO_FUNCTION_BLOCK_ID)
	{
		...
		{ _field_short_block_index, "scale function by", &scenario_function_block },
		...
		SCENARIO_SOFT_CEILINGS_BLOCK_ID)
	{
		...
		FIELD_PAD("my name is", nullptr, 2),
		{ _field_terminator }
	};
		...
		SCENARIO_DETAIL_OBJECT_COLLECTION_PALETTE_BLOCK_ID)
	{
		...
		FIELD_PAD("XBMYUIKEJ", nullptr, 32),
		{ _field_terminator }
	};
	...
	{
		{ _field_short_block_index, "type", &scenario_atmosphere_palette_block },
		FIELD_PAD("XQQ", nullptr, 2),
		{ _field_terminator }
	};
	...
	{
		{ _field_short_block_index, "type", &scenario_camera_fx_palette_block },
		FIELD_PAD("XQQ", nullptr, 2),
		{ _field_terminator }
	};
	...
	{
		{ _field_short_block_index, "type", &scenario_weather_palette_block },
		FIELD_PAD("XQQ", nullptr, 2),
		{ _field_terminator }
	};
	...
	{
		{ _field_short_block_index, "palette index", &scenario_cheap_particle_system_palette_block },
		FIELD_PAD("VLKSJLER", nullptr, 2),
		{ _field_real_point_3d, "position" },
		...
		SCENARIO_PERFORMANCES_BLOCK_STRUCT_ID)
	{
		...
		{ _field_real, "thespian radius", "The radius inside which actors have to be in order to start." },
	...
	{
		FIELD_CUSTOM("CASCADE", nullptr, _field_id_function_group_begin),
		...
		SCENARIO_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_CUSTOM("link to scenario lightmap", nullptr, _field_id_unknown_compile),
		...
		{ _field_tag_reference, "Scenario sound bank", &global_soundbank_reference },
		{ _field_tag_reference, "Scenario sound bank Number 2", &global_soundbank_reference },
		...
		{ _field_tag_reference, "game performance throttles", &game_performance_throttle_reference$2 },
		...
		FIELD_EXPLANATION("SPAWN INFLUENCE OVERRIDES", nullptr, "You can use the following to override multiplayer global spawn influencers for the scenario.  Default settings are defined in multiplayer/multiplayer_globals.multiplayer_globals."),
		{ _field_tag_reference, "Spawn Settings", &g_spawnSettingsReference },
		FIELD_EXPLANATION("RENDER FLUFF", nullptr, "Pretty"),
		...
		{ _field_block, "full cues", &ai_full_cue_block },
		...
		{ _field_tag_reference, "global screen effect", &global_area_screen_effect_reference },
		{ _field_tag_reference, "global ssao", &global_ssao_definition_reference },
		{ _field_tag_reference, "atmosphere globals", &global_atmosphere_globals_reference },
		...
		{ _field_block, "thespian", &scenario_performances_block },
		...
		FIELD_EXPLANATION("garbage collection", nullptr, "specify zero for values that should use the data in the globals tag."),
		...
		FIELD_EXPLANATION("Random ordnance", nullptr, "Drops randomly selected set of ordnance at positions marked by drop_point objects."),
		{ _field_word_flags, "ordnance flags", &ordnance_flags },
		FIELD_PAD("SRO", nullptr, 2),
		...
		{ _field_block, "Exit load screen", &loadScreenReferenceBlock_block },
		{ _field_terminator }
	};
		...
		SCENARIOVOLUMETRICLIGHTSHAFTSETTINGSSTRUCT_ID)
	{
		...
		FIELD_PAD("pad the byte flag", nullptr, 3),
	...
	{
		FIELD_EXPLANATION("Lightmap resolution for each buckets", nullptr, "relative to world unit per texel. default:\n1-> 1\n2-> 4\n2-> 16\n3-> 64\n5-> 128\n6-> 256\n7-> 512"),
		...
		{ _field_long_block_flags, "extra lighting bsp flags", &scenario_structure_bsp_reference_block },
		{ _field_terminator }
	};
