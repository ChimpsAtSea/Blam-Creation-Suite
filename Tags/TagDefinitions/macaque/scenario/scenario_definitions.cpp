...
namespace macaque
{
		...
		SCENARIO_ZONE_SET_BLOCK_ID)
	{
		...
		{ _field_long_block_flags, "required designer zones", &scenario_designer_zone_block, _field_id_block_flags_32bit },
		...
		SCENARIO_CLUSTER_DATA_BLOCK_ID)
	{
		...
		{ _field_block, "acoustics", FIELD_FLAG_READ_ONLY, &scenario_cluster_acoustics_block },
		...
		SCENARIO_STRUCT_DEFINITION_ID)
	{
		...
		{ _field_block, "Playtest req palette", &scenario_requisition_palette_block, _field_id_sort },
		...
		{ _field_block, "acoustics palette", &scenario_acoustics_palette_block_definition_block, _field_id_sort },
