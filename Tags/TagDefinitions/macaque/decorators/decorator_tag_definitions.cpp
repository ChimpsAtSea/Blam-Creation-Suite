...
namespace macaque
{
		...
		DECORATOR_SET_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION("LOD FADE + CULL", nullptr, "\n"),
		...
		{ _field_real, "decimation speed", "1 is default", FIELD_FLAG_UNKNOWN0 },
		{ _field_real, "decimation start distance", "[block size by default] decimation offset of the starting point", FIELD_FLAG_UNKNOWN0 },
		{ _field_real, "decimate to", "0 means all the way removed. 100 means nothing", FIELD_FLAG_UNKNOWN0 },
