...
namespace macaque
{
	...
	extern s_tag_struct_definition decorator_set; // decorator_set_block
	...
	extern c_versioned_string_list decorator_set_render_flags_definition_strings;
	extern s_string_list_definition decorator_set_render_flags_definition;
	extern c_versioned_string_list decorator_set_render_shader_enum_definition_strings;
	extern s_string_list_definition decorator_set_render_shader_enum_definition;
	extern c_versioned_string_list decorator_set_lighting_sample_pattern_enum_definition_strings;
