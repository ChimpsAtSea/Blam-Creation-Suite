...
namespace macaque
{
		...
		SIMULATION_INTERPOLATION_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_CUSTOM("High level settings", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		FIELD_CUSTOM("Warp Thresholds", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_function_group_end),
		FIELD_CUSTOM("Position while controlled", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		{ _field_struct, "position_while_controlled", &single_domain_configuration_struct },
		FIELD_CUSTOM(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_function_group_end),
		FIELD_CUSTOM("Rotation while controlled", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		{ _field_struct, "rotation_while_controlled", &single_domain_configuration_struct },
		FIELD_CUSTOM(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_function_group_end),
		FIELD_CUSTOM("Position while not controlled", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		{ _field_struct, "position_while_uncontrolled", &single_domain_configuration_struct },
		FIELD_CUSTOM(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_function_group_end),
		FIELD_CUSTOM("Rotation while not controlled", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		SINGLE_DOMAIN_CONFIGURATION_STRUCT_ID)
	{
		...
		FIELD_CUSTOM("Velocity bumps", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		{ _field_struct, "velocity bumps", &single_domain_velocity_bumps_configuration_struct },
		FIELD_CUSTOM(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_function_group_end),
		FIELD_CUSTOM("Blending", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
