...
namespace macaque
{
		...
		SIMULATION_INTERPOLATION_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_CUSTOM("Warp Thresholds", nullptr, _field_id_function_group_begin),
		FIELD_EXPLANATION("WARP THRESHOLDS", nullptr, "If any of the warp thresholds (position or rotation, global or xy) are exceeded, a warp in all domains (position and rotation) is executed."),
		...
		FIELD_CUSTOM(nullptr, nullptr, _field_id_function_group_end),
		FIELD_CUSTOM("Position while controlled", nullptr, _field_id_function_group_begin),
		{ _field_struct, "position_while_controlled", &single_domain_configuration_struct },
		FIELD_CUSTOM(nullptr, nullptr, _field_id_function_group_end),
		FIELD_CUSTOM("Rotation while controlled", nullptr, _field_id_function_group_begin),
		{ _field_struct, "rotation_while_controlled", &single_domain_configuration_struct },
		FIELD_CUSTOM(nullptr, nullptr, _field_id_function_group_end),
		FIELD_CUSTOM("Position while not controlled", nullptr, _field_id_function_group_begin),
		{ _field_struct, "position_while_uncontrolled", &single_domain_configuration_struct },
		FIELD_CUSTOM(nullptr, nullptr, _field_id_function_group_end),
		FIELD_CUSTOM("Rotation while not controlled", nullptr, _field_id_function_group_begin),
		{ _field_struct, "rotation_while_uncontrolled", &single_domain_configuration_struct },
		FIELD_CUSTOM(nullptr, nullptr, _field_id_function_group_end),
		{ _field_terminator }
	};
		...
		SINGLE_DOMAIN_CONFIGURATION_STRUCT_ID)
	{
		...
		FIELD_CUSTOM("Velocity bumps", nullptr, _field_id_function_group_begin),
		{ _field_struct, "velocity bumps", &single_domain_velocity_bumps_configuration_struct },
		FIELD_CUSTOM(nullptr, nullptr, _field_id_function_group_end),
		FIELD_CUSTOM("Blending", nullptr, _field_id_function_group_begin),
	...
	{
		FIELD_EXPLANATION("SINGLE DOMAIN VELOCITY BUMPS", nullptr, "Velocity bumps are used for small mis-predictions because they are more visually pleasing than straight blending. However, they are less accurate, less consistent, and harder to tune."),
		...
		FIELD_EXPLANATION("Velocity Bump Suppression", nullptr, "We suppress velocity bumps when the object is \"close enough\" to encourage objects to come to rest. Both of the below conditions must be satisfied to suppress velocity bumps."),
	...
	{
		FIELD_EXPLANATION("SINGLE DOMAIN BLENDING CONFIGURATION", nullptr, "Whether these speeds are linear or angular depends on the context - check context before modifying."),
