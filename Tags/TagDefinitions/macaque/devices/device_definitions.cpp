...
namespace macaque
{
		...
		DEVICE_CONTROL_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_CUSTOM("$$$ CONTROL $$$", _custom_field_function_group_begin),
		...
		DEVICE_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_CUSTOM("$$$ DEVICE $$$", _custom_field_function_group_begin),
	...
	{
		{ _field_struct, "device", &device_struct_definition },
		FIELD_CUSTOM("DISPENSER", _custom_field_function_group_begin),
