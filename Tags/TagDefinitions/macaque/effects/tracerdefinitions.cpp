...
namespace macaque
{
		...
		TRACERDEFINITIONBLOCK_ID)
	{
		...
		FIELD_CUSTOM("Tracer Shape", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		FIELD_CUSTOM("Tracer Appearance", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
