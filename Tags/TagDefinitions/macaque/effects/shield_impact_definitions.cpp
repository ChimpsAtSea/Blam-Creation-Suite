...
namespace macaque
{
		...
		SHIELD_IMPACT_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_CUSTOM("Shield Intensity", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM("Shield Edge", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Plasma", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Extrusion Oscillation", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("Hit Response", _custom_field_function_group_begin),
