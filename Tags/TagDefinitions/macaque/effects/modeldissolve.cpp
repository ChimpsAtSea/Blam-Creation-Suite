...
namespace macaque
{
		...
		MODEL_DISSOLVE_DEFINITION_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_CUSTOM("particle velocity factors", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		FIELD_CUSTOM("effects", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
