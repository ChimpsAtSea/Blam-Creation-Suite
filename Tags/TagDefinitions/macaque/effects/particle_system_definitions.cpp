...
namespace macaque
{
		...
		PARTICLE_SYSTEM_EMITTER_DEFINITION_BLOCK_ID)
	{
		...
		FIELD_CUSTOM("EMITTER SETTINGS", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		FIELD_CUSTOM("EMISSION SETTINGS", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_function_group_end),
		FIELD_CUSTOM("PARTICLE MOTION", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		{ _field_struct, "particle initial velocity", nullptr, "world units per second", &particle_property_scalar_struct_new },
		{ _field_struct, "particle rotation", nullptr, ".25=90°, .5=180°, 1=360° ... adds to physics", &particle_property_scalar_struct_new },
		{ _field_struct, "particle initial rotation rate", nullptr, "360 degree rotations per second", &particle_property_scalar_struct_new },
		FIELD_CUSTOM(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_function_group_end),
		FIELD_CUSTOM("PARTICLE APPEARANCE", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
