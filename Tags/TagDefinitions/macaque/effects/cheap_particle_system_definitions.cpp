...
namespace macaque
{
		...
		CHEAP_PARTICLE_TYPE_BLOCK_ID)
	{
		...
		FIELD_CUSTOM(nullptr, nullptr, _field_id_function_group_end),
		FIELD_CUSTOM("render", nullptr, _field_id_function_group_begin),
		{ _field_long_enum, "orientation", &cheap_particle_type_orientation },
		FIELD_EXPLANATION("render parameters", nullptr, "cheap particles do not use alpha-blend transparency, they use multiply-and-add\nas such, an alpha of zero gives you additive particles, and an alpha of one gives you alpha-blend particles"),
		...
		CHEAP_PARTICLE_EMITTER_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_EXPLANATION("TYPES", nullptr, "types of particles to spawn, from the global particle type library"),
		FIELD_CUSTOM("types", nullptr, _field_id_function_group_begin),
		...
		FIELD_EXPLANATION("PARTICLE PARAMETERS", nullptr, "controls randomized rotation and size"),
		...
		FIELD_EXPLANATION("LIGHTING PARAMETERS", nullptr, "controls the effects of lighting on this particle\nNOTE: only monochrome lighting is supported in neuticles"),
