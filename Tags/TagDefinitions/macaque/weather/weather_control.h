...
namespace macaque
{
	...
	extern s_tag_group weather_globals_group; // weather_globals_block


	extern s_tag_block_definition weather_globals_block;
	extern s_tag_block_definition global_textures_refs_block;
	extern s_tag_struct_definition global_textures_refs_block_struct_definition; // global_textures_refs_block

	extern s_tag_struct_definition weather_globals_struct_definition; // tag group
