...
namespace macaque
{
		...
		RAIN_DEFINITION_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_CUSTOM("particles", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		FIELD_CUSTOM("rain sheet", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_function_group_end),
		FIELD_CUSTOM("light volume", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_function_group_end),
		FIELD_CUSTOM("rain transition", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
		{ _field_real, "wetness fade in time", nullptr, "seconds" },
		{ _field_real, "wetness fade out time", nullptr, "seconds" },
		FIELD_CUSTOM(nullptr, nullptr, FIELD_FLAG_NONE, _field_id_function_group_end),
		FIELD_CUSTOM("material dim", nullptr, FIELD_FLAG_NONE, _field_id_function_group_begin),
