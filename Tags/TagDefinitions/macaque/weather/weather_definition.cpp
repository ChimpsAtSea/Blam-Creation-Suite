...
namespace macaque
{
		...
		RAIN_DEFINITION_STRUCT_DEFINITION_ID)
	{
		...
		FIELD_CUSTOM("particles", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM("rain sheet", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("light volume", _custom_field_function_group_begin),
		...
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("rain transition", _custom_field_function_group_begin),
		{ _field_real, "wetness fade in time:seconds" },
		{ _field_real, "wetness fade out time:seconds" },
		FIELD_CUSTOM(nullptr, _custom_field_function_group_end),
		FIELD_CUSTOM("material dim", _custom_field_function_group_begin),
