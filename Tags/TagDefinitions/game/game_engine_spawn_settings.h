...
namespace blofeld
{
	...
	extern s_tag_struct_definition influencerSpawnSettingsBlock_block_struct;
	extern s_tag_block_definition influencerSpawnSettingsBlock_block;
	extern s_tag_struct_definition weaponSpawnInfluenceBlock_block_struct;
	extern s_tag_block_definition weaponSpawnInfluenceBlock_block;
	extern s_tag_struct_definition vehicleSpawnInfluenceBlock_block_struct;
	extern s_tag_block_definition vehicleSpawnInfluenceBlock_block;
	extern s_tag_struct_definition projectileSpawnInfluenceBlock_block_struct;
	extern s_tag_block_definition projectileSpawnInfluenceBlock_block;
	extern s_tag_struct_definition equipmentSpawnInfluenceBlock_block_struct;
