...
c_mantle_bitmap_gui_tab::c_mantle_bitmap_gui_tab(c_cache_file& cache_file, c_mantle_gui_tab* parent_tab, v_tag_interface_legacy<s_bitmap_definition_legacy>& bitmap_tag_interface) :
