...
c_tag_interface* c_groundhog_cache_file::get_tag_interface(uint16_t tag_index) const
{
	return nullptr;
}

c_tag_interface* const* c_groundhog_cache_file::get_tag_interfaces() const
{
	return nullptr;
}

c_tag_interface* const* c_groundhog_cache_file::get_tag_interfaces_sorted_by_name_with_group_id() const
{
	return nullptr;
}

c_tag_interface* const* c_groundhog_cache_file::get_tag_interfaces_sorted_by_path_with_group_id() const
{
	return nullptr;
}

c_tag_group_interface* c_groundhog_cache_file::get_tag_group_interface(uint16_t group_index) const
{
	return nullptr;
}

c_tag_group_interface* c_groundhog_cache_file::get_group_interface_by_group_id(unsigned long tag_group) const
{
	return nullptr;
}

c_tag_group_interface* const* c_groundhog_cache_file::get_tag_group_interfaces() const
{
	return nullptr;
}
...
const char* c_groundhog_cache_file::get_tag_path(uint16_t tag_index) const
{
	return nullptr;
}

unsigned long c_groundhog_cache_file::get_tag_group_by_tag_index(uint32_t tag_index) const
{
...
const s_section_cache& c_groundhog_cache_file::get_section(e_haloreach_cache_file_section_index cache_file_section) const
{
	return *get_section(0);
}

void* c_groundhog_cache_file::get_internal_tag_instance_impl(uint16_t tag_index) const
{
	return nullptr;
}
