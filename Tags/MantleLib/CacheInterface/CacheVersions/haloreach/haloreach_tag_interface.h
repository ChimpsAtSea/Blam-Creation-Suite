...
public:
	...
	inline s_cache_file_tag_instance* get_cache_file_instance() const { return cache_file_tag_instance; };
	inline s_cache_file_tag_group* get_cache_file_group() const { return cache_file_tag_group; };

	virtual const char* get_path_cstr() const final;
