...
c_tag_interface* const* c_halo3_cache_file::get_tag_interfaces() const
{
	return nullptr;
}

c_tag_interface* const* c_halo3_cache_file::get_tag_interfaces_sorted_by_name_with_group_id() const
{
	return nullptr;
}

c_tag_interface* const* c_halo3_cache_file::get_tag_interfaces_sorted_by_path_with_group_id() const
{
	return nullptr;
}
...
c_tag_group_interface* c_halo3_cache_file::get_group_interface_by_group_id(unsigned long tag_group) const
{
	return nullptr;
}
...
unsigned long c_halo3_cache_file::get_tag_group_by_tag_index(uint32_t tag_index) const
{
