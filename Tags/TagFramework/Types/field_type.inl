...
#define FIELD_TO_TAG_FIELD_TYPE(_field, _tag_field_type) { #_field, _tag_field_type }
		...
		FIELD_TO_TAG_FIELD_TYPE(_field_char_block_index_custom_search, "custom char block index"),
		FIELD_TO_TAG_FIELD_TYPE(_field_short_block_index, "short block index"),
		FIELD_TO_TAG_FIELD_TYPE(_field_short_block_index_custom_search, "custom short block index"),
		FIELD_TO_TAG_FIELD_TYPE(_field_long_block_index, "long block index"),
		FIELD_TO_TAG_FIELD_TYPE(_field_long_block_index_custom_search, "custom long block index"),
