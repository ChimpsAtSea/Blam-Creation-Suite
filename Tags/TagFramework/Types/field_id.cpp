...
#define FIELD_ID_TO_STRING(_field) if(field == blofeld::e_field_id::_field) return #_field;
...
#undef FIELD_ID_TO_STRING
	...
	if (const char* tag_field_custom_type_string = tag_field_custom_type_to_string(static_cast<e_tag_field_custom_type>(field)))
	{
		return tag_field_custom_type_string;
	}
	if (const char* tag_field_attributed_definition_string = tag_field_attributed_definition_to_string(static_cast<e_tag_field_attributed_definition>(field)))
	{
		return tag_field_attributed_definition_string;
	}
