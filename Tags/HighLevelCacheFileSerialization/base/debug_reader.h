...
public:
	...
	virtual BCS_RESULT string_id_to_index(string_id string_identifier, uint32_t& string_index) = 0;
	...
	virtual BCS_RESULT string_id_to_string(string_id string_identifier, const char*& string) = 0;
	...
	virtual BCS_RESULT get_tag_filepath(uint32_t tag_index, const char*& filepath) = 0;
