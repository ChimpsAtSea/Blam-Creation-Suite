...
//
//bool c_blofeld_tag_debugger_tab::show_hex_values = settings_read_bool(_settings_section_mandrill, k_show_hex_values_setting, false);
//bool c_blofeld_tag_debugger_tab::show_hex_values_float = settings_read_bool(_settings_section_mandrill, k_show_hex_values_float_setting, false);
//bool c_blofeld_tag_debugger_tab::show_broken_block_data = settings_read_bool(_settings_section_mandrill, k_show_broken_block_data_setting, false);
//bool c_blofeld_tag_debugger_tab::show_field_offsets = settings_read_bool(_settings_section_mandrill, k_show_field_offsets_setting, true);
//bool c_blofeld_tag_debugger_tab::show_custom_fields = settings_read_bool(_settings_section_mandrill, k_show_custom_fields_setting, false);
//bool c_blofeld_tag_debugger_tab::use_absolute_offsets = settings_read_bool(_settings_section_mandrill, k_use_absolute_offsets_setting, false);
//
...
//				settings_write_bool(_settings_section_mandrill, k_show_hex_values_setting, show_hex_values);
//			}
...
//				settings_write_bool(_settings_section_mandrill, k_show_hex_values_float_setting, show_hex_values_float);
//			}
...
//				settings_write_bool(_settings_section_mandrill, k_show_broken_block_data_setting, show_broken_block_data);
//			}
//			if (ImGui::MenuItem(show_field_offsets ? "Hide Field Offsets" : "Show Field Offsets"))
//			{
//				show_field_offsets = !show_field_offsets;
//				settings_write_bool(_settings_section_mandrill, k_show_field_offsets_setting, show_field_offsets);
//			}
//			if (ImGui::MenuItem(show_custom_fields ? "Hide Custom Fields" : "Show Custom Fields"))
//			{
//				show_custom_fields = !show_custom_fields;
//				settings_write_bool(_settings_section_mandrill, k_show_custom_fields_setting, show_custom_fields);
//			}
...
//				settings_write_bool(_settings_section_mandrill, k_use_absolute_offsets_setting, use_absolute_offsets);
//			}
//
//
//			ImGui::EndMenu();
