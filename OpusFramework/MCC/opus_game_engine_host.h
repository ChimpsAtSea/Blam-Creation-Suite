...
public:
	...
	virtual __int64 __fastcall UpdatePlayerConfiguration(wchar_t player_names[4][32], PlayerConfiguration& player_configuration) override;
	...
	virtual bool __fastcall __fastcall UpdatePlayerNames(__int64*, wchar_t player_names[4][32], size_t data_size) override;
