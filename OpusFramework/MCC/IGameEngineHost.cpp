...
void IGameEngineHost::ConfigureGameEngineHost()
{
	...
	if (build == _build_mcc_1_1305_0_0)
	{
		...
		__vtbl_dynamic_data[29] = custom_game_engine_host_vtable[__game_engine_virtual_function_update_player_configuration];
		__vtbl_dynamic_data[30] = custom_game_engine_host_vtable[__game_engine_virtual_function_update_input];
		__vtbl_dynamic_data[31] = custom_game_engine_host_vtable[__game_engine_virtual_function_function32];
		__vtbl_dynamic_data[32] = custom_game_engine_host_vtable[__game_engine_virtual_function_function33];
		__vtbl_dynamic_data[33] = custom_game_engine_host_vtable[__game_engine_virtual_function_xinput_set_state];
		__vtbl_dynamic_data[34] = custom_game_engine_host_vtable[__game_engine_virtual_function_update_player_names];
		__vtbl_dynamic_data[35] = custom_game_engine_host_vtable[__game_engine_virtual_function_function36];
		__vtbl_dynamic_data[36] = custom_game_engine_host_vtable[__game_engine_virtual_function_function37];
		__vtbl_dynamic_data[37] = custom_game_engine_host_vtable[__game_engine_virtual_function_network_send_to];
		__vtbl_dynamic_data[38] = custom_game_engine_host_vtable[__game_engine_virtual_function_network_recieve_from];
		__vtbl_dynamic_data[39] = custom_game_engine_host_vtable[__game_engine_virtual_function_function40];
		__vtbl_dynamic_data[40] = custom_game_engine_host_vtable[__game_engine_virtual_function_function41];
		__vtbl_dynamic_data[41] = custom_game_engine_host_vtable[__game_engine_virtual_function_function42];
		__vtbl_dynamic_data[42] = custom_game_engine_host_vtable[__game_engine_virtual_function_firefight_new];
		__vtbl_dynamic_data[43] = custom_game_engine_host_vtable[__game_engine_virtual_function_function44];
		__vtbl_dynamic_data[44] = custom_game_engine_host_vtable[__game_engine_virtual_function_get_path_by_type];
		__vtbl_dynamic_data[45] = custom_game_engine_host_vtable[__game_engine_virtual_function_get_path_by_type_wide];
		__vtbl_dynamic_data[46] = custom_game_engine_host_vtable[__game_engine_virtual_function_function47];
		__vtbl_dynamic_data[47] = custom_game_engine_host_vtable[__game_engine_virtual_function_function48];
	}
	else
	{
		__vtbl_dynamic_data[0] = custom_game_engine_host_vtable[__game_engine_virtual_function_frame_start];
