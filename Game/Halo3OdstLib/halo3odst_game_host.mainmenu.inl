...
uintptr_t game_context_map_id_parse_to_halo3odst_offset(e_engine_type engine_type, e_build build)
{
	...
	OFFSET(_engine_type_halo3odst, _build_mcc_1_1864_0_0, ~uintptr_t());
	OFFSET(_engine_type_halo3odst, _build_mcc_1_1871_0_0, ~uintptr_t());
	return ~uintptr_t();
}
...
std::vector<uint8_t> halo3odst_external_launch_timeout_patch_bytes(e_engine_type engine_type, e_build build)
{
	...
	OFFSET(_engine_type_halo3odst, _build_mcc_1_1864_0_0, 0xE9, 0xDB, 0x00, 0x00, 0x00, 0x90);
	OFFSET(_engine_type_halo3odst, _build_mcc_1_1871_0_0, 0xE9, 0xDB, 0x00, 0x00, 0x00, 0x90);
	return { };
}
