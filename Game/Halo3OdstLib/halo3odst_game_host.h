...
class c_halo3odst_game_host : public c_aotus_game_engine_host
{
public:
	c_halo3odst_game_host(s_engine_platform_build engine_platform_build);
	virtual ~c_halo3odst_game_host();
	...
	static inline IDataAccess* get_data_access() { return g_halo3odst_game_runtime->get_data_access(); }
...
private:
	static c_game_runtime* g_halo3odst_game_runtime;
};
