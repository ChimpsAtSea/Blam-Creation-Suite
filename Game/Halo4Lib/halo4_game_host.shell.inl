...
uintptr_t halo4_external_launch_state_offset(e_engine_type engine_type, e_build build)
{
	...
	OFFSET(_engine_type_halo4, _build_mcc_1_2028_0_0, 0x180F20A7C);
	OFFSET(_engine_type_halo4, _build_mcc_1_2094_0_0, 0x180F20A7C);
	return ~uintptr_t();
}
...
uintptr_t halo4_main_game_launch_offset(e_engine_type engine_type, e_build build)
{
	...
	OFFSET(_engine_type_halo4, _build_mcc_1_2028_0_0, 0x18003EBB0);
	OFFSET(_engine_type_halo4, _build_mcc_1_2094_0_0, 0x18003EBB0);
	return ~uintptr_t();
}
