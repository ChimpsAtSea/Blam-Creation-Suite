...
uintptr_t halo3_tag_instances_offset(e_engine_type engine_type, e_build build)
{
	...
	OFFSET(_engine_type_halo3, _build_mcc_1_1778_0_0, 0x180B72F30);
	OFFSET(_engine_type_halo3, _build_mcc_1_1792_0_0, 0x180B736B0);
	OFFSET(_engine_type_halo3, _build_mcc_1_1829_0_0, 0x180B882B0);
	OFFSET(_engine_type_halo3, _build_mcc_1_1864_0_0, 0x180B882B0);
	OFFSET(_engine_type_halo3, _build_mcc_1_1871_0_0, 0x180B882B0);
	OFFSET(_engine_type_halo3, _build_mcc_1_1955_0_0, 0x1809B0EB0);
	OFFSET(_engine_type_halo3, _build_mcc_1_2028_0_0, 0x1809C4130);
	OFFSET(_engine_type_halo3, _build_mcc_1_2094_0_0, 0x1809ED530);
	return ~uintptr_t();
}
...
uintptr_t k_halo3_virtual_to_physical_base_offset(e_engine_type engine_type, e_build build)
{
	...
	OFFSET(_engine_type_halo3, _build_mcc_1_1778_0_0, 0x18B8E05F8);
	OFFSET(_engine_type_halo3, _build_mcc_1_1792_0_0, 0x18B8E0D78);
	OFFSET(_engine_type_halo3, _build_mcc_1_1829_0_0, 0x18B8F5978);
	OFFSET(_engine_type_halo3, _build_mcc_1_1864_0_0, 0x18B8F5978);
	OFFSET(_engine_type_halo3, _build_mcc_1_1871_0_0, 0x18B8F5978);
	OFFSET(_engine_type_halo3, _build_mcc_1_1955_0_0, 0x181A6D618);
	OFFSET(_engine_type_halo3, _build_mcc_1_2028_0_0, 0x181A80AD8);
	OFFSET(_engine_type_halo3, _build_mcc_1_2094_0_0, 0x181AA9ED8);
	return ~uintptr_t();
}
...
uintptr_t k_halo3_physical_base_offset(e_engine_type engine_type, e_build build)
{
	...
	OFFSET(_engine_type_halo3, _build_mcc_1_1778_0_0, 0x18092E7B0);
	OFFSET(_engine_type_halo3, _build_mcc_1_1792_0_0, 0x18092E7D0);
	OFFSET(_engine_type_halo3, _build_mcc_1_1829_0_0, 0x18093A790);
	OFFSET(_engine_type_halo3, _build_mcc_1_1864_0_0, 0x18093A790);
	OFFSET(_engine_type_halo3, _build_mcc_1_1871_0_0, 0x18093A790);
	OFFSET(_engine_type_halo3, _build_mcc_1_1955_0_0, 0x18077A750);
	OFFSET(_engine_type_halo3, _build_mcc_1_2028_0_0, 0x18077F980);
	OFFSET(_engine_type_halo3, _build_mcc_1_2094_0_0, 0x180794980);
	return ~uintptr_t();
}
...
uintptr_t halo3_cache_file_header_offset(e_engine_type engine_type, e_build build)
{
	...
	OFFSET(_engine_type_halo3, _build_mcc_1_1778_0_0, 0x18BB1B2A8);
	OFFSET(_engine_type_halo3, _build_mcc_1_1792_0_0, 0x18BB1BA28);
	OFFSET(_engine_type_halo3, _build_mcc_1_1829_0_0, 0x18BB30628);
	OFFSET(_engine_type_halo3, _build_mcc_1_1864_0_0, 0x18BB30628);
	OFFSET(_engine_type_halo3, _build_mcc_1_1871_0_0, 0x18BB30628);
	OFFSET(_engine_type_halo3, _build_mcc_1_1955_0_0, 0x181CD7988);
	OFFSET(_engine_type_halo3, _build_mcc_1_2028_0_0, 0x181CEC438);
	OFFSET(_engine_type_halo3, _build_mcc_1_2094_0_0, 0x181D15838);
	return ~uintptr_t();
}
...
uintptr_t halo3_cache_file_tags_header_offset(e_engine_type engine_type, e_build build)
{
	...
	OFFSET(_engine_type_halo3, _build_mcc_1_1778_0_0, 0x18BB1E2A8);
	OFFSET(_engine_type_halo3, _build_mcc_1_1792_0_0, 0x18BB1EA28);
	OFFSET(_engine_type_halo3, _build_mcc_1_1829_0_0, 0x18BB33628);
	OFFSET(_engine_type_halo3, _build_mcc_1_1864_0_0, 0x18BB33628);
	OFFSET(_engine_type_halo3, _build_mcc_1_1871_0_0, 0x18BB33628);
	OFFSET(_engine_type_halo3, _build_mcc_1_1955_0_0, 0x181CDA988);
	OFFSET(_engine_type_halo3, _build_mcc_1_2028_0_0, 0x181CEF438);
...
uintptr_t halo3_file_table_mapping_offset(e_engine_type engine_type, e_build build)
{
	...
	OFFSET(_engine_type_halo3, _build_mcc_1_1778_0_0, 0x180B72F38);
	OFFSET(_engine_type_halo3, _build_mcc_1_1792_0_0, 0x180B736B8);
	OFFSET(_engine_type_halo3, _build_mcc_1_1829_0_0, 0x180B882B8);
	OFFSET(_engine_type_halo3, _build_mcc_1_1864_0_0, 0x180B882B8);
	OFFSET(_engine_type_halo3, _build_mcc_1_1871_0_0, 0x180B882B8);
	OFFSET(_engine_type_halo3, _build_mcc_1_1955_0_0, 0x1809B0EB8);
	OFFSET(_engine_type_halo3, _build_mcc_1_2028_0_0, 0x1809C4138);
	OFFSET(_engine_type_halo3, _build_mcc_1_2094_0_0, 0x1809ED538);
	return ~uintptr_t();
}
...
const char* halo3_tag_name_get(unsigned long tag_index)
{
	...
	if (!is_valid(halo3_file_table_mapping) || !halo3_file_table_mapping || (tag_index < 0 && tag_index > file_count))
	{
		return nullptr;
	}

	const char* file_path = (const char*)halo3_file_table_mapping + *((long*)halo3_file_table_mapping + tag_index) + 0x14000;
	return file_path;
}
...
char* halo3_tag_address_get(uint32_t tag_instance_address)
{
	...
	char* data = tag_instance_address == -1 ? nullptr : reinterpret_cast<char*>(k_halo3_virtual_to_physical_base + ((unsigned long long)tag_instance_address * 4));
	return data;
}
