...
// #TODO: cache refactor
//uintptr_t groundhog_tag_instances_offset(s_engine_platform_build engine_platform_build)
//{
...
//	OFFSET(_engine_type_groundhog, _build_mcc_1_2094_0_0, 0x1811FCDF8);
//	return ~uintptr_t();
//}
...
uintptr_t groundhog_tag_address_table_offset(s_engine_platform_build engine_platform_build)
{
	...
	OFFSET(_engine_type_groundhog, _build_mcc_1_2094_0_0, 0x1832D7E00);
	return ~uintptr_t();
}
...
uintptr_t groundhog_cache_file_global_loaded_state_offset(s_engine_platform_build engine_platform_build)
{
	...
	OFFSET(_engine_type_groundhog, _build_mcc_1_2094_0_0, 0x18117BD00);
	return ~uintptr_t();
}
