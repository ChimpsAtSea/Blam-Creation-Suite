...
class c_halo2_game_host : public c_opus_game_engine_host
{
public:
	...
	static inline IDataAccess* get_data_access() { return g_halo2_game_runtime->get_data_access(); }
...
private:
	static c_game_runtime* g_halo2_game_runtime;
};
