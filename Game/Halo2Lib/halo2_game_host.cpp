...
{
	c_console::write_line_verbose("Init Halo2GameHost");
...
{
	c_console::write_line_verbose("Deinit Halo2GameHost");
...
void c_halo2_game_host::FrameEnd(IDXGISwapChain* swap_chain, _QWORD unknown1)
{
