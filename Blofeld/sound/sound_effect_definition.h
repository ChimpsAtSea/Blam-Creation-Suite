...
namespace blofeld
{
	...
	extern s_tag_struct_definition sound_effect_template_parameter_block_block_struct;
	extern s_tag_block_definition sound_effect_template_parameter_block_block;
	extern s_tag_struct_definition sound_effect_templates_block_block_struct;
	extern s_tag_block_definition sound_effect_templates_block_block;
	extern s_tag_struct_definition sound_effect_template_additional_sound_input_block_block_struct;
