...
namespace blofeld
{
	...
	TAG_ENUM(sound_effect_template_type_enum_definition, 3)
	{
		OPTION("integer"),
		OPTION("real"),
		OPTION("filter type"),
	...
	TAG_ENUM(sound_effect_template_parameter_flags_definition, 1)
	{
		OPTION("expose as function"),
	};

	TAG_ENUM(sound_effect_template_flags_definition, 2)
	{
		OPTION("use high level parameters"),
	...
	TAG_BLOCK(sound_effect_templates_block, k_maximum_number_of_sound_effect_templates)
	{
		...
		FIELD( _field_long_flags, "flags", &sound_effect_template_flags_definition ),
	...
	TAG_BLOCK(sound_effect_template_parameter_block, k_maximum_number_of_sound_effect_parameters)
	{
		...
		FIELD( _field_enum, "type", &sound_effect_template_type_enum_definition ),
		FIELD( _field_word_flags, "flags", &sound_effect_template_parameter_flags_definition ),
