...
TAG_STRUCT(soundLipSyncInfoBlock_struct)
{
	...
	FIELD( _field_block, "deterministic event info", &deterministicSpeechEventBlock ),
...
{
	FIELD( _field_block, "promotion rules", &sound_promotion_rule_block ),
	FIELD( _field_block, "runtime timers!", &sound_promotion_runtime_timer_block ),
...
TAG_BLOCK(sound_globals_block, 1)
{
	...
	FIELD( _field_block, "Streaming pack files", &StreamingPackBlock ),
...
TAG_GROUP(soundbank_block, SOUNDBANK_TAG)
{
	FIELD( _field_long_flags, "flags" ),
	FIELD( _field_long_flags, "import flags!" ),
	FIELD( _field_long_flags, "xsync flags!" ),
	FIELD( _field_block, "Sound bank list#List of names of soundbanks. If more than one, one will be randomly chosen at load", &SoundBankBlock ),
...
TAG_GROUP(sound_global_propagation_block, SOUND_GLOBAL_PROPAGATION_TAG)
{
...
TAG_GROUP(sound_block, SOUND_TAG)
{
	FIELD( _field_long_flags, "flags" ),
	FIELD( _field_long_flags, "import flags!" ),
	FIELD( _field_long_flags, "xsync flags!" ),
	...
	FIELD( _field_block, "lipsync info", &soundLipSyncInfoBlock ),
	FIELD( _field_long_integer, "deterministic flag index" ),
	FIELD( _field_terminator )
};

TAG_GROUP(sound_old_block, SOUND_OLD_TAG)
{
	FIELD( _field_long_flags, "flags" ),
	FIELD( _field_long_flags, "import flags!" ),
	FIELD( _field_long_flags, "xsync flags!" ),
...
TAG_GROUP(sound2_block, SOUND2_TAG)
{
	FIELD( _field_long_flags, "flags" ),
	FIELD( _field_long_flags, "import flags!" ),
	FIELD( _field_long_flags, "xsync flags!" ),
...
TAG_GROUP(sound_mix_block, SOUND_MIX_TAG)
{
...
TAG_GROUP(sound_dialogue_constants_block, SOUND_DIALOGUE_CONSTANTS_TAG)
{
	FIELD( _field_explanation, "named playing fractions" ),
	FIELD( _field_real, "almost never" ),
	FIELD( _field_real, "rarely" ),
