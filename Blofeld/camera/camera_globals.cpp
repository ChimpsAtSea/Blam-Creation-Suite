...
TAG_BLOCK(camera, 1)
{
	{ _field_tag_reference, "default unit camera track" },
	{ _field_explanation, "SANDBOX" },
	{ _field_struct, "pitch to vertical offset" },
	...
	{ _field_enum, "vertical movement function" },
	{ _field_pad, "moist", 2 },
