...
TAG_GROUP_INHERIT(unit, UNIT_TAG, object, OBJECT_TAG)
{
	...
	FIELD( _field_struct, "sync action camera" ),
	...
	FIELD( _field_struct, "more damn nodes" ),
	...
	FIELD( _field_struct, "boost" ),
	FIELD( _field_custom ),
	FIELD( _field_explanation, "Lipsync" ),
	FIELD( _field_struct, "lipsync" ),
