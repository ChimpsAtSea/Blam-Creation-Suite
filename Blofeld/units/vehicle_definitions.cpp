...
namespace blofeld
{
	...
	TAG_BLOCK(alien_scout_block, 1)
	{
		...
		FIELD( _field_char_enum, "specific type", &alien_scout_specific_type_enum ),
		FIELD( _field_byte_flags, "flags", &alien_scout_flags ),
	...
	{
		FIELD( _field_word_flags, "flags", &turret_flags ),
	...
	TAG_BLOCK(space_fighter_block, 1)
	{
		...
		FIELD( _field_long_flags, "roll flags", &space_fighter_roll_flags ),
		...
		FIELD( _field_long_flags, "turn back flags", &space_fighter_turn_back_flags ),
	...
	TAG_BLOCK(physics_transitions_block, k_max_vehicle_physics_transitions)
	{
		...
		FIELD( _field_char_enum, "transition target vehicle type#upon reaching transition velocity, act like this vehicle type", &vehicle_type_enum ),
	...
	TAG_STRUCT(vehicle_group)
	{
		...
		FIELD( _field_char_enum, "player training vehicle type", &player_training_vehicle_type_enum ),
		FIELD( _field_char_enum, "vehicle size#The size determine what kind of seats in larger vehicles it may occupy (i.e. small or large cargo seats)", &vehicle_size_enum ),
	...
	TAG_STRUCT(human_tank_struct)
	{
		...
		FIELD( _field_byte_flags, "control flags", &tank_flags ),
	...
	TAG_STRUCT(flight_surface_struct)
	{
		...
		FIELD( _field_char_enum, "normal axis", &dimensions_enum ),
