...
TAG_STRUCT(biped_group)
{
	...
	FIELD( _field_block, "Sound RTPCs", &BipedSoundRTPCBlock ),
	FIELD( _field_block, "Sound Sweeteners", &BipedSoundSweetenerBlock ),
	FIELD( _field_block, "Aiming Fixup", &BipedAimingJointFixupBlock ),
...
TAG_STRUCT(biped_grab_object_data_struct)
{
	...
	FIELD( _field_block, "grab object animation sets", &biped_grab_object_animation_set_block ),
	FIELD( _field_custom ),
	FIELD( _field_terminator )
};
...
TAG_GROUP_INHERIT(biped_block, BIPED_TAG, unit, UNIT_TAG)
{
	FIELD( _field_struct, "unit", &unit_struct_definition_struct_definition ),
	FIELD( _field_custom, "$$$ BIPED $$$" ),
	FIELD( _field_angle, "moving turning speed:degrees per second" ),
