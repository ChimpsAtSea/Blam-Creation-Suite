...
namespace blofeld
{
	...
	TAG_STRUCT(camera_fx_exposure_struct)
	{
		...
		FIELD( _field_word_flags, "flags", &camera_fx_parameter_flags_auto_adjust ),
	...
	TAG_STRUCT(camera_fx_exposure_sensitivity_struct)
	{
		...
		FIELD( _field_word_flags, "flags", &camera_fx_parameter_flags_no_auto_adjust ),
	...
	{
		FIELD( _field_word_flags, "flags!", &camera_fx_parameter_flags_bling_spikes ),
	...
	TAG_STRUCT(camera_fx_filmic_tone_curve_struct)
	{
		...
		FIELD( _field_word_flags, "flags", &camera_fx_parameter_flags_enabled ),
		FIELD( _field_pad, "MKRGRF", 2 ),
	...
	TAG_ENUM(camera_fx_parameter_flags_auto_adjust, 7)
	{
		OPTION("use default (ignore these values)"),
		OPTION("maximum change is relative"),
		OPTION("auto-adjust target"),
		OPTION("bit3!"),
		OPTION("fixed!"),
		OPTION("(unused2)!"),
		OPTION("fixed2!"),
	...
	TAG_ENUM(camera_fx_parameter_flags_no_auto_adjust, 7)
	{
		OPTION("use default (ignore these values)"),
		OPTION("maximum change is relative"),
		OPTION("(unused)!"),
	...
	TAG_ENUM(camera_fx_parameter_flags_enabled, 7)
	{
		OPTION("use default (ignore these values)"),
		OPTION("maximum change is relative"),
		OPTION("(unused)!"),
	...
	TAG_ENUM(camera_fx_parameter_flags_bling_spikes, 7)
	{
		OPTION("use default (ignore these values)"),
		OPTION("maximum change is relative"),
		OPTION("(unused)!"),
		OPTION("double sided bling"),
		OPTION("fixed!"),
		OPTION("(unused2)!"),
		OPTION("fixed2!"),
	};
