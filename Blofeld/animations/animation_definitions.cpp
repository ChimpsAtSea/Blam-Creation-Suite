...
TAG_STRUCT(animation_graph_definitions_struct)
{
	...
	FIELD( _field_block, "node usage*|ABCDCC", &animation_usage_block ),
	FIELD( _field_block, "node masks|ABCDCC", &animation_node_mask_block ),
	FIELD( _field_block, "functions|ABCDCC", &animation_function_block ),
	FIELD( _field_block, "model animation variants|ABCDCC", &model_animation_variant_block ),
	FIELD( _field_block, "skeleton nodes*|ABCDCC", &animation_graph_node_block ),
	FIELD( _field_block, "sound references|ABCDCC!*#Legacy field - please edit in new frame event tag below", &animation_graph_sound_reference_block ),
	FIELD( _field_block, "effect references|ABCDCC!*#Legacy field - please edit in new frame event tag below", &animation_graph_effect_reference_block ),
	FIELD( _field_block, "blend screens|ABCDCC!*#Legacy field - please edit in NEW blend screens tag below", &animation_blend_screen_block ),
	FIELD( _field_block, "foot markers|ABCDCC", &foot_tracking_member_block ),
	FIELD( _field_block, "animations*|ABCDCC", &animation_pool_block ),
	FIELD( _field_block, "NEW blend screens|CCBBAA", &new_animation_blend_screen_block ),
	FIELD( _field_block, "NEW function overlays|CCAABB", &new_animation_function_overlay_block ),
	FIELD( _field_block, "overlay groups{pose overlays|NEW overlays}|CCBBAA", &overlay_group_definition_block ),
	FIELD( _field_block, "gaits|ABCDCC", &animation_gait_block ),
	FIELD( _field_block, "gait groups|ABCDCC", &animation_gait_group_block ),
	FIELD( _field_block, "ik data|CCBBAA", &animation_ik_block ),
	FIELD( _field_block, "ik sets|CCBBAA", &animation_ik_set ),
	FIELD( _field_block, "ik chains|CCBBAA", &animation_ik_chain_block ),
	FIELD( _field_block, "composites", &g_compositeTag ),
...
TAG_STRUCT(animation_graph_contents_struct)
{
	...
	FIELD( _field_block, "modes|AABBCC", &animation_mode_block ),
	FIELD( _field_explanation, "SPECIAL CASE ANIMS" ),
	FIELD( _field_block, "vehicle suspension|CCAABB", &vehicle_suspension_block ),
	FIELD( _field_block, "function overlays{object overlays}|CCAABB", &function_overlay_animation_block ),
	FIELD( _field_terminator )
};
...
TAG_STRUCT(model_animation_runtime_data_struct)
{
	...
	FIELD( _field_block, "inheritence list*|BBAAAA", &inherited_animation_block ),
	FIELD( _field_block, "new inheritance list*|BBAAAA", &inherited_animation_block ),
	FIELD( _field_block, "weapon list|BBAAAA", &weapon_class_lookup_block ),
...
TAG_BLOCK(import_animation_event_block, 2*k_max_animations_per_graph)
{
	...
	FIELD( _field_block, "sound events", &animation_sound_event_block_extended ),
	FIELD( _field_block, "effect events", &animation_effects_event_block_extended ),
	FIELD( _field_block, "dialogue events", &animation_dialogue_event_block_extended ),
	FIELD( _field_block, "script events", &animation_script_event_block_extended ),
	FIELD( _field_terminator )
};
...
{
	FIELD( _field_string_id, "name^" ),
	FIELD( _field_block, "nodes", &animation_node_mask_entry_block ),
...
TAG_BLOCK(model_animation_variant_block, k_animation_maximum_model_variants)
{
	...
	FIELD( _field_block, "mode or stance aliases", &mode_or_stance_alias_block ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(animation_pool_block, k_max_animations_per_graph)
{
	...
	FIELD( _field_block, "shared animation data", &shared_model_animation_block ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(shared_model_animation_block, 1)
{
	...
	FIELD( _field_block, "frame events|ABCDCC!*#Legacy field - please edit in new frame event tag below", &animation_frame_event_block ),
	FIELD( _field_block, "sound events|ABCDCC!*#Legacy field - please edit in new frame event tag below", &animation_sound_event_block ),
	FIELD( _field_block, "effect events|ABCDCC!*#Legacy field - please edit in new frame event tag below", &animation_effect_event_block ),
	FIELD( _field_block, "dialogue events|ABCDCC!*#Legacy field - please edit in new frame event tag below", &animation_dialogue_event_block ),
	FIELD( _field_block, "script events|ABCDCC!*#Legacy field - please edit in new frame event tag below", &animation_script_event_block ),
	FIELD( _field_explanation, "b!" ),
	FIELD( _field_block, "object-space parent nodes|ABCDCC", &object_space_node_data_block ),
	FIELD( _field_block, "foot tracking|ABCDCC", &foot_tracking_block ),
	FIELD( _field_block, "object space offset nodes|ABCDCC", &object_space_offset_node_block ),
	FIELD( _field_block, "forward-invert kinetic anchor nodes|ABCDCC", &fik_anchor_node_block ),
	FIELD( _field_block, "ik chain events*!", &animation_ik_chain_events ),
	FIELD( _field_block, "ik chain proxies*!", &animation_ik_chain_proxies ),
	FIELD( _field_block, "facial wrinkle events*!", &animation_facial_wrinkle_events ),
	FIELD( _field_block, "extended data events*!", &animation_extended_events ),
	FIELD( _field_block, "animation object functions", &animation_object_functions ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(foot_tracking_block, k_max_tracked_feet)
{
	...
	FIELD( _field_block, "cycles|ABCDCC", &foot_lock_cycle_block ),
	FIELD( _field_terminator )
};
...
{
	FIELD( _field_string_id, "name^" ),
	FIELD( _field_block, "blend screens{blend screen}|CCBBAA", &blend_screen_item_definition_block ),
	FIELD( _field_block, "function overlays|CCBBAA", &function_overlay_item_definition_block ),
	FIELD( _field_terminator )
};
...
{
	FIELD( _field_string_id, "name^" ),
	FIELD( _field_block, "animation gaits", &animation_gait_item_block ),
	FIELD( _field_terminator )
};
...
{
	FIELD( _field_string_id, "name^" ),
	FIELD( _field_block, "ik points|CCBBAA", &animation_ik_set_item ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(animation_mode_block, k_max_modes_per_graph)
{
	...
	FIELD( _field_long_flags, "flags*" ),
	FIELD( _field_block, "weapon class|AABBCC", &weapon_class_block ),
	FIELD( _field_block, "mode ik|AABBCC", &animation_ik_block_v1 ),
	FIELD( _field_block, "foot defaults|AABBCC", &foot_tracking_defaults ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(weapon_class_block, k_max_weapon_classes)
{
	...
	FIELD( _field_short_block_index, "overlay group{pose overlay|overlay}" ),
	FIELD( _field_short_block_index, "ik set" ),
	FIELD( _field_block, "weapon type|AABBCC", &weapon_type_block ),
	FIELD( _field_block, "weapon ik|AABBCC", &animation_ik_block_v1 ),
	FIELD( _field_block, "ranged actions", &animation_ranged_action_block ),
	FIELD( _field_block, "sync actions groups", &animation_sync_action_group_block ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(weapon_type_block, k_max_weapon_types)
{
	...
	FIELD( _field_short_block_index, "overlay group{pose overlay|overlay}" ),
	FIELD( _field_short_block_index, "ik set" ),
	FIELD( _field_block, "sets|AABBCC", &animation_set_block ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(animation_set_block, k_max_animation_sets)
{
	...
	FIELD( _field_block, "actions|AABBCC", &animation_entry_block ),
	FIELD( _field_block, "overlay animations{overlays}|AABBCC", &animation_entry_block ),
	FIELD( _field_block, "death and damage|AABBCC", &damage_animation_block ),
	FIELD( _field_block, "transitions|AABBCC", &animation_transition_source_block ),
	FIELD( _field_block, "velocity boundaries!", &animation_velocity_boundaries_block ),
	FIELD( _field_terminator )
};
...
{
	FIELD( _field_string_id, "label^" ),
	FIELD( _field_block, "directions*|AABBCC", &damage_direction_block ),
	FIELD( _field_terminator )
};

TAG_BLOCK(damage_direction_block, k_total_damage_directions)
{
	FIELD( _field_block, "regions*|AABBCC", &damage_region_block ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(animation_transition_source_block, k_max_animations_per_block)
{
	...
	FIELD( _field_block, "destinations", &animation_transition_destination_block ),
	FIELD( _field_terminator )
};
...
{
	FIELD( _field_string_id, "label^" ),
	FIELD( _field_block, "animations", &ranged_animation_entry_block ),
	FIELD( _field_block, "triangulation data!", &triangulation_entry_block ),
...
{
	FIELD( _field_block, "points", &triangulation_point_block ),
	FIELD( _field_block, "triangles", &triangulation_triangle_block ),
	FIELD( _field_terminator )
};
...
{
	FIELD( _field_string_id, "name^" ),
	FIELD( _field_block, "sync actions", &animation_sync_action_block ),
	FIELD( _field_terminator )
};
...
{
	FIELD( _field_string_id, "name^" ),
	FIELD( _field_block, "same type participants", &animation_sync_action_same_type_participant ),
	FIELD( _field_block, "other participants", &animation_sync_action_other_type_participant ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(inherited_animation_block, k_max_animation_inheritence_levels)
{
	...
	FIELD( _field_block, "node map*", &inherited_animation_node_map_block ),
	FIELD( _field_block, "node map flags*", &inherited_animation_node_map_flag_block ),
...
TAG_GROUP(frame_event_list_block, FRAME_EVENT_LIST_TAG)
{
	FIELD( _field_explanation, "IMPORTANT TAG NOTES" ),
	FIELD( _field_block, "sound references|ABCDCC", &animation_graph_sound_reference_block ),
	FIELD( _field_block, "effect references|ABCDCC", &animation_graph_effect_reference_block ),
...
TAG_GROUP(model_animation_graph_block, MODEL_ANIMATION_GRAPH_TAG)
{
	...
	FIELD( _field_block, "tag resource groups", &model_animation_tag_resource_group ),
