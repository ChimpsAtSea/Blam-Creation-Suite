...
TAG_STRUCT(rasterizer_globals_struct_definition)
{
	...
	FIELD( _field_block, "default bitmaps", &default_textures_refs_block ),
	FIELD( _field_explanation, "material textures:" ),
	FIELD( _field_block, "material textures", &material_textures_refs_block ),
	FIELD( _field_explanation, "explicit shaders:" ),
	FIELD( _field_block, "explicit shaders", &explicit_shader_refs_block ),
...
{
	FIELD( _field_long_flags, "options" ),
...
TAG_GROUP(rasterizer_globals_block, RASTERIZER_GLOBALS_TAG)
{
	FIELD( _field_explanation, "default bitmaps:" ),
	FIELD( _field_block, "default bitmaps", &default_textures_refs_block ),
	FIELD( _field_explanation, "material textures:" ),
