...
TAG_BLOCK(material_postprocess, 1)
{
	...
	FIELD( _field_block, "texture constants", &real_vector4d_block ),
	FIELD( _field_block, "real vectors", &real_vector4d_block ),
	FIELD( _field_block, "real vertex vectors", &real_vector4d_block ),
	...
	FIELD( _field_struct, "physics material 0!" ),
	FIELD( _field_struct, "physics material 1!" ),
	FIELD( _field_struct, "physics material 2!" ),
	FIELD( _field_struct, "physics material 3!" ),
