...
TAG_BLOCK(scenario_designer_zone, k_maximum_designer_zone_count)
{
	...
	FIELD( _field_block, "vehicle", &vehicle_block_index_flags_block ),
	FIELD( _field_custom, "weapon" ),
	FIELD( _field_block, "weapon", &weapon_block_index_flags_block ),
	FIELD( _field_custom, "equipment" ),
	FIELD( _field_block, "equipment", &equipment_block_index_flags_block ),
	FIELD( _field_custom, "scenery" ),
	FIELD( _field_block, "scenery", &scenery_block_index_flags_block ),
	FIELD( _field_custom, "machine" ),
	FIELD( _field_block, "machine", &machine_block_index_flags_block ),
	FIELD( _field_custom, "terminal" ),
	FIELD( _field_block, "terminal", &terminal_block_index_flags_block ),
	FIELD( _field_custom, "control" ),
	FIELD( _field_block, "control", &control_block_index_flags_block ),
	FIELD( _field_custom, "dispenser" ),
	FIELD( _field_block, "dispenser", &dispenser_block_index_flags_block ),
	FIELD( _field_custom, "sound_scenery" ),
	FIELD( _field_block, "sound_scenery", &sound_scenery_block_index_flags_block ),
	FIELD( _field_custom, "crate" ),
	FIELD( _field_block, "crate", &crate_block_index_flags_block ),
	FIELD( _field_custom, "creature" ),
	FIELD( _field_block, "creature", &creature_block_index_flags_block ),
	FIELD( _field_custom, "giant" ),
	FIELD( _field_block, "giant", &giant_block_index_flags_block ),
	FIELD( _field_custom, "effect_scenery" ),
	FIELD( _field_block, "effect_scenery", &effect_scenery_block_index_flags_block ),
	FIELD( _field_custom, "character" ),
	FIELD( _field_block, "character", &character_block_index_flags_block ),
	FIELD( _field_custom, "spawner" ),
	FIELD( _field_block, "spawner", &spawner_block_index_flags_block ),
