...
TAG_STRUCT(scenario_wetness_bsp_data_struct_definition)
{
	...
	FIELD( _field_block, "wetness", &wentness_bit_vector ),
	FIELD( _field_block, "wetness in bytes", &wentness_byte_vector ),
	FIELD( _field_block, "cluster_offset", &cluster_wetness_offset_block ),
	FIELD( _field_block, "instance_offset", &instance_wetness_instance_block ),
...
TAG_BLOCK(scenario_lightmap_rasterized_chart_data, 1024 * 1024)
{
	...
	FIELD( _field_block, "sourceVertices", &scenario_lightmap_rasterized_chart_source ),
	FIELD( _field_block, "chartBitmap", &scenario_lightmap_rasterized_chart_element ),
	FIELD( _field_terminator )
};
...
{
	FIELD( _field_block, "mesh", &triangle_mapping_block ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(scenario_lightmap_dynamic_light_instance, 2147483647L)
{
	...
	FIELD( _field_block, "instance indices", &scenario_lightmap_dynamic_light_instance_data_block ),
	FIELD( _field_terminator )
};
...
TAG_GROUP(scenario_lightmap_bsp_data_block, SCENARIO_LIGHTMAP_BSP_DATA_TAG)
{
	...
	FIELD( _field_block, "clusters", &scenario_lightmap_cluster_data ),
	FIELD( _field_block, "instances", &scenario_lightmap_instance_data ),
	FIELD( _field_block, "probes", &scenario_lightmap_lightprobe_value ),
	FIELD( _field_block, "shadow geometry excluded instance indices", &scenario_lightmap_instance_index_block ),
	FIELD( _field_block, "per-pixel padding!", &scenario_lightmap_global_perpixel_padding_data ),
	FIELD( _field_block, "per-pixel rasterized charts!", &scenario_lightmap_rasterized_chart_data ),
	FIELD( _field_block, "New AO Data!", &scenario_lightmap_new_ao_data_block ),
	FIELD( _field_block, "Adjacent Bounce Vertices!", &scenario_lightmap_adjacent_bounce_vertex_block ),
	FIELD( _field_block, "Adjacent Bounce Indices!", &scenario_lightmap_adjacent_bounce_index_block ),
	...
	FIELD( _field_block, "per mesh triangle mapping", &triangle_mapping_per_mesh_block ),
	...
	FIELD( _field_block, "light instance data", &scenario_lightmap_dynamic_light_instance ),
	FIELD( _field_block, "structure light instance data", &scenario_lightmap_structure_light_instance ),
	FIELD( _field_block, "extruded silhouette vertices", &s_scenario_lightmap_silhouette_vertex ),
	FIELD( _field_block, "extruded silhouette edges", &s_scenario_lightmap_silhouette_edge ),
	FIELD( _field_block, "extruded silhouette groups", &s_scenario_lightmap_silhouette_group ),
	FIELD( _field_block, "airprobes", &scenario_lightmap_airprobe_value ),
	FIELD( _field_block, "errors*", &global_error_report_categories_block ),
	FIELD( _field_block, "self_track", &global_self_track_block ),
...
TAG_GROUP(scenario_lightmap_block, SCENARIO_LIGHTMAP_TAG)
{
	FIELD( _field_long_integer, "job guid" ),
	FIELD( _field_block, "lightmap BSP references", &scenario_lightmap_bsp_data_reference_block ),
	FIELD( _field_terminator )
};

TAG_GROUP(scenario_wetness_bsp_data_block, SCENARIO_WETNESS_BSP_DATA_TAG)
{
	FIELD( _field_short_integer, "bsp reference index" ),
	FIELD( _field_pad, "LHWCHFX", 2 ),
	FIELD( _field_long_integer, "structure BSP import checksum" ),
