...
namespace blofeld
{
	...
	extern s_tag_struct_definition cubemap_reference_points_block_block_struct;
	extern s_tag_block_definition cubemap_reference_points_block_block;
	extern s_tag_struct_definition structure_cluster_cubemap_block_struct;
	extern s_tag_block_definition structure_cluster_cubemap_block;
	extern s_tag_struct_definition scenario_cubemap_block_block_struct;
