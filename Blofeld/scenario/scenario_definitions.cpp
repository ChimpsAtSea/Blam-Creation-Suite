...
TAG_BLOCK(scenario_structure_bsp_reference, MAXIMUM_STRUCTURE_BSPS_PER_SCENARIO)
{
	...
	FIELD( _field_struct, "volumetric light shaft settings" ),
	FIELD( _field_custom ),
	FIELD( _field_custom, "floating shadows" ),
	FIELD( _field_struct, "floating shadow settings" ),
	FIELD( _field_custom ),
	FIELD( _field_explanation, "Clones" ),
	FIELD( _field_long_block_flags, "cloned bsp flags" ),
	FIELD( _field_struct, "lightmap setting{lightmap resolution buckets}" ),
...
TAG_GROUP(scenario, SCENARIO_TAG)
{
	...
	FIELD( _field_block, "acoustics palette{background sound palette}", &scenario_acoustics_palette_block ),
	...
	FIELD( _field_block, "zone debugger!", &scenario_zone_debugger_block ),
