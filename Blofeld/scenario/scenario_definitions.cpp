...
{
	FIELD( _field_block, "child scenarios", &scenario_child_references_block ),
	FIELD( _field_custom, "link to scenario lightmap" ),
	FIELD( _field_enum, "type" ),
	FIELD( _field_word_flags, "flags" ),
	FIELD( _field_long_flags, "runtime trigger volume flags*!" ),
	...
	FIELD( _field_block, "structure bsps", &scenario_structure_bsp_reference_block ),
	FIELD( _field_block, "structure designs", &scenario_design_reference_block ),
	FIELD( _field_tag_reference, "structure seams" ),
	FIELD( _field_tag_reference, "local structure seams*!" ),
	FIELD( _field_block, "skies", &scenario_sky_reference_block ),
	FIELD( _field_block, "zone set pvs*!", &scenario_zone_set_pvs_block ),
	FIELD( _field_block, "zone set audibility*!", &game_audibility_block ),
	FIELD( _field_block, "zone sets", &scenario_zone_set_block ),
	FIELD( _field_block, "lighting zone sets!", &scenario_lighting_zone_set_block ),
	FIELD( _field_block, "predicted resources*", &g_null_block ),
	FIELD( _field_block, "functions", &scenario_function_block ),
	FIELD( _field_data, "editor scenario data" ),
	FIELD( _field_block, "comments", &editor_comment_block ),
	FIELD( _field_block, "unused scenario environment objects!", &dont_use_me_scenario_environment_object_block ),
	FIELD( _field_block, "object names*", &scenario_object_names_block ),
	FIELD( _field_block, "scenery", &scenario_scenery_block ),
	FIELD( _field_block, "scenery palette", &scenario_scenery_palette_block ),
	FIELD( _field_block, "bipeds", &scenario_biped_block ),
	FIELD( _field_block, "biped palette", &scenario_biped_palette_block ),
	FIELD( _field_block, "vehicles", &scenario_vehicle_block ),
	FIELD( _field_block, "vehicle palette", &scenario_vehicle_palette_block ),
	FIELD( _field_block, "equipment", &scenario_equipment_block ),
	FIELD( _field_block, "equipment palette", &scenario_equipment_palette_block ),
	FIELD( _field_block, "weapons", &scenario_weapon_block ),
	FIELD( _field_block, "weapon palette", &scenario_weapon_palette_block ),
	FIELD( _field_block, "device groups", &device_group_block ),
	FIELD( _field_block, "machines", &scenario_machine_block ),
	FIELD( _field_block, "machine palette", &scenario_machine_palette_block ),
	FIELD( _field_block, "terminals", &scenario_terminal_block ),
	FIELD( _field_block, "terminal palette", &scenario_terminal_palette_block ),
	FIELD( _field_block, "controls", &scenario_control_block ),
	FIELD( _field_block, "control palette", &scenario_control_palette_block ),
	FIELD( _field_block, "dispensers", &ScenarioDispenserBlock ),
	FIELD( _field_block, "dispenser palette", &ScenarioDispenserPaletteBlock ),
	FIELD( _field_block, "sound scenery", &scenario_sound_scenery_block ),
	FIELD( _field_block, "sound scenery palette", &scenario_sound_scenery_palette_block ),
	FIELD( _field_block, "giants", &scenario_giant_block ),
	FIELD( _field_block, "giant palette", &scenario_giant_palette_block ),
	FIELD( _field_block, "effect scenery", &scenario_effect_scenery_block ),
	FIELD( _field_block, "effect scenery palette", &scenario_effect_scenery_palette_block ),
	FIELD( _field_block, "spawners", &scenario_spawner_block ),
	FIELD( _field_block, "spawner palette", &scenario_spawner_palette_block ),
	FIELD( _field_block, "bink palette", &binkPaletteBlock ),
	FIELD( _field_block, "scenario attached effects", &scenarioAttachedEffectsBlock ),
	FIELD( _field_block, "scenario attached lens flares", &scenarioAttachedLensFlaresBlock ),
	FIELD( _field_block, "scenario attached light cones", &scenarioAttachedLightConesBlock ),
	FIELD( _field_block, "map variant palettes", &map_variant_palette_block ),
	FIELD( _field_tag_reference, "multiplayer object types" ),
	FIELD( _field_char_enum, "multiplayer map size" ),
	FIELD( _field_pad, "mulmapsizepad", 3 ),
	FIELD( _field_block, "Playtest req palette#requisition for SvE, activated via an init.txt option for playtest balance", &scenario_requisition_palette_block ),
	FIELD( _field_real, "player requisition frequency:seconds" ),
	FIELD( _field_long_integer, "initial game currency:SpaceBucks" ),
	FIELD( _field_block, "soft ceilings", &scenario_soft_ceilings_block ),
	FIELD( _field_block, "player starting profile", &scenario_profiles_block ),
	FIELD( _field_block, "player starting locations", &scenario_players_block ),
	FIELD( _field_block, "trigger volumes", &scenario_trigger_volume_block ),
	FIELD( _field_block, "acoustic sectors", &scenario_acoustic_sector_block ),
	FIELD( _field_block, "acoustic transitions", &scenario_acoustic_transition_block ),
	FIELD( _field_block, "atmosphere dumplings", &scenario_atmosphere_dumpling_block ),
	FIELD( _field_block, "weather dumplings", &scenario_weather_dumpling_block ),
	FIELD( _field_block, "recorded animations", &recorded_animation_block ),
	FIELD( _field_block, "zone set switch trigger volumes~", &scenario_zone_set_switch_trigger_volume_block ),
	FIELD( _field_block, "named location volumes", &scenario_named_location_volume_block ),
	...
	FIELD( _field_block, "decals", &scenario_decals_block ),
	FIELD( _field_block, "decal palette", &scenario_decal_palette_block ),
	...
	FIELD( _field_block, "detail object collection palette", &scenario_detail_object_collection_palette_block ),
	FIELD( _field_block, "style pallette", &style_palette_block ),
	FIELD( _field_block, "squad groups", &squad_groups_block ),
	FIELD( _field_block, "squads", &squads_block ),
	FIELD( _field_block, "zones", &zone_block ),
	FIELD( _field_block, "squad patrols", &squad_patrol_block ),
	FIELD( _field_block, "actual cues!", &ai_cue_block ),
	FIELD( _field_block, "full cues{cues}", &ai_full_cue_block ),
	FIELD( _field_block, "quick cues", &ai_quick_cue_block ),
	FIELD( _field_block, "mission scenes", &ai_scene_block ),
	FIELD( _field_block, "character palette", &character_palette_block ),
	FIELD( _field_tag_reference, "ai pathfinding data" ),
	FIELD( _field_block, "ai user hint data", &user_hint_block ),
	FIELD( _field_block, "ai recording references", &ai_recording_reference_block ),
	FIELD( _field_struct, "script data*!", &hs_script_data_struct_struct_definition ),
	FIELD( _field_block, "manual script file references", &hs_source_reference_block ),
	FIELD( _field_tag_reference, "compiled global scripts*!" ),
	FIELD( _field_block, "scripting data", &cs_script_data_block ),
	FIELD( _field_block, "cutscene flags", &scenario_cutscene_flag_block ),
	FIELD( _field_block, "cutscene camera points", &scenario_cutscene_camera_point_block ),
	FIELD( _field_block, "cutscene titles", &scenario_cutscene_title_block ),
	FIELD( _field_tag_reference, "custom object names" ),
	FIELD( _field_tag_reference, "chapter title text" ),
	FIELD( _field_block, "scenario kill triggers", &scenario_kill_trigger_volumes_block ),
	FIELD( _field_block, "scenario safe zone triggers", &scenario_safe_zone_trigger_volumes_block ),
	FIELD( _field_block, "scenario trigger volumes mopp code*!", &trigger_volume_mopp_code_block ),
	FIELD( _field_block, "scenario requisition triggers", &scenario_requisition_trigger_volumes_block ),
	FIELD( _field_block, "scenario location name triggers", &scenario_location_name_trigger_volumes_block ),
	FIELD( _field_block, "scenario unsafe spawn trigger volumes", &scenarioUnsafeSpawnZoneTriggerVolumesBlock ),
	FIELD( _field_short_block_index, "scenario ordnance bounds trigger volume" ),
	FIELD( _field_pad, "ordnandy", 2 ),
	FIELD( _field_block, "Orders", &orders_block ),
	FIELD( _field_block, "Triggers", &triggers_block ),
	FIELD( _field_block, "acoustics palette{background sound palette}", &scenario_acoustics_palette_block_definition ),
	FIELD( _field_block, "atmosphere", &scenario_atmosphere_palette_block ),
	FIELD( _field_block, "camera fx palette", &scenario_camera_fx_palette_block ),
	FIELD( _field_block, "weather palette", &scenario_weather_palette_block ),
	FIELD( _field_block, "scenario cluster data", &scenario_cluster_data_block ),
	FIELD( _field_array, "object_salts*" ),
	FIELD( _field_block, "spawn data", &scenario_spawn_data_block ),
	FIELD( _field_tag_reference, "sound effect collection" ),
	FIELD( _field_block, "crates", &scenario_crate_block ),
	FIELD( _field_block, "crate palette", &scenario_crate_palette_block ),
	FIELD( _field_block, "flock palette", &flock_palette_block ),
	FIELD( _field_block, "flocks", &flock_instance_block ),
	FIELD( _field_tag_reference, "subtitles" ),
	FIELD( _field_block, "soundSubtitles*!", &SoundSubtitleBlock ),
	FIELD( _field_block, "creatures", &scenario_creature_block ),
	FIELD( _field_block, "creature palette", &scenario_creature_palette_block ),
	FIELD( _field_block, "big battle creature palette", &big_battle_creature_palette_block ),
	FIELD( _field_block, "editor folders!", &g_scenario_editor_folder_block ),
	FIELD( _field_tag_reference, "game engine strings" ),
	FIELD( _field_pad, "QVUC", 4 ),
	FIELD( _field_block, "mission dialogue", &ai_scenario_mission_dialogue_block ),
	FIELD( _field_tag_reference, "voiceover" ),
	FIELD( _field_tag_reference, "objectives" ),
	FIELD( _field_tag_reference, "interpolators" ),
	FIELD( _field_block, "shared references", &hs_references_block ),
	...
	FIELD( _field_block, "ai objectives", &objectives_block ),
	FIELD( _field_block, "designer zones", &scenario_designer_zone_block ),
	FIELD( _field_block, "zone debugger!", &scenario_zone_debugger_block_definition ),
	FIELD( _field_block, "decorators", &scenario_decorator_block ),
	FIELD( _field_block, "neuticle palette", &scenario_cheap_particle_system_palette_block ),
	FIELD( _field_block, "neuticles", &scenario_cheap_particle_systems_block ),
	FIELD( _field_explanation, "Scriptable Light Rigs" ),
	FIELD( _field_block, "scriptable light rigs", &scriptableLightRigBlock ),
	FIELD( _field_block, "cinematics", &scenario_cinematics_block ),
	FIELD( _field_block, "cinematic lighting palette", &scenario_cinematic_lighting_palette_block ),
	FIELD( _field_block, "override player representations", &player_representation_block ),
	FIELD( _field_block, "campaign metagame", &campaign_metagame_scenario_block ),
	FIELD( _field_block, "soft surfaces", &soft_surfaces_definition_block ),
	FIELD( _field_block, "cubemaps", &scenario_cubemap_block ),
	FIELD( _field_block, "airprobes", &scenario_airprobes_block ),
	FIELD( _field_block, "budget references", &scenario_budget_references_block ),
	FIELD( _field_block, "model references*", &model_references_block ),
	FIELD( _field_block, "thespian{performances}", &scenario_performances_block ),
	FIELD( _field_block, "puppetShows", &PuppetShowsBlock ),
	FIELD( _field_tag_reference, "location name globals" ),
	FIELD( _field_explanation, "garbage collection" ),
	FIELD( _field_block, "garbage collection", &garbage_collection_block ),
	...
	FIELD( _field_word_flags, "ordnance flags" ),
	...
	FIELD( _field_block, "Drop sets", &scenarioRandomOrdnanceDropSetBlock ),
	FIELD( _field_explanation, "Ordnance personal" ),
	FIELD( _field_tag_reference, "Scenario Ordnance List" ),
	FIELD( _field_block, "Unit Recordings", &ScenarioUnitRecordingBlock ),
	FIELD( _field_block, "Exit load screen#for non-mainmenu, we always use the first one", &loadScreenReferenceBlock ),
	FIELD( _field_terminator )
};

TAG_STRUCT(scenario_required_resource_struct_definition)
{
	FIELD( _field_block, "resources", &scenario_budget_references_block ),
	FIELD( _field_terminator )
};
...
TAG_STRUCT(scenario_trigger_volume_struct)
{
	...
	FIELD( _field_block, "sector points", &trigger_volume_point_block ),
	FIELD( _field_block, "runtime triangles*!", &trigger_volume_runtime_triangles_block ),
...
TAG_STRUCT(manualBspFlagsReferences)
{
	...
	FIELD( _field_block, "references block*!", &scenarioBspReferenceBlock ),
...
TAG_STRUCT(scenarioFloatingShadowSettingsStruct)
{
	...
	FIELD( _field_char_enum, "quality" ),
	FIELD( _field_char_enum, "resolution" ),
	FIELD( _field_real, "static shadow sharpening" ),
	FIELD( _field_array, "frustums*" ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(scenario_performance_line_block, MAXIMUM_LINES_PER_PERFORMANCE)
{
	...
	FIELD( _field_long_enum, "Line progress type" ),
	FIELD( _field_block, "Script fragments", &scenario_performance_line_script_fragment_block ),
	FIELD( _field_block, "Point interaction", &scenario_performance_line_point_interaction_block ),
	FIELD( _field_block, "Animations", &scenario_performance_line_animation_block ),
	FIELD( _field_block, "Sync Actions", &scenario_performance_line_sync_action_block ),
	FIELD( _field_block, "Scenery Sync Actions", &scenario_performance_line_scenery_sync_action_block ),
	FIELD( _field_block, "Dialog lines", &scenario_performance_line_dialog_block ),
	FIELD( _field_block, "Sounds", &scenario_performance_line_sound_block ),
	FIELD( _field_terminator )
};

TAG_BLOCK(scenario_performance_line_script_fragment_block, MAXIMUM_SCRIPT_FRAGMENTS_PER_PERFORMANCE_LINE)
{
	FIELD( _field_enum, "fragment placement" ),
	FIELD( _field_enum, "fragment type" ),
...
{
	FIELD( _field_long_flags, "interaction type" ),
...
TAG_BLOCK(scenario_performance_line_sync_action_block, MAXIMUM_SYNC_ACTIONS_PER_PERFORMANCE_LINE)
{
	...
	FIELD( _field_word_flags, "flags" ),
	FIELD( _field_block, "Actors", &scenario_performance_line_sync_action_actor_block ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(scenario_structure_bsp_reference_block, MAXIMUM_STRUCTURE_BSPS_PER_SCENARIO)
{
	...
	FIELD( _field_long_enum, "refinement size class" ),
...
TAG_BLOCK(scenario_zone_set_pvs_block, k_maximum_scenario_zone_set_count+1)
{
	...
	FIELD( _field_word_flags, "flags*!" ),
	FIELD( _field_block, "bsp checksums*!", &scenario_zone_set_bsp_checksum_block ),
	FIELD( _field_block, "structure bsp pvs*!", &scenario_zone_set_bsp_pvs_block ),
	FIELD( _field_block, "portal=>device mapping*!", &structure_portal_device_mapping_block ),
	FIELD( _field_terminator )
};
...
{
	FIELD( _field_block, "cluster pvs*!", &scenario_zone_set_cluster_pvs_block ),
	FIELD( _field_block, "cluster pvs doors closed*!", &scenario_zone_set_cluster_pvs_block ),
	FIELD( _field_block, "bsp cluster mapings*!", &scenario_zone_set_bsp_seam_cluster_mappings_block ),
	FIELD( _field_terminator )
};

TAG_BLOCK(scenario_zone_set_cluster_pvs_block, MAXIMUM_CLUSTERS_PER_STRUCTURE)
{
	FIELD( _field_block, "cluster pvs bit vectors*!", &scenario_zone_set_bsp_bits_block ),
	FIELD( _field_terminator )
};

TAG_BLOCK(scenario_zone_set_bsp_bits_block, MAXIMUM_STRUCTURE_BSPS_PER_SCENARIO)
{
	FIELD( _field_block, "bits*!", &scenario_zone_set_cluster_pvs_bit_vector_block ),
	FIELD( _field_terminator )
};
...
{
	FIELD( _field_block, "root clusters*!", &scenario_zone_set_cluster_reference_block ),
	FIELD( _field_block, "attached clusters*!", &scenario_zone_set_cluster_reference_block ),
	FIELD( _field_block, "connected clusters*!", &scenario_zone_set_cluster_reference_block ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(scenario_zone_set_block, k_maximum_scenario_zone_set_count)
{
	...
	FIELD( _field_block, "planar fog visibility*!", &planar_fog_zone_set_visibility_definition_block ),
	FIELD( _field_block, "budget overrides", &scenario_zone_set_budget_override_block ),
	...
	FIELD( _field_block, "lipsync sounds", &scenario_zone_set_lipsync_block ),
...
TAG_BLOCK(scenario_function_block, MAXIMUM_FUNCTIONS_PER_SCENARIO)
{
	...
	FIELD( _field_enum, "bounds mode#controls how the bounds, below, are used" ),
...
TAG_BLOCK(trigger_volume_mopp_code_block, 1)
{
	...
	FIELD( _field_block, "mopp code*!", &mopp_code_definition_block ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(scenario_cluster_data_block, MAXIMUM_STRUCTURE_BSPS_PER_SCENARIO)
{
	...
	FIELD( _field_block, "cluster centroids*", &scenario_cluster_points_block ),
	FIELD( _field_long_block_index, "default acoustic palette" ),
	FIELD( _field_block, "acoustics{background sounds}*", &scenario_cluster_acoustics_block ),
	FIELD( _field_block, "atmospheric properties*", &scenario_cluster_atmosphere_properties_block ),
	FIELD( _field_block, "camera fx properties*", &scenario_cluster_camera_fx_properties_block ),
	FIELD( _field_block, "weather properties*", &scenario_cluster_weather_properties_block ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(scenario_performances_block, MAXIMUM_PERFORMANCES_PER_SCENARIO)
{
	...
	FIELD( _field_pad, "padding", 2 ),
	FIELD( _field_block, "Actors", &scenario_performance_actor_block ),
	FIELD( _field_block, "Lines", &scenario_performance_line_block ),
	FIELD( _field_real_point_3d, "position" ),
	...
	FIELD( _field_block, "tasks!", &scenario_performance_task_block ),
	FIELD( _field_custom ),
	FIELD( _field_custom ),
	FIELD( _field_terminator )
};
...
{
	FIELD( _field_word_flags, "drop set flags" ),
	FIELD( _field_pad, "ODSF", 2 ),
	FIELD( _field_string, "name^" ),
	FIELD( _field_long_integer, "count" ),
	FIELD( _field_tag_reference, "Ordnance List" ),
	FIELD( _field_block, "Drop point list", &scenarioRandomOrdnanceDropPointBlock ),
	FIELD( _field_terminator )
};
...
TAG_GROUP(performance_template_block, PERFORMANCE_TEMPLATE_TAG)
{
	FIELD( _field_string_id, "name^" ),
	FIELD( _field_string_id, "script name#The name of a custom script used to drive the performance. If none is given, a default script is uses that goes through the lines in sequence" ),
	FIELD( _field_block, "Actors", &performance_template_actor_block ),
	FIELD( _field_block, "Lines", &scenario_performance_line_block ),
	FIELD( _field_block, "Points", &performance_template_point_block ),
	FIELD( _field_terminator )
};

TAG_GROUP(scenario_block, SCENARIO_TAG)
{
	FIELD( _field_block, "child scenarios", &scenario_child_references_block ),
	FIELD( _field_custom, "link to scenario lightmap" ),
	FIELD( _field_enum, "type" ),
...
TAG_GROUP(scenario_required_resource_block, SCENARIO_REQUIRED_RESOURCE_TAG)
{
	FIELD( _field_block, "resources", &scenario_budget_references_block ),
	FIELD( _field_terminator )
};
