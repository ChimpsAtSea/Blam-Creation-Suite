...
namespace blofeld
{
	...
	extern s_tag_struct_definition GameGlobalsOrdnanceBlock_block_struct;
	extern s_tag_block_definition GameGlobalsOrdnanceBlock_block;
	extern s_tag_struct_definition OrdnanceRemappingBlock_block_struct;
	extern s_tag_block_definition OrdnanceRemappingBlock_block;
	extern s_tag_struct_definition OrdnanceRemappingVariantBlock_block_struct;
	...
	extern s_tag_struct_definition RandomOrdnanceItemBlock_block_struct;
	extern s_tag_block_definition RandomOrdnanceItemBlock_block;
	extern s_tag_struct_definition PlayerOrdnanceItemBlock_block_struct;
	extern s_tag_block_definition PlayerOrdnanceItemBlock_block;
	extern s_tag_struct_definition PlayerOrdnanceGroupBlock_block_struct;
