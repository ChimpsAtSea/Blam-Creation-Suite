...
TAG_BLOCK(melee_damage_parameters, k_melee_damage_class_count)
{
	...
	{ _field_tag_reference, "lunge melee damage#this is only important for the energy sword" },
	{ _field_tag_reference, "lunge melee response#this is only important for the energy sword" },
	{ _field_tag_reference, "empty melee damage#this is only important for the energy sword" },
	{ _field_tag_reference, "empty melee response#this is only important for the energy sword" },
	{ _field_tag_reference, "clang melee damage#this is only important for the energy sword" },
	{ _field_tag_reference, "clang melee response#this is only important for the energy sword" },
	{ _field_tag_reference, "clang melee against melee weapon damage#e.g. used by AR to damage sword guy when clanging sword attack" },
	{ _field_tag_reference, "clang melee against melee weapon damage response#e.g. used by AR to damage sword guy when clanging sword attack" },
	{ _field_tag_reference, "lunge melee explosive damage" },
	{ _field_terminator },
};
...
TAG_BLOCK(magazines, MAXIMUM_NUMBER_OF_MAGAZINES_PER_WEAPON)
{
	...
	{ _field_pad, "HPMIV", 8 },
	{ _field_pad, "P", 16 },
	{ _field_tag_reference, "reloading effect" },
	{ _field_tag_reference, "reloading damage effect" },
	{ _field_tag_reference, "chambering effect" },
	{ _field_tag_reference, "chambering damage effect" },
	{ _field_useless_pad },
...
TAG_BLOCK(weapon_triggers, k_weapon_trigger_count)
{
	{ _field_long_flags, "flags" },
	{ _field_enum, "input" },
	{ _field_enum, "behavior" },
	{ _field_short_block_index, "primary barrel" },
	{ _field_short_block_index, "secondary barrel" },
	{ _field_enum, "prediction" },
	{ _field_pad, "GNFR", 2 },
	{ _field_useless_pad },
	{ _field_struct, "autofire" },
	{ _field_struct, "charging" },
	{ _field_tag_reference, "double latch projectile releasable effect#created once player is able to release the tethered projectile" },
	{ _field_tag_reference, "double latch projectile released effect#created when player releases the tethered projectile" },
	{ _field_terminator },
};
...
TAG_BLOCK(weapon_barrels, k_weapon_barrel_count)
{
	...
	{ _field_enum, "firing noise#how loud this weapon appears to the AI" },
	{ _field_explanation, "prediction properties" },
	{ _field_enum, "prediction type" },
	...
	{ _field_struct, "firing error" },
	{ _field_explanation, "projectile" },
	{ _field_enum, "distribution function" },
	...
	{ _field_struct, "accuracy penalties" },
	...
	{ _field_tag_reference, "optional secondary projectile" },
	{ _field_struct, "eh" },
	{ _field_tag_reference, "crate projectile" },
...
TAG_BLOCK(barrel_firing_effect, k_weapon_barrel_effect_count)
{
	...
	{ _field_tag_reference, "firing effect^#this effect is used when the weapon is loaded and fired normally" },
	{ _field_tag_reference, "critical effect^#this effect is used when the weapon is loaded and will do critical damage" },
	{ _field_tag_reference, "misfire effect#this effect is used when the weapon is loaded but fired while overheated" },
	{ _field_tag_reference, "empty effect#this effect is used when the weapon is not loaded" },
	{ _field_tag_reference, "optional secondary firing effect#this effect is used when the weapon is not loaded" },
	{ _field_tag_reference, "firing damage#this effect is used when the weapon is loaded and fired normally" },
	{ _field_tag_reference, "critical damage^#this effect is used when the weapon is loaded and will do critical damage" },
	{ _field_tag_reference, "misfire damage#this effect is used when the weapon is loaded but fired while overheated" },
	{ _field_tag_reference, "empty damage#this effect is used when the weapon is not loaded" },
	{ _field_tag_reference, "optional secondary firing damage#this effect is used when the weapon is loaded and fired normally" },
	{ _field_tag_reference, "firing rider damage#this effect is used when the weapon is loaded and fired normally" },
	{ _field_tag_reference, "critical rider damage^#this effect is used when the weapon is loaded and will do critical damage" },
	{ _field_tag_reference, "misfire rider damage#this effect is used when the weapon is loaded but fired while overheated" },
	{ _field_tag_reference, "empty rider damage#this effect is used when the weapon is not loaded" },
	{ _field_tag_reference, "optional secondary firing rider damage#this effect is used when the weapon is loaded and fired normally" },
	{ _field_terminator },
};
...
TAG_BLOCK(weaponScaleshotLevelStruct, WeaponScaleshotLevelDefinition::k_maxLevels)
{
	...
	{ _field_tag_reference, "projectile#the projectile to fire at this level" },
...
TAG_GROUP_INHERIT(weapon, WEAPON_TAG, item, ITEM_TAG)
{
	...
	{ _field_enum, "secondary trigger mode" },
	...
	{ _field_tag_reference, "vision mode#activated when this weapon is charging" },
	...
	{ _field_tag_reference, "ready effect" },
	{ _field_tag_reference, "ready damage effect" },
	...
	{ _field_tag_reference, "overheated" },
	{ _field_tag_reference, "overheated damage effect" },
	{ _field_tag_reference, "detonation" },
	{ _field_tag_reference, "detonation damage effect" },
	{ _field_block, "melee damage parameters", &melee_damage_parameters_block },
	{ _field_tag_reference, "clang effect#effect that is played in the air between two players that clang with this weapon" },
	{ _field_char_enum, "melee damage reporting type" },
	...
	{ _field_pad, "wzt", 3 },
	{ _field_tag_reference, "zoom effect#effect that is played while zoomed" },
	{ _field_explanation, "weapon aim assist!#DEPRECATED -- this will go away in favor of aim assist modes below" },
	{ _field_struct, "weapon aim assist" },
	{ _field_struct, "iron sights modifiers" },
	...
	{ _field_enum, "movement penalized" },
	...
	{ _field_tag_reference, "weapon power-on effect" },
	{ _field_tag_reference, "weapon power-off effect" },
	...
	{ _field_tag_reference, "zoom-in sound" },
	{ _field_tag_reference, "zoom-out sound" },
	...
	{ _field_char_enum, "first time pickup type" },
	{ _field_pad, "PAD", 3 },
	{ _field_enum, "weapon type" },
	{ _field_short_integer, "low ammo threshold" },
	{ _field_struct, "player interface" },
	...
	{ _field_tag_reference, "deployed vehicle" },
	{ _field_tag_reference, "tossed weapon" },
	{ _field_tag_reference, "age effect" },
	{ _field_tag_reference, "aged weapon" },
	{ _field_tag_reference, "aged material effects" },
	...
	{ _field_tag_reference, "age fully recovered (sound or effect)#the sound or effect played when the weapon\'s age reaches fully recovered" },
	...
	{ _field_tag_reference, "single shot fire for automatics" },
	{ _field_tag_reference, "firing loop for automatics" },
