...
TAG_BLOCK(equipmentAbilityDatum, k_equipmentMaxAbilityCount)
{
	...
	{ _field_struct, "movement speed to energy rate:1/s" },
	...
	{ _field_char_enum, "activation mode^" },
	...
	{ _field_custom, "Type Definitions" },
	...
	{ _field_custom },
	{ _field_tag_reference, "activation while disabled by player traits sound" },
	{ _field_tag_reference, "activate effect" },
	{ _field_tag_reference, "looping effect" },
	{ _field_tag_reference, "deactivate effect" },
...
TAG_BLOCK(equipmentAbilityTypeSpawnerBlock, 1)
{
	...
	{ _field_tag_reference, "spawned effect" },
	{ _field_terminator },
};
...
TAG_BLOCK(equipmentAbilityTypeAiSpawnerBlock, 1)
{
	...
	{ _field_enum, "type" },
	{ _field_pad, "RFD", 2 },
	{ _field_tag_reference, "spawned character" },
	{ _field_terminator },
};

TAG_BLOCK(equipmentAbilityTypeProximityMineBlock, 1)
{
	{ _field_tag_reference, "explosion effect" },
	{ _field_tag_reference, "explosion damage effect" },
...
TAG_BLOCK(equipmentAbilityTypeInvincibilityBlock, 1)
{
	...
	{ _field_pad, "invincibility material pad", 2 },
	{ _field_real, "shield recharge rate:1.0f/s#while active, shields recharge at this fraction per second" },
	{ _field_real, "shield max recharge level#highest level shield can recharge to (can be up to 4)" },
	{ _field_tag_reference, "override collision damage" },
	{ _field_tag_reference, "ai melee reflect damage" },
	{ _field_tag_reference, "player melee reflect damage" },
	...
	{ _field_struct, "post-invincibility time to shield level function" },
	{ _field_real, "maximum vertical velocity:WU/SEC#we use this to specify the domain of the active vertical velocity funtion" },
	{ _field_struct, "active vertical velocity damping" },
...
TAG_BLOCK(aiEquipmentTraitAppearanceBlock, 1)
{
	...
	{ _field_char_enum, "active camo setting" },
	{ _field_pad, "pad", 3 },
	{ _field_terminator },
};
...
TAG_BLOCK(equipmentAbilityTypeBallLightningBlock, 1)
{
	...
	{ _field_tag_reference, "lightning damage" },
	{ _field_terminator },
};
...
TAG_BLOCK(equipmentAbilityTypeDaddyBlock, 1)
{
	...
	{ _field_real_bounds, "min and max pitch:degrees#the min and max pitch that the child will follow as you aim up and down.  -90 to 90" },
	{ _field_real, "visual activation time:seconds" },
	{ _field_tag_reference, "spawn effect" },
	{ _field_custom },
	{ _field_string_id, "spawn effect marker" },
	{ _field_tag_reference, "despawn effect" },
	{ _field_custom },
...
TAG_BLOCK(equipmentAbilityTypePowerFistBlock, 1)
{
	...
	{ _field_tag_reference, "melee response" },
	{ _field_tag_reference, "clang damage" },
	{ _field_tag_reference, "clang response" },
	{ _field_terminator },
};

TAG_BLOCK(equipmentAbilityTypeHealthPackBlock, 1)
{
	{ _field_struct, "health given over energy used" },
	{ _field_terminator },
};
...
TAG_BLOCK(equipmentAbilityTypeJetPackBlock, 1)
{
	...
	{ _field_pad, "pad after useCamAndMoveForThrustDirection", 3 },
	{ _field_struct, "thrust to acceleration function" },
	{ _field_struct, "Infinite energy thrust to acceleration function" },
...
TAG_BLOCK(equipmentAbilityPartCowCatcherBlock, 1)
{
	...
	{ _field_tag_reference, "collision damage override#if \"hide unit during transit\" isn\'t checked, this can override the unit\'s collision damage definition during the teleport" },
	{ _field_terminator },
};
...
TAG_BLOCK(equipmentAbilityTypeHologramBlock, 1)
{
	...
	{ _field_long_enum, "havok filter group" },
	{ _field_tag_reference, "creation effect" },
	{ _field_tag_reference, "attached effect" },
	{ _field_custom },
	...
	{ _field_tag_reference, "destruction effect" },
	{ _field_real, "shimmer decrease rate:1.0/s#how fast shimmer decreases" },
	{ _field_real, "shimmer bullet ping:0-1#how much to ping shimmer when hit by a bullet" },
	...
	{ _field_byte_flags, "flags" },
	{ _field_pad, "pad after hologram flags", 3 },
	{ _field_terminator },
};
...
TAG_BLOCK(equipmentAbilityTypeSpecialMoveBlock, 1)
{
	...
	{ _field_char_enum, "default direction" },
	{ _field_pad, "pad0", 3 },
	{ _field_tag_reference, "directional effect" },
...
TAG_BLOCK(equipmentAbilityTypeTeleporterBlock, 1)
{
	...
	{ _field_tag_reference, "trace effect#an effect that will follow along the travel path" },
...
TAG_BLOCK(equipmentAbilityTypeAutoTurretBlock, 1)
{
	...
	{ _field_real, "turret halt engage time:seconds#amount of time after a moving turret engages a target before it halts movement" },
	{ _field_real, "turret idle equipment drain multiplier:[0.1]#the multiplier on equipment drain when equipment is in its idle state" },
	{ _field_real, "turret inactive equipment drain multiplier:[0.1]#the multiplier on equipment drain when equipment is in its inactive state" },
	{ _field_real, "spawn radius:world units#area that must be clear in order for turret to spawn" },
	{ _field_real, "spawn in time:seconds#the turret will be inactive for this duration" },
	{ _field_real_vector_3d, "spawn offset from player:world units#relative to origin and camera direction without pitch" },
	{ _field_real, "vertical bob height:world units" },
	{ _field_real, "vertical bobs per second" },
	{ _field_tag_reference, "spawn effect#effect played on the turret when it is spawned into the world" },
	{ _field_custom },
	{ _field_string_id, "spawn effect marker" },
	{ _field_string_id, "spawn dissolve type" },
	{ _field_string_id, "spawn dissolve marker" },
	{ _field_tag_reference, "collision phase effect#effect played on the turret while a biped or vehicle passes through it" },
	{ _field_terminator },
};
...
TAG_BLOCK(equipmentAbilityTypeVisionModeBlock, 1)
{
	{ _field_byte_flags, "Flags" },
	{ _field_pad, "vmbf", 3 },
	{ _field_real, "maximum tell distance:wu#\'Other activation tell effect\' will be applied to players within this distance" },
	{ _field_tag_reference, "activation tell effect#applied to other players within maximum distance" },
	...
	{ _field_tag_reference, "vision mode" },
	{ _field_terminator },
};
...
TAG_BLOCK(equipmentAbilityTypeShieldProjectorBlock, 1)
{
	...
	{ _field_tag_reference, "Project Effect #Beam effect that links equipment to projected shield." },
	{ _field_tag_reference, "Warmup Effect #Effect played at eventual shield projection point during warmup period." },
	{ _field_tag_reference, "Shield Crate #Crate created to represent projected shield." },
	{ _field_terminator },
};
...
TAG_BLOCK(equipmentAbilityTypeProjectileCollectorBlock, 1)
{
	...
	{ _field_tag_reference, "Collect Effect #Beam effect that links equipment to each collected projectile." },
	{ _field_terminator },
};
...
TAG_BLOCK(equipmentAbilityTypeEquipmentHackerBlock, 1)
{
	...
	{ _field_tag_reference, "cone effect#an effect that will shoot out of your face" },
	{ _field_tag_reference, "target effect#an effect that will play on the target" },
	{ _field_terminator },
};
...
{
	{ _field_tag_reference, "hologram spawner#reference the equipment that will spawn the hologram that will pilot the remote vehicle" },
	{ _field_tag_reference, "vehicle#reference the remote vehicle to be created" },
...
TAG_GROUP_INHERIT(equipment, EQUIPMENT_TAG, item, ITEM_TAG)
{
	...
	{ _field_real, "energy recovery time:seconds#after deactivation, energy stays constant for this long before starting to change by \'inactive energy rate\'" },
	...
	{ _field_char_enum, "pickup behavior" },
	{ _field_pad, "IJKMOP", 3 },
	...
	{ _field_pad, "LKSHFDIJ", 3 },
	{ _field_tag_reference, "hud screen reference" },
	{ _field_tag_reference, "pickup sound" },
	{ _field_tag_reference, "energy charged effect" },
	{ _field_tag_reference, "unable to activate sound" },
	{ _field_tag_reference, "Player sound bank#High quality player sound bank to be prefetched. Can be empty." },
