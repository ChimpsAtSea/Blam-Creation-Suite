...
{
	FIELD( _field_block, "prediction quanta", &cache_file_tag_resource_prediction_quantum_block ),
	FIELD( _field_block, "prediction atoms", &cache_file_tag_resource_prediction_atom_block ),
	FIELD( _field_block, "prediction molecule atoms", &cache_file_tag_resource_prediction_molecule_atom_reference_block ),
	FIELD( _field_block, "prediction molecules", &cache_file_tag_resource_prediction_molecule_block ),
	FIELD( _field_block, "prediction molecule keys", &cache_file_tag_resource_prediction_molecule_keys_block ),
	FIELD( _field_terminator )
};
...
TAG_GROUP(cache_file_resource_layout_table_block, CACHE_FILE_RESOURCE_LAYOUT_TABLE_TAG)
{
...
TAG_GROUP(cache_file_resource_gestalt_block, CACHE_FILE_RESOURCE_GESTALT_TAG)
{
