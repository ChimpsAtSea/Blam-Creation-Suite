...
TAG_STRUCT(creature_struct_definition)
{
	...
	FIELD( _field_block, "big battle weapon fire timing", &creature_scalar_timing_block ),
...
TAG_GROUP(big_battle_creature_block, BIG_BATTLE_CREATURE_TAG)
{
	FIELD( _field_custom, "CREATURE" ),
	FIELD( _field_long_flags, "flags" ),
	FIELD( _field_enum, "default team" ),
...
TAG_GROUP_INHERIT(creature_block, CREATURE_TAG, object, OBJECT_TAG)
{
	FIELD( _field_struct, "object", &object_struct_definition_struct_definition ),
	FIELD( _field_custom, "$$$ CREATURE $$$" ),
	FIELD( _field_long_flags, "flags" ),
