...
namespace blofeld
{
	...
	extern s_tag_struct big_battle_creature_block_struct;
	...
	extern s_tag_struct creature_scalar_timing_block_block_struct;
	extern s_tag_block_definition creature_scalar_timing_block_block;

	extern s_tag_struct creature_struct_definition_struct_definition; // tag group
