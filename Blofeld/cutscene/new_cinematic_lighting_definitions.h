...
namespace blofeld
{
	...
	extern s_tag_struct cinematic_dynamic_light_block_block_struct;
	extern s_tag_block_definition cinematic_dynamic_light_block_block;

	extern s_tag_struct new_cinematic_lighting_struct_definition_struct_definition; // tag group
