...
TAG_STRUCT(device_terminal_struct_definition)
{
	...
	FIELD( _field_block, "pages", &terminal_page_block_definition ),
	FIELD( _field_terminator )
};
...
TAG_GROUP_INHERIT(device_control_block, DEVICE_CONTROL_TAG, device, DEVICE_TAG)
{
	FIELD( _field_struct, "device", &device_struct_definition_struct_definition ),
	FIELD( _field_custom, "$$$ CONTROL $$$" ),
	FIELD( _field_enum, "type" ),
...
TAG_GROUP_INHERIT(device_block, DEVICE_TAG, object, OBJECT_TAG)
{
	FIELD( _field_struct, "object", &object_struct_definition_struct_definition ),
	FIELD( _field_custom, "$$$ DEVICE $$$" ),
	FIELD( _field_long_flags, "flags" ),
...
TAG_GROUP_INHERIT(device_dispenser_block, DEVICE_DISPENSER_TAG, device, DEVICE_TAG)
{
	FIELD( _field_struct, "device", &device_struct_definition_struct_definition ),
	FIELD( _field_custom, "DISPENSER" ),
	FIELD( _field_byte_flags, "flags" ),
...
TAG_GROUP_INHERIT(device_machine_block, DEVICE_MACHINE_TAG, device, DEVICE_TAG)
{
	FIELD( _field_struct, "device", &device_struct_definition_struct_definition ),
	FIELD( _field_explanation, "$$$ MACHINE $$$" ),
	FIELD( _field_enum, "type" ),
...
TAG_GROUP_INHERIT(device_terminal_block, DEVICE_TERMINAL_TAG, device, DEVICE_TAG)
{
	FIELD( _field_struct, "device", &device_struct_definition_struct_definition ),
	FIELD( _field_explanation, "$$$ TERMINAL $$$" ),
	FIELD( _field_long_integer, "bah bah" ),
