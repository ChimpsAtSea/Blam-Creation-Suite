...
TAG_BLOCK(phantom_types, k_maximum_phantom_types_per_physics_model)
{
	...
	{ _field_char_enum, "minimum size" },
	{ _field_char_enum, "maximum size" },
	{ _field_pad, "OF", 2 },
	{ _field_custom },
...
{
	{ _field_enum, "constraint type" },
	{ _field_custom_short_block_index, "constraint index" },
	{ _field_struct, "motor x" },
	{ _field_struct, "motor y" },
	{ _field_struct, "motor z" },
	{ _field_terminator },
};
...
TAG_BLOCK(physics_model_ragdoll_motors, 1)
{
	...
	{ _field_struct, "twist motor" },
	{ _field_explanation, "cone" },
	{ _field_struct, "cone motor" },
	{ _field_explanation, "plane" },
	{ _field_struct, "plane motor" },
	{ _field_terminator },
};
...
TAG_BLOCK(rigid_bodies, k_maximum_rigid_bodies_per_physics_model)
{
	...
	{ _field_char_enum, "motion type" },
	{ _field_explanation, "collision group override" },
	{ _field_char_enum, "proxy collision group" },
	{ _field_enum, "size" },
...
{
	{ _field_struct, "base" },
	{ _field_struct, "sphere shape" },
	{ _field_pad, "algn344", 12 },
	{ _field_struct, "translate shape" },
	{ _field_terminator },
};
...
{
	{ _field_struct, "base" },
	{ _field_struct, "sphere rep shape" },
	{ _field_long_integer, "num spheres*!" },
	{ _field_pad, "bull434", 12 },
	{ _field_array, "four vectors storage*!" },
	{ _field_terminator },
};
...
{
	{ _field_struct, "base" },
	{ _field_struct, "polyhedron shape" },
...
TAG_BLOCK(mopps, k_maximum_rigid_bodies_per_physics_model)
{
	...
	{ _field_struct, "childShapePointer!~" },
...
{
	{ _field_struct, "constraint bodies*!" },
...
{
	{ _field_struct, "bv shape" },
	{ _field_struct, "havok shape reference struct1" },
	{ _field_long_integer, "field pointer skip!~" },
	{ _field_long_integer, "child shape pointer!~" },
	{ _field_struct, "phantom shape" },
	{ _field_terminator },
};
...
TAG_GROUP(physics_model, PHYSICS_MODEL_TAG)
{
	...
	{ _field_block, "materials*", &materials$2_block },
