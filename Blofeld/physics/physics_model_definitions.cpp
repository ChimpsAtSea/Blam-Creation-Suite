...
namespace blofeld
{
	...
	{
		FIELD( _field_long_flags, "flags", &PhantomFlagsV2 ),
		...
		FIELD( _field_char_enum, "minimum size", &rigid_body_size_enum ),
		FIELD( _field_char_enum, "maximum size", &rigid_body_size_enum ),
	...
	{
		FIELD( _field_enum, "constraint type", &rigid_constraint_types_enum ),
	...
	{
		FIELD( _field_block, "nodes", &physics_model_powered_chain_nodes_block_block ),
		FIELD( _field_block, "constraints", &physics_model_powered_chain_constraints_block_block ),
		FIELD( _field_terminator )
	};
	...
	{
		FIELD( _field_enum, "type*!", &rigid_constraint_types_enum ),
		FIELD( _field_custom_short_block_index, "index*!" ),
		FIELD( _field_long_flags, "flags", &rigid_body_constraint_edge_constraint_flags_definition ),
		FIELD( _field_real, "friction#0 is the default (takes what it was set in max) anything else overrides that value" ),
		FIELD( _field_block, "ragdoll motors", &physics_model_ragdoll_motors_block_block ),
		FIELD( _field_block, "limited hinge motors", &physics_model_limited_hinge_motors_block_block ),
		FIELD( _field_terminator )
	};
	...
	TAG_BLOCK(physics_model_node_constraint_edge_block, k_maximum_node_constraint_edges_per_physics_model)
	{
		...
		FIELD( _field_block, "constraints*", &physics_model_constraint_edge_constraint_block_block ),
	...
	TAG_BLOCK(rigid_bodies_block, k_maximum_rigid_bodies_per_physics_model)
	{
		...
		FIELD( _field_word_flags, "flags", &rigid_body_flags ),
		FIELD( _field_short_block_index, "no phantom power alt" ),
		FIELD( _field_char_enum, "motion type", &rigid_body_motion_enum ),
		FIELD( _field_explanation, "collision group override" ),
		FIELD( _field_char_enum, "proxy collision group", &physics_material_proxy_collision_groups ),
		FIELD( _field_enum, "size", &rigid_body_size_enum ),
		...
		FIELD( _field_char_enum, "collision quality override type", &rigid_body_collision_quality_enum ),
	...
	{
		FIELD( _field_string_id, "name^*!" ),
		FIELD( _field_byte_flags, "flags", &physics_material_flags ),
	...
	TAG_BLOCK(multi_spheres_block, k_maximum_shapes_per_physics_model)
	{
		...
		FIELD( _field_array, "four vectors storage*!", &multi_sphere_vector_storage_array ),
		FIELD( _field_terminator )
	};
	...
	{
		FIELD( _field_string_id, "name^*!" ),
		FIELD( _field_block, "rigid bodies", &rigid_body_indices_block_block ),
		FIELD( _field_terminator )
	};
	...
	{
		FIELD( _field_string_id, "name^*!" ),
		FIELD( _field_block, "permutations", &permutations_block_block ),
		FIELD( _field_terminator )
	};
	...
	{
		FIELD( _field_string_id, "name^*!" ),
		FIELD( _field_word_flags, "flags", &nodes_flags ),
	...
	TAG_BLOCK(point_to_path_curve_block, k_maximum_rigid_bodies_per_physics_model)
	{
		...
		FIELD( _field_block, "points*!", &point_to_path_curve_point_block_block ),
		FIELD( _field_terminator )
	};
	...
	{
		FIELD( _field_real_vector_3d, "sphere*!" ),
		FIELD( _field_real, "havok w sphere*!!" ),
		FIELD( _field_terminator )
	};
	...
	TAG_STRUCT(havok_primitive_struct)
	{
		...
		FIELD( _field_byte_flags, "material flags*", &physics_material_flags ),
	...
	{
		FIELD( _field_enum, "shape type*", &shape_enum ),
	...
	{
		FIELD( _field_long_flags, "flags", &physics_model_flags ),
		...
		FIELD( _field_block, "damped spring motors", &physics_model_damped_spring_motor_block_block ),
		FIELD( _field_block, "position motors", &physics_model_position_motor_block_block ),
		FIELD( _field_block, "phantom types", &phantom_types_block_block ),
		FIELD( _field_block, "powered chains", &physics_model_powered_chains_block_block ),
		FIELD( _field_block, "node edges*", &physics_model_node_constraint_edge_block_block ),
		FIELD( _field_block, "rigid bodies*", &rigid_bodies_block_block ),
		FIELD( _field_block, "materials*", &materials_block$3_block ),
		FIELD( _field_block, "spheres*", &spheres_block_block ),
		FIELD( _field_block, "multi spheres*", &multi_spheres_block_block ),
		FIELD( _field_block, "pills*", &pills_block_block ),
		FIELD( _field_block, "boxes*", &boxes_block_block ),
		FIELD( _field_block, "triangles*", &triangles_block_block ),
		FIELD( _field_block, "polyhedra*", &polyhedra_block_block ),
		FIELD( _field_block, "polyhedron four vectors*!", &polyhedron_four_vectors_block_block ),
		FIELD( _field_block, "polyhedron plane equations*!", &polyhedron_plane_equations_block_block ),
		FIELD( _field_block, "mass distributions*!", &mass_distributions_block_block ),
		FIELD( _field_block, "lists*!", &lists_block_block ),
		FIELD( _field_block, "list shapes*!", &list_shapes_block_block ),
		FIELD( _field_block, "mopps*!", &mopps_block_block ),
		FIELD( _field_data, "mopp codes*!" ),
		FIELD( _field_block, "hinge constraints*!", &hinge_constraints_block_block ),
		FIELD( _field_block, "ragdoll constraints*!", &ragdoll_constraints_block_block ),
		FIELD( _field_block, "regions*", &regions_block_block ),
		FIELD( _field_block, "nodes*", &nodes_block_block ),
		FIELD( _field_block, "errors*!", &global_error_report_categories_block_block ),
		FIELD( _field_block, "point to path curves*!", &point_to_path_curve_block_block ),
		FIELD( _field_block, "limited hinge constraints*!", &limited_hinge_constraints_block_block ),
		FIELD( _field_block, "ball and socket constraints*!", &ball_and_socket_constraints_block_block ),
		FIELD( _field_block, "stiff spring constraints*!", &stiff_spring_constraints_block_block ),
		FIELD( _field_block, "prismatic constraints*!", &prismatic_constraints_block_block ),
		FIELD( _field_block, "phantoms*!", &phantoms_block_block ),
	...
	{
		FIELD( _field_enum, "motor type", &physics_model_motor_types_enum ),
		FIELD( _field_custom_short_block_index, "index" ),
		FIELD( _field_terminator )
	};
	...
	TAG_ENUM(physics_material_flags, 2)
	{
		OPTION("supresses effects"),
		OPTION("force enable collision with player#enables collision with the player regardless of the collision group"),
	};

	TAG_ENUM(PhantomFlagsV2, 31)
	{
		OPTION("UNUSED"),
		OPTION("use acc as force"),
		OPTION("negates gravity"),
		OPTION("ignores players"),
		OPTION("ignores nonplayers"),
		OPTION("ignores bipeds"),
		OPTION("ignores vehicles"),
		OPTION("ignores weapons"),
		OPTION("ignores equipment"),
		OPTION("ignores projectiles"),
		OPTION("ignores scenery"),
		OPTION("ignores devices"),
		OPTION("ignores crates"),
		OPTION("ignores creatures"),
		OPTION("ignores giants"),
		OPTION("ignores spawners"),
		OPTION("ignores mechs"),
		OPTION("ignores team objects"),
		OPTION("smart directional acceleration"),
		OPTION("ignores grounded bipeds"),
		OPTION("localizes physics"),
		OPTION("disable linear damping"),
		OPTION("disable angular damping"),
		OPTION("ignores dead bipeds"),
		OPTION("ignores live bipeds"),
		OPTION("reciprocal acc"),
		OPTION("reciprocal acc ONLY"),
		OPTION("latching disabled"),
		OPTION("mirrored axis"),
		OPTION("activate ragdolls"),
		OPTION("ignores forge editor"),
	};

	TAG_ENUM(rigid_body_size_enum, 7)
	{
		OPTION("default"),
		OPTION("tiny"),
		OPTION("small"),
	...
	TAG_ENUM(physics_material_proxy_collision_groups, 21)
	{
		OPTION("NONE"),
		OPTION("small crate"),
		OPTION("crate"),
		...
		OPTION("only collide with environment"),
	...
	TAG_ENUM(physics_model_flags, 4)
	{
		OPTION("mopp codes dirty*!"),
		OPTION("serialized havok data converted to target platform!*"),
		OPTION("make physical children keyframed"),
		OPTION("shrink radius by havok complex radius"),
	};

	TAG_ENUM(rigid_constraint_types_enum, 7)
	{
		OPTION("hinge"),
		OPTION("limited hinge"),
		OPTION("ragdoll"),
		OPTION("stiff spring"),
		OPTION("ball and socket"),
		OPTION("prismatic"),
		OPTION("powered chain"),
	};

	TAG_ENUM(physics_model_motor_types_enum, 3)
	{
		OPTION("none"),
		OPTION("damped spring"),
		OPTION("stongest force"),
	};

	TAG_ENUM(rigid_body_constraint_edge_constraint_flags_definition, 4)
	{
		OPTION("is physical child#this constraint will only be created when this object is a child of another physical object (turrets on vehicles for example)"),
		OPTION("is rigid#this constraint makes the edge rigid until it is loosened by damage"),
		OPTION("disable effects#this constraint will not generate impact effects"),
		OPTION("not created automatically#this flag is used for special systems that need to create constraints dynamically"),
	};

	TAG_ENUM(nodes_flags, 1)
	{
		OPTION("does not animate"),
	};

	TAG_ENUM(rigid_body_flags, 8)
	{
		OPTION("has no phantom power version#don\'t check this flag without talking to eamon"),
		OPTION("infinite intertia tensor#rigid body will never have angular velocity"),
		OPTION("can use mopps#this flag was invented for the behemoth and is dangerous to use anywhere else (obsolete)!"),
		OPTION("Havok rigid body#rigid body properties like center of mass and inertia tensor come from Havok Content Tools (and shouldn\'t be edited in Bonobo)"),
		OPTION("explicit mass#the mass is explicit, and not computed based on volume and density"),
		OPTION("absolute center of mass#the \'center of mass offset\' is relative to the pivot and not to the computed center"),
		OPTION("force keyframed#rigid body is always keyframed and can\'t be overriden to dynamic or fixed"),
		OPTION("force not cut NavMesh#this rigid body will not generate a cutting silhouette"),
	};

	TAG_ENUM(rigid_body_motion_enum, 6)
	{
		OPTION("sphere"),
		OPTION("stabilized sphere"),
		OPTION("box"),
		OPTION("stabilized box"),
		OPTION("keyframed"),
		OPTION("fixed"),
	};

	TAG_ENUM(rigid_body_collision_quality_enum, 7)
	{
		OPTION("none"),
		OPTION("debris_simple_toi"),
		OPTION("moving"),
		OPTION("critical"),
		OPTION("bullet"),
		OPTION("character"),
