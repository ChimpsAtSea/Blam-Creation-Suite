...
namespace blofeld
{
	...
	extern s_tag_struct_definition cheap_particle_type_block_block_struct;
	extern s_tag_block_definition cheap_particle_type_block_block;
	extern s_tag_struct_definition cheap_particle_bitmap_reference_block_block_struct;
	extern s_tag_block_definition cheap_particle_bitmap_reference_block_block;
	extern s_tag_struct_definition cheapParticleTurbulenceTypeBlock_block_struct;
