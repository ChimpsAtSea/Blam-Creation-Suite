...
namespace blofeld
{
	...
	{
		FIELD( _field_array, "runtime gpu_property_sub_array!", &gpu_property_sub_array_array ),
		FIELD( _field_terminator )
	};

	TAG_BLOCK(gpu_function_block, k_max_gpu_functions)
	{
		FIELD( _field_array, "runtime gpu_function_sub_array!", &gpu_function_sub_array_array ),
		FIELD( _field_terminator )
	};

	TAG_BLOCK(gpu_color_block, k_max_gpu_colors)
	{
		FIELD( _field_array, "runtime gpu_color_sub_array!", &gpu_color_sub_array_array ),
		FIELD( _field_terminator )
	};
