...
TAG_STRUCT(camera_shake_struct)
{
		...
		FIELD( _field_enum, "wobble function#a function to perturb the effect\'s behavior over time", &global_periodic_functions_enum ),
		FIELD( _field_explanation, "animated camera shake" ),
		FIELD( _field_char_enum, "animated shake playback", &animated_camera_shake_playback_type_enum ),
		FIELD( _field_char_enum, "animated shake weight", &animated_camera_shake_weight_type_enum ),
