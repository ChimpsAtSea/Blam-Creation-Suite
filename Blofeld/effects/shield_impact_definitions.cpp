...
TAG_GROUP(shield_impact, SHIELD_IMPACT_TAG)
{
	...
	FIELD( _field_struct, "Edge Glow Color" ),
	FIELD( _field_struct, "Edge Glow Intensity" ),
	FIELD( _field_custom ),
	...
	FIELD( _field_struct, "Plasma Center Color" ),
	FIELD( _field_struct, "Plasma Center Intensity" ),
	FIELD( _field_struct, "Plasma Edge Color" ),
	FIELD( _field_struct, "Plasma Edge Intensity" ),
	FIELD( _field_custom ),
	...
	FIELD( _field_struct, "Extrusion Amount" ),
	FIELD( _field_struct, "Oscillation Amplitude" ),
	FIELD( _field_custom ),
	FIELD( _field_custom, "Hit Response" ),
	FIELD( _field_explanation, "Hit Response" ),
	FIELD( _field_real, "Hit Time:seconds" ),
	FIELD( _field_struct, "Hit Color" ),
	FIELD( _field_struct, "Hit Intensity" ),
	FIELD( _field_struct, "Hit Radius" ),
