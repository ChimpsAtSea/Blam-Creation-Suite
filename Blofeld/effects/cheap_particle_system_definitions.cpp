...
TAG_STRUCT(cheap_particle_type_library_struct_definition)
{
	...
	FIELD( _field_block, "types", &cheap_particle_type_block ),
	FIELD( _field_block, "textures", &cheap_particle_bitmap_reference_block ),
	FIELD( _field_tag_reference, "random:texture used to generate random values per particle" ),
	FIELD( _field_block, "turbulence types", &cheapParticleTurbulenceTypeBlock ),
...
TAG_GROUP(cheap_particle_emitter_block, CHEAP_PARTICLE_EMITTER_TAG)
{
	FIELD( _field_word_flags, "flags" ),
	FIELD( _field_word_integer, "version!" ),
	FIELD( _field_real, "spawn rate!:particles per second" ),
...
TAG_GROUP(cheap_particle_type_library_block, CHEAP_PARTICLE_TYPE_LIBRARY_TAG)
{
	FIELD( _field_custom, "compile" ),
	FIELD( _field_block, "types", &cheap_particle_type_block ),
	FIELD( _field_block, "textures", &cheap_particle_bitmap_reference_block ),
