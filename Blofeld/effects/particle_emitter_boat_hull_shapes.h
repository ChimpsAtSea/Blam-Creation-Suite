...
namespace blofeld
{
	...
	extern s_tag_struct particle_emitter_boat_hull_group_block_block_struct;
	extern s_tag_block_definition particle_emitter_boat_hull_group_block_block;

	extern s_tag_struct particle_emitter_boat_hull_shape_struct_definition_struct_definition; // tag group
