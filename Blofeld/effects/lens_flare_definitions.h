...
namespace blofeld
{
	...
	extern s_tag_struct_definition lens_flare_reflection_block_block_struct;
	extern s_tag_block_definition lens_flare_reflection_block_block;
	extern s_tag_struct_definition lens_flare_scalar_animation_block_block_struct;
	extern s_tag_block_definition lens_flare_scalar_animation_block_block;
	extern s_tag_struct_definition lens_flare_color_animation_block_block_struct;
