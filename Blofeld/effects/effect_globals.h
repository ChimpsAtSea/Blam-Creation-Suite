...
namespace blofeld
{
	...
	extern s_tag_struct_definition effect_component_holdback_block_block_struct;
	extern s_tag_block_definition effect_component_holdback_block_block;
	extern s_tag_struct_definition effect_component_holdbacks_block_block_struct;
	extern s_tag_block_definition effect_component_holdbacks_block_block;
	extern s_tag_struct_definition effect_global_spawn_effects_block_block_struct;
