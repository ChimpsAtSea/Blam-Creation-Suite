...
TAG_STRUCT(model_dissolve_definition_struct_definition)
{
	...
	FIELD( _field_block, "per-region time offset", &modelDissolvePerRegionTimeOffsetBlock ),
...
TAG_GROUP(model_dissolve_definition_block, MODEL_DISSOLVE_DEFINITION_TAG)
{
	FIELD( _field_byte_flags, "flags" ),
	FIELD( _field_char_enum, "particle spawn position" ),
	FIELD( _field_pad, "graaag", 2 ),
