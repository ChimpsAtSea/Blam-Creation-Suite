...
namespace blofeld
{
	...
	{
		FIELD( _field_array, "runtime m_count!", &gpu_single_constant_register_array_array ),
	...
	{
		FIELD( _field_array, "runtime gpu_sprite_array!", &gpu_single_constant_register_array_array ),
		FIELD( _field_terminator )
	};
	...
	{
		FIELD( _field_real, "runtime gpu_real!" ),
		FIELD( _field_terminator )
	};
