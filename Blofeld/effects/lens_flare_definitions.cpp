...
TAG_BLOCK(lens_flare_reflection, k_maximum_reflections_per_lens_flare)
{
	...
	FIELD( _field_struct, "radius curve#interpolated by external input" ),
	FIELD( _field_struct, "scale curve X#interpolated by external input" ),
	FIELD( _field_struct, "scale curve Y#interpolated by external input" ),
	FIELD( _field_struct, "brightness curve#interpolated by external input" ),
	FIELD( _field_explanation, "TINT COLOR" ),
	FIELD( _field_struct, "color curve#interpolated by external input" ),
...
{
	FIELD( _field_struct, "color animation" ),
	FIELD( _field_terminator )
};
