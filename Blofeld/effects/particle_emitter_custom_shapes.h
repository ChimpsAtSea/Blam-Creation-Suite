...
namespace blofeld
{
	...
	extern s_tag_struct particle_emitter_custom_point_block_block_struct;
	extern s_tag_block_definition particle_emitter_custom_point_block_block;

	extern s_tag_struct particle_emitter_custom_points_struct_definition_struct_definition; // tag group
