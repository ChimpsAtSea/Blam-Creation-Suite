...
{
	FIELD( _field_block, "faces*", &map_leaf_face_block_block ),
	FIELD( _field_block, "connection indices*", &map_leaf_connection_index_block_block ),
...
TAG_BLOCK(map_leaf_face_block, MAXIMUM_FACES_PER_MAP_LEAF)
{
	...
	FIELD( _field_block, "vertices*", &map_leaf_face_vertex_block_block ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(global_leaf_connection_block, MAXIMUM_CONNECTIONS_PER_LEAF_MAP)
{
	...
	FIELD( _field_block, "vertices*", &leaf_connection_vertex_block_block ),
