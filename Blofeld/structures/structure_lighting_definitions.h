...
namespace blofeld
{
	...
	extern s_tag_struct structure_lighting_generic_light_definition_block_block_struct;
	extern s_tag_block_definition structure_lighting_generic_light_definition_block_block;
	extern s_tag_struct structure_lighting_generic_light_instance_block_block_struct;
	extern s_tag_block_definition structure_lighting_generic_light_instance_block_block;
	extern s_tag_struct screen_space_light_shader_override_block_block_struct;
	...
	extern s_tag_struct structureLightingCinematicObjectBlock_block_struct;
	extern s_tag_block_definition structureLightingCinematicObjectBlock_block;

	extern s_tag_struct scenario_structure_lighting_info_struct_definition_struct_definition; // tag group
