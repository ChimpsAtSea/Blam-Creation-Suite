...
{
	FIELD( _field_block, "original vertices*!", &structure_seam_original_vertex_block ),
	FIELD( _field_terminator )
};

TAG_STRUCT(structure_seam_final_geometry_struct)
{
	FIELD( _field_block, "planes*!", &structure_seam_final_planes_block ),
	FIELD( _field_block, "points*!", &structure_seam_final_points_block ),
	FIELD( _field_block, "triangles*!", &structure_seam_final_triangles_block ),
	FIELD( _field_block, "edges*!", &structure_seam_final_edges_block ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(structure_seam_original_vertex_block, k_structure_seam_maximum_points_count)
{
	...
	FIELD( _field_block, "plane normals*", &structure_seam_original_vertex_plane_normals_block ),
	FIELD( _field_terminator )
};
...
TAG_GROUP(structure_seams_block, STRUCTURE_SEAMS_TAG)
{
	FIELD( _field_struct, "structure manifest*", &structure_manifest_struct_struct_definition ),
	FIELD( _field_explanation, "This tag defines the geometry between seam connected structures bsp." ),
	FIELD( _field_long_integer, "version*!" ),
