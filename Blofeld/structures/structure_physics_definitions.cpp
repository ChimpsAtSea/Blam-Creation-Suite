...
TAG_BLOCK(structure_water_instances_block, k_maximum_structure_water_instances)
{
	...
	FIELD( _field_block, "water planes block!*", &structure_water_instance_planes_block_block ),
	FIELD( _field_block, "water debug triangles block!*", &structure_water_instance_debug_triangles_block_block ),
...
TAG_STRUCT(global_structure_physics_design_struct)
{
	...
	FIELD( _field_block, "water mopp code!*", &mopp_code_definition_block_block ),
