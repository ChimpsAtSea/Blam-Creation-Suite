...
{
	FIELD( _field_block, "planar fogs", &planar_fog_definition_block ),
...
TAG_BLOCK(planar_fog_definition_block, s_planer_fog_set_definition::k_maximum_planar_fog_count)
{
	...
	FIELD( _field_block, "vertices*", &planar_fog_vertex_block ),
	FIELD( _field_block, "triangles*", &planar_fog_triangle_block ),
...
{
	FIELD( _field_block, "planes*", &planar_fog_triangle_planes_block ),
	FIELD( _field_terminator )
};
...
TAG_GROUP(planar_fog_parameters_block, PLANAR_FOG_PARAMETERS_TAG)
{
	FIELD( _field_word_flags, "flags" ),
	FIELD( _field_pad, "ABCDadf", 2 ),
	FIELD( _field_real, "fog thickness [0.0 to 1.0]" ),
