...
TAG_STRUCT(SpawnSettings_struct_definition)
{
	...
	FIELD( _field_block, "Spawn Settings", &influencerSpawnSettingsBlock ),
	FIELD( _field_explanation, "ENEMY FORBID" ),
	FIELD( _field_real, "ef full weight radius:wu" ),
	FIELD( _field_real, "ef fall-off radius:wu" ),
	FIELD( _field_block, "ef falloff function#Multiplier applied to weight (domain is full weight radius to fall-off radius, range should be 0 to 1).", &spawn_influence_weight_falloff_function_block ),
	...
	FIELD( _field_block, "eb falloff function#Multiplier applied to weight (domain is full weight radius to fall-off radius, range should be 0 to 1).", &spawn_influence_weight_falloff_function_block ),
	...
	FIELD( _field_block, "ab falloff function#Multiplier applied to weight (domain is full weight radius to fall-off radius, range should be 0 to 1).", &spawn_influence_weight_falloff_function_block ),
	...
	FIELD( _field_block, "sab falloff function#Multiplier applied to weight (domain is full weight radius to fall-off radius, range should be 0 to 1).", &spawn_influence_weight_falloff_function_block ),
	...
	FIELD( _field_block, "dt falloff function#Multiplier applied to weight (domain is full weight radius to fall-off radius, range should be 0 to 1).", &spawn_influence_weight_falloff_function_block ),
	...
	FIELD( _field_block, "Drop Pod falloff function#Multiplier applied to weight (domain is full weight radius to fall-off radius, range should be 0 to 1).", &spawn_influence_weight_falloff_function_block ),
	...
	FIELD( _field_block, "Auto Turret falloff function#Multiplier applied to weight (domain is full weight radius to fall-off radius, range should be 0 to 1).", &spawn_influence_weight_falloff_function_block ),
	...
	FIELD( _field_block, "weapon influencers", &weaponSpawnInfluenceBlock ),
	FIELD( _field_explanation, "VEHICLE INFLUENCERS" ),
	FIELD( _field_block, "vehicle influencers", &vehicleSpawnInfluenceBlock ),
	FIELD( _field_explanation, "PROJECTILE INFLUENCERS" ),
	FIELD( _field_block, "projectile influencers", &projectileSpawnInfluenceBlock ),
	FIELD( _field_explanation, "EQUIPMENT INFLUENCERS" ),
	FIELD( _field_block, "equipment influencers", &equipmentSpawnInfluenceBlock ),
...
TAG_GROUP(SpawnSettings_block, SPAWNSETTINGS_TAG)
{
	FIELD( _field_real, "minimum spawn time:seconds#Absolute floor.  Used to put a few-frame delay between death and instaspawn.  Will not override longer minimum times." ),
	FIELD( _field_real, "min acceptable spawn score#spawns with a score lower than this will never be used" ),
	FIELD( _field_explanation, "Spawn Randomization" ),
