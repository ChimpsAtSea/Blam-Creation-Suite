...
TAG_BLOCK(active_camo_globals, 1)
{
	...
	FIELD( _field_struct, "camo value to distortion" ),
	FIELD( _field_struct, "camo value to transparency#maps active-camo percentage to alpha for THIRD PERSON rendering" ),
	FIELD( _field_struct, "camo value to fp transparency#maps active-camo percentage to alpha for FIRST PERSON rendering" ),
	FIELD( _field_struct, "camo distortion texture strength" ),
	...
	FIELD( _field_struct, "camo depth bias function#This is used to deal with ugly rendering artifacts when camo is not fully on" ),
...
TAG_BLOCK(active_camo_level_definition, k_number_of_active_camo_levels)
{
	...
	FIELD( _field_struct, "speed to maximum camo" ),
	FIELD( _field_terminator )
};
