...
TAG_STRUCT(globals_struct_definition)
{
	...
	FIELD( _field_block, "sounds", &sound_block$2 ),
	...
	FIELD( _field_block, "interface tags", &interface_tag_references ),
	...
	FIELD( _field_block, "Hologram Lighting", &hologramLightingGlobalsBlock ),
...
TAG_GROUP(globals_block, GLOBALS_TAG)
{
	FIELD( _field_pad, "YJLTWDSL", 172 ),
	FIELD( _field_long_enum, "language" ),
	FIELD( _field_block, "havok cleanup resources", &havok_cleanup_resources_block ),
...
TAG_GROUP(patch_globals_block, PATCH_GLOBALS_TAG)
{
	FIELD( _field_struct, "language pack1!", &language_pack_definition_struct_definition ),
	FIELD( _field_struct, "language pack2!", &language_pack_definition_struct_definition ),
	FIELD( _field_struct, "language pack3!", &language_pack_definition_struct_definition ),
