...
TAG_GROUP(globals, GLOBALS_TAG)
{
	...
	FIELD( _field_block, "havok cleanup resources", &havok_cleanup_resources_block ),
	FIELD( _field_block, "sound globals", &sound_globals_block ),
	FIELD( _field_explanation, "AI globals" ),
	FIELD( _field_block, "DEPRECATED{ai globals}*!", &ai_globals_data_block ),
	FIELD( _field_tag_reference, "ai globals ref" ),
	FIELD( _field_block, "damage table", &game_globals_damage_block ),
	FIELD( _field_block, "sounds", &sound$2_block ),
	FIELD( _field_block, "camera", &camera_block ),
	FIELD( _field_block, "controller input", &controller_input_block ),
	FIELD( _field_block, "player control", &player_control_block ),
	FIELD( _field_block, "default player traits", &game_engine_player_traits_block ),
	FIELD( _field_block, "difficulty", &difficulty_block ),
	FIELD( _field_block, "co-op difficulty", &coop_difficulty_block ),
	FIELD( _field_block, "soft ceilings", &soft_ceiling_globals_block ),
	FIELD( _field_block, "interface tags", &interface_tag_references_block ),
	FIELD( _field_block, "@weapon list (update _weapon_list enum in game_globals.h)", &cheat_weapons_block ),
	FIELD( _field_block, "@cheat powerups", &cheat_powerups_block ),
	FIELD( _field_block, "@player information", &player_information_block ),
	FIELD( _field_block, "@player representation", &player_representation_block ),
	FIELD( _field_block, "damage{falling damage}", &damage_globals_block ),
	FIELD( _field_block, "shield boost", &shield_boost_block ),
	FIELD( _field_block, "materials", &materials_block ),
	FIELD( _field_block, "profile colors", &multiplayer_color_block ),
	FIELD( _field_block, "emblem colors", &multiplayer_color_block ),
	FIELD( _field_block, "visor colors", &visor_color_block ),
	FIELD( _field_custom, "Elite specular colors" ),
	FIELD( _field_struct, "elite specular color" ),
	FIELD( _field_custom ),
	...
	FIELD( _field_block, "cinematics globals", &cinematics_globals_block ),
	FIELD( _field_block, "campaign metagame globals", &campaign_metagame_globals_block ),
	FIELD( _field_tag_reference, "game medal globals" ),
	FIELD( _field_struct, "language pack1!" ),
	FIELD( _field_struct, "language pack2!" ),
	FIELD( _field_struct, "language pack3!" ),
	FIELD( _field_struct, "language pack4!" ),
	FIELD( _field_struct, "language pack5!" ),
	FIELD( _field_struct, "language pack6!" ),
	FIELD( _field_struct, "language pack7!" ),
	FIELD( _field_struct, "language pack8!" ),
	FIELD( _field_struct, "language pack9!" ),
	FIELD( _field_struct, "language pack10!" ),
	FIELD( _field_struct, "language pack11!" ),
	FIELD( _field_struct, "language pack12!" ),
	FIELD( _field_struct, "language pack13!" ),
	FIELD( _field_struct, "language pack14!" ),
	FIELD( _field_struct, "language pack15!" ),
	FIELD( _field_struct, "language pack16!" ),
	FIELD( _field_struct, "language pack17!" ),
	...
	FIELD( _field_block, "active camo", &active_camo_globals_block ),
	...
	FIELD( _field_block, "camera impulse", &global_camera_impulse_block ),
	FIELD( _field_block, "runtime materials*!", &runtime_materials_block ),
