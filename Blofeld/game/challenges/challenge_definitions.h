...
namespace blofeld
{
	...
	extern s_tag_struct challenge_category_block_block_struct;
	extern s_tag_block_definition challenge_category_block_block;
	extern s_tag_struct challenge_block_block_struct;
	extern s_tag_block_definition challenge_block_block;

	extern s_tag_struct challenge_globals_definition_struct_definition_struct_definition; // tag group
