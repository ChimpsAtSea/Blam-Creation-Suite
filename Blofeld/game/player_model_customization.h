...
namespace blofeld
{
	...
	extern s_tag_struct customized_model_selection_block_block_struct;
	extern s_tag_block_definition customized_model_selection_block_block;
	extern s_tag_struct customized_model_player_bits_block_block_struct;
	extern s_tag_block_definition customized_model_player_bits_block_block;

	extern s_tag_struct player_model_customization_globals_struct_definition_struct_definition; // tag group
