...
namespace blofeld
{
	...
	extern s_tag_struct aural_enhancement_audio_settings_block_block_struct;
	extern s_tag_block_definition aural_enhancement_audio_settings_block_block;

	extern s_tag_struct armormod_globals_struct_definition_struct_definition; // tag group
