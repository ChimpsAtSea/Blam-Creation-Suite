...
TAG_BLOCK(game_completion_rewards_definition, eCT_count)
{
	...
	{ _field_block, "apm falloff curve{cpm falloff curve}#amount per minute falloff curve; used to provide diminishing returns for longer play time", &game_completion_rewards_falloff_point_block },
	{ _field_terminator },
};
