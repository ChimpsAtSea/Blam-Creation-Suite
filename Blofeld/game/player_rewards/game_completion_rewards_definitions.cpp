...
TAG_BLOCK(game_completion_rewards_difficulty, 1)
{
	...
	FIELD( _field_block, "heroic matchmaking#this block is used for heroic matchmade games", &game_completion_rewards_definition_block ),
	FIELD( _field_block, "legendary matchmaking#this block is used for legendary matchmade games", &game_completion_rewards_definition_block ),
...
TAG_BLOCK(game_completion_rewards_definition, eCT_count)
{
	...
	FIELD( _field_block, "apm falloff curve{cpm falloff curve}#amount per minute falloff curve; used to provide diminishing returns for longer play time", &game_completion_rewards_falloff_point_block ),
	FIELD( _field_terminator )
};
...
TAG_BLOCK(game_completion_rewards_multiplayer, 1)
{
	...
	FIELD( _field_block, "custom#this block is used for custom games", &game_completion_rewards_definition_block ),
	FIELD( _field_block, "unused0!", &game_completion_rewards_definition_block ),
	FIELD( _field_block, "unused1!", &game_completion_rewards_definition_block ),
	FIELD( _field_block, "unused2!", &game_completion_rewards_definition_block ),
	FIELD( _field_terminator )
};
