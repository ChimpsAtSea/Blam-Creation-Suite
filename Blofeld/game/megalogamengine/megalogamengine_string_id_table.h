...
namespace blofeld
{
	...
	extern s_tag_struct megalo_string_id_block_block_struct;
	extern s_tag_block_definition megalo_string_id_block_block;
	extern s_tag_struct megalo_string_id_to_sprite_index_block_block_struct;
	extern s_tag_block_definition megalo_string_id_to_sprite_index_block_block;

	extern s_tag_struct megalo_string_id_table_struct_definition_struct_definition; // tag group
