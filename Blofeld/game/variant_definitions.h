...
namespace blofeld
{
	...
	extern s_tag_struct single_variant_block_block_struct;
	extern s_tag_block_definition single_variant_block_block;
	extern s_tag_struct FallbackHopperFileBlock_block_struct;
	extern s_tag_block_definition FallbackHopperFileBlock_block;

	extern s_tag_struct variant_globals_struct_definition_struct_definition; // tag group
