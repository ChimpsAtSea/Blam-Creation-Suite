...
{
	{ _field_long_flags, "general flags" },
	{ _field_enum, "type" },
	...
	{ _field_enum, "follower positioning#where should my followers try and position themselves when I am their leader\?" },
	...
	{ _field_enum, "default grenade type" },
	{ _field_enum, "behavior tree root" },
	{ _field_block, "disallowed weapons from trading", &disallowed_weapons_for_trading_block },
	{ _field_tag_reference, "Initial Primary Weapon #Overrides initial primary weapon set in unit tag." },
	{ _field_tag_reference, "Initial Secondary Weapon #Overrides initial secondary weapon set in unit tag." },
	{ _field_tag_reference, "Initial Equipment #Fallback used if initial equipment not specified as drop item or in scenario." },
	{ _field_terminator },
};
...
{
	{ _field_enum, "Proto Spawn Type #Can be used to automatically setup a character to be spawned by another character." },
...
{
	{ _field_enum, "highest prop class^#The prop class that this block is describing" },
...
{
	{ _field_long_flags, "vitality flags" },
	...
	{ _field_tag_reference, "resurrect weapon#If I\'m being automatically resurrected then I pull out a ..." },
...
TAG_BLOCK(character_perception, c_character_perception_properties_internal::k_block_count)
{
	...
	{ _field_struct, "normal active camo perception" },
	{ _field_custom },
	{ _field_custom, "Legendary active-camo perception" },
	{ _field_struct, "legendary active camo perception" },
	{ _field_custom },
	{ _field_terminator },
};
...
{
	{ _field_long_flags, "Hopping Flags" },
...
TAG_BLOCK(characterHopDefinitionBlock, 1)
{
	...
	{ _field_struct, "Default" },
	{ _field_custom },
	{ _field_custom, "Passive" },
	{ _field_struct, "Passive" },
	{ _field_custom },
	{ _field_custom, "Aggressive" },
	{ _field_struct, "Aggressive" },
	{ _field_custom },
	{ _field_terminator },
};
...
{
	{ _field_long_flags, "movement flags" },
	...
	{ _field_enum, "obstacle leap min size" },
	{ _field_enum, "obstacle leap max size" },
	{ _field_enum, "obstacle ignore size" },
	{ _field_enum, "obstacle smashable size" },
	{ _field_pad, "RQEMJY", 2 },
	{ _field_enum, "jump height" },
	...
	{ _field_long_flags, "movement hints" },
	...
	{ _field_custom },
	{ _field_struct, "smooth throttle#Allows characters to be smooth throttle changes." },
	{ _field_struct, "smooth stopping#Allows characters to slow down smoothly when stopping." },
	{ _field_terminator },
};
...
{
	{ _field_enum, "combat status#When combat status is bigger or equal to this combat status, use the throttle settings below." },
	{ _field_word_flags, "flags" },
...
TAG_BLOCK(character_throttle_style, c_character_throttle_style_properties_internal::k_block_count)
{
	...
	{ _field_struct, "acceleration function#Defines throttle as a function of time from start of style application" },
	{ _field_real, "deceleration distance:wu" },
	{ _field_struct, "deceleration function#Defines throttle as a function of distance from the goal" },
...
TAG_BLOCK(character_engage, c_character_engage_properties_internal::k_block_count)
{
	...
	{ _field_tag_reference, "override grenade projectile#when I throw a grenade, forget what type I officially have: throw this type of projectile instead" },
...
{
	{ _field_long_flags, "Charge flags" },
	...
	{ _field_tag_reference, "berserk weapon#when I berserk, I pull out a ..." },
...
{
	{ _field_long_flags, "Retreat flags" },
	...
	{ _field_tag_reference, "backup weapon#If I want to flee and I don\'t have flee animations with my current weapon, throw it away and try a ..." },
	{ _field_terminator },
};

TAG_BLOCK(character_search, c_character_search_properties_internal::k_block_count)
{
	{ _field_long_flags, "Search flags" },
...
{
	{ _field_long_flags, "Pre-search flags" },
...
TAG_BLOCK(character_engineer, c_character_engineer_properties_internal::k_block_count)
{
	...
	{ _field_tag_reference, "proximity equipment#if target enters radius and detonation is not chosen, deploy this equipment." },
	{ _field_terminator },
};
...
{
	{ _field_long_flags, "weapons flags" },
	{ _field_tag_reference, "weapon^" },
	...
	{ _field_enum, "special-fire mode#the type of special weapon fire that we can use" },
	{ _field_enum, "special-fire situation#when we will decide to use our special weapon fire mode" },
	...
	{ _field_tag_reference, "weapon melee damage" },
	{ _field_terminator },
};
...
{
	{ _field_long_flags, "grenades flags" },
	{ _field_enum, "grenade type#type of grenades that we throw^" },
	{ _field_enum, "trajectory type#how we throw our grenades" },
	{ _field_pad, "YZNPI", 2 },
...
{
	{ _field_tag_reference, "unit^" },
	{ _field_tag_reference, "style^" },
	...
	{ _field_long_flags, "vehicle flags" },
...
{
	{ _field_tag_reference, "ranged character" },
	{ _field_tag_reference, "tank character" },
	{ _field_tag_reference, "stealth character" },
	{ _field_tag_reference, "morph muffins" },
	{ _field_tag_reference, "ranged weapon" },
	{ _field_tag_reference, "tank weapon" },
	{ _field_tag_reference, "stealth weapon" },
	...
	{ _field_tag_reference, "spew infection character#What character should I throw up all over my target\? Carrots\?" },
...
TAG_BLOCK(character_equipment, 8)
{
	...
	{ _field_tag_reference, "equipment#The equipment item that is to be usable" },
	{ _field_long_flags, "flags" },
...
TAG_BLOCK(character_equipment_usage, k_character_equipment_usage_when_count)
{
	...
	{ _field_enum, "use when^#When should we use this equipment\?" },
	{ _field_enum, "use how#How should we use this equipment\?" },
	{ _field_explanation, "Skip Fraction" },
...
TAG_BLOCK(character_stimuli_response, k_max_character_stimuli_responses)
{
	...
	{ _field_tag_reference, "override character" },
	{ _field_terminator },
};
...
{
	{ _field_tag_reference, "junk collect effect" },
	{ _field_tag_reference, "junk attack effect" },
	...
	{ _field_tag_reference, "shield effect" },
	{ _field_tag_reference, "shield crate" },
	...
	{ _field_tag_reference, "repair beam effect" },
	{ _field_tag_reference, "repair crate" },
	...
	{ _field_tag_reference, "Resurrection Ground Effect #The effect created on the ground when resurrecting a dead ally." },
	{ _field_tag_reference, "Res. Area Scan Start Effect #The effect created on the ground when scanning for a clear area before resurrection." },
	{ _field_tag_reference, "Res. Area Scan Success Effect #The effect created on the ground when area scan succeeds." },
	{ _field_tag_reference, "Res. Area Scan Failure Effect #The effect created on the ground when area scan fails." },
	{ _field_tag_reference, "Shard Object #Created by bishop when shard spawning.  Runs spawning logic." },
	{ _field_tag_reference, "Shard Spawn Ground Effect #The effect created on the ground when spawning shards (pawns)." },
...
TAG_BLOCK(character_combotron_parent, c_character_combotron_parent_properties_internal::k_block_count)
{
	...
	{ _field_tag_reference, "effect socket occupied" },
	{ _field_tag_reference, "effect socket cooling" },
	{ _field_tag_reference, "effect socket available" },
	{ _field_terminator },
};
...
TAG_BLOCK(character_combotron_child, c_character_combotron_child_properties_internal::k_block_count)
{
	...
	{ _field_long_flags, "flags" },
	{ _field_tag_reference, "socket weapon#When socketed, this guy turns into a weapon of the type referenced here" },
	{ _field_tag_reference, "socket child#When socketed, this guy turns into a child of the type referenced here" },
	{ _field_tag_reference, "socket character definition#Parent adopts this character definition when this guy is socketed" },
	...
	{ _field_tag_reference, "effect socketing#this effect plays while a child is socketing into a parent" },
	{ _field_terminator },
};
...
TAG_BLOCK(character_handle_dismemberment, c_character_handle_dismemberment_properties_internal::k_block_count)
{
	...
	{ _field_tag_reference, "berserk persistent melee effect" },
	{ _field_tag_reference, "alternate weapon#If I lose my firing arm then I pull out a ..." },
	{ _field_terminator },
};
...
TAG_BLOCK(character_cover_fight, c_character_cover_fight_properties_internal::k_block_count)
{
	...
	{ _field_tag_reference, "Into ball transition effect" },
	{ _field_tag_reference, "Out of ball transition effect" },
	{ _field_tag_reference, "Ball moving effect" },
	{ _field_tag_reference, "Ball interrupted effect" },
	{ _field_terminator },
};

TAG_BLOCK(character_emerge, c_character_emerge_properties_internal::k_block_count)
{
	{ _field_tag_reference, "Wall effect" },
	{ _field_tag_reference, "Floor effect" },
	{ _field_terminator },
};

TAG_BLOCK(dynamic_task, c_character_dynamic_task_properties_internal::k_block_count)
{
	{ _field_long_flags, "Agent Filter Flags #Limits dynamic tasks that can be assigned to this AI." },
	{ _field_long_flags, "Task Generation Flags #Controls which tasks can be generated by this AI." },
	...
	{ _field_tag_reference, "Shield Crate Override #Crate created to represent projected shield." },
	{ _field_terminator },
};
...
TAG_BLOCK(character_advance, c_character_advance_properties_internal::k_block_count)
{
	...
	{ _field_long_flags, "advance flags" },
	...
	{ _field_long_enum, "advance method" },
	...
	{ _field_tag_reference, "Teleport Launch FX #Effect to play at teleport launch point" },
	{ _field_tag_reference, "Teleport Land FX #Effect to play at teleport destination point" },
	{ _field_terminator },
};
...
{
	{ _field_long_flags, "forerunner flags" },
...
{
	{ _field_long_flags, "Character flags" },
	{ _field_tag_reference, "parent character" },
	{ _field_tag_reference, "unit" },
	{ _field_tag_reference, "creature#Creature reference for swarm characters ONLY" },
	{ _field_tag_reference, "style" },
	{ _field_tag_reference, "major character" },
