...
TAG_BLOCK(cui_player_model_controller_settings_definition, s_cui_player_model_control_settings_definition::k_maximum_count)
{
	...
	FIELD( _field_custom ),
	FIELD( _field_struct, "zoom transition function" ),
...
{
	FIELD( _field_custom ),
	FIELD( _field_struct, "camera transition function" ),
	FIELD( _field_terminator )
};
...
{
	FIELD( _field_custom ),
	FIELD( _field_struct, "analog scroll function" ),
	FIELD( _field_terminator )
};
...
TAG_GROUP(user_interface_globals_definition, USER_INTERFACE_GLOBALS_DEFINITION_TAG)
{
	...
	FIELD( _field_block, "cui screen widgets", &cui_component_screen_reference_block ),
	FIELD( _field_block, "cui overlay cameras", &cui_overlay_camera_block ),
	...
	FIELD( _field_block, "campaign state screen scripts", &campaign_state_screen_script_block ),
...
TAG_GROUP(user_interface_shared_globals_definition, USER_INTERFACE_SHARED_GLOBALS_DEFINITION_TAG)
{
	...
	FIELD( _field_custom ),
	FIELD( _field_struct, "spinner tab speed function" ),
