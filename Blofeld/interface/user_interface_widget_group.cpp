...
namespace blofeld
{
	...
	TAG_BLOCK(InfinityMissionSeasonImagesDefinition, k_infinityMaximumSeasonCount)
	{
		...
		FIELD( _field_block, "season images", &InfinityMissionImagesDefinition_block ),
		FIELD( _field_terminator )
	};
	...
	{
		FIELD( _field_char_enum, "player type", &pgcr_player_type_enum ),
	...
	{
		FIELD( _field_char_enum, "character type", &campaign_metagame_bucket_type_with_none_enum ),
		FIELD( _field_char_enum, "character class", &campaign_metagame_bucket_class_with_none_enum ),
	...
	TAG_BLOCK(cui_overlay_camera_block_definition, k_cui_max_overlay_count)
	{
		...
		FIELD( _field_char_enum, "pivot corner", &cui_camera_pivot_corner_enum_definition ),
		FIELD( _field_pad, "pad0", 3 ),
	...
	{
		FIELD( _field_byte_flags, "flags", &UIGameStartSequenceFlagsDefinition ),
	...
	{
		FIELD( _field_block, "text player", &color_list_block_block ),
		FIELD( _field_block, "text team", &color_list_block_block ),
		FIELD( _field_block, "bitmap player", &color_list_block_block ),
		FIELD( _field_block, "bitmap team", &color_list_block_block ),
	...
	TAG_BLOCK(gui_alert_description_block, s_gui_alert_description::k_maximum_gui_error_types_count)
	{
		...
		FIELD( _field_byte_flags, "flags", &gui_alert_flags ),
		FIELD( _field_char_enum, "error category", &gui_error_category_enum ),
		FIELD( _field_char_enum, "error icon", &gui_error_icon_enum ),
		FIELD( _field_pad, "pad0", 1 ),
	...
	TAG_BLOCK(gui_dialog_description_block, s_gui_dialog_description::k_maximum_gui_dialog_types_count)
	{
		...
		FIELD( _field_word_flags, "flags", &gui_dialog_flags ),
		FIELD( _field_pad, "pad0", 2 ),
		FIELD( _field_string_id, "title" ),
		FIELD( _field_string_id, "message" ),
		...
		FIELD( _field_enum, "default item", &gui_dialog_choice_enum ),
		FIELD( _field_enum, "b button action", &gui_dialog_b_button_action_enum ),
		FIELD( _field_terminator )
	};
	...
	TAG_STRUCT(user_interface_globals_definition_struct_definition)
	{
		...
		FIELD( _field_block, "cui screen widgets", &cui_component_screen_reference_block_definition_block ),
		FIELD( _field_block, "cui overlay cameras", &cui_overlay_camera_block_definition_block ),
		FIELD( _field_block, "player model camera settings", &cui_player_model_camera_settings_definition_block ),
		FIELD( _field_block, "player model input settings", &cui_player_model_controller_settings_definition_block ),
		FIELD( _field_block, "player model camera transition settings", &cui_player_model_transition_settings_definition_block ),
		...
		FIELD( _field_block, "active roster settings", &cui_active_roster_settings_block_block ),
		...
		FIELD( _field_block, "campaign state screen scripts", &campaign_state_screen_script_block_definition_block ),
		FIELD( _field_real, "spawn-timer countdown rate:counts/sec" ),
		FIELD( _field_block, "game intro sequence", &UserInterfaceGameScreenSequenceStepDefinition_block ),
		FIELD( _field_block, "game round end sequence", &UserInterfaceGameScreenSequenceStepDefinition_block ),
		FIELD( _field_block, "game next round sequence", &UserInterfaceGameScreenSequenceStepDefinition_block ),
		FIELD( _field_block, "game end sequence", &UserInterfaceGameScreenSequenceStepDefinition_block ),
		FIELD( _field_block, "game end with killcam sequence", &UserInterfaceGameScreenSequenceStepDefinition_block ),
	...
	TAG_STRUCT(user_interface_shared_globals_definition_struct_definition)
	{
		...
		FIELD( _field_block, "color presets", &color_presets_block_block ),
		FIELD( _field_explanation, "Tint colors" ),
		FIELD( _field_block, "tint colors", &tint_colors_block_block ),
		...
		FIELD( _field_block, "alert descriptions", &gui_alert_description_block_block ),
		FIELD( _field_explanation, "HaloX Dialogs" ),
		FIELD( _field_block, "dialog descriptions", &gui_dialog_description_block_block ),
