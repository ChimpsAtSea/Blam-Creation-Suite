...
s_tag_struct CONCAT(tag_struct_name, _struct_definition) = { #tag_struct_name, #tag_struct_name, __FILE__, __LINE__, {0}, CONCAT(tag_struct_name, _struct_definition_fields) }; \
...
s_tag_struct CONCAT(tag_struct_name, _struct) = { #tag_struct_name"_struct", #tag_struct_name"_struct", __FILE__, __LINE__, {0}, CONCAT(tag_struct_name, _struct_fields) }; \
...
s_tag_group CONCAT(tag_group_name, _group) = { #tag_group_name, group_tag, parent_group_tag, block_name, &CONCAT(parent_tag_group_name, _group) };
