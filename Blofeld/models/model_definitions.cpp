...
namespace blofeld
{
	...
	TAG_GROUP(model, MODEL_TAG)
	{
		...
		FIELD( _field_array, "render-only node flags*!", &g_node_flag_storage_array_array ),
		FIELD( _field_array, "render-only section flags*!", &g_node_flag_storage_array_array ),
	...
	TAG_BLOCK(model_variant_permutation_block, MAXIMUM_PERMUTATIONS_PER_MODEL_REGION)
	{
		...
		FIELD( _field_array, "runtime state permutation indices!", &model_state_permutation_index_array_array ),
	...
	TAG_BLOCK(model_variant_block, k_maximum_variants_per_model)
	{
		...
		FIELD( _field_array, "runtime variant region indices!", &runtime_region_index_array_array ),
		...
		FIELD( _field_array, "muted flag*!", &g_node_flag_storage_array_array ),
		FIELD( _field_terminator )
	};
