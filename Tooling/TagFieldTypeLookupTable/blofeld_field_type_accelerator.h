...
#define blofeld_field_type_accelerator_hash(hash_name, string, seed) \
	...
	{
	public:
		static constexpr unsigned long k_accelerator_seed = 1lu;
		static constexpr unsigned long k_accelerator_bits = 10lu;
		static constexpr unsigned long k_accelerator_table_size = 1lu << k_accelerator_bits;
		static constexpr unsigned long k_accelerator_bit_mask = k_accelerator_table_size - 1;
		static constexpr unsigned long k_expected_fields_count = 71lu;
		...
		unsigned long hash_by_field_type[k_number_of_blofeld_field_types];
