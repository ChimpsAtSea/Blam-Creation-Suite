...
public:
	...
	static unsigned int calculate_struct_size(c_tag_serialization_context& serialization_context, c_runtime_tag_struct_definition& struct_definition, std::vector<c_serialization_error*>& serialization_errors);
};
