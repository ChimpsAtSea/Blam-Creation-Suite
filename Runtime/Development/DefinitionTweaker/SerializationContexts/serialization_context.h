...
public:
	...
	c_serialization_context(s_engine_platform_build _engine_platform_build, const void* data_start, std::string name);
	c_serialization_context(c_serialization_context& parent_serialization_context, const void* data_start, std::string name);
