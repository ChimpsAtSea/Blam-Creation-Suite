...
namespace xxhash {
	...
	///	@param	seed	seed.
	///	@return	xxHash32
	constexpr hash<32>::hash_type xxh32(const char* buf, std::size_t len, hash<32>::hash_type seed = XXHASH_CX_XXH32_SEED) {
	...
	///	@param	seed	seed.
	///	@return	xxHash64
	constexpr hash<64>::hash_type xxh64(const char* buf, std::size_t len, hash<64>::hash_type seed = XXHASH_CX_XXH64_SEED) {
