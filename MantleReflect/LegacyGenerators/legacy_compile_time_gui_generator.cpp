...
const char* get_primitive_handler_function(e_legacy_primitive_type primitiveType)
{
	...
	{
	case _legacy_primitive_type_int8:						return "render_primitive_gui_legacy<_legacy_primitive_type_int8,				int8_t>";
	case _legacy_primitive_type_int16:						return "render_primitive_gui_legacy<_legacy_primitive_type_int16,				int16_t>";
	case _legacy_primitive_type_int32:						return "render_primitive_gui_legacy<_legacy_primitive_type_int32,				int32_t>";
	case _legacy_primitive_type_int64:						return "render_primitive_gui_legacy<_legacy_primitive_type_int64,				int64_t>";
	case _legacy_primitive_type_uint8:						return "render_primitive_gui_legacy<_legacy_primitive_type_uint8,				uint8_t>";
	case _legacy_primitive_type_uint16:					return "render_primitive_gui_legacy<_legacy_primitive_type_uint16,			uint16_t>";
	case _legacy_primitive_type_uint32:					return "render_primitive_gui_legacy<_legacy_primitive_type_uint32,			uint32_t>";
	case _legacy_primitive_type_uint64:					return "render_primitive_gui_legacy<_legacy_primitive_type_uint64,			uint64_t>";
	case _legacy_primitive_type_float:						return "render_primitive_gui_legacy<_legacy_primitive_type_float,				float>";
	case _legacy_primitive_type_double:					return "render_primitive_gui_legacy<_legacy_primitive_type_float,				double>";
	case _legacy_primitive_type_boolean8:					return "render_primitive_gui_legacy<_legacy_primitive_type_boolean8,			boolean8_t>";
	case _legacy_primitive_type_boolean16:					return "render_primitive_gui_legacy<_legacy_primitive_type_boolean16,			boolean16_t>";
	case _legacy_primitive_type_boolean32:					return "render_primitive_gui_legacy<_legacy_primitive_type_boolean32,			boolean32_t>";
	case _legacy_primitive_type_boolean64:					return "render_primitive_gui_legacy<_legacy_primitive_type_boolean64,			boolean64_t>";
	case _legacy_primitive_type_enum8:						return "render_primitive_gui_legacy<_legacy_primitive_type_enum8,				enum8_t>";
	case _legacy_primitive_type_enum16:					return "render_primitive_gui_legacy<_legacy_primitive_type_enum16,			enum16_t>";
	case _legacy_primitive_type_enum32:					return "render_primitive_gui_legacy<_legacy_primitive_type_enum32,			enum32_t>";
	case _legacy_primitive_type_enum64:					return "render_primitive_gui_legacy<_legacy_primitive_type_enum64,			enum64_t>";
	case _legacy_primitive_type_bitfield8:					return "render_primitive_gui_legacy<_legacy_primitive_type_bitfield8,			bitfield8_t>";
	case _legacy_primitive_type_bitfield16:				return "render_primitive_gui_legacy<_legacy_primitive_type_bitfield16,		bitfield16_t>";
	case _legacy_primitive_type_bitfield32:				return "render_primitive_gui_legacy<_legacy_primitive_type_bitfield32,		bitfield32_t>";
	case _legacy_primitive_type_bitfield64:				return "render_primitive_gui_legacy<_legacy_primitive_type_bitfield64,		bitfield64_t>";
	case _legacy_primitive_type_bitflag8:					return "render_primitive_gui_legacy<_legacy_primitive_type_bitflag8,			bitflag8_t>";
	case _legacy_primitive_type_bitflag16:					return "render_primitive_gui_legacy<_legacy_primitive_type_bitflag16,			bitflag16_t>";
	case _legacy_primitive_type_bitflag32:					return "render_primitive_gui_legacy<_legacy_primitive_type_bitflag32,			bitflag32_t>";
	case _legacy_primitive_type_bitflag64:					return "render_primitive_gui_legacy<_legacy_primitive_type_bitflag64,			bitflag64_t>";
	case _legacy_primitive_type_undefined8:				return "render_primitive_gui_legacy<_legacy_primitive_type_undefined8,		s_undefined8_legacy>";
	case _legacy_primitive_type_undefined16:				return "render_primitive_gui_legacy<_legacy_primitive_type_undefined16,		s_undefined16_legacy>";
	case _legacy_primitive_type_undefined32:				return "render_primitive_gui_legacy<_legacy_primitive_type_undefined32,		s_undefined32_legacy>";
	case _legacy_primitive_type_undefined64:				return "render_primitive_gui_legacy<_legacy_primitive_type_undefined64,		s_undefined64_legacy>";
	case _legacy_primitive_type_char8:						return "render_primitive_gui_legacy<_legacy_primitive_type_char8,				char>";
	case _legacy_primitive_type_char16:					return "render_primitive_gui_legacy<_legacy_primitive_type_char16,			wchar_t>";
	case _legacy_primitive_type_static_string8:			return "render_primitive_gui_legacy<_legacy_primitive_type_static_string8,	char>";
	case _legacy_primitive_type_static_string16:			return "render_primitive_gui_legacy<_legacy_primitive_type_static_string16,	wchar_t>";
	}
...
const char* get_legacy_reflection_type_category_handler_function(e_legacy_reflection_type_category legacy_reflection_type_category)
{
	...
	{
	case _legacy_reflection_type_category_primitive:			return "render_primitive_gui_legacy";
	case _legacy_reflection_type_category_structure:			return "render_struct_gui_legacy";
	case _legacy_reflection_type_category_tag_reference:		return "render_tagref_gui_legacy";
	case _legacy_reflection_type_category_tag_block:			return "render_tagblock_gui_legacy";
	case _legacy_reflection_type_category_data_reference:		return "render_dataref_gui_legacy";
	case _legacy_reflection_type_category_shader_data:			return "render_shaderdata_gui";
	case _legacy_reflection_type_category_string_id:			return "render_stringid_gui_legacy";
	case _legacy_reflection_type_category_enum:				return "render_enum_gui_legacy";
	case _legacy_reflection_type_category_bitfield:			return "render_bitfield_gui_legacy";
	}
	throw;
