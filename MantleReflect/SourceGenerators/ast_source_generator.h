...
{
public:
	c_ast_source_generator(const wchar_t* output_header_file, const wchar_t* output_source_file, std::vector<c_reflection_type_container*>& reflection_types);
...
protected:
	...
	std::vector<c_reflection_type_container*>& reflection_types;
};
