...
protected:
	...
	c_reflection_type_container* create_reflected_enum_type(clang::ASTContext* Context, const clang::QualType* recordQualifiedType, const clang::RecordDecl& rRecordDeclaration);
	c_reflection_type_container* create_reflected_type(clang::ASTContext* ast_context, const clang::QualType* record_qualified_type, const clang::RecordDecl& record_declaration, bool is_primitive = false);
