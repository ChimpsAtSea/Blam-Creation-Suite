...
void c_runtime_reflection_generator::write_render_gui_type_entry_source2(const c_reflection_type_container& type_container)
{
	...
	for (const c_reflection_field_container* field_container : type_container.field_containers)
	{
		...
		source_string_stream << "\t" << "s_reflection_member(" << type_container.type_name << "_type_info, sizeof(int32_t), memberoffset(" << type_container.type_name << ", " << field_container->field_name << "), int32_t_type_info, \"" << field_container->field_name << "\", \"" << field_container->nice_name << "\", \"" << field_container->description << "\")," << std::endl;
