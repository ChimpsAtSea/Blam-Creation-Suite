...
#pragma pack(pop)
		...
		static_assert(offsetof(s_cache_file_header, unknown2D4) == 0x000002C4);
		static_assert(offsetof(s_cache_file_header, unknown2D8) == 0x000002C8);
		static_assert(offsetof(s_cache_file_header, expected_base_address) == 0x000002E8);
		static_assert(offsetof(s_cache_file_header, xdk_version) == 0x000002EC);
		static_assert(offsetof(s_cache_file_header, tag_post_link_buffer) == 0x000002F0);
		static_assert(offsetof(s_cache_file_header, tag_language_dependent_read_only_buffer) == 0x000002F8);
		static_assert(offsetof(s_cache_file_header, tag_language_dependent_read_write_buffer) == 0x00000300);
		static_assert(offsetof(s_cache_file_header, tag_language_neutral_read_write_buffer) == 0x00000308);
		static_assert(offsetof(s_cache_file_header, tag_language_neutral_write_combined_buffer) == 0x00000310);
		static_assert(offsetof(s_cache_file_header, tag_language_neutral_read_only_buffer) == 0x00000318);
		static_assert(offsetof(s_cache_file_header, unknown330) == 0x00000320);
		static_assert(offsetof(s_cache_file_header, unknown334) == 0x00000324);
		static_assert(offsetof(s_cache_file_header, unknown338) == 0x00000328);
		static_assert(offsetof(s_cache_file_header, unknown33C) == 0x0000032C);
		static_assert(offsetof(s_cache_file_header, hash) == 0x00000330);
		static_assert(offsetof(s_cache_file_header, rsa) == 0x0000036C);
		static_assert(offsetof(s_cache_file_header, offset_masks) == 0x0000046C);
		static_assert(offsetof(s_cache_file_header, section_file_bounds) == 0x0000047C);
		static_assert(offsetof(s_cache_file_header, unknown4AC) == 0x0000049C);
		static_assert(offsetof(s_cache_file_header, unknown4B0) == 0x000004A0);
		static_assert(offsetof(s_cache_file_header, unknown4B4) == 0x000004A4);
		static_assert(offsetof(s_cache_file_header, unknown4B8) == 0x000004A8);
		static_assert(offsetof(s_cache_file_header, gap4BC) == 0x000004AC);
		static_assert(offsetof(s_cache_file_header, unknown18E94) == 0x00018E84);
		static_assert(offsetof(s_cache_file_header, unknown18E95) == 0x00018E85);
		static_assert(offsetof(s_cache_file_header, unknown18E96) == 0x00018E86);
		static_assert(offsetof(s_cache_file_header, unknown18E97) == 0x00018E87);
		static_assert(offsetof(s_cache_file_header, insertion_point_resource_usage) == 0x00018E88);
		static_assert(offsetof(s_cache_file_header, gap1D728) == 0x0001D718);
		static_assert(offsetof(s_cache_file_header, late_binding_tag_reference_fixup_info_count) == 0x0001D728);
		static_assert(offsetof(s_cache_file_header, late_binding_tag_reference_fixup_info_address) == 0x0001D72C);
		static_assert(offsetof(s_cache_file_header, cache_file_fixups_count) == 0x0001D730);
		static_assert(offsetof(s_cache_file_header, cache_file_fixups_address) == 0x0001D734);
		static_assert(offsetof(s_cache_file_header, gap1D748) == 0x0001D738);
		static_assert(offsetof(s_cache_file_header, footer_signature) == 0x0001DFEC);
