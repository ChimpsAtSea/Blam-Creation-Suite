...
c_halo1_tools_pc64_tag_struct_definition::c_halo1_tools_pc64_tag_struct_definition(c_halo1_tools_pc64_tag_definition_manager& _tag_definition_manager, ptr32 _definition_address) :
	...
	conflict_handled(false)
{
	...
	c_halo1_tools_pc64_tag_field* tag_field = nullptr;
	do
	{
		tag_field = new() c_halo1_tools_pc64_tag_field(tag_definition_manager, fields_address);
		fields.push_back(tag_field);

		// array fixup
		if (tag_field->field_definition.field_type == _halo1_tools_pc64_field_array_start)
		{
			c_halo1_tools_pc64_tag_array_definition* array_definition = static_cast<c_halo1_tools_pc64_tag_array_definition*>(tag_field->get_array_definition());
			ASSERT(array_definition != nullptr);
			c_halo1_tools_pc64_tag_struct_definition& struct_definition = static_cast<c_halo1_tools_pc64_tag_struct_definition&>(array_definition->get_struct_definition());

			c_halo1_tools_pc64_tag_field* array_end_field = dynamic_cast<c_halo1_tools_pc64_tag_field*>(struct_definition.fields.back());
		...
		fields_address += sizeof(s_halo1_tools_pc64_tag_field);
	} while (tag_field->get_field_type() != blofeld::_field_terminator);
}

c_halo1_tools_pc64_tag_struct_definition::~c_halo1_tools_pc64_tag_struct_definition()
{
...
const char* c_halo1_tools_pc64_tag_struct_definition::get_name()
{
	return name.c_str();
}

const char* c_halo1_tools_pc64_tag_struct_definition::get_code_symbol_name()
{
	return code_symbol_name.c_str();
}

const char* c_halo1_tools_pc64_tag_struct_definition::get_structure_type_name()
{
...
blofeld::s_tag_persistent_identifier& c_halo1_tools_pc64_tag_struct_definition::get_persistent_identifier()
{
	static blofeld::s_tag_persistent_identifier id;
	return id;
}

c_flags<blofeld::e_tag_field_set_bit> c_halo1_tools_pc64_tag_struct_definition::get_field_set_bits()
{
