...
{
protected:
	c_halo1_tools_pc64_tag_array_definition(c_halo1_tools_pc64_tag_definition_manager& tag_definition_manager, ptr32 definition_address);
	c_halo1_tools_pc64_tag_array_definition(const c_halo1_tools_pc64_tag_array_definition&) = delete;
	c_halo1_tools_pc64_tag_array_definition(c_halo1_tools_pc64_tag_array_definition&&) = delete;
	~c_halo1_tools_pc64_tag_array_definition();
...
protected:
	...
	c_halo1_tools_pc64_tag_array_struct_definition& struct_definition;
	std::string name;
