...
enum e_reach_x360_tag_field_set_bit : unsigned int
{
...
{
	c_enum<e_reach_x360_tag_memory_allocation_type, uint32_t, _reach_x360_tag_memory_default, k_num_reach_x360_tag_memory_type> memory_type;
	c_flags<e_reach_x360_tag_memory_usage_bit, uint32_t, k_num_reach_x360_tag_memory_usage_bits> usage_flags;
};
...
struct s_reach_x360_tag_struct_runtime
{
	...
	uint32_t structure_size;																							//136				88
	c_flags<e_reach_x360_tag_field_set_bit, int32_t, k_num_reach_x360_runtime_flags> flags;												//140				8C
	ptr32 combined_fields;																									//144				90
	uint32_t cache_file_struct_size;																					//148				94
	uint32_t unknown98;																								//152				98
	uint32_t num_combined_fields;																						//156				9C
	ptr32 unknownA0;																										//160				A0
	uint32_t unique_index;																								//164				A4
	c_big_flags_typed<int32_t, k_num_reach_x360_fields> inlined_field_types;												//168				A8
	c_big_flags_typed<int32_t, k_num_reach_x360_fields> unknown_field_types;												//176				B0
...
struct s_reach_x360_tag_struct_definition
{
	...
	uint32_t unknown54;																								//84				54
	uint32_t exploded_struct_size;																						//88				58
	uint32_t unknown5C;																								//92				5C
	s_reach_x360_tag_memory_attributes memory_attributes;																		//96				60
	s_reach_x360_tag_struct_runtime runtime;																				//104				68
	uint32_t unknownBC;																								//104				BC
};
