...
template<> void byteswap_inplace(s_halo2_tools_pc64_byte_swap_definition& value)
{
...
template<> void byteswap_inplace(s_halo2_tools_pc64_tag_struct_runtime& value)
{
...
template<> void byteswap_inplace(s_halo2_tools_pc64_tag_struct_type& value)
{
...
template<> void byteswap_inplace(s_halo2_tools_pc64_tag_struct_definition& value)
{
	byteswap_inplace(value.type);
	byteswap_inplace(value.runtime);
}

template<> void byteswap_inplace(s_halo2_tools_pc64_tag_field_struct_definition& value)
{
	byteswap_inplace(value.name);
	byteswap_inplace(value.signature);
...
c_halo2_tools_pc64_tag_struct_definition::c_halo2_tools_pc64_tag_struct_definition(c_halo2_tools_pc64_tag_definition_manager& _tag_definition_manager, ptr32 _definition_address) :
	c_blamtoozle_tag_struct_definition(_tag_definition_manager),
	definition_address(_definition_address),
	struct_definition(tag_definition_manager.read_structure<s_halo2_tools_pc64_tag_struct_definition>(_definition_address)),
	display_name(),
	name(),
	...
	structure_version()
{
	...
	do
	{
		...
		// array fixup
		if (tag_field->field_definition.field_type == _halo2_tools_pc64_field_array_start)
		{
			c_halo2_tools_pc64_tag_array_definition* array_definition = static_cast<c_halo2_tools_pc64_tag_array_definition*>(tag_field->get_array_definition());
			ASSERT(array_definition != nullptr);
			c_halo2_tools_pc64_tag_struct_definition& struct_definition = static_cast<c_halo2_tools_pc64_tag_struct_definition&>(array_definition->get_struct_definition());

			c_halo2_tools_pc64_tag_field* array_end_field = dynamic_cast<c_halo2_tools_pc64_tag_field*>(struct_definition.fields.back());
...
const char* c_halo2_tools_pc64_tag_struct_definition::get_pretty_name()
{
	return display_name.c_str();
}

const char* c_halo2_tools_pc64_tag_struct_definition::get_name()
{
	return name.c_str();
}

const char* c_halo2_tools_pc64_tag_struct_definition::get_code_symbol_name()
{
	return code_symbol_name.c_str();
}

const char* c_halo2_tools_pc64_tag_struct_definition::get_structure_type_name()
{
...
blofeld::s_tag_persistent_identifier& c_halo2_tools_pc64_tag_struct_definition::get_persistent_identifier()
{
	static blofeld::s_tag_persistent_identifier id;
	return id;
}

c_flags<blofeld::e_tag_field_set_bit> c_halo2_tools_pc64_tag_struct_definition::get_field_set_bits()
{
...
void c_halo2_tools_pc64_tag_struct_definition::generate_structure_names()
{
	...
	{
		c_halo2_tools_pc64_tag_block_definition* tag_block_definition = tag_definition_manager.current_block_traverse_hack;
