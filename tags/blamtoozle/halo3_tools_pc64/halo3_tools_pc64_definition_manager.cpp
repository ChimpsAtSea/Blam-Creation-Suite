...
void c_halo3_tools_pc64_tag_definition_manager::traverse(ptr64 group_table_address, uint32_t num_tag_layouts)
{
...
{
	return eval_definition<c_halo3_tools_pc64_tag_definition_manager, c_halo3_tools_pc64_tag_group_definition>(definition_address, tag_group_definitions, tag_group_definitions_lookup);
}

c_halo3_tools_pc64_tag_block_definition& c_halo3_tools_pc64_tag_definition_manager::eval_block(ptr64 definition_address)
{
	return eval_definition<c_halo3_tools_pc64_tag_definition_manager, c_halo3_tools_pc64_tag_block_definition>(definition_address, tag_block_definitions, tag_block_definitions_lookup);
}
...
{
	return eval_definition<c_halo3_tools_pc64_tag_definition_manager, c_halo3_tools_pc64_tag_reference_definition>(definition_address, tag_reference_definitions, tag_reference_definitions_lookup);
}

c_halo3_tools_pc64_tag_struct_definition& c_halo3_tools_pc64_tag_definition_manager::eval_struct(ptr64 definition_address)
{
	return eval_definition<c_halo3_tools_pc64_tag_definition_manager, c_halo3_tools_pc64_tag_struct_definition>(definition_address, tag_struct_definitions, tag_struct_definitions_lookup);
}

c_halo3_tools_pc64_tag_array_definition& c_halo3_tools_pc64_tag_definition_manager::eval_array(ptr64 definition_address)
{
	return eval_definition<c_halo3_tools_pc64_tag_definition_manager, c_halo3_tools_pc64_tag_array_definition>(definition_address, tag_array_definitions, tag_array_definitions_lookup);
}
...
{
	return eval_definition<c_halo3_tools_pc64_tag_definition_manager, c_halo3_tools_pc64_string_list_definition>(definition_address, tag_string_list_definitions, tag_string_list_definitions_lookup);
}
...
{
	return eval_definition<c_halo3_tools_pc64_tag_definition_manager, c_halo3_tools_pc64_tag_resource_definition>(definition_address, tag_resource_definitions, tag_resource_definitions_lookup);
}

c_halo3_tools_pc64_tag_data_definition& c_halo3_tools_pc64_tag_definition_manager::eval_data(ptr64 definition_address)
{
	return eval_definition<c_halo3_tools_pc64_tag_definition_manager, c_halo3_tools_pc64_tag_data_definition>(definition_address, tag_data_definitions, tag_data_definitions_lookup);
}
...
{
	return eval_definition<c_halo3_tools_pc64_tag_definition_manager, c_halo3_tools_pc64_tag_api_interop_definition>(definition_address, tag_api_interop_definitions, tag_api_interop_definitions_lookup);
}
...
{
	return eval_definition<c_halo3_tools_pc64_tag_definition_manager, c_halo3_tools_pc64_tag_block_index_custom_search_definition>(definition_address, tag_block_index_custom_search_definitions, tag_block_index_custom_search_definitions_lookup);
}
