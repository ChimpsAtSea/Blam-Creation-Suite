...
{
public:
	c_structure_relationship_node(s_engine_platform_build engine_platform_build, blofeld::s_tag_struct_definition const& tag_struct_definition);
	void populate();
	...
	static c_structure_relationship_node& get_node_by_structure(s_engine_platform_build engine_platform_build, blofeld::s_tag_struct_definition const& tag_struct_definition);
	...
	static std::vector<blofeld::s_tag_block_definition const*> sorted_block_definitions[k_number_of_engine_types];
	static std::unordered_set<blofeld::s_tag_block_definition const*> unsorted_block_definitions[k_number_of_engine_types];
