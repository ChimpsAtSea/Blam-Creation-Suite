...
c_infinite_tag_group::~c_infinite_tag_group()
{
...
BCS_RESULT c_infinite_tag_group::get_group_tag(tag& out_group_tag) const
{
	out_group_tag = blofeld_tag_group.group_tag;
	return BCS_S_OK;
}

BCS_RESULT c_infinite_tag_group::get_group_name(const char*& out_group_name) const
{
	out_group_name = blofeld_tag_group.name;
	return BCS_S_OK;
}

BCS_RESULT c_infinite_tag_group::get_group_short_name(const char*& out_group_short_name) const
{
