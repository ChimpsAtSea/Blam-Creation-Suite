...
BCS_SHARED extern BCS_RESULT iterate_prototype_references(h_prototype& prototype, void(*callback)(void* userdata, h_tag_reference&), void* userdata);
BCS_SHARED extern BCS_RESULT iterate_prototype_references(h_prototype& prototype, void(*callback)(h_tag_reference&));
