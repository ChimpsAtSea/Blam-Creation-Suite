...
class c_halo1_debug_reader;
class c_halo1_tag_reader;
class c_halo1_resource_reader;
class c_halo1_localization_reader;
class c_halo1_tag_group;
class c_halo1_tag_instance;

class c_halo1_cache_cluster : public c_cache_cluster
{
public:
	...
	friend c_halo1_debug_reader;
	friend c_halo1_tag_reader;
	friend c_halo1_resource_reader;
	friend c_halo1_localization_reader;
	...
	BCS_RESULT get_tag_reader(c_halo1_cache_file_reader& cache_reader, c_halo1_tag_reader*& tag_reader);
...
protected:
	...
	BCS_RESULT get_cache_reader_by_relative_path(const char* relative_path, c_halo1_cache_file_reader*& cache_reader);
};
