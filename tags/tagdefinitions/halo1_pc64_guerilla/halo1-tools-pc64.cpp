...
namespace blofeld::halo1::pc64
{
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$14 },
		{ _field_long_flags, "more flags", &unnamed_enum$15 },
		FIELD_PAD("value", 12),
		{ _field_short_enum, "type", &unnamed_enum$16 },
		FIELD_PAD("value", 2),
		FIELD_EXPLANATION("perception", nullptr),
		...
		FIELD_PAD("value", 8),
		FIELD_PAD("value", 16),
		{ _field_tag_reference, "DO NOT USE weapon", "unused ranged", FIELD_FLAG_UNKNOWN0, &weapon_group_reference },
		FIELD_PAD("value", 268),
		{ _field_tag_reference, "DO NOT USE projectile", "unused grenade", FIELD_FLAG_UNKNOWN0, &projectile_group_reference },
		FIELD_EXPLANATION("unopposable", nullptr),
		{ _field_short_enum, "unreachable danger trigger", "danger level of an unreachable enemy which will trigger a retreat if it continues over time", &unnamed_enum$17 },
		{ _field_short_enum, "vehicle danger trigger", "danger level of a vehicle-based enemy which will trigger a retreat if it continues over time", &unnamed_enum$17 },
		{ _field_short_enum, "player danger trigger", "danger level of an enemy player which will trigger a retreat if it continues over time", &unnamed_enum$17 },
		FIELD_PAD("value", 2),
		...
		FIELD_PAD("value", 8),
		FIELD_EXPLANATION("panic", nullptr),
		...
		{ _field_short_enum, "leader type", "if we see a friend of this type killed we have a chance of panicking", &unnamed_enum$16 },
		FIELD_PAD("value", 2),
		...
		FIELD_PAD("value", 16),
		{ _field_short_enum, "defensive crouch type", &unnamed_enum$18 },
		FIELD_PAD("value", 2),
		...
		FIELD_PAD("value", 4),
		FIELD_EXPLANATION("pursuit", nullptr),
		...
		FIELD_PAD("value", 32),
		FIELD_EXPLANATION("berserk", nullptr),
		...
		FIELD_PAD("value", 12),
		FIELD_EXPLANATION("firing positions", nullptr),
		...
		FIELD_PAD("value", 40),
		FIELD_EXPLANATION("communication", nullptr),
		...
		FIELD_PAD("value", 48),
		FIELD_PAD("value", 128),
		{ _field_tag_reference, "DO NOT USE major upgrade", "unused", FIELD_FLAG_UNKNOWN0, &actor_group_reference },
		FIELD_PAD("value", 48),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "reference", &actor_variant_group_reference$4 },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_byte_flags, "flags", &unnamed_enum$216 },
		{ _field_short_enum, "return state", "state that this actor will return to when it has nothing to do", &unnamed_enum$211 },
		{ _field_short_enum, "initial state", "state that this actor starts in", &unnamed_enum$211 },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$19 },
		{ _field_tag_reference, "actor definition", &actor_group_reference },
		{ _field_tag_reference, "unit", &unit_group_reference },
		{ _field_tag_reference, "major variant", &actor_variant_group_reference },
		FIELD_EXPLANATION("Metagame parameters", nullptr),
		{ _field_short_enum, "metagame type", &unnamed_enum$20 },
		{ _field_short_enum, "metagame class", &unnamed_enum$21 },
		FIELD_PAD("value", 20),
		FIELD_EXPLANATION("movement switching", "note: only the flood combat forms will ever try to switch movement types voluntarily during combat"),
		{ _field_short_enum, "movement type", "when we have a choice of movement types, which type we will use", &unnamed_enum$22 },
		FIELD_PAD("value", 2),
		...
		FIELD_EXPLANATION("ranged combat", nullptr),
		...
		{ _field_short_enum, "special-fire mode", "the type of special weapon fire that we can use", &unnamed_enum$23 },
		{ _field_short_enum, "special-fire situation", "when we will decide to use our special weapon fire mode", &unnamed_enum$24 },
		...
		FIELD_EXPLANATION("berserking and melee", nullptr),
		...
		FIELD_PAD("value", 8),
		FIELD_EXPLANATION("grenades", nullptr),
		{ _field_short_enum, "grenade type", "type of grenades that we throw", &unnamed_enum$25 },
		{ _field_short_enum, "trajectory type", "how we throw our grenades", &unnamed_enum$26 },
		{ _field_short_enum, "grenade stimulus", "what causes us to consider throwing a grenade", &unnamed_enum$27 },
		...
		FIELD_PAD("value", 20),
		FIELD_EXPLANATION("items", nullptr),
		{ _field_tag_reference, "equipment", "equipment item to drop when we die", &equipment_group_reference },
		...
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 12),
		{ _field_block, "change colors", &actor_variant_change_colors_block },
		{ _field_terminator }
	};
	...
	STRINGS(unnamed_enum$19)
	{
		...
		"interpolate color in HSV#unused. Change colors are ALWAYS interpolated (Not sure if Bungie made a typo or not)!",
		"has unlimited grenades#unused!",
		"movement switching try to stay with friends#try not to get ahead of or fall behind any nearby friends that are also switching movement modes",
		"active camouflage",
	...
	TAG_REFERENCE(actor_variant_group_reference, ACTOR_VARIANT_TAG);
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_tag_reference, "animation graph", "leave this blank to use the unit's normal animation graph", &model_animations_group_reference$2 },
		FIELD_PAD("value", 12),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_enum, "atom type", &unnamed_enum$221 },
	...
	{
		{ _field_string, "name" },
		{ _field_long_flags, "flags", &unnamed_enum$220 },
		FIELD_PAD("value", 8),
		...
		FIELD_PAD("value", 2),
		{ _field_block, "commands", &ai_command_block },
		{ _field_block, "points", &ai_command_point_block },
		FIELD_PAD("value", 24),
		{ _field_terminator }
	};
	...
	{
		{ _field_string, "name" },
		{ _field_word_flags, "flags", &unnamed_enum$222 },
		FIELD_PAD("value", 2),
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_word_flags, "flags", &unnamed_enum$225 },
		{ _field_short_block_index, "participant" },
		{ _field_short_enum, "addressee", &unnamed_enum$226 },
	...
	{
		FIELD_PAD("value", 2),
		{ _field_word_flags, "flags", &unnamed_enum$223 },
		{ _field_short_enum, "selection type", &unnamed_enum$224 },
		{ _field_short_enum, "actor type", &unnamed_enum$16 },
	...
	{
		{ _field_string, "name" },
		{ _field_short_enum, "type", &unnamed_enum$32 },
		{ _field_short_integer, "frame count" },
		{ _field_short_integer, "frame size" },
		{ _field_short_enum, "frame info type", &unnamed_enum$33 },
		...
		{ _field_word_flags, "flags", &unnamed_enum$34 },
		...
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 4),
		{ _field_data, "frame info", &frame_info_data_definition },
		{ _field_array, "node trans. flag data", &unnamed_array },
		FIELD_PAD("value", 8),
		{ _field_array, "node rotation flag data", &unnamed_array$2 },
		FIELD_PAD("value", 8),
		{ _field_array, "node scale flag data", &unnamed_array$3 },
		FIELD_PAD("value", 4),
		{ _field_long_integer, "offset to compressed data", nullptr, "bytes", FIELD_FLAG_READ_ONLY },
		{ _field_data, "default data", &animation_default_data_definition },
		{ _field_data, "frame data", &animation_frame_data_definition },
		{ _field_terminator }
	};
	...
	{
		FIELD_PAD("value", 16),
		{ _field_block, "animations", &first_person_weapon_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 2),
		{ _field_long_flags, "Node joint flags", &unnamed_enum$31 },
	...
	{
		{ _field_short_block_index, "animation" },
		{ _field_short_enum, "function", &unnamed_enum$28 },
		{ _field_short_enum, "function controls", &unnamed_enum$29 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 12),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 8),
		{ _field_block, "animations", &unit_seat_animation_block },
		{ _field_block, "ik points", &animation_graph_unit_seat_ik_point_block },
		{ _field_block, "weapons", &animation_graph_weapon_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_integer, "up pitch frame count" },
		FIELD_PAD("value", 68),
		{ _field_block, "animations", &vehicle_animation_block },
		{ _field_block, "suspension animations", &suspension_animation_block },
		{ _field_terminator }
	};
	...
	{
		FIELD_PAD("value", 16),
		{ _field_block, "animations", &weapon_animation_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_integer, "up pitch frame count" },
		FIELD_PAD("value", 32),
		{ _field_block, "animations", &weapon_class_animation_block },
		{ _field_block, "ik points", &animation_graph_unit_seat_ik_point_block },
		{ _field_block, "weapon types", &animation_graph_weapon_type_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_string, "label" },
		FIELD_PAD("value", 16),
		{ _field_block, "animations", &weapon_type_animation_block },
		{ _field_terminator }
	};
	...
	{
		FIELD_PAD("value", 2),
		{ _field_word_flags, "flags", &unnamed_enum$35 },
		...
		FIELD_PAD("value", 4),
		{ _field_tag_reference, "model", &gbxmodel_group_reference },
		{ _field_tag_reference, "animation graph", &model_animations_group_reference },
		FIELD_PAD("value", 40),
		{ _field_tag_reference, "collision model", &model_collision_geometry_group_reference },
		...
		{ _field_short_enum, "A in", &unnamed_enum$36 },
		{ _field_short_enum, "B in", &unnamed_enum$36 },
		{ _field_short_enum, "C in", &unnamed_enum$36 },
		{ _field_short_enum, "D in", &unnamed_enum$36 },
		FIELD_PAD("value", 44),
		...
		{ _field_short_enum, "default team", &unnamed_enum$47 },
		{ _field_short_enum, "constant sound volume", &unnamed_enum$48 },
		...
		{ _field_short_enum, "A in", &unnamed_enum$49 },
		{ _field_short_enum, "B in", &unnamed_enum$49 },
		{ _field_short_enum, "C in", &unnamed_enum$49 },
		{ _field_short_enum, "D in", &unnamed_enum$49 },
		...
		{ _field_tag_reference, "spawned actor", "actor variant which we spawn when we are destroyed or self-destruct", &actor_variant_group_reference$2 },
		...
		{ _field_short_enum, "motion sensor blip size", &unnamed_enum$50 },
		FIELD_PAD("value", 2),
		FIELD_EXPLANATION("Metagame parameters", nullptr),
		{ _field_short_enum, "metagame type", &unnamed_enum$20 },
		{ _field_short_enum, "metagame class", &unnamed_enum$21 },
		...
		{ _field_short_enum, "grenade type", &unnamed_enum$25 },
		...
		{ _field_long_flags, "flags", &unnamed_enum$52 },
		{ _field_angle, "stationary turning threshold" },
		FIELD_PAD("value", 16),
		{ _field_short_enum, "A in", &unnamed_enum$53 },
		{ _field_short_enum, "B in", &unnamed_enum$53 },
		{ _field_short_enum, "C in", &unnamed_enum$53 },
		{ _field_short_enum, "D in", &unnamed_enum$53 },
		...
		FIELD_PAD("value", 24),
		{ _field_tag_reference, "footsteps", &material_effects_group_reference },
		FIELD_PAD("value", 24),
	...
	TAG_REFERENCE(gbxmodel_group_reference, GBXMODEL_TAG);

	TAG_REFERENCE(model_animations_group_reference, MODEL_ANIMATIONS_TAG);

	TAG_REFERENCE(model_collision_geometry_group_reference, MODEL_COLLISION_GEOMETRY_TAG);
	...
	STRINGS(unnamed_enum$46)
	{
		...
		"has no aiming",
		"simple creature#has most complex behavior disabled (used for infection form)",
		...
		"shield sapping",
		"runs around flaming",
		"inconsequential#Results in different behavior for: aim magnetism, game_safe_to_save calculations, and infection form pop damage effects",
		"special cinematic unit#cannot turn, no flying death",
	...
	TAG_REFERENCE(actor_variant_group_reference$2, ACTOR_VARIANT_TAG);
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_enum, "format", &unnamed_enum$55 },
		...
		{ _field_short_enum, "usage", &unnamed_enum$56 },
		{ _field_word_flags, "flags", &unnamed_enum$57 },
		...
		FIELD_EXPLANATION("sprite processing", "When creating a sprite group, specify the number and size of textures that the group is allowed to occupy. During importing, you\'ll receive feedback about how well the alloted space was used."),
		{ _field_short_enum, "sprite budget size", &unnamed_enum$58 },
		...
		{ _field_short_enum, "sprite usage", &unnamed_enum$59 },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_enum, "type", "determines bitmap 'geometry'", &unnamed_enum$60 },
		{ _field_short_enum, "format", "determines how pixels are represented internally", &unnamed_enum$61 },
		{ _field_word_flags, "flags", &unnamed_enum$62 },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "particle type", &particle_group_reference$2 },
		{ _field_long_flags, "flags", &unnamed_enum$149 },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$264 },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "widget tag", &ui_widget_definition_group_reference },
		{ _field_string, "name (unused)" },
		{ _field_long_flags, "flags", &unnamed_enum$13 },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 12),
		{ _field_block, "bsps", &collision_bsps_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "widget tag", &ui_widget_definition_group_reference },
		{ _field_string, "name (unused)" },
		{ _field_long_flags, "flags", &unnamed_enum$12 },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 24),
		FIELD_EXPLANATION("vibrate parameters", nullptr),
		...
		FIELD_PAD("value", 12),
		{ _field_short_enum, "wobble function", "a function to perturb the effect's behavior over time", &unnamed_enum$41 },
		FIELD_PAD("value", 2),
		...
		{ _field_short_enum, "side effect", &unnamed_enum$63 },
		{ _field_short_enum, "category", &unnamed_enum$64 },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_word_flags, "flags", &unnamed_enum$72 },
		{ _field_word_flags, "scale flags", "these flags determine which fields are scaled by the contrail density", &unnamed_enum$73 },
		...
		{ _field_short_enum, "render type", "this specifies how the contrail is oriented in space", &unnamed_enum$74 },
		FIELD_PAD("value", 2),
		...
		FIELD_PAD("value", 64),
		FIELD_PAD("value", 40),
		{ _field_word_flags, "shader flags", &unnamed_enum$75 },
		{ _field_short_enum, "framebuffer blend function", &unnamed_enum$76 },
		{ _field_short_enum, "framebuffer fade mode", &unnamed_enum$77 },
		{ _field_word_flags, "map flags", &unnamed_enum$78 },
		FIELD_PAD("value", 28),
		FIELD_EXPLANATION("Secondary Map", "Optional multitextured second map"),
		{ _field_tag_reference, "bitmap", &bitmap_group_reference },
		{ _field_short_enum, "anchor", &unnamed_enum$79 },
		{ _field_word_flags, "flags", &unnamed_enum$78 },
		{ _field_short_enum, "u-animation source", &unnamed_enum$37 },
		{ _field_short_enum, "u-animation function", &unnamed_enum$41 },
		...
		{ _field_short_enum, "v-animation source", &unnamed_enum$37 },
		{ _field_short_enum, "v-animation function", &unnamed_enum$41 },
		...
		{ _field_short_enum, "rotation-animation source", &unnamed_enum$37 },
		{ _field_short_enum, "rotation-animation function", &unnamed_enum$41 },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_long_flags, "scale flags", "these flags determine which fields are scaled by the contrail density", &unnamed_enum$80 },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_real_bounds, "radius", nullptr, "world units" },
		{ _field_real_fraction, "cutoff scale", nullptr, nullptr, "[0,1]" },
		{ _field_long_flags, "flags", &unnamed_enum$132 },
		FIELD_PAD("value", 20),
		...
		{ _field_short_enum, "type", &unnamed_enum$133 },
		{ _field_short_enum, "priority", &unnamed_enum$134 },
		FIELD_PAD("value", 12),
		{ _field_real, "duration", nullptr, "seconds" },
		{ _field_short_enum, "fade function", &unnamed_enum$42 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 8),
		...
		{ _field_short_enum, "falloff function", "a function to envelope the effect's magnitude over time", &unnamed_enum$42 },
		FIELD_PAD("value", 2),
		{ _field_real, "random translation", "random translation in all directions", "world units" },
		{ _field_angle, "random rotation", "random rotation in all directions", "degrees" },
		FIELD_PAD("value", 12),
	...
	{
		{ _field_string, "name" },
		{ _field_long_flags, "flags", &unnamed_enum$68 },
		{ _field_short_enum, "material type", &unnamed_enum$67 },
		FIELD_PAD("value", 2),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 12),
		{ _field_tag_reference, "destroyed effect", &effect_group_reference },
		{ _field_block, "permutations", &damage_permutations_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_word_flags, "flags", &unnamed_enum$85 },
		{ _field_short_enum, "type", "controls how the decal wraps onto surface geometry", &unnamed_enum$86 },
		{ _field_short_enum, "layer", &unnamed_enum$87 },
		FIELD_PAD("value", 2),
		{ _field_tag_reference, "next decal in chain", &decal_group_reference },
		FIELD_EXPLANATION("radius and color", nullptr),
		{ _field_real_bounds, "radius", "0 defaults to 0.125", "world units" },
		FIELD_PAD("value", 12),
		{ _field_real_fraction_bounds, "intensity", "1 is fully visible, 0 is invisible", nullptr, "[0,1]" },
		...
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 20),
		{ _field_tag_reference, "map", &bitmap_group_reference },
		FIELD_PAD("value", 20),
		FIELD_EXPLANATION("sprite info", nullptr),
	...
	STRINGS(unnamed_enum$85)
	{
		...
		"animation loop",
		"preserve aspect",
		"disabled in remastered by blood setting#In MCC, when the \'blood\' setting is switched to off, this will not render in remastered mode"
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_short_enum, "collection type", &unnamed_enum$90 },
		FIELD_PAD("value", 2),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_byte_flags, "type flags", &unnamed_enum$91 },
		FIELD_PAD("value", 2),
	...
	{
		FIELD_PAD("value", 84),
		{ _field_block, "animations", &device_animation_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_long_flags, "flags", &unnamed_enum$81 },
		...
		{ _field_short_enum, "A in", &unnamed_enum$82 },
		{ _field_short_enum, "B in", &unnamed_enum$82 },
		{ _field_short_enum, "C in", &unnamed_enum$82 },
		{ _field_short_enum, "D in", &unnamed_enum$82 },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_enum, "type", &unnamed_enum$83 },
		{ _field_short_enum, "triggers when", &unnamed_enum$84 },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_long_flags, "flags", &unnamed_enum$200 },
		FIELD_PAD("value", 12),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_enum, "type", &unnamed_enum$145 },
		{ _field_word_flags, "flags", &unnamed_enum$146 },
		{ _field_real, "door open time", nullptr, "seconds" },
		FIELD_PAD("value", 80),
		{ _field_short_enum, "collision response", &unnamed_enum$147 },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_tag_reference, "idle noncombat", "played randomly and intermittently whenever we aren't in combat", &sound_group_reference$3 },
		{ _field_tag_reference, "idle combat", "played randomly and intermittently whenever we're in combat", &sound_group_reference$3 },
		{ _field_tag_reference, "idle flee", "played continuously while we are fleeing", &sound_group_reference$3 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		...
		{ _field_tag_reference, "pain body minor", "took body damage", &sound_group_reference$3 },
		{ _field_tag_reference, "pain body major", "took a significant amount of body damage", &sound_group_reference$3 },
		{ _field_tag_reference, "pain shield", "took shield damage", &sound_group_reference$3 },
		{ _field_tag_reference, "pain falling", "took damage from falling", &sound_group_reference$3 },
		{ _field_tag_reference, "scream fear", "screaming in fear (falling to your death, explosive stuck to you)", &sound_group_reference$3 },
		{ _field_tag_reference, "scream pain", "screaming in pain (being flamed)", &sound_group_reference$3 },
		{ _field_tag_reference, "maimed limb", "limb body part (arm or leg) was destroyed", &sound_group_reference$3 },
		{ _field_tag_reference, "maimed head", "head body part was destroyed", &sound_group_reference$3 },
		{ _field_tag_reference, "death quiet", "died from minor damage, or was unprepared", &sound_group_reference$3 },
		{ _field_tag_reference, "death violent", "died from violent trauma", &sound_group_reference$3 },
		{ _field_tag_reference, "death falling", "died from falling", &sound_group_reference$3 },
		{ _field_tag_reference, "death agonizing", "died in a horribly painful fashion (burnt to death)", &sound_group_reference$3 },
		{ _field_tag_reference, "death instant", "died instantly", &sound_group_reference$3 },
		{ _field_tag_reference, "death flying", "died and was blown up into the air", &sound_group_reference$3 },
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("hurting people", nullptr),
		{ _field_tag_reference, "damaged friend", "hurt a friendly AI", &sound_group_reference$3 },
		{ _field_tag_reference, "damaged friend player", "hurt a friendly player", &sound_group_reference$3 },
		{ _field_tag_reference, "damaged enemy", "hurt an enemy", &sound_group_reference$3 },
		{ _field_tag_reference, "damaged enemy cm", "hurt an enemy: comment to friend", &sound_group_reference$3 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("being hurt", nullptr),
		{ _field_tag_reference, "hurt friend", "hurt by a friendly AI", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt friend re", "hurt by a friendly AI: response from that friend", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt friend player", "hurt by a friendly player", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy", "hurt by an enemy", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy re", "hurt by an enemy: response from the enemy that hurt us ('you like that?')", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy cm", "hurt by an enemy: comment from a friend of ours", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy bullet", "hurt by an enemy with bullets", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy needler", "hurt by an enemy with needles", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy plasma", "hurt by an enemy with a plasma bolt", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy sniper", "hurt by an enemy with a sniper weapon", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy grenade", "a grenade is stuck to us", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy explosion", "hurt by an enemy with an explosive weapon", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy melee", "hurt by an enemy with a melee weapon", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy flame", "hurt by an enemy with flamethrower", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy shotgun", "hurt by an enemy with a shotgun", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy vehicle", "hurt by an enemy with a vehicle", &sound_group_reference$3 },
		{ _field_tag_reference, "hurt enemy mountedweapon", "hurt by an enemy with a fixed weapon", &sound_group_reference$3 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("killing people", nullptr),
		{ _field_tag_reference, "killed friend", "killed a friendly AI", &sound_group_reference$3 },
		{ _field_tag_reference, "killed friend cm", "killed a friendly AI: comment from a friend", &sound_group_reference$3 },
		{ _field_tag_reference, "killed friend player", "killed a friendly player", &sound_group_reference$3 },
		{ _field_tag_reference, "killed friend player cm", "killed a friendly player: comment from a friend", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy", "killed an enemy", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy cm", "killed an enemy: comment from a friend", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy player", "killed an enemy player", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy player cm", "killed an enemy player: comment from a friend", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy covenant", "killed an enemy covenant", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy covenant cm", "killed an enemy covenant: comment from a friend", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy floodcombat", "killed an enemy flood combat form", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy floodcombat cm", "killed an enemy flood combat form: comment from a friend", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy floodcarrier", "killed an enemy flood carrier form", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy floodcarrier cm", "killed an enemy flood carrier form: comment from a friend", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy sentinel", "killed an enemy sentinel", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy sentinel cm", "killed an enemy sentinel: comment from a friend", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy bullet", "killed an enemy with bullets", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy needler", "killed an enemy with needles", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy plasma", "killed an enemy with a plasma bolt", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy sniper", "killed an enemy with a sniper weapon", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy grenade", "killed an enemy with a grenade", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy explosion", "killed an enemy with an explosive weapon", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy melee", "killed an enemy with a melee weapon", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy flame", "killed an enemy with flamethrower", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy shotgun", "killed an enemy with a shotgun", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy vehicle", "killed an enemy by hitting them with a vehicle", &sound_group_reference$3 },
		{ _field_tag_reference, "killed enemy mountedweapon", "killed an enemy with a fixed weapon", &sound_group_reference$3 },
		{ _field_tag_reference, "killing spree", "we are on a killing spree", &sound_group_reference$3 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("player kill responses", "responses to a friendly player killing an enemy nearby"),
		{ _field_tag_reference, "player kill cm", "response to the player killing an enemy", &sound_group_reference$3 },
		{ _field_tag_reference, "player kill bullet cm", "response to the player killing an enemy with bullets", &sound_group_reference$3 },
		{ _field_tag_reference, "player kill needler cm", "response to the player killing an enemy with needles", &sound_group_reference$3 },
		{ _field_tag_reference, "player kill plasma cm", "response to the player killing an enemy with a plasma bolt", &sound_group_reference$3 },
		{ _field_tag_reference, "player kill sniper cm", "response to the player killing an enemy with a sniper weapon", &sound_group_reference$3 },
		{ _field_tag_reference, "anyone kill grenade cm", "response to _anyone_ killing an enemy with a grenade", &sound_group_reference$3 },
		{ _field_tag_reference, "player kill explosion cm", "response to the player killing an enemy with an explosive weapon", &sound_group_reference$3 },
		{ _field_tag_reference, "player kill melee cm", "response to the player killing an enemy with a melee weapon", &sound_group_reference$3 },
		{ _field_tag_reference, "player kill flame cm", "response to the player killing an enemy with flamethrower", &sound_group_reference$3 },
		{ _field_tag_reference, "player kill shotgun cm", "response to the player killing an enemy with a shotgun", &sound_group_reference$3 },
		{ _field_tag_reference, "player kill vehicle cm", "response to the player killing an enemy by hitting them with a vehicle", &sound_group_reference$3 },
		{ _field_tag_reference, "player kill mountedweapon cm", "response to the player killing an enemy with a fixed weapon", &sound_group_reference$3 },
		{ _field_tag_reference, "player killling spree cm", "response to the player going on a killing spree", &sound_group_reference$3 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("friends dying", nullptr),
		{ _field_tag_reference, "friend died", "a friendly AI died", &sound_group_reference$3 },
		{ _field_tag_reference, "friend player died", "a friendly player died", &sound_group_reference$3 },
		{ _field_tag_reference, "friend killed by friend", "a friend died from friendly fire", &sound_group_reference$3 },
		{ _field_tag_reference, "friend killed by friendly player", "friend died from player's friendly fire", &sound_group_reference$3 },
		{ _field_tag_reference, "friend killed by enemy", "a friend died from enemy fire", &sound_group_reference$3 },
		{ _field_tag_reference, "friend killed by enemy player", "friend died from an enemy player", &sound_group_reference$3 },
		{ _field_tag_reference, "friend killed by covenant", "a friend died from covenant fire", &sound_group_reference$3 },
		{ _field_tag_reference, "friend killed by flood", "a friend died from the flood", &sound_group_reference$3 },
		{ _field_tag_reference, "friend killed by sentinel", "a friend died from sentinel fire", &sound_group_reference$3 },
		{ _field_tag_reference, "friend betrayed", "a friend was deliberately killed by an ally that we don't trust (e.g. player killed a marine)", &sound_group_reference$3 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("shouting", "vocalizations that can be played even if a friend is talking"),
		{ _field_tag_reference, "new combat alone", "see an enemy and we have not previously been in combat", &sound_group_reference$3 },
		{ _field_tag_reference, "new enemy recent combat", "see a new enemy and we have recently been in combat", &sound_group_reference$3 },
		{ _field_tag_reference, "old enemy sighted", "see an enemy that we are currently looking for", &sound_group_reference$3 },
		{ _field_tag_reference, "unexpected enemy", "unexpectedly encounters enemy (behind or to the side)", &sound_group_reference$3 },
		{ _field_tag_reference, "dead friend found", "unexpectedly finds a dead body of a friend", &sound_group_reference$3 },
		{ _field_tag_reference, "alliance broken", "we decide that a former ally is now a traitor", &sound_group_reference$3 },
		{ _field_tag_reference, "alliance reformed", "we forgive a traitor and make him our friend again", &sound_group_reference$3 },
		{ _field_tag_reference, "grenade throwing", "throwing a grenade", &sound_group_reference$3 },
		{ _field_tag_reference, "grenade sighted", "see an enemy grenade", &sound_group_reference$3 },
		{ _field_tag_reference, "grenade startle", "alerted by a grenade bouncing near us", &sound_group_reference$3 },
		{ _field_tag_reference, "grenade danger enemy", "in danger from an enemy grenade", &sound_group_reference$3 },
		{ _field_tag_reference, "grenade danger self", "in danger from your own grenade", &sound_group_reference$3 },
		{ _field_tag_reference, "grenade danger friend", "in danger from a friendly grenade (not our own)", &sound_group_reference$3 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("group communication", "vocalizations that require friends"),
		{ _field_tag_reference, "new combat group re", "reply to a nearby friend who alerted us to an enemy", &sound_group_reference$3 },
		{ _field_tag_reference, "new combat nearby re", "reply to a distant friend who alerted us to an enemy", &sound_group_reference$3 },
		{ _field_tag_reference, "alert friend", "alert a friend who is in a noncombat state", &sound_group_reference$3 },
		{ _field_tag_reference, "alert friend re", "alerted by a friend when in a noncombat state", &sound_group_reference$3 },
		{ _field_tag_reference, "alert lost contact", "alert friends that target was not at expected location", &sound_group_reference$3 },
		{ _field_tag_reference, "alert lost contact re", "alert friends that target was not at expected location: response", &sound_group_reference$3 },
		{ _field_tag_reference, "blocked", "friend is blocking us from moving or firing", &sound_group_reference$3 },
		{ _field_tag_reference, "blocked re", "friend is blocking us from moving or firing: response", &sound_group_reference$3 },
		{ _field_tag_reference, "search start", "starting to search", &sound_group_reference$3 },
		{ _field_tag_reference, "search query", "asking searchers whether they have found anything", &sound_group_reference$3 },
		{ _field_tag_reference, "search query re", "asking searchers whether they have found anything: response", &sound_group_reference$3 },
		{ _field_tag_reference, "search report", "searcher reporting that an area is clear", &sound_group_reference$3 },
		{ _field_tag_reference, "search abandon", "searcher giving up on search", &sound_group_reference$3 },
		{ _field_tag_reference, "search group abandon", "search coordinator giving up on search", &sound_group_reference$3 },
		{ _field_tag_reference, "group uncover", "starting to uncover target with friend", &sound_group_reference$3 },
		{ _field_tag_reference, "group uncover re", "starting to uncover target: response", &sound_group_reference$3 },
		{ _field_tag_reference, "advance", "our platoon starts to attack or advance", &sound_group_reference$3 },
		{ _field_tag_reference, "advance re", "our platoon starts to attack or advance: response", &sound_group_reference$3 },
		{ _field_tag_reference, "retreat", "our platoon starts to defend or retreat", &sound_group_reference$3 },
		{ _field_tag_reference, "retreat re", "our platoon starts to defend or retreat: response", &sound_group_reference$3 },
		{ _field_tag_reference, "cover", "telling friends to seek cover", &sound_group_reference$3 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("actions", "vocalizations that don\'t require friends"),
		{ _field_tag_reference, "sighted friend player", "sighted a new friendly player", &sound_group_reference$3 },
		{ _field_tag_reference, "shooting", "shooting at an enemy", &sound_group_reference$3 },
		{ _field_tag_reference, "shooting vehicle", "shooting from a vehicle at an enemy", &sound_group_reference$3 },
		{ _field_tag_reference, "shooting berserk", "shooting at an enemy while berserk", &sound_group_reference$3 },
		{ _field_tag_reference, "shooting group", "shooting at a group of enemies", &sound_group_reference$3 },
		{ _field_tag_reference, "shooting traitor", "shooting at a traitorous player", &sound_group_reference$3 },
		{ _field_tag_reference, "taunt", "taunting the enemy", &sound_group_reference$3 },
		{ _field_tag_reference, "taunt re", "taunted by an enemy: response", &sound_group_reference$3 },
		{ _field_tag_reference, "flee", "fleeing in panic", &sound_group_reference$3 },
		{ _field_tag_reference, "flee re", "fleeing in panic: response", &sound_group_reference$3 },
		{ _field_tag_reference, "flee leader died", "fleeing in panic because our leaders are all dead", &sound_group_reference$3 },
		{ _field_tag_reference, "attempted flee", "unable to flee because a leader is nearby", &sound_group_reference$3 },
		{ _field_tag_reference, "attempted flee re", "unable to flee because a leader is nearby - response", &sound_group_reference$3 },
		{ _field_tag_reference, "lost contact", "target was not at expected location", &sound_group_reference$3 },
		{ _field_tag_reference, "hiding finished", "stops hiding and pursues target", &sound_group_reference$3 },
		{ _field_tag_reference, "vehicle entry", "enters vehicle", &sound_group_reference$3 },
		{ _field_tag_reference, "vehicle exit", "exits vehicle", &sound_group_reference$3 },
		{ _field_tag_reference, "vehicle woohoo", "excited while in vehicle (big air, etc)", &sound_group_reference$3 },
		{ _field_tag_reference, "vehicle scared", "scared while in vehicle (imminent crash)", &sound_group_reference$3 },
		{ _field_tag_reference, "vehicle collision", "riding in a vehicle and the driver collides with something", &sound_group_reference$3 },
		{ _field_tag_reference, "partially sighted", "saw something suspicious but not sure it was an enemy", &sound_group_reference$3 },
		{ _field_tag_reference, "nothing there", "decided that a suspicious sighting was nothing after all", &sound_group_reference$3 },
		{ _field_tag_reference, "pleading", "pleading for the player to spare our pitiable lives", &sound_group_reference$3 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		...
		{ _field_tag_reference, "surprise", "surprised by an enemy, noise, body or weapon impact", &sound_group_reference$3 },
		{ _field_tag_reference, "berserk", "went berserk", &sound_group_reference$3 },
		{ _field_tag_reference, "melee attack", "attacked an enemy in melee", &sound_group_reference$3 },
		{ _field_tag_reference, "dive", "dove away from danger or into cover", &sound_group_reference$3 },
		{ _field_tag_reference, "uncover exclamation", "leapt out of corner to uncover a suspected target", &sound_group_reference$3 },
		{ _field_tag_reference, "leap attack", "begin a leap attack", &sound_group_reference$3 },
		{ _field_tag_reference, "resurrection", "arise and return to life", &sound_group_reference$3 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("post-combat actions", "vocalizations that immediately follow combat"),
		{ _field_tag_reference, "celebration", "all enemies defeated", &sound_group_reference$3 },
		{ _field_tag_reference, "check body enemy", "post-combat checking an enemy's dead body", &sound_group_reference$3 },
		{ _field_tag_reference, "check body friend", "post-combat checking a friend's dead body", &sound_group_reference$3 },
		{ _field_tag_reference, "shooting dead enemy", "post-combat shooting an enemy's dead body", &sound_group_reference$3 },
		{ _field_tag_reference, "shooting dead enemy player", "post-combat shooting an enemy player's dead body", &sound_group_reference$3 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("post-combat chatter", "vocalizations that immediately follow combat"),
		{ _field_tag_reference, "alone", "post-combat all friends killed", &sound_group_reference$3 },
		{ _field_tag_reference, "unscathed", "post-combat we were not hurt", &sound_group_reference$3 },
		{ _field_tag_reference, "seriously wounded", "post-combat we were badly hurt", &sound_group_reference$3 },
		{ _field_tag_reference, "seriously wounded re", "post-combat replying to a friend who was badly hurt", &sound_group_reference$3 },
		{ _field_tag_reference, "massacre", "post-combat our friends took heavy casualties", &sound_group_reference$3 },
		{ _field_tag_reference, "massacre re", "post-combat reply: our friends took heavy casualties", &sound_group_reference$3 },
		{ _field_tag_reference, "rout", "post-combat our friends kicked alien BLAM", FIELD_FLAG_UNKNOWN0, &sound_group_reference$3 },
		{ _field_tag_reference, "rout re", "post-combat reply: our friends kicked alien BLAM", FIELD_FLAG_UNKNOWN0, &sound_group_reference$3 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 16),
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_real_point_3d, "position" },
		FIELD_PAD("value", 16),
		{ _field_data, "comment", &editor_comment_data_definition },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$92 },
		{ _field_short_block_index, "loop start event" },
		{ _field_short_block_index, "loop stop event" },
		FIELD_PAD("value", 32),
	...
	STRINGS(unnamed_enum$92)
	{
		...
		"must_be_deterministic#set automagically by postprocessing*",
		"disabled in remastered by blood setting#In MCC, when the \'blood\' setting is switched to off, this will not render in remastered mode"
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_block, "particles", &effect_particles_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_short_enum, "create in", &unnamed_enum$93 },
		{ _field_short_enum, "violence mode", &unnamed_enum$94 },
		{ _field_short_block_index, "location" },
		{ _field_word_flags, "flags", &unnamed_enum$95 },
		FIELD_PAD("value", 16),
		{ _field_tag_reference, "type", &damage_effect_group_object_group_particle_system_group_sound_group_decal_group_light_group_reference },
		FIELD_PAD("value", 24),
		...
		{ _field_long_flags, "A scales values", &unnamed_enum$96 },
		{ _field_long_flags, "B scales values", &unnamed_enum$96 },
		{ _field_terminator }
	};
	...
	TAG_REFERENCE_GROUP(damage_effect_group_object_group_particle_system_group_sound_group_decal_group_light_group_reference)
	{
		DAMAGE_EFFECT_TAG,
		OBJECT_TAG,
		PARTICLE_SYSTEM_TAG,
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_short_enum, "create in", &unnamed_enum$93 },
		{ _field_short_enum, "violence mode", &unnamed_enum$94 },
		{ _field_short_enum, "create", &unnamed_enum$97 },
		FIELD_PAD("value", 2),
		{ _field_short_block_index, "location" },
		FIELD_PAD("value", 2),
		...
		FIELD_PAD("value", 12),
		FIELD_PAD("value", 40),
		{ _field_tag_reference, "particle type", &particle_group_reference },
		{ _field_long_flags, "flags", &unnamed_enum$98 },
		{ _field_short_enum, "distribution function", "describes how the part creations are distributed over the event duration", &unnamed_enum$99 },
		FIELD_PAD("value", 2),
		...
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("SCALE MODIFIERS", nullptr),
		{ _field_long_flags, "A scales values", &unnamed_enum$100 },
		{ _field_long_flags, "B scales values", &unnamed_enum$100 },
		{ _field_terminator }
	};
	...
	{
		{ _field_string, "name" },
		{ _field_long_flags, "flags", &unnamed_enum$208 },
		{ _field_short_enum, "team index", &unnamed_enum$209 },
		FIELD_SKIP("value", 2),
		{ _field_short_enum, "search behavior", &unnamed_enum$210 },
		{ _field_short_integer, "manual bsp index", "structure bsp index that this encounter belongs to... ignored unless 'manual bsp index' flag is checked. if this flag is not checked, the structure bsp is found automatically (may fail in areas of overlapping geometry)" },
		...
		{ _field_block, "platoons", &platoons_block },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_EXPLANATION("message-index", "This sets which string from tags\\ui\\hud\\hud_item_messages.unicode_string_list to display."),
		...
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 16),
		{ _field_short_enum, "A in", &unnamed_enum$103 },
		{ _field_short_enum, "B in", &unnamed_enum$103 },
		{ _field_short_enum, "C in", &unnamed_enum$103 },
		{ _field_short_enum, "D in", &unnamed_enum$103 },
		FIELD_PAD("value", 164),
		...
		{ _field_short_enum, "powerup type", &unnamed_enum$104 },
		{ _field_short_enum, "grenade type", &unnamed_enum$25 },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$5 },
		{ _field_short_enum, "event type", &unnamed_enum$6 },
		{ _field_short_enum, "function", &unnamed_enum$7 },
		{ _field_tag_reference, "widget tag", &ui_widget_definition_group_reference },
		{ _field_tag_reference, "sound effect", &sound_group_reference },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_tag_reference, "vehicle environemtn collision damage effect", &damage_effect_group_reference },
	...
	{
		{ _field_real_point_3d, "position" },
		{ _field_short_enum, "group index", &unnamed_enum$219 },
		FIELD_PAD("value", 10),
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "first person hands", &gbxmodel_group_reference$2 },
		{ _field_tag_reference, "base bitmap", &bitmap_group_reference },
		{ _field_tag_reference, "shield meter", &meter_group_reference },
		{ _field_point_2d, "shield meter origin" },
		{ _field_tag_reference, "body meter", &meter_group_reference },
		{ _field_point_2d, "body meter origin" },
		{ _field_tag_reference, "night-vision OFF->ON effect", &effect_group_reference },
		{ _field_tag_reference, "night-vision ON->OFF effect", &effect_group_reference },
		FIELD_PAD("value", 88),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$105 },
		{ _field_short_enum, "trailing edge shape", &unnamed_enum$106 },
		...
		{ _field_short_enum, "attached edge shape", &unnamed_enum$107 },
		FIELD_PAD("value", 2),
		...
		{ _field_tag_reference, "red flag shader", &shader_group_reference },
		{ _field_tag_reference, "physics", &point_physics_group_reference },
		{ _field_real, "wind noise", nullptr, "world units per second^2" },
		FIELD_PAD("value", 8),
		{ _field_tag_reference, "blue flag shader", &shader_group_reference },
		{ _field_block, "attachment points", "attachment points determine where the flag is attached", &flag_attachment_point_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_long_flags, "flags", &unnamed_enum$108 },
		FIELD_PAD("value", 4),
		FIELD_PAD("value", 76),
		...
		FIELD_EXPLANATION("SCREEN LAYERS", nullptr),
		{ _field_word_flags, "flags", &unnamed_enum$109 },
		...
		{ _field_real_fraction_bounds, "density gradient", nullptr, nullptr, "[0,1]" },
		...
		{ _field_tag_reference, "map", &bitmap_group_reference },
		FIELD_EXPLANATION("SCREEN LAYER ANIMATION", nullptr),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 36),
		{ _field_block, "character tables", &font_character_tables_block },
		{ _field_tag_reference, "bold", &font_group_reference },
		{ _field_tag_reference, "italic", &font_group_reference },
		{ _field_tag_reference, "condense", &font_group_reference },
		{ _field_tag_reference, "underline", &font_group_reference },
		{ _field_block, "characters", &font_character_block },
		{ _field_data, "pixels", &pixels },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_integer, "bitmap width" },
		{ _field_short_integer, "bitmap height" },
		{ _field_short_integer, "bitmap origin x" },
		{ _field_short_integer, "bitmap origin y" },
		{ _field_short_integer, "hardware character index" },
		FIELD_PAD("value", 2),
		{ _field_long_integer, "pixels offset" },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_block, "character table", &font_character_table_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_short_enum, "function", &unnamed_enum$4 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 32),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$154 },
		{ _field_long_integer, "node list checksum" },
		...
		FIELD_PAD("value", 116),
		{ _field_block, "markers", &model_markers_block },
		{ _field_block, "nodes", &model_node_block },
		{ _field_block, "regions", &gbxmodel_region_block },
		{ _field_block, "geometries", &gbxmodel_geometry_block },
		{ _field_block, "shaders", &model_shader_reference_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 32),
		{ _field_block, "parts", &gbxmodel_geometry_part_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$157 },
		...
		{ _field_block, "uncompressed vertices", &model_vertex_uncompressed_block },
		{ _field_block, "compressed vertices", &model_vertex_compressed_block },
		{ _field_block, "triangles", &model_triangle_block },
		FIELD_PAD("value", 20),
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 1),
		FIELD_PAD("value", 1),
		...
		{ _field_array, "local_node_table", &unnamed_array$4 },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_string, "name" },
		FIELD_PAD("value", 32),
		{ _field_block, "permutations", &gbxmodel_region_permutation_block },
		{ _field_terminator }
	};
	...
	{
		{ _field_string, "name" },
		{ _field_long_flags, "flags", &unnamed_enum$155 },
		FIELD_PAD("value", 28),
		...
		FIELD_PAD("value", 2),
		{ _field_block, "markers", "import markers, will automagically be postprocessed to model_marker_instance_block", &model_region_permutation_marker_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_enum, "framebuffer blend func", &unnamed_enum$76 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 32),
		...
		{ _field_short_enum, "primary anchor", &unnamed_enum$118 },
		{ _field_short_enum, "secondary anchor", &unnamed_enum$118 },
		{ _field_short_enum, "tertiary anchor", &unnamed_enum$118 },
		FIELD_EXPLANATION("blending function", "how to blend the textures together"),
		{ _field_short_enum, "0 to 1 blend func", &unnamed_enum$119 },
		{ _field_short_enum, "1 to 2 blend func", &unnamed_enum$119 },
		FIELD_PAD("value", 2),
		...
		{ _field_short_enum, "primary wrap mode", &unnamed_enum$120 },
		{ _field_short_enum, "secondary wrap mode", &unnamed_enum$120 },
		{ _field_short_enum, "tertiary wrap mode", &unnamed_enum$120 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 184),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_enum, "destination type", &unnamed_enum$121 },
		{ _field_short_enum, "destination", &unnamed_enum$122 },
		{ _field_short_enum, "source", &unnamed_enum$123 },
		FIELD_PAD("value", 2),
		...
		{ _field_short_enum, "periodic function", &unnamed_enum$41 },
		FIELD_PAD("value", 2),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_word_flags, "flags", &unnamed_enum$293 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 16),
		...
		{ _field_word_flags, "flags", &unnamed_enum$294 },
		FIELD_PAD("value", 2),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_block, "vertices", &leaf_portal_vertex_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_block, "portal indices", &map_leaf_portal_index_block },
		{ _field_terminator }
	};
	...
	{
		FIELD_PAD("value", 248),
		{ _field_block, "sounds", &gg_sound_block },
		...
		{ _field_block, "interface bitmaps", &interface_tag_references_block },
		...
		{ _field_block, "first person interface", &first_person_interface_block },
		{ _field_block, "falling damage", &falling_damage_block },
		{ _field_block, "materials", &materials_block },
		{ _field_block, "playlist members", &playlist_autogenerate_choice_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_enum, "boundary effect", "particles behavior on reaching the end of an object", &unnamed_enum$110 },
		{ _field_short_enum, "normal particle distribution", "distribution of the normal particles about the object", &unnamed_enum$111 },
		{ _field_short_enum, "trailing particle distribution", "distribution of the trailing particles about the object", &unnamed_enum$112 },
		{ _field_long_flags, "glow flags", &unnamed_enum$113 },
		FIELD_PAD("value", 28),
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 4),
		{ _field_short_enum, "attachment", &unnamed_enum$114 },
		FIELD_PAD("value", 2),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_word_flags, "scaling flags", &unnamed_enum$116 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 20),
		...
		{ _field_word_flags, "flash flags", &unnamed_enum$117 },
		...
		{ _field_byte_flags, "flags", &unnamed_enum$124 },
		...
		{ _field_byte_flags, "flags", &unnamed_enum$128 },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_integer, "sequence index" },
		{ _field_word_flags, "type", &unnamed_enum$125 },
		{ _field_long_flags, "flags", &unnamed_enum$126 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 40),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_long_flags, "latched to", &unnamed_enum$127 },
		{ _field_real, "scale" },
		FIELD_PAD("value", 32),
		{ _field_terminator }
	};

	TAG_REFERENCE_GROUP(sound_group_sound_looping_group_reference)
	{
		SOUND_TAG,
		SOUND_LOOPING_TAG,
		INVALID_TAG
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_tag_reference, "hud interface", &grenade_hud_interface_group_reference },
	...
	{
		{ _field_string, "name" },
		{ _field_short_enum, "type", &unnamed_enum$228 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 4),
	...
	{
		FIELD_PAD("value", 24),
		{ _field_tag_reference, "reference", &_reference },
		{ _field_terminator }
	};
	...
	{
		{ _field_string, "name" },
		{ _field_short_enum, "script type", &unnamed_enum$227 },
		{ _field_short_enum, "return type", &unnamed_enum$228 },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "target bitmap", &bitmap_group_reference },
		{ _field_short_enum, "language", &unnamed_enum$130 },
		{ _field_word_flags, "flags", &unnamed_enum$131 },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "original bitmap", &bitmap_group_reference },
		{ _field_block, "targets", &hud_bitmap_remap_element_block_definition_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 20),
		{ _field_tag_reference, "fullscreen font", &font_group_reference },
		{ _field_tag_reference, "splitscreen font", &font_group_reference },
		{ _field_real, "up time" },
		{ _field_real, "fade time" },
		{ _field_real_argb_color, "icon color" },
		{ _field_real_argb_color, "text color" },
		{ _field_real, "text spacing" },
		{ _field_tag_reference, "item message text", &unicode_string_list_group_reference },
		{ _field_tag_reference, "icon bitmap", &bitmap_group_reference },
		{ _field_tag_reference, "alternate icon text", &unicode_string_list_group_reference },
		...
		{ _field_tag_reference, "default weapon hud", &weapon_hud_interface_group_reference },
		...
		{ _field_short_integer, "fullscreen sequence index" },
		{ _field_short_integer, "splitscreen sequence index" },
		...
		FIELD_EXPLANATION("Hud stuff that wouldn't fit anywhere else", nullptr),
		{ _field_short_integer, "loading begin text", nullptr, "item message text index" },
		{ _field_short_integer, "loading end text", nullptr, "item message text index" },
		{ _field_short_integer, "checkpoint begin text", nullptr, "item message text index" },
		{ _field_short_integer, "checkpoint end text", nullptr, "item message text index" },
		{ _field_tag_reference, "checkpoint sound", &sound_group_reference },
		FIELD_EXPLANATION("Remap bitmaps for remastered hud", nullptr),
		{ _field_block, "remaps", &hud_bitmap_remaps_block_definition_block },
		FIELD_PAD("value", 84),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_data, "text data", &string_data },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 16),
		{ _field_long_flags, "flags", &unnamed_enum$129 },
		FIELD_PAD("value", 24),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_short_enum, "device type", &unnamed_enum$88 },
		{ _field_word_flags, "flags", &unnamed_enum$89 },
		{ _field_data, "device id", &deviceid_data },
		{ _field_data, "profile", &player_profile_data },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "font system", &font_group_reference },
		{ _field_tag_reference, "font terminal", &font_group_reference },
		...
		{ _field_tag_reference, "localization", &string_list_group_reference },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_word_flags, "flags", &unnamed_enum$70 },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_enum, "occlusion offset direction", &unnamed_enum$135 },
		FIELD_PAD("value", 2),
		...
		{ _field_tag_reference, "bitmap", "used by reflections", &bitmap_group_reference },
		{ _field_word_flags, "flags", &unnamed_enum$136 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 76),
		FIELD_EXPLANATION("corona rotation", "Controls how corona rotation is affected by viewer and light angles."),
		{ _field_short_enum, "rotation function", &unnamed_enum$137 },
		FIELD_PAD("value", 2),
		{ _field_angle, "rotation function scale", nullptr, "degrees" },
		FIELD_PAD("value", 24),
		FIELD_EXPLANATION("corona radius scale", nullptr),
	...
	STRINGS(unnamed_enum$136)
	{
		...
		"fade in more quickly*#not supported",
		"fade out more quickly*#not supported",
		"scale by marker"
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_word_flags, "flags", &unnamed_enum$138 },
		FIELD_PAD("value", 2),
		{ _field_short_integer, "bitmap index" },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 20),
		...
		{ _field_short_enum, "radius scaled by", &unnamed_enum$139 },
		FIELD_PAD("value", 2),
		{ _field_real_fraction_bounds, "brightness", "interpolated by light scale", nullptr, "[0,1]" },
		{ _field_short_enum, "brightness scaled by", &unnamed_enum$139 },
		FIELD_PAD("value", 2),
		...
		FIELD_EXPLANATION("animation", "Causes lens flare reflection to flicker, pulse, or whatever. Animated color modulates tint color, above, while animated alpha modulates brightness. Animation is ignored if tint color is BLACK or the animation function is ONE or ZERO."),
		...
		{ _field_word_flags, "flags", &unnamed_enum$140 },
		{ _field_short_enum, "animation function", &unnamed_enum$41 },
	...
	STRINGS(unnamed_enum$138)
	{
		...
		"radius scaled by occlusion factor#scales radius by 1/2 to 1 as occlusion goes from 0 to 1",
		"occluded by solid objects#reflection will be drawn with the zbuffer enabled (it will be drawn \'behind\' solid geometry)"
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$141 },
		...
		{ _field_real_bounds, "radius modifier", "how the radius changes with external scale" },
		...
		FIELD_PAD("value", 24),
		FIELD_EXPLANATION("COLOR", nullptr),
		{ _field_long_flags, "interpolation flags", &unnamed_enum$44 },
		{ _field_real_argb_color, "color lower bound" },
		{ _field_real_argb_color, "color upper bound" },
		FIELD_PAD("value", 12),
		FIELD_EXPLANATION("GEL", "the gel map tints the light per-pixel of cube map"),
		{ _field_tag_reference, "primary cube map", "used for diffuse and specular light", &bitmap_group_reference },
		FIELD_PAD("value", 2),
		{ _field_short_enum, "texture animation function", "a function to control texture animation", &unnamed_enum$41 },
		{ _field_real, "texture animation period", "time between repeats", "seconds" },
		{ _field_tag_reference, "secondary cube map", "used for specular light", &bitmap_group_reference },
		FIELD_PAD("value", 2),
		{ _field_short_enum, "yaw function", "a function to control rotation of the gel in yaw", &unnamed_enum$41 },
		{ _field_real, "yaw period", "time between repeats", "seconds" },
		FIELD_PAD("value", 2),
		{ _field_short_enum, "roll function", "a function to control rotation of the gel in roll", &unnamed_enum$41 },
		{ _field_real, "roll period", "time between repeats", "seconds" },
		FIELD_PAD("value", 2),
		{ _field_short_enum, "pitch function", "a function to control rotation of the gel in pitch", &unnamed_enum$41 },
		{ _field_real, "pitch period", "time between repeats", "seconds" },
		FIELD_PAD("value", 8),
		FIELD_EXPLANATION("LENS FLARE", "optional lens flare associated with this light"),
		...
		FIELD_PAD("value", 2),
		{ _field_short_enum, "falloff function", "the scale of the light will diminish over time according to this function", &unnamed_enum$42 },
		FIELD_PAD("value", 8),
		FIELD_PAD("value", 92),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 2),
		{ _field_word_flags, "flags", &unnamed_enum$153 },
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("brightness scale", "Fades the effect in and out with distance, viewer angle, and external source."),
		...
		{ _field_short_enum, "brightness scale source", "scales brightness based on external value", &unnamed_enum$37 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 20),
		FIELD_EXPLANATION("bitmaps", "Bitmap tag used to draw the light volume, repeated <count> times. Default is \'tags\\rasterizer_textures\\glow\'. Note that sprite plates are not valid for light volumes."),
		{ _field_tag_reference, "map", "NOT A SPRITE PLATE", &bitmap_group_reference },
		{ _field_short_integer, "sequence index" },
		{ _field_short_integer, "count", "number of bitmaps to draw (0 causes light volume not to render)" },
		FIELD_PAD("value", 72),
		FIELD_EXPLANATION("frame animation", "Frames are descriptions of the light volume at a particular point in time, interpolated by an external source. For example, a bolt of energy can be made to stretch out and grow thinner as it is fired from a weapon."),
		{ _field_short_enum, "frame animation source", "interpolates between frames based on external value", &unnamed_enum$37 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 36),
		FIELD_PAD("value", 64),
		{ _field_block, "frames", &light_volume_frame_block },
		FIELD_PAD("value", 32),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 16),
		{ _field_short_enum, "jitter scale source", &unnamed_enum$37 },
		{ _field_short_enum, "thickness scale source", &unnamed_enum$37 },
		{ _field_short_enum, "tint modulation source", &unnamed_enum$38 },
		{ _field_short_enum, "brightness scale source", &unnamed_enum$37 },
		{ _field_tag_reference, "bitmap", &bitmap_group_reference },
		FIELD_PAD("value", 84),
		{ _field_block, "markers", &lightning_marker_block },
		{ _field_block, "shader", &lightning_shader_block },
		FIELD_PAD("value", 88),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_word_flags, "flags", &unnamed_enum$101 },
		FIELD_PAD("value", 2),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_long_flags, "flags", &unnamed_enum$144 },
		FIELD_PAD("value", 48),
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$143 },
		{ _field_real_fraction, "gain" },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 8),
		FIELD_PAD("value", 16),
		{ _field_tag_reference, "reloading effect", &sound_group_effect_group_reference$3 },
		{ _field_tag_reference, "chambering effect", &sound_group_effect_group_reference$3 },
		FIELD_PAD("value", 12),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_long_flags, "flags", &unnamed_enum$167 },
		...
		{ _field_short_enum, "friction type", &unnamed_enum$168 },
		FIELD_PAD("value", 2),
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_block, "materials", &material_effect_material_block },
		FIELD_PAD("value", 16),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_tag_reference, "sound", &sound_group_reference },
		FIELD_PAD("value", 24),
		{ _field_block, "particle effects", &breakable_surface_particle_effect_block },
		FIELD_PAD("value", 60),
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$150 },
		{ _field_tag_reference, "stencil bitmaps", "two bitmaps specifying the mask and the meter levels", &bitmap_group_reference$4 },
		...
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 4),
		{ _field_short_enum, "interpolate colors...", &unnamed_enum$151 },
		{ _field_short_enum, "anchor colors...", &unnamed_enum$152 },
		FIELD_PAD("value", 8),
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_block, "OBJECTS", &animation_graph_object_overlay_block },
		{ _field_block, "UNITS", &animation_graph_unit_seat_block },
		{ _field_block, "WEAPONS", &animation_graph_weapon_animations_block },
		{ _field_block, "VEHICLES", &animation_graph_vehicle_animations_block },
		{ _field_block, "DEVICES", &device_animations_block },
		{ _field_block, "UNIT DAMAGE", &unit_damage_animations_block },
		{ _field_block, "FIRST PERSON WEAPONS", &animation_graph_first_person_weapon_animations_block },
		{ _field_block, "sound references", &animation_graph_sound_reference_block },
		{ _field_real, "limp body node radius", "0 uses 0.04 default" },
		{ _field_word_flags, "flags", &unnamed_enum$30 },
		FIELD_PAD("value", 2),
		{ _field_block, "nodes", &animation_graph_node_block },
		{ _field_block, "animations", &animation_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_block, "markers", &model_markers_block },
		{ _field_block, "nodes", &model_node_block },
		{ _field_block, "regions", &model_region_block },
		{ _field_block, "geometries", &model_geometry_block },
		{ _field_block, "shaders", &model_shader_reference_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$66 },
		...
		FIELD_PAD("value", 2),
		{ _field_short_enum, "shield material type", "the material type used when projectiles impact the shield (instead of the body)", &unnamed_enum$67 },
		FIELD_PAD("value", 24),
		{ _field_short_enum, "shield failure function", "how fast the shield begins to leak", &unnamed_enum$42 },
		FIELD_PAD("value", 2),
		...
		FIELD_PAD("value", 12),
		FIELD_PAD("value", 112),
		{ _field_block, "materials", &damage_materials_block },
		{ _field_block, "regions", &damage_regions_block },
		{ _field_block, "modifiers", &damage_modifiers_block },
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("pathfinding box", nullptr),
		{ _field_real_bounds, "x" },
		{ _field_real_bounds, "y" },
		{ _field_real_bounds, "z" },
		{ _field_block, "pathfinding spheres", &pathfinding_spheres_block },
		{ _field_block, "nodes", &collision_nodes_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$156 },
		FIELD_PAD("value", 32),
		{ _field_block, "parts", &model_geometry_part_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 16),
		{ _field_block, "instances", &model_marker_instance_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_string, "name" },
		FIELD_PAD("value", 32),
		{ _field_block, "permutations", &model_region_permutation_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "type", &light_group_light_volume_group_contrail_group_particle_system_group_effect_group_sound_looping_group_reference },
		{ _field_string, "marker" },
		{ _field_short_enum, "primary scale", &unnamed_enum$37 },
		{ _field_short_enum, "secondary scale", &unnamed_enum$37 },
		{ _field_short_enum, "change color", &unnamed_enum$38 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 16),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_short_enum, "darken by", &unnamed_enum$40 },
		{ _field_short_enum, "scale by", &unnamed_enum$40 },
		{ _field_long_flags, "scale flags", &unnamed_enum$44 },
		{ _field_real_rgb_color, "color lower bound" },
		{ _field_real_rgb_color, "color upper bound" },
		{ _field_block, "permutations", &object_change_color_permutations_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$39 },
		...
		{ _field_short_enum, "scale period by", "multiply this function by the above period", &unnamed_enum$40 },
		{ _field_short_enum, "function", &unnamed_enum$41 },
		{ _field_short_enum, "scale function by", "multiply this function by the result of the above function", &unnamed_enum$40 },
		{ _field_short_enum, "wobble function", "the curve used for the wobble", &unnamed_enum$41 },
		...
		{ _field_short_enum, "map to", &unnamed_enum$42 },
		...
		{ _field_short_enum, "add", "add this function to the final result of all of the above math", &unnamed_enum$40 },
		{ _field_short_enum, "scale result by", "multiply this function (from a weapon, vehicle, etc.) final result of all of the above math", &unnamed_enum$40 },
		{ _field_short_enum, "bounds mode", "controls how the bounds, below, are used", &unnamed_enum$43 },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "reference", &flag_group_antenna_group_glow_group_light_volume_group_lightning_group_reference },
		FIELD_PAD("value", 16),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$158 },
		{ _field_tag_reference, "bitmap", &bitmap_group_reference },
		{ _field_tag_reference, "physics", &point_physics_group_reference },
		{ _field_tag_reference, "collision material effects", "no one traded their kids for this", &material_effects_group_reference },
		FIELD_PAD("value", 4),
		{ _field_real_bounds, "lifespan", nullptr, "seconds" },
		{ _field_real, "fade in time" },
		{ _field_real, "fade out time" },
		{ _field_tag_reference, "collision effect", &sound_group_effect_group_reference$2 },
		{ _field_tag_reference, "death effect", &sound_group_effect_group_reference$2 },
		...
		FIELD_PAD("value", 12),
		{ _field_short_enum, "orientation", &unnamed_enum$159 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 40),
		{ _field_word_flags, "shader flags", &unnamed_enum$75 },
		{ _field_short_enum, "framebuffer blend function", &unnamed_enum$76 },
		...
		PERSISTENT_ID_EMPTY)
	{
		FIELD_PAD("value", 4),
		FIELD_PAD("value", 52),
		FIELD_EXPLANATION("system behavior", "These settings affect the behavior of the system\'s origin."),
		{ _field_tag_reference, "point physics", &point_physics_group_reference },
		{ _field_short_enum, "system update physics", &unnamed_enum$160 },
		FIELD_PAD("value", 2),
		{ _field_long_flags, "physics flags", &unnamed_enum$161 },
		{ _field_block, "physics constants", &particle_system_physics_constants_block },
		{ _field_block, "particle types", &particle_system_types_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_tag_reference, "bitmaps", &bitmap_group_reference },
		{ _field_short_integer, "sequence index" },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 4),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 84),
		{ _field_short_enum, "particle creation physics", "This controls the placement of particles created during this state.", &unnamed_enum$164 },
		{ _field_short_enum, "particle update physics", "This controls the motion of particles during this state.", &unnamed_enum$165 },
		{ _field_block, "physics constants", &particle_system_physics_constants_block },
		{ _field_terminator }
	};
	...
	{
		{ _field_string, "name" },
		{ _field_long_flags, "flags", &unnamed_enum$162 },
		{ _field_short_integer, "initial particle count" },
		FIELD_PAD("value", 2),
		{ _field_short_enum, "complex sprite render modes", &unnamed_enum$163 },
		FIELD_PAD("value", 2),
		{ _field_real, "radius", nullptr, "world units" },
		FIELD_PAD("value", 36),
		{ _field_short_enum, "particle creation physics", "This controls the initial placement of particles.", &unnamed_enum$164 },
		FIELD_PAD("value", 2),
		{ _field_long_flags, "physics flags", &unnamed_enum$161 },
		{ _field_block, "physics constants", &particle_system_physics_constants_block },
		{ _field_block, "states", &particle_system_type_states_block },
		{ _field_block, "particle states", &particle_system_type_particle_states_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 12),
		{ _field_short_enum, "change attacking/defending state when", &unnamed_enum$218 },
		{ _field_short_block_index, "happens to" },
		FIELD_PAD("value", 4),
		FIELD_PAD("value", 4),
		{ _field_short_enum, "maneuver when", &unnamed_enum$218 },
		{ _field_short_block_index, "happens to" },
		FIELD_PAD("value", 4),
		FIELD_PAD("value", 4),
		FIELD_PAD("value", 64),
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$169 },
		FIELD_PAD("value", 28),
	...
	{
		{ _field_string, "name" },
		{ _field_long_flags, "flags", &unnamed_enum$166 },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_short_enum, "type", &unnamed_enum$45 },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_tag_reference, "pattern", &bitmap_group_reference },
		{ _field_short_integer, "bitmap index" },
		FIELD_PAD("value", 2),
		{ _field_tag_reference, "decal", &bitmap_group_reference },
		{ _field_short_integer, "bitmap index" },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 800),
		{ _field_terminator }
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_long_flags, "flags", &unnamed_enum$170 },
		{ _field_short_enum, "detonation timer starts", &unnamed_enum$171 },
		{ _field_short_enum, "impact noise", &unnamed_enum$48 },
		{ _field_short_enum, "A in", &unnamed_enum$172 },
		{ _field_short_enum, "B in", &unnamed_enum$172 },
		{ _field_short_enum, "C in", &unnamed_enum$172 },
		{ _field_short_enum, "D in", &unnamed_enum$172 },
		...
		{ _field_short_enum, "detonation noise", &unnamed_enum$48 },
		FIELD_PAD("value", 2),
		...
		FIELD_PAD("value", 12),
		{ _field_block, "material responses", &projectile_material_response_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_word_flags, "flags", &unnamed_enum$173 },
		FIELD_EXPLANATION("default result", "(if the potential result, below, fails to happen)"),
		{ _field_short_enum, "response", &unnamed_enum$174 },
		{ _field_tag_reference, "effect", &effect_group_reference },
		FIELD_PAD("value", 16),
		...
		{ _field_short_enum, "scale effects by", &unnamed_enum$176 },
		FIELD_PAD("value", 2),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_tag_reference, "atmospheric fog density", &bitmap_group_reference },
		{ _field_tag_reference, "planar fog density", &bitmap_group_reference },
		{ _field_tag_reference, "linear corner fade", "used for shadows", &bitmap_group_reference },
		{ _field_tag_reference, "active camouflage distortion", &bitmap_group_reference },
		...
		{ _field_tag_reference, "test 0", &bitmap_group_reference$3 },
		{ _field_tag_reference, "test 1", &bitmap_group_reference$3 },
		{ _field_tag_reference, "test 2", &bitmap_group_reference$3 },
		{ _field_tag_reference, "test 3", &bitmap_group_reference$3 },
		FIELD_EXPLANATION("video effect textures", "Used in cinematics."),
		{ _field_tag_reference, "video scanline map", &bitmap_group_reference },
		{ _field_tag_reference, "video noise map", &bitmap_group_reference },
		FIELD_PAD("value", 52),
		FIELD_EXPLANATION("active camouflage", nullptr),
		{ _field_word_flags, "flags", &unnamed_enum$148 },
		FIELD_PAD("value", 2),
		...
		{ _field_tag_reference, "distance attenuation 2D", "the pc can't use 3d textures, so we use this instead", &bitmap_group_reference },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_word_flags, "not placed", &unnamed_enum$195 },
		...
		{ _field_long_flags, "flags", &unnamed_enum$196 },
		FIELD_PAD("value", 8),
		FIELD_PAD("value", 32),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_tag_reference, "CAN'T USE", &sky_group_reference },
		{ _field_block, "skies", &scenario_sky_reference_block },
		{ _field_short_enum, "type", &unnamed_enum$191 },
		{ _field_word_flags, "flags", &unnamed_enum$192 },
		...
		{ _field_block, "scavenger hunt objects", &scenario_scavenger_hunt_object_block },
		FIELD_PAD("value", 212),
		...
		{ _field_block, "netgame flags", &scenario_netgame_flags_block },
		...
		{ _field_block, "encounters", &encounter_block },
		{ _field_block, "command lists", &ai_command_list_block },
		...
		{ _field_data, "script syntax data", &hs_syntax_data_definition },
		...
		FIELD_PAD("value", 108),
		{ _field_tag_reference, "custom object names", &unicode_string_list_group_reference$2 },
		{ _field_tag_reference, "ingame help text", &unicode_string_list_group_reference$2 },
		{ _field_tag_reference, "hud messages", &hud_message_text_group_reference$2 },
		{ _field_block, "structure bsps", &scenario_structure_bsps_block },
		{ _field_terminator }
	};
	...
	STRINGS(unnamed_enum$192)
	{
		...
		"color correction (ntsc->srgb)#enable ntsc to srgb color space conversion"
	};
	STRING_LIST(unnamed_enum$192, unnamed_enum$192_strings, _countof(unnamed_enum$192_strings));

	TAG_REFERENCE(unicode_string_list_group_reference$2, UNICODE_STRING_LIST_TAG);
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "child scenario", &scenario_group_reference },
		FIELD_PAD("value", 16),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_long_flags, "flags", &unnamed_enum$201 },
		{ _field_long_flags, "flags", &unnamed_enum$203 },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_enum, "style", &unnamed_enum$229 },
		{ _field_short_enum, "justification", &unnamed_enum$230 },
		FIELD_PAD("value", 2),
		{ _field_long_flags, "text flags", &unnamed_enum$231 },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "reference", &decal_group_reference$2 },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_tag_reference, "displayed map name", &unicode_string_list_group_reference },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_real_euler_angles_3d, "rotation" },
		FIELD_PAD("value", 2),
		{ _field_word_flags, "misc flags", &unnamed_enum$198 },
		{ _field_char_integer, "appearance player index" },
		FIELD_PAD("value", 3),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "name", &equipment_group_reference$2 },
		FIELD_PAD("value", 32),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$193 },
		{ _field_string, "name" },
		{ _field_real, "period", "this is the period for the above function (lower values make the function oscillate quickly, higher values make it oscillate slowly)", "seconds" },
		...
		{ _field_short_enum, "bounds mode", "controls how the bounds, below, are used", &unnamed_enum$194 },
		{ _field_real_fraction_bounds, "bounds" },
		FIELD_PAD("value", 4),
		FIELD_PAD("value", 2),
		{ _field_short_block_index, "turn off with", "if the specified function is off, so is this function" },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_block_index, "position group" },
		{ _field_long_flags, "flags", &unnamed_enum$201 },
		{ _field_long_flags, "flags", &unnamed_enum$202 },
		FIELD_PAD("value", 12),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$206 },
		{ _field_short_enum, "type 0", &unnamed_enum$204 },
		{ _field_short_enum, "type 1", &unnamed_enum$204 },
		{ _field_short_enum, "type 2", &unnamed_enum$204 },
		{ _field_short_enum, "type 3", &unnamed_enum$204 },
		...
		{ _field_real_point_3d, "position" },
		{ _field_angle, "facing", nullptr, "degrees" },
		{ _field_tag_reference, "item collection", &item_collection_group_reference },
		FIELD_PAD("value", 48),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_real_point_3d, "position" },
		{ _field_angle, "facing", nullptr, "degrees" },
		{ _field_short_enum, "type", &unnamed_enum$205 },
		...
		{ _field_tag_reference, "weapon group", &item_collection_group_reference },
		FIELD_PAD("value", 112),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_tag_reference, "primary weapon", &weapon_group_reference$4 },
		{ _field_short_integer, "rounds loaded" },
		{ _field_short_integer, "rounds total" },
		{ _field_tag_reference, "secondary weapon", &weapon_group_reference$4 },
		{ _field_short_integer, "rounds loaded" },
		{ _field_short_integer, "rounds total" },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$207 },
		{ _field_short_enum, "type 0", &unnamed_enum$204 },
		{ _field_short_enum, "type 1", &unnamed_enum$204 },
		{ _field_short_enum, "type 2", &unnamed_enum$204 },
		{ _field_short_enum, "type 3", &unnamed_enum$204 },
		FIELD_PAD("value", 48),
		{ _field_tag_reference, "item collection 1", &item_collection_group_reference },
		{ _field_tag_reference, "item collection 2", &item_collection_group_reference },
		{ _field_tag_reference, "item collection 3", &item_collection_group_reference },
		{ _field_tag_reference, "item collection 4", &item_collection_group_reference },
		{ _field_tag_reference, "item collection 5", &item_collection_group_reference },
		{ _field_tag_reference, "item collection 6", &item_collection_group_reference },
		FIELD_PAD("value", 48),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "lightmap bitmaps", &bitmap_group_reference },
		...
		{ _field_block, "collision bsp", &collision_bsp_block },
		{ _field_block, "nodes", &structure_bsp_node_block },
		...
		{ _field_block, "leaf surfaces", &structure_bsp_surface_reference_block },
		{ _field_block, "surfaces", &structure_bsp_surface_block },
		{ _field_block, "lightmaps", &structure_bsp_lightmap_block },
		FIELD_PAD("value", 12),
		{ _field_block, "lens flares", &structure_bsp_lens_flare_block },
		{ _field_block, "lens flare markers", &structure_bsp_lens_flare_marker_block },
		...
		{ _field_block, "fog regions", &structure_bsp_fog_region_block },
		{ _field_block, "fog palette", &structure_bsp_fog_palette_block },
		FIELD_PAD("value", 24),
		...
		FIELD_PAD("value", 24),
		{ _field_block, "pathfinding surfaces", &structure_bsp_pathfinding_surfaces_block },
		...
		{ _field_block, "leaf map portals", &global_leaf_portal_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		FIELD_SKIP("value", 4),
		{ _field_string, "name" },
		{ _field_array, "value", &unnamed_array$7 },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 1),
		{ _field_word_flags, "multiplayer spawn flags", &unnamed_enum$197 },
		FIELD_PAD("value", 28),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "name", &weapon_group_reference$3 },
		FIELD_PAD("value", 32),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_block, "change colors", &object_change_colors_block },
		{ _field_block, "predicted resources", &predicted_resource_block },
		{ _field_long_flags, "flags", &unnamed_enum$182 },
		FIELD_PAD("value", 124),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_enum, "replace function", &unnamed_enum$8 },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_word_flags, "flags", &unnamed_enum$183 },
		{ _field_short_enum, "detail level", "affects the density of tesselation (high means slow).", &unnamed_enum$184 },
		...
		{ _field_word_flags, "flags", &unnamed_enum$185 },
		{ _field_short_enum, "material type", &unnamed_enum$67 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 2),
		{ _field_terminator }
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 44),
		FIELD_EXPLANATION("diffuse properties", nullptr),
		{ _field_word_flags, "flags", &unnamed_enum$234 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 24),
		{ _field_tag_reference, "base map", &bitmap_group_reference },
		FIELD_PAD("value", 24),
		{ _field_short_enum, "detail map function", "affects primary and secondary detail maps", &unnamed_enum$235 },
		FIELD_PAD("value", 2),
		{ _field_real, "primary detail map scale", "0 defaults to 1" },
		{ _field_tag_reference, "primary detail map", &bitmap_group_reference },
		{ _field_real, "secondary detail map scale", "0 defaults to 1" },
		{ _field_tag_reference, "secondary detail map", &bitmap_group_reference },
		FIELD_PAD("value", 24),
		{ _field_short_enum, "micro detail map function", &unnamed_enum$235 },
		FIELD_PAD("value", 2),
		{ _field_real, "micro detail map scale", "0 defaults to 1" },
		{ _field_tag_reference, "micro detail map", &bitmap_group_reference },
		...
		FIELD_PAD("value", 12),
		FIELD_EXPLANATION("bump properties", "Perforated (alpha-tested) shaders use alpha in bump map."),
		{ _field_real, "bump map scale" },
		{ _field_tag_reference, "bump map", &bitmap_group_reference },
		FIELD_PAD("value", 8),
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("texture scrolling animation", "Scrolls all 2D maps simultaneously."),
		{ _field_short_enum, "u-animation function", &unnamed_enum$41 },
		FIELD_PAD("value", 2),
		...
		{ _field_short_enum, "secondary animation function", &unnamed_enum$41 },
		FIELD_PAD("value", 2),
		...
		{ _field_short_enum, "plasma animation function", &unnamed_enum$41 },
		FIELD_PAD("value", 2),
		...
		{ _field_tag_reference, "map", &bitmap_group_reference },
		FIELD_PAD("value", 24),
		FIELD_EXPLANATION("specular properties", "Controls dynamic specular highlights. The highlight is modulated by <brightness> as well as a blend between <perpendicular color> and <parallel color>.\n\nSet <brightness> to zero to disable."),
		{ _field_word_flags, "flags", &unnamed_enum$237 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 16),
		...
		FIELD_PAD("value", 8),
		FIELD_PAD("value", 16),
		{ _field_tag_reference, "reflection cube map", &bitmap_group_reference },
		FIELD_PAD("value", 16),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 2),
		FIELD_EXPLANATION("model shader", "Setting <true atmospheric fog> enables per-pixel atmospheric fog but disables point/spot lights, planar fog, and the ability to control the atmospheric fog density for this shader."),
		{ _field_word_flags, "flags", &unnamed_enum$249 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 12),
		{ _field_real_fraction, "translucency", "amount of light that can illuminate the shader from behind" },
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("change color", "Change color is used to recolor the diffuse map, it affects pixels based on the BLUE channel of the multipurpose map."),
		{ _field_short_enum, "change color source", &unnamed_enum$38 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 28),
		FIELD_EXPLANATION("self-illumination", "Self-illumination adds diffuse light to pixels based on the GREEN channel of the multipurpose map. The external self-illumination color referenced by <color source> is modulated by the self-illumination animation."),
		{ _field_word_flags, "flags", &unnamed_enum$250 },
		FIELD_PAD("value", 2),
		{ _field_short_enum, "color source", &unnamed_enum$38 },
		{ _field_short_enum, "animation function", &unnamed_enum$41 },
		{ _field_real, "animation period", nullptr, "seconds" },
		{ _field_real_rgb_color, "animation color lower bound" },
		{ _field_real_rgb_color, "animation color upper bound" },
		FIELD_PAD("value", 12),
		FIELD_EXPLANATION("maps", "Base map alpha is used for alpha-testing.\n\nMultipurpose map is used for the following:\n* BLUE: specular reflection mask (modulates reflections)\n* GREEN: self-illumination mask (adds to diffuse light)\n* ALPHA: primary change color mask (recolors diffuse map)\n* RED: auxiliary mask\n\nMultipurpose map is used for the following (if <OG Xbox channel order> flag is set):\n* RED: specular reflection mask (modulates reflections)\n* GREEN: self-illumination mask (adds to diffuse light)\n* BLUE: primary change color mask (recolors diffuse map)\n* ALPHA: auxiliary mask\n\nNote that when DXT1 compressed color-key textures are used for the multipurpose map (as they should be normally), the alpha channel is 1-bit and any non-zero alpha pixels must have zero-color, therefore the secondary change color mask cannot affect pixels already affected by any of the other channels.\n\nDetail map affects diffuse map, and optionally affects reflection if <detail after reflection> flag is set."),
		...
		{ _field_tag_reference, "base map", &bitmap_group_reference },
		FIELD_PAD("value", 8),
		{ _field_tag_reference, "multipurpose map", &bitmap_group_reference },
		FIELD_PAD("value", 8),
		{ _field_short_enum, "detail function", "controls how detail map is applied to diffuse map", &unnamed_enum$251 },
		{ _field_short_enum, "detail mask", "controls how detail map is masked", &unnamed_enum$252 },
		...
		{ _field_real_point_2d, "rotation-animation center" },
		FIELD_PAD("value", 8),
		FIELD_EXPLANATION("reflection properties", nullptr),
	...
	STRINGS(unnamed_enum$249)
	{
		...
		"multipurpose map uses OG Xbox channel order"
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_byte_flags, "flags", &unnamed_enum$186 },
		{ _field_short_enum, "first map type", &unnamed_enum$187 },
		{ _field_short_enum, "framebuffer blend function", &unnamed_enum$76 },
		{ _field_short_enum, "framebuffer fade mode", &unnamed_enum$77 },
		{ _field_short_enum, "framebuffer fade source", "fade is multiplied by this external value", &unnamed_enum$37 },
		FIELD_PAD("value", 2),
		FIELD_EXPLANATION("lens flares", nullptr),
		{ _field_real, "lens flare spacing", "0 places a single lens flare", "world units" },
		{ _field_tag_reference, "lens flare", &lens_flare_group_reference$2 },
		{ _field_block, "extra layers", &shader_transparent_layer_block },
		{ _field_block, "maps", &shader_transparent_chicago_map_block },
		{ _field_long_flags, "extra flags", &unnamed_enum$190 },
		FIELD_PAD("value", 8),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_tag_reference, "lens flare", &lens_flare_group_reference$2 },
		{ _field_block, "extra layers", &shader_transparent_layer_block },
		{ _field_block, "4 stage maps", &shader_transparent_chicago_map_block },
		{ _field_block, "2 stage maps", &shader_transparent_chicago_map_block },
		{ _field_long_flags, "extra flags", &unnamed_enum$190 },
		FIELD_PAD("value", 8),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_word_flags, "flags", &unnamed_enum$188 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 40),
		{ _field_short_enum, "color function", "ignored for last map", &unnamed_enum$189 },
		{ _field_short_enum, "alpha function", "ignored for last map", &unnamed_enum$189 },
		FIELD_PAD("value", 36),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 2),
		FIELD_EXPLANATION("generic transparent shader", nullptr),
		{ _field_char_integer, "numeric counter limit", nullptr, nullptr, "[0,255]" },
		{ _field_byte_flags, "flags", &unnamed_enum$186 },
		{ _field_short_enum, "first map type", &unnamed_enum$253 },
		{ _field_short_enum, "framebuffer blend function", &unnamed_enum$76 },
		{ _field_short_enum, "framebuffer fade mode", &unnamed_enum$77 },
		{ _field_short_enum, "framebuffer fade source", "fade is multiplied by this external value", &unnamed_enum$37 },
		FIELD_PAD("value", 2),
		...
		{ _field_tag_reference, "lens flare", &lens_flare_group_reference$2 },
		{ _field_block, "extra layers", &shader_transparent_layer_block },
		{ _field_block, "maps", &shader_transparent_generic_map_block },
		{ _field_block, "stages", &shader_transparent_generic_stage_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_word_flags, "flags", &unnamed_enum$254 },
		FIELD_PAD("value", 2),
		{ _field_real, "map u-scale", "0 defaults to 1" },
		{ _field_real, "map v-scale", "0 defaults to 1" },
		{ _field_real, "map u-offset" },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_word_flags, "flags", &unnamed_enum$255 },
		FIELD_PAD("value", 2),
		FIELD_EXPLANATION("constants and animation", "Constant color 0 is animated in exactly the same way as the self-illumination color of the model shader, except that it has an alpha component in addition to the RGB components. Constant color 1 is just a constant."),
		{ _field_short_enum, "color0 source", &unnamed_enum$38 },
		{ _field_short_enum, "color0 animation function", &unnamed_enum$41 },
		...
		FIELD_EXPLANATION("color inputs", nullptr),
		{ _field_short_enum, "input A", &unnamed_enum$256 },
		{ _field_short_enum, "input A mapping", &unnamed_enum$257 },
		{ _field_short_enum, "input B", &unnamed_enum$256 },
		{ _field_short_enum, "input B mapping", &unnamed_enum$257 },
		{ _field_short_enum, "input C", &unnamed_enum$256 },
		{ _field_short_enum, "input C mapping", &unnamed_enum$257 },
		{ _field_short_enum, "input D", &unnamed_enum$256 },
		{ _field_short_enum, "input D mapping", &unnamed_enum$257 },
		FIELD_EXPLANATION("color outputs", nullptr),
		{ _field_short_enum, "output AB", &unnamed_enum$258 },
		{ _field_short_enum, "output AB function", &unnamed_enum$259 },
		{ _field_short_enum, "output CD", &unnamed_enum$258 },
		{ _field_short_enum, "output CD function", &unnamed_enum$259 },
		{ _field_short_enum, "output AB CD mux/sum", &unnamed_enum$258 },
		{ _field_short_enum, "output mapping", &unnamed_enum$260 },
		FIELD_EXPLANATION("alpha inputs", nullptr),
		{ _field_short_enum, "input A", &unnamed_enum$261 },
		{ _field_short_enum, "input A mapping", &unnamed_enum$257 },
		{ _field_short_enum, "input B", &unnamed_enum$261 },
		{ _field_short_enum, "input B mapping", &unnamed_enum$257 },
		{ _field_short_enum, "input C", &unnamed_enum$261 },
		{ _field_short_enum, "input C mapping", &unnamed_enum$257 },
		{ _field_short_enum, "input D", &unnamed_enum$261 },
		{ _field_short_enum, "input D mapping", &unnamed_enum$257 },
		FIELD_EXPLANATION("alpha outputs", nullptr),
		{ _field_short_enum, "output AB", &unnamed_enum$262 },
		{ _field_short_enum, "output CD", &unnamed_enum$262 },
		{ _field_short_enum, "output AB CD mux/sum", &unnamed_enum$262 },
		{ _field_short_enum, "output mapping", &unnamed_enum$260 },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_word_flags, "flags", &unnamed_enum$240 },
		FIELD_PAD("value", 2),
		...
		{ _field_tag_reference, "background tint map", &bitmap_group_reference },
		FIELD_PAD("value", 20),
		...
		FIELD_PAD("value", 2),
		{ _field_short_enum, "reflection type", &unnamed_enum$241 },
		...
		{ _field_tag_reference, "reflection map", &bitmap_group_reference },
		{ _field_real, "bump map scale" },
		{ _field_tag_reference, "bump map", &bitmap_group_reference },
		FIELD_PAD("value", 128),
		...
		{ _field_tag_reference, "diffuse detail map", &bitmap_group_reference },
		FIELD_PAD("value", 28),
		...
		{ _field_tag_reference, "specular map", &bitmap_group_reference },
		{ _field_real, "specular detail map scale", "0 defaults to 1" },
		{ _field_tag_reference, "specular detail map", &bitmap_group_reference },
		FIELD_PAD("value", 28),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_word_flags, "flags", &unnamed_enum$243 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 32),
		{ _field_tag_reference, "map", &bitmap_group_reference },
		FIELD_PAD("value", 32),
		...
		{ _field_short_enum, "meter brightness source", "overall meter brightness (default is 1)", &unnamed_enum$37 },
		{ _field_short_enum, "flash brightness source", "brightness of flash (default is 1)", &unnamed_enum$37 },
		{ _field_short_enum, "value source", "position of flash leading edge (default is 1)", &unnamed_enum$37 },
		{ _field_short_enum, "gradient source", "high color leading edge (default is 1)", &unnamed_enum$37 },
		{ _field_short_enum, "flash-extension source", "position of flash extension leading edge (default is 1)", &unnamed_enum$37 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 32),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 2),
		FIELD_EXPLANATION("plasma shader", nullptr),
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 2),
		FIELD_EXPLANATION("intensity", "Controls how bright the plasma is."),
		{ _field_short_enum, "intensity source", &unnamed_enum$37 },
		FIELD_PAD("value", 2),
		{ _field_real, "intensity exponent", "0 defaults to 1" },
		FIELD_EXPLANATION("offset", "Controls how far the plasma energy extends from the model geometry."),
		{ _field_short_enum, "offset source", &unnamed_enum$37 },
		FIELD_PAD("value", 2),
		{ _field_real, "offset amount", nullptr, "world units" },
		{ _field_real, "offset exponent", "0 defaults to 1" },
		FIELD_PAD("value", 32),
		FIELD_EXPLANATION("color", "Controls the tint color and Fresnel brightness effects."),
		{ _field_real_fraction, "perpendicular brightness", nullptr, nullptr, "[0,1]" },
		{ _field_real_rgb_color, "perpendicular tint color" },
		{ _field_real_fraction, "parallel brightness", nullptr, nullptr, "[0,1]" },
		{ _field_real_rgb_color, "parallel tint color" },
		{ _field_short_enum, "tint color source", "modulates perpendicular and parallel colors above", &unnamed_enum$38 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 32),
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 16),
		FIELD_EXPLANATION("primary noise map", nullptr),
		FIELD_PAD("value", 4),
		FIELD_PAD("value", 4),
		...
		{ _field_tag_reference, "primary noise map", &bitmap_group_reference },
		FIELD_PAD("value", 32),
		FIELD_EXPLANATION("secondary noise map", nullptr),
		FIELD_PAD("value", 4),
		...
		{ _field_tag_reference, "secondary noise map", &bitmap_group_reference },
		FIELD_PAD("value", 32),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 2),
		FIELD_EXPLANATION("water shader", "Base map color modulates the background, while base map alpha modulates reflection brightness. Both of these effects can be independently enables and disabled. Note that if the <base map alpha modulates reflection> flag is not set, then the perpendicular/parallel brightness has no effect (but the perpendicular/parallel tint color DOES has an effect)."),
		{ _field_word_flags, "flags", &unnamed_enum$263 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 32),
		{ _field_tag_reference, "base map", "controls reflection brightness and background tint", &bitmap_group_reference },
		FIELD_PAD("value", 16),
		...
		FIELD_PAD("value", 16),
		{ _field_tag_reference, "reflection map", nullptr, nullptr, "[0,1]", &bitmap_group_reference },
		FIELD_PAD("value", 16),
		...
		{ _field_tag_reference, "ripple maps", &bitmap_group_reference },
		...
		FIELD_PAD("value", 64),
		{ _field_block, "ripples", &shader_transparent_water_ripple_block },
		FIELD_PAD("value", 16),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "model", &gbxmodel_group_reference$3 },
		{ _field_tag_reference, "animation_graph", &model_animations_group_reference$3 },
		FIELD_PAD("value", 24),
		...
		{ _field_tag_reference, "indoor fog screen", "used for FOG SCREEN only; not used for planar fog", &fog_group_reference$2 },
		FIELD_PAD("value", 4),
	...
	{
		FIELD_EXPLANATION("LENS FLARE", nullptr),
		{ _field_tag_reference, "lens flare", &lens_flare_group_reference$3 },
		...
		{ _field_long_flags, "flags", &unnamed_enum$242 },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$244 },
		{ _field_short_enum, "class", &unnamed_enum$245 },
		{ _field_short_enum, "sample rate", &unnamed_enum$246 },
		...
		{ _field_short_enum, "encoding", &unnamed_enum$247 },
		{ _field_short_enum, "compression", &unnamed_enum$248 },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 8),
		FIELD_PAD("value", 16),
		{ _field_tag_reference, "continuous damage effect", &continuous_damage_effect_group_reference },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_enum, "initial state", "state that this actor starts in", &unnamed_enum$211 },
		{ _field_short_enum, "return state", "state that this actor will return to when it has nothing to do", &unnamed_enum$211 },
		{ _field_long_flags, "flags", &unnamed_enum$212 },
		{ _field_short_enum, "unique leader type", "what kind of leader this squad has (e.g. a sarge for marines) - 'normal' is based on the size of the squad, 'random' always creates a leader, or you can specify an individual type", &unnamed_enum$213 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 28),
		FIELD_PAD("value", 2),
		{ _field_short_block_index, "maneuver to squad" },
		{ _field_real, "squad delay time", nullptr, "seconds" },
		{ _field_long_flags, "attacking", &unnamed_enum$214 },
		{ _field_long_flags, "attacking search", &unnamed_enum$214 },
		{ _field_long_flags, "attacking guard", &unnamed_enum$214 },
		{ _field_long_flags, "defending", &unnamed_enum$214 },
		{ _field_long_flags, "defending search", &unnamed_enum$214 },
		{ _field_long_flags, "defending guard", &unnamed_enum$214 },
		{ _field_long_flags, "pursuing", &unnamed_enum$214 },
		FIELD_PAD("value", 4),
		FIELD_PAD("value", 8),
		...
		{ _field_short_enum, "major upgrade", &unnamed_enum$215 },
		FIELD_PAD("value", 2),
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_block, "string references", &string_list_string_reference_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_data, "string", &string_data$2 },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 24),
		{ _field_block, "predicted resources", &predicted_resource_block },
		{ _field_block, "subclusters", &structure_bsp_subcluster_block },
		{ _field_short_integer, "first lens flare marker index" },
		{ _field_short_integer, "lens flare marker count" },
		{ _field_block, "surface indices", &structure_bsp_cluster_surface_index_block },
		{ _field_block, "mirrors", &structure_bsp_mirror_block },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_long_flags, "flags", &unnamed_enum$181 },
		FIELD_PAD("value", 24),
	...
	{
		{ _field_string, "name" },
		{ _field_tag_reference, "fog", &fog_group_reference },
		FIELD_PAD("value", 4),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 2),
		{ _field_real_plane_3d, "plane" },
		{ _field_block, "vertices", &structure_bsp_fog_plane_vertex_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 16),
		{ _field_block, "materials", &structure_bsp_material_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_word_flags, "flags", &unnamed_enum$180 },
		...
		FIELD_PAD("value", 2),
		{ _field_array, "vertex buffers", &unnamed_array$6 },
		{ _field_data, "uncompressed vertices", &structure_bsp_uncompressed_vertex_data_definition },
		{ _field_data, "compressed vertices", &structure_bsp_compressed_vertex_data_definition },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 20),
		{ _field_tag_reference, "shader", &shader_group_reference },
		{ _field_block, "vertices", &structure_bsp_mirror_vertex_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_real_bounds, "world bounds y" },
		{ _field_real_bounds, "world bounds z" },
		{ _field_block, "surface indices", &structure_bsp_subcluster_surface_index_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_array, "vertices", &unnamed_array$5 },
		{ _field_terminator }
	};
	...
	{
		{ _field_string, "name" },
		{ _field_tag_reference, "particle system", &weather_particle_system_group_reference },
		FIELD_PAD("value", 4),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_byte_flags, "flags", &unnamed_enum$71 },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_block, "tag references", &tag_collection_tag_reference_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 32),
		{ _field_tag_reference, "firing effect", "this effect is used when the weapon is loaded and fired normally", &sound_group_effect_group_reference$3 },
		{ _field_tag_reference, "misfire effect", "this effect is used when the weapon is loaded but fired while overheated", &sound_group_effect_group_reference$3 },
		{ _field_tag_reference, "empty effect", "this effect is used when the weapon is not loaded", &sound_group_effect_group_reference$3 },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_enum, "prediction type", &unnamed_enum$282 },
		{ _field_short_enum, "firing noise", "how loud this weapon appears to the AI", &unnamed_enum$48 },
		...
		{ _field_short_enum, "overcharged action", &unnamed_enum$283 },
		FIELD_PAD("value", 2),
		...
		{ _field_tag_reference, "charging effect", "the charging effect is created once when the trigger begins to charge", &sound_group_effect_group_reference$3 },
		FIELD_EXPLANATION("projectile", nullptr),
		{ _field_short_enum, "distribution function", &unnamed_enum$284 },
		...
		FIELD_PAD("value", 32),
		FIELD_PAD("value", 24),
		{ _field_block, "firing effects", "firing effects determine what happens when this trigger is fired", &trigger_firing_effect_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_block, "ui widget definitions", &ui_widget_references_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_short_enum, "widget type", &unnamed_enum },
		{ _field_short_enum, "controller index", &unnamed_enum$2 },
		{ _field_string, "name" },
		{ _field_rectangle_2d, "bounds" },
		{ _field_long_flags, "flags", &unnamed_enum$3 },
		...
		{ _field_tag_reference, "background bitmap", &bitmap_group_reference },
		...
		{ _field_block, "game data inputs", &game_data_input_references_block },
		...
		{ _field_block, "event handlers", &event_handler_references_block },
		...
		{ _field_block, "search and replace functions", &search_and_replace_reference_block },
		FIELD_PAD("value", 128),
		...
		{ _field_tag_reference, "text label unicode strings list", &unicode_string_list_group_reference },
		{ _field_tag_reference, "text font", &font_group_reference },
		{ _field_real_argb_color, "text color" },
		{ _field_short_enum, "justification", &unnamed_enum$9 },
		{ _field_long_flags, "flags", &unnamed_enum$10 },
		FIELD_PAD("value", 12),
		...
		FIELD_PAD("value", 2),
		{ _field_long_flags, "flags", &unnamed_enum$11 },
		FIELD_EXPLANATION("spinner list", "parameters specific to spinner list widgets\nchild widgets are the list items"),
		{ _field_tag_reference, "list header bitmap", &bitmap_group_reference },
		{ _field_tag_reference, "list footer bitmap", &bitmap_group_reference },
		...
		{ _field_tag_reference, "extended description widget", &ui_widget_definition_group_reference },
		FIELD_PAD("value", 32),
		FIELD_PAD("value", 256),
		...
		{ _field_block, "conditional widgets", &conditional_widget_reference_block },
		FIELD_PAD("value", 128),
		FIELD_PAD("value", 128),
		...
		{ _field_block, "child widgets", &child_widget_reference_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "ui_widget_definition", &ui_widget_definition_group_reference },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_block, "string references", &unicode_string_list_string_reference_block },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_data, "string", &string_data$3 },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_block, "multitex overlay", &global_hud_multitexture_overlay_definition_block },
		FIELD_PAD("value", 4),
		{ _field_short_enum, "type", &unnamed_enum$266 },
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_short_enum, "type", &unnamed_enum$269 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 16),
		...
		{ _field_byte_flags, "flags", &unnamed_enum$265 },
		...
		{ _field_long_flags, "flags", &unnamed_enum$270 },
		FIELD_PAD("value", 24),
		FIELD_PAD("value", 64),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_EXPLANATION("Vehicle hud", nullptr),
		FIELD_PAD("value", 356),
		FIELD_PAD("value", 48),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "unit hud interface", &unit_hud_interface_group_reference },
		FIELD_PAD("value", 32),
		{ _field_terminator }
	};
	...
	{
		{ _field_tag_reference, "sound", &sound_group_sound_looping_group_reference },
		{ _field_long_flags, "latched to", &unnamed_enum$268 },
		{ _field_real, "scale" },
		FIELD_PAD("value", 32),
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_long_flags, "flags", &unnamed_enum$51 },
		{ _field_string, "label" },
		{ _field_string, "marker name" },
		FIELD_PAD("value", 32),
		...
		{ _field_tag_reference, "built-in gunner", &actor_variant_group_reference$3 },
		FIELD_PAD("value", 20),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_long_flags, "flags", &unnamed_enum$272 },
		{ _field_short_enum, "type", &unnamed_enum$273 },
		FIELD_PAD("value", 2),
		...
		{ _field_short_enum, "A in", &unnamed_enum$274 },
		{ _field_short_enum, "B in", &unnamed_enum$274 },
		{ _field_short_enum, "C in", &unnamed_enum$274 },
		{ _field_short_enum, "D in", &unnamed_enum$274 },
		FIELD_PAD("value", 12),
	...
	STRINGS(unnamed_enum$272)
	{
		...
		"ai driver hovering",
		"vehicle steers directly*#NOT YET BACKPORTED from H2",
		"unused*#NOT YET BACKPORTED from H2",
		"has e-brake*#NOT YET BACKPORTED from H2",
		"noncombat vehicle*#NOT YET BACKPORTED from H2",
		"no friction w/driver*#NOT YET BACKPORTED from H2",
		"can trigger automatic opening doors*#NOT YET BACKPORTED from H2",
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "vehicle", &vehicle_group_reference },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_short_enum, "keyboard key", &unnamed_enum$271 },
		...
		{ _field_tag_reference, "unselected background bitmap", &bitmap_group_reference },
		{ _field_tag_reference, "selected background bitmap", &bitmap_group_reference },
		{ _field_tag_reference, "active background bitmap", &bitmap_group_reference },
		{ _field_tag_reference, "sticky background bitmap", &bitmap_group_reference },
		{ _field_terminator }
	};
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_tag_reference, "display font", &font_group_reference },
		{ _field_tag_reference, "background bitmap", &bitmap_group_reference },
		{ _field_tag_reference, "special key labels string list", &unicode_string_list_group_reference },
		{ _field_block, "virtual keys", &virtual_key_block },
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_EXPLANATION("export to functions", nullptr),
		{ _field_short_enum, "A in", &unnamed_enum$277 },
		{ _field_short_enum, "B in", &unnamed_enum$277 },
		{ _field_short_enum, "C in", &unnamed_enum$277 },
		{ _field_short_enum, "D in", &unnamed_enum$277 },
		{ _field_real, "ready time", nullptr, "seconds" },
		{ _field_tag_reference, "ready effect", &sound_group_effect_group_reference$3 },
		...
		FIELD_PAD("value", 16),
		{ _field_tag_reference, "overheated", &sound_group_effect_group_reference$3 },
		{ _field_tag_reference, "detonation", &sound_group_effect_group_reference$3 },
		...
		FIELD_PAD("value", 8),
		FIELD_EXPLANATION("actor firing parameters", "an optional actor variant that specifies the burst geometry and firing patterns to be used with this weapon"),
		{ _field_tag_reference, "actor firing parameters", &actor_variant_group_reference$3 },
		FIELD_EXPLANATION("reticle", nullptr),
		...
		FIELD_PAD("value", 4),
		FIELD_EXPLANATION("movement", nullptr),
		{ _field_short_enum, "movement penalized", &unnamed_enum$278 },
		FIELD_PAD("value", 2),
		...
		{ _field_tag_reference, "light power-on effect", &sound_group_effect_group_reference$3 },
		{ _field_tag_reference, "light power-off effect", &sound_group_effect_group_reference$3 },
		...
		{ _field_tag_reference, "first person model", &gbxmodel_group_reference$4 },
		{ _field_tag_reference, "first person animations", &model_animations_group_reference$4 },
		FIELD_PAD("value", 4),
		{ _field_tag_reference, "hud interface", &weapon_hud_interface_group_reference },
		{ _field_tag_reference, "pickup sound", &sound_group_reference },
		...
		{ _field_short_enum, "weapon type", &unnamed_enum$279 },
		{ _field_block, "predicted resources", &predicted_resource_block },
	...
	TAG_REFERENCE(gbxmodel_group_reference$4, GBXMODEL_TAG);

	TAG_REFERENCE(model_animations_group_reference$4, MODEL_ANIMATIONS_TAG);
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_short_enum, "crosshair type", &unnamed_enum$290 },
		FIELD_PAD("value", 2),
		{ _field_short_enum, "can use on map type", &unnamed_enum$287 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 28),
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_short_integer, "sequence index" },
		{ _field_long_flags, "flags", &unnamed_enum$291 },
		FIELD_PAD("value", 32),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		{ _field_word_flags, "flags", &unnamed_enum$285 },
		FIELD_PAD("value", 2),
	...
	TAG_STRUCT(
		...
		PERSISTENT_ID_EMPTY)
	{
		{ _field_short_enum, "state attached to", &unnamed_enum$286 },
		FIELD_PAD("value", 2),
		{ _field_short_enum, "can use on map type", &unnamed_enum$287 },
		{ _field_short_enum, "anchor", &unnamed_enum$288 },
		FIELD_PAD("value", 28),
		{ _field_point_2d, "anchor offset" },
		{ _field_real, "width scale" },
		{ _field_real, "height scale" },
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 1),
		FIELD_PAD("value", 12),
		{ _field_word_flags, "weapon specific flags", &unnamed_enum$289 },
		FIELD_PAD("value", 2),
		FIELD_PAD("value", 36),
		{ _field_terminator }
	};
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 2),
		{ _field_short_integer, "sequence index" },
		{ _field_word_flags, "type", &unnamed_enum$292 },
		{ _field_long_flags, "flags", &unnamed_enum$126 },
		FIELD_PAD("value", 16),
		FIELD_PAD("value", 40),
		{ _field_terminator }
		...
		PERSISTENT_ID_EMPTY)
	{
		...
		FIELD_PAD("value", 32),
		{ _field_block, "particle types", &weather_particle_type_block },
		{ _field_terminator }
	};
	...
	{
		{ _field_string, "name" },
		{ _field_long_flags, "flags", &unnamed_enum$178 },
		...
		FIELD_PAD("value", 64),
		FIELD_EXPLANATION("SHADER", nullptr),
		{ _field_tag_reference, "sprite bitmap", &bitmap_group_reference },
		{ _field_short_enum, "render mode", &unnamed_enum$159 },
		{ _field_short_enum, "render direction source", "Render modes that depend on an direction will use this vector.", &unnamed_enum$179 },
		FIELD_PAD("value", 40),
		{ _field_word_flags, "shader flags", &unnamed_enum$75 },
		{ _field_short_enum, "framebuffer blend function", &unnamed_enum$76 },
		{ _field_short_enum, "framebuffer fade mode", &unnamed_enum$77 },
