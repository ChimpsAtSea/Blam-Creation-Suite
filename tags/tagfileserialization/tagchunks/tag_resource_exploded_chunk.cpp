...
BCS_RESULT c_tag_resource_exploded_chunk::read_chunk(void* userdata, const void* data, bool use_read_only, bool parse_children)
{
	...
	s_tag_persist_resource_definition& resource_definition = reader.get_resource_definition_by_index(current_resource_index);
	s_tag_persist_struct_definition& struct_definition = reader.get_struct_definition_by_index(resource_definition.structure_entry_index);
