...
unsigned char const c_lxz_decoder::extra_bits[] =
{
...
long const c_lxz_decoder::position_base_minus2[_countof(c_lxz_decoder::extra_bits)] =
{
...
c_lxz_decoder::c_lxz_decoder(unsigned short window_bits)
{
...
void c_lxz_decoder::make_decode_table(unsigned short num_symbols, unsigned char num_bits, unsigned char* length, unsigned short* table)
{
	unsigned long leaf;
...
void c_lxz_decoder::read_lengths(unsigned char* lens, const unsigned long first, const unsigned long last)
{
...
unsigned long c_lxz_decoder::read_huffman_symbols(const unsigned short* table, const unsigned char* lengths, const unsigned long num_symbols, const unsigned char num_bits)
{
	unsigned long i, j;
	ensure_bits(16);
...
void c_lxz_decoder::init_bits(const unsigned char* input_buffer)
{
	bit_buffer_buffer = 0;
...
void c_lxz_decoder::ensure_bits(const unsigned char bits)
{
...
unsigned long c_lxz_decoder::peek_bits(const unsigned char bits) const
{
	return (bit_buffer_buffer >> ((sizeof(unsigned long) * 8) - bits));
}

void c_lxz_decoder::remove_bits(const unsigned char bits)
{
	bit_buffer_buffer <<= bits;
	bit_buffer_bits_left -= bits;
}

unsigned long c_lxz_decoder::read_bits(const unsigned char bits)
{
	unsigned long ret = 0;
