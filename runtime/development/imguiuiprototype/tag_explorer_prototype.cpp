...
static void draw_parents(s_parent_entry* entry_start, s_parent_entry* entry_end)
{
...
static s_parent_entry children[] =
{
...
static void mandrill_tag_explorer_prototype(c_window& window)
{
	mandrill_theme_push();
	//return;
