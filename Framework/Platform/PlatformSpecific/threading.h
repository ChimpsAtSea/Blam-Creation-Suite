...
BCS_DEBUG_API extern void (*parallel_invoke_impl0)(int32_t start, int32_t end, t_parallel_invoke_long_func parallel_invoke_func, void* userdata);
BCS_DEBUG_API extern void (*parallel_invoke_impl1)(int64_t start, int64_t end, t_parallel_invoke_longlong_func parallel_invoke_func, void* userdata);
BCS_DEBUG_API extern void (*parallel_invoke_impl2)(uint32_t start, uint32_t end, t_parallel_invoke_ulong_func parallel_invoke_func, void* userdata);
BCS_DEBUG_API extern void (*parallel_invoke_impl3)(uint64_t start, uint64_t end, t_parallel_invoke_ulonglong_func parallel_invoke_func, void* userdata);
#endif

BCS_DEBUG_API extern void parallel_invoke(int32_t start, int32_t end, t_parallel_invoke_long_func parallel_invoke_func, void* userdata);
BCS_DEBUG_API extern void parallel_invoke(int64_t start, int64_t end, t_parallel_invoke_longlong_func parallel_invoke_func, void* userdata);
BCS_DEBUG_API extern void parallel_invoke(uint32_t start, uint32_t end, t_parallel_invoke_ulong_func parallel_invoke_func, void* userdata);
BCS_DEBUG_API extern void parallel_invoke(uint64_t start, uint64_t end, t_parallel_invoke_ulonglong_func parallel_invoke_func, void* userdata);
...
BCS_DEBUG_API extern uint32_t get_processors_thread_count();