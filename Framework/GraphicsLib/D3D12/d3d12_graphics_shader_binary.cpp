...
{
	shader_binary_data = tracked_malloc(graphics_tracked_memory, src_shader_binary_data_size);
	...
	const char* debug_name)
{
	try
	{
		shader_binary = new(graphics_tracked_memory) c_graphics_shader_binary_d3d12(
			*graphics,
			shader_binary_data,
