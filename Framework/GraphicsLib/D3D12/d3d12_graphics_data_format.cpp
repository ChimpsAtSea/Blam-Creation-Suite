...
#define GRAPHICS_DATA_FORMAT_TO_DXGI_FORMAT(_graphics_data_format, _dxgi_format) \
    ...
    GRAPHICS_DATA_FORMAT_TO_DXGI_FORMAT(_graphics_data_format_r8_unorm, DXGI_FORMAT_R8_UNORM);
    GRAPHICS_DATA_FORMAT_TO_DXGI_FORMAT(_graphics_data_format_r8g8_unorm, DXGI_FORMAT_R8G8_UNORM);
