...
enum e_abstract_button : long
{
	...
	_abstract_button_loadout_menu_v8 = _abstract_button_special_action_v6 + 1,

	_abstract_button_activate_waypoint_v9,
	_abstract_button_activate_waypoint_alt_v9,
	...
	k_number_of_abstract_buttons_v8 = _abstract_button_loadout_menu_v8 + 1,
	k_number_of_abstract_buttons_v9 = _abstract_button_activate_waypoint_alt_v9 + 1,
};
...
using t_player_configuration_v10 = s_player_configuration_v7<k_number_of_abstract_buttons_v8, 32>;
CHECK_STRUCTURE_SIZE(t_player_configuration_v10, 0xB0C);
using t_player_configuration_v11 = s_player_configuration_v7<k_number_of_abstract_buttons_v9, 32>;
CHECK_STRUCTURE_SIZE(t_player_configuration_v11, 0xB3C);
...
enum e_player_configuration_version
{
	...
	_player_configuration_version_10,
	_player_configuration_version_11,
};
...
private:
	union
	{
		...
		t_player_configuration_v10 player_configuration_v10;
		t_player_configuration_v11 player_configuration_v11;
	};
public:
...
#define player_configuration_reference_getter_v1(field_name) \
	...
	{ \
		...
		case _player_configuration_version_10: return &player_configuration_v10.field_name; \
		case _player_configuration_version_11: return &player_configuration_v11.field_name; \
		} \
		return nullptr; \
	}
...
#undef player_configuration_reference_getter_v7
	...
	public:
		...
		s_user_skin& operator[](size_t user_skin_index) const
		{
			...
			case _player_configuration_version_10: return parent.player_configuration_v10.UserSkins[user_skin_index];
			case _player_configuration_version_11: return parent.player_configuration_v11.UserSkins[user_skin_index];
			}
			throw;
		}
	};
	...
	public:
		...
		s_custom_key_mapping& operator[](size_t abstract_button_index) const
		{
			...
			case _player_configuration_version_10: return parent.player_configuration_v10.CustomKeyboardMouseMappings[abstract_button_index];
			case _player_configuration_version_11: return parent.player_configuration_v11.CustomKeyboardMouseMappings[abstract_button_index];
			}
			throw;
		}
	};
	...
	e_abstract_button GetAbstractButtonCount()
	{
		...
		case _player_configuration_version_10:
			return k_number_of_abstract_buttons_v8;
		case _player_configuration_version_11:
			return k_number_of_abstract_buttons_v9;
		}
...
public:
	...
	c_player_configuration(e_player_configuration_version player_configuration_version) :
		...
		//player_configuration_v7(),
		//player_configuration_v8(),
		//player_configuration_v9(),
		//player_configuration_v10(),
		//player_configuration_v11(),
		...
		WeaponDisplayOffsets(*GetWeaponDisplayOffsets())
	{
		...
		memset(&player_configuration_v10, 0, sizeof(player_configuration_v10));
		memset(&player_configuration_v11, 0, sizeof(player_configuration_v11));
	}
};
