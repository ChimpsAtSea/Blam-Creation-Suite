...
public:
	...
	virtual c_player_configuration* __fastcall GetPlayerConfiguration(__int64 value) override;
	virtual __int64 __fastcall UpdatePlayerConfiguration(wchar_t player_names[4][16], c_player_configuration* player_configuration) override;
