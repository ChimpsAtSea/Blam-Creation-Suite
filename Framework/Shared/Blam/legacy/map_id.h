...
static inline long map_id_to_engine_type(e_map_id map_id)
{
	switch (map_id)
	{
	...
	case _map_id_halo1_gephyrophobia:
		return 3; // #TODO: replace hardcoded value with _engine_type_halo1;
	...
	case _map_id_halo2_uplift:
		return 4; // #TODO: replace hardcoded value with _engine_type_halo2;
	...
	case _map_id_halo3_longshore:
		return 5; // #TODO: replace hardcoded value with _engine_type_halo3;
	...
	case _map_id_halo3odst_epilogue:
		return 6; // #TODO: replace hardcoded value with _engine_type_halo3odst;
	...
	case _map_id_halo4_ff_engine:
		return 7; // #TODO: replace hardcoded value with _engine_type_halo4;
	...
	case _map_id_groundhog_relic:
		return 8; // #TODO: replace hardcoded value with _engine_type_groundhog;
	}
...
static inline long map_id_to_game_mode(e_map_id map_id)
{
	switch (map_id)
	{
	case _map_id_mainmenu:
		return 4; // #TODO: replace hardcoded value with _mcc_game_mode_ui_shell;
	...
	case _map_id_halo4_midnight:
	case _map_id_halo4_epilogue:
		return 1; // #TODO: replace hardcoded value with _mcc_game_mode_campaign;
	...
	case _map_id_groundhog_forge_skybox03:
	case _map_id_groundhog_relic:
		return 3; // #TODO: replace hardcoded value with _mcc_game_mode_multiplayer;
	...
	case _map_id_haloreach_overlook:
	case _map_id_haloreach_waterfront:
		return 5; // #TODO: replace hardcoded value with _mcc_game_mode_firefight;
	...
	case _map_id_halo4_ff_hillside:
	case _map_id_halo4_ff_engine:
		return 2; // #TODO: replace hardcoded value with _mcc_game_mode_spartan_ops;
	}

	return 0; // #TODO: replace hardcoded value with _mcc_game_mode_none;
}