...
struct nicename("achievements") tag_group('achi') s_achievements_definition
{
	struct nicename("Achievement Information") s_achievement_information_definition
	{
		...
		int8_t __unknown1;
		int8_t __unknown2;
		s_tag_block_legacy<s_achievement_unlock_information_definition> nicename("Achievement Unlock Information") achievement_unlock_information_block;
	};

	s_tag_block_legacy<s_achievement_information_definition> nicename("Achievement Information") achievement_information_block;
};
