...
struct nicename("havok_collision_filter") tag_group('hcfd') s_havok_collision_filter_definition_legacy
{
	...
	int32_t nicename("yes") yes;
	int32_t nicename("yes") yes1;
	int32_t nicename("yes") yes2;
