...
struct nicename("decal_system") tag_group('decs') s_decal_system_definition_legacy
{
	struct nicename("Decal System") s_decal_system1_definition_legacy
	{
		...
		s_tag_block_legacy<s_unknown_definition_legacy> __unknown3;
		...
		s_tag_block_legacy<s_unknown5_definition_legacy> __unknown9;
		int8_t __unknown10;
		int8_t __unknown11;
		int8_t __unknown12;
		int8_t __unknown13;
	...
	float __unknown5;
	float __unknown6;
	s_tag_block_legacy<s_decal_system1_definition_legacy> nicename("Decal System") decal_system_block;
	float __unknown7;
};
