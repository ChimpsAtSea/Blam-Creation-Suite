...
struct nicename("device_machine") tag_group('mach') s_device_machine_definition_legacy
{
	...
	{
		/*nicename("Door")*/ _type_door = 0ui16,
		/*nicename("Platform")*/ _type_platform = 1ui16,
		/*nicename("Gear")*/ _type_gear = 2ui16,
	};

	enum nicename("Collision Response") e_collision_response : uint16_t
	{
		/*nicename("Pause Until Crushed")*/ _collision_response_pause_until_crushed = 0ui16,
		/*nicename("Reverse Directions")*/ _collision_response_reverse_directions = 1ui16,
		/*nicename("Discs")*/ _collision_response_discs = 2ui16,
	};

	enum nicename("Pathfinding Policy") e_pathfinding_policy : uint16_t
	{
		/*nicename("Discs")*/ _pathfinding_policy_discs = 0ui16,
		/*nicename("Sectors")*/ _pathfinding_policy_sectors = 1ui16,
		/*nicename("Cut Out")*/ _pathfinding_policy_cut_out = 2ui16,
		/*nicename("None")*/ _pathfinding_policy_none = 3ui16,
	};
	...
	{
		/*nicename("Pathfinding Obstacle")*/ _flags2_pathfinding_obstacle = 1ui16 << 0ui16,
		/*nicename("...But Not When Open")*/ _flags2_but_not_when_open = 1ui16 << 1ui16,
		/*nicename("Elevator")*/ _flags2_elevator = 1ui16 << 2ui16,
	...
	float nicename("Door Open Time") door_open_time;
	float nicename("Occlusion Bounds min") occlusion_bounds_min;
	float nicename("Occlusion Bounds max") occlusion_bounds_max;
	e_collision_response nicename("Collision Response") collision_response;
	int16_t nicename("Elevator Node") elevator_node;
