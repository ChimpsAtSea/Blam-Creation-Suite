...
struct nicename("user_interface_shared_globals_definition") tag_group('wigl') s_user_interface_shared_globals_definition_definition
{
	...
	struct nicename("Player Colors") s_player_colors_definition
	{
		...
		s_tag_block_definition<s_player_text_color_definition> nicename("Player Text Color") player_text_color_block;
		s_tag_block_definition<s_team_text_color_definition> nicename("Team Text Color") team_text_color_block;
		s_tag_block_definition<s_player_ui_color_definition> nicename("Player UI Color") player_ui_color_block;
		s_tag_block_definition<s_team_ui_color_definition> nicename("Team UI Color") team_ui_color_block;
	};
	...
	colorf nicename("Color") color;
	colorf nicename("Text Stroke Color") text_stroke_color;
	s_tag_block_definition<s_text_colors_definition> nicename("Text Colors") text_colors_block;
	...
	s_tag_block_definition<s_alerts_definition> nicename("Alerts") alerts_block;
	s_tag_block_definition<s_dialogs_definition> nicename("Dialogs") dialogs_block;
