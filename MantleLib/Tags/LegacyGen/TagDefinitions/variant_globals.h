...
struct nicename("variant_globals") tag_group('vtgl') s_variant_globals_definition
{
	...
	s_tag_block_legacy<s_map_variants_definition> nicename("Map Variants") map_variants1_block;
	...
	s_tag_block_legacy<s_megalo_variants_definition> nicename("Megalo Variants") megalo_variants1_block;
};
