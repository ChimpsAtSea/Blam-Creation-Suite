...
struct nicename("variant_globals") tag_group('vtgl') s_variant_globals_definition_legacy
{
	struct nicename("Map Variants") s_map_variants_definition_legacy
	{
		s_data_reference_legacy nicename("Raw Header") raw_header_data_reference;
		s_data_reference_legacy nicename("Raw MVAR") raw_mvar_data_reference;
		char nicename("File Name") file_name[256];
	};

	struct nicename("Megalo Variants") s_megalo_variants_definition_legacy
	{
		s_data_reference_legacy nicename("Raw Header") raw_header_data_reference;
		s_data_reference_legacy nicename("Raw MPVR") raw_mpvr_data_reference;
		char nicename("File Name") file_name[256];
	};
	...
	s_tag_block_legacy<s_map_variants_definition_legacy> nicename("Map Variants") map_variants1_block;
	...
	s_tag_block_legacy<s_megalo_variants_definition_legacy> nicename("Megalo Variants") megalo_variants1_block;
};
