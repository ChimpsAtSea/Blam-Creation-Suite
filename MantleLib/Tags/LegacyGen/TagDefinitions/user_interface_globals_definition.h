...
struct nicename("user_interface_globals_definition") tag_group('wgtz') s_user_interface_globals_definition_definition
{
	...
	s_tag_block_legacy<s_cui_screen_index_definition> nicename("CUI Screen Index") cui_screen_index_block;
	s_tag_block_legacy<s_cui_global_skewing_definition> nicename("CUI Global Skewing") cui_global_skewing_block;
	s_tag_block_legacy<s_cui_camera_definitions_definition> nicename("CUI Camera Definitions") cui_camera_definitions_block;
	s_tag_block_legacy<s_cui_camera_modifiers_definition> nicename("CUI Camera Modifiers") cui_camera_modifiers_block;
	...
	s_tag_block_legacy<s_dynamic_lobby_cameras_definition> nicename("Dynamic Lobby Cameras") dynamic_lobby_cameras_block;
};
