...
struct nicename("chud_animation_definition") tag_group('chad') s_chud_animation_definition_definition
{
	...
	struct nicename("Rotation") s_rotation_definition
	{
		...
		s_tag_block_legacy<s_animation1_definition> nicename("Animation") animation_block;
		s_data_reference_legacy nicename("Function") function_data_reference;
	};
	...
	struct nicename("Size") s_size_definition
	{
		...
		s_tag_block_legacy<s_animation2_definition> nicename("Animation") animation_block;
	...
	struct nicename("Color") s_color_definition
	{
		...
		s_tag_block_legacy<s_animation3_definition> nicename("Animation") animation_block;
	...
	struct nicename("Alpha") s_alpha_definition
	{
		...
		s_tag_block_legacy<s_animation4_definition> nicename("Animation") animation_block;
		s_data_reference_legacy nicename("Function") function_data_reference;
	};
	...
	struct nicename("Alpha Unknown") s_alpha_unknown_definition
	{
		...
		s_tag_block_legacy<s_animation5_definition> nicename("Animation") animation_block;
		s_data_reference_legacy nicename("Function") function_data_reference;
	};
	...
	struct nicename("Bitmap") s_bitmap_definition
	{
		...
		s_tag_block_legacy<s_animation6_definition> nicename("Animation") animation_block;
		s_data_reference_legacy nicename("Function") function_data_reference;
	};
	...
	struct nicename("Ammo Counter Boot") s_ammo_counter_boot_definition
	{
		...
		s_tag_block_legacy<s_ammo_counter_definition> nicename("Ammo Counter") ammo_counter_block;
		s_data_reference_legacy nicename("Function") function_data_reference;
	};
	...
	int8_t __unknown0;
	int16_t __unknown1;
	s_tag_block_legacy<s_position_definition> nicename("Position") position_block;
	s_tag_block_legacy<s_rotation_definition> nicename("Rotation") rotation_block;
	s_tag_block_legacy<s_size_definition> nicename("Size") size_block;
	s_tag_block_legacy<s_color_definition> nicename("Color") color_block;
	s_tag_block_legacy<s_alpha_definition> nicename("Alpha") alpha_block;
	s_tag_block_legacy<s_alpha_unknown_definition> nicename("Alpha Unknown") alpha_unknown_block;
	s_tag_block_legacy<s_bitmap_definition> nicename("Bitmap") bitmap_block;
	s_tag_block_legacy<s_ammo_counter_boot_definition> nicename("Ammo Counter Boot") ammo_counter_boot_block;
