...
struct nicename("model") tag_group('hlmt') s_model_definition
{
	...
	{
		/*nicename("Guardians (Unknown)")*/ _collision_damage_reporting_type_guardians_unknown = 0ui8,
		/*nicename("Guardians")*/ _collision_damage_reporting_type_guardians = 1ui8,
		/*nicename("Guardians (Scripting)")*/ _collision_damage_reporting_type_guardians_scripting = 2ui8,
		/*nicename("Suicide")*/ _collision_damage_reporting_type_suicide = 3ui8,
		/*nicename("Magnum")*/ _collision_damage_reporting_type_magnum = 4ui8,
		/*nicename("Assault Rifle")*/ _collision_damage_reporting_type_assault_rifle = 5ui8,
		/*nicename("DMR")*/ _collision_damage_reporting_type_dmr = 6ui8,
		/*nicename("Shotgun")*/ _collision_damage_reporting_type_shotgun = 7ui8,
		/*nicename("Sniper Rifle")*/ _collision_damage_reporting_type_sniper_rifle = 8ui8,
		/*nicename("Rocket Launcher")*/ _collision_damage_reporting_type_rocket_launcher = 9ui8,
		/*nicename("Spartan Laser")*/ _collision_damage_reporting_type_spartan_laser = 10ui8,
		/*nicename("Frag Grenade")*/ _collision_damage_reporting_type_frag_grenade = 11ui8,
		/*nicename("Grenade Launcher")*/ _collision_damage_reporting_type_grenade_launcher = 12ui8,
		/*nicename("Plasma Pistol")*/ _collision_damage_reporting_type_plasma_pistol = 13ui8,
		/*nicename("Needler")*/ _collision_damage_reporting_type_needler = 14ui8,
		/*nicename("Plasma Rifle")*/ _collision_damage_reporting_type_plasma_rifle = 15ui8,
		/*nicename("Plasma Repeater")*/ _collision_damage_reporting_type_plasma_repeater = 16ui8,
		/*nicename("Needle Rifle")*/ _collision_damage_reporting_type_needle_rifle = 17ui8,
		/*nicename("Spiker")*/ _collision_damage_reporting_type_spiker = 18ui8,
		/*nicename("Plasma Launcher")*/ _collision_damage_reporting_type_plasma_launcher = 19ui8,
		/*nicename("Gravity Hammer")*/ _collision_damage_reporting_type_gravity_hammer = 20ui8,
		/*nicename("Energy Sword")*/ _collision_damage_reporting_type_energy_sword = 21ui8,
		/*nicename("Plasma Grenade")*/ _collision_damage_reporting_type_plasma_grenade = 22ui8,
		/*nicename("Concussion Rifle")*/ _collision_damage_reporting_type_concussion_rifle = 23ui8,
		/*nicename("Ghost")*/ _collision_damage_reporting_type_ghost = 24ui8,
		/*nicename("Revenant")*/ _collision_damage_reporting_type_revenant = 25ui8,
		/*nicename("Revenant Gunner")*/ _collision_damage_reporting_type_revenant_gunner = 26ui8,
		/*nicename("Wraith")*/ _collision_damage_reporting_type_wraith = 27ui8,
		/*nicename("Wraith Turret")*/ _collision_damage_reporting_type_wraith_turret = 28ui8,
		/*nicename("Banshee")*/ _collision_damage_reporting_type_banshee = 29ui8,
		/*nicename("Banshee Bomb")*/ _collision_damage_reporting_type_banshee_bomb = 30ui8,
		/*nicename("Seraph")*/ _collision_damage_reporting_type_seraph = 31ui8,
		/*nicename("Mongoose")*/ _collision_damage_reporting_type_mongoose = 32ui8,
		/*nicename("Warthog")*/ _collision_damage_reporting_type_warthog = 33ui8,
		/*nicename("Warthog Chaingun")*/ _collision_damage_reporting_type_warthog_chaingun = 34ui8,
		/*nicename("Warthog Gauss")*/ _collision_damage_reporting_type_warthog_gauss = 35ui8,
		/*nicename("Warthog Rocket")*/ _collision_damage_reporting_type_warthog_rocket = 36ui8,
		/*nicename("Scorpion")*/ _collision_damage_reporting_type_scorpion = 37ui8,
		/*nicename("Scorpion Turret")*/ _collision_damage_reporting_type_scorpion_turret = 38ui8,
		/*nicename("Falcon")*/ _collision_damage_reporting_type_falcon = 39ui8,
		/*nicename("Falcon Gunner")*/ _collision_damage_reporting_type_falcon_gunner = 40ui8,
		/*nicename("Falling")*/ _collision_damage_reporting_type_falling = 41ui8,
		/*nicename("Collision")*/ _collision_damage_reporting_type_collision = 42ui8,
		/*nicename("Melee")*/ _collision_damage_reporting_type_melee = 43ui8,
		/*nicename("Explosion")*/ _collision_damage_reporting_type_explosion = 44ui8,
		/*nicename("Birthday Explosion")*/ _collision_damage_reporting_type_birthday_explosion = 45ui8,
		/*nicename("Flag")*/ _collision_damage_reporting_type_flag = 46ui8,
		/*nicename("Bomb")*/ _collision_damage_reporting_type_bomb = 47ui8,
		/*nicename("Bomb Explosion")*/ _collision_damage_reporting_type_bomb_explosion = 48ui8,
		/*nicename("Ball")*/ _collision_damage_reporting_type_ball = 49ui8,
		/*nicename("Teleporter")*/ _collision_damage_reporting_type_teleporter = 50ui8,
		/*nicename("Transfer Damage")*/ _collision_damage_reporting_type_transfer_damage = 51ui8,
		/*nicename("Armor Lock")*/ _collision_damage_reporting_type_armor_lock = 52ui8,
		/*nicename("Target Locator")*/ _collision_damage_reporting_type_target_locator = 53ui8,
		/*nicename("Human Turret")*/ _collision_damage_reporting_type_human_turret = 54ui8,
		/*nicename("Plasma Cannon")*/ _collision_damage_reporting_type_plasma_cannon = 55ui8,
		/*nicename("Plasma Mortar")*/ _collision_damage_reporting_type_plasma_mortar = 56ui8,
		/*nicename("Plasma Turret")*/ _collision_damage_reporting_type_plasma_turret = 57ui8,
		/*nicename("Shade Turret")*/ _collision_damage_reporting_type_shade_turret = 58ui8,
		/*nicename("Sabre")*/ _collision_damage_reporting_type_sabre = 59ui8,
		/*nicename("SMG")*/ _collision_damage_reporting_type_smg = 60ui8,
		/*nicename("Carbine")*/ _collision_damage_reporting_type_carbine = 61ui8,
		/*nicename("Battle Rifle")*/ _collision_damage_reporting_type_battle_rifle = 62ui8,
		/*nicename("Focus Rifle")*/ _collision_damage_reporting_type_focus_rifle = 63ui8,
		/*nicename("Fuel Rod")*/ _collision_damage_reporting_type_fuel_rod = 64ui8,
		/*nicename("Missile Pod")*/ _collision_damage_reporting_type_missile_pod = 65ui8,
		/*nicename("Brute Shot")*/ _collision_damage_reporting_type_brute_shot = 66ui8,
		/*nicename("Flamethrower")*/ _collision_damage_reporting_type_flamethrower = 67ui8,
		/*nicename("Sentinel Gun")*/ _collision_damage_reporting_type_sentinel_gun = 68ui8,
		/*nicename("Spike Grenade")*/ _collision_damage_reporting_type_spike_grenade = 69ui8,
		/*nicename("Firebomb Grenade")*/ _collision_damage_reporting_type_firebomb_grenade = 70ui8,
		/*nicename("Elephant Turret")*/ _collision_damage_reporting_type_elephant_turret = 71ui8,
		/*nicename("Spectre")*/ _collision_damage_reporting_type_spectre = 72ui8,
		/*nicename("Spectre Gunner")*/ _collision_damage_reporting_type_spectre_gunner = 73ui8,
		/*nicename("Tank")*/ _collision_damage_reporting_type_tank = 74ui8,
		/*nicename("Chopper")*/ _collision_damage_reporting_type_chopper = 75ui8,
		/*nicename("Falcon")*/ _collision_damage_reporting_type_falcon1 = 76ui8,
		/*nicename("Mantis")*/ _collision_damage_reporting_type_mantis = 77ui8,
		/*nicename("Prowler")*/ _collision_damage_reporting_type_prowler = 78ui8,
		/*nicename("Sentinel Beam")*/ _collision_damage_reporting_type_sentinel_beam = 79ui8,
		/*nicename("Sentinel RPG")*/ _collision_damage_reporting_type_sentinel_rpg = 80ui8,
		/*nicename("Tripmine")*/ _collision_damage_reporting_type_tripmine = 81ui8,
	};

	enum nicename("Response Damage Reporting Type") e_response_damage_reporting_type : uint8_t
	{
		/*nicename("Guardians (Unknown)")*/ _response_damage_reporting_type_guardians_unknown = 0ui8,
		/*nicename("Guardians")*/ _response_damage_reporting_type_guardians = 1ui8,
		/*nicename("Guardians (Scripting)")*/ _response_damage_reporting_type_guardians_scripting = 2ui8,
		/*nicename("Suicide")*/ _response_damage_reporting_type_suicide = 3ui8,
		/*nicename("Magnum")*/ _response_damage_reporting_type_magnum = 4ui8,
		/*nicename("Assault Rifle")*/ _response_damage_reporting_type_assault_rifle = 5ui8,
		/*nicename("DMR")*/ _response_damage_reporting_type_dmr = 6ui8,
		/*nicename("Shotgun")*/ _response_damage_reporting_type_shotgun = 7ui8,
		/*nicename("Sniper Rifle")*/ _response_damage_reporting_type_sniper_rifle = 8ui8,
		/*nicename("Rocket Launcher")*/ _response_damage_reporting_type_rocket_launcher = 9ui8,
		/*nicename("Spartan Laser")*/ _response_damage_reporting_type_spartan_laser = 10ui8,
		/*nicename("Frag Grenade")*/ _response_damage_reporting_type_frag_grenade = 11ui8,
		/*nicename("Grenade Launcher")*/ _response_damage_reporting_type_grenade_launcher = 12ui8,
		/*nicename("Plasma Pistol")*/ _response_damage_reporting_type_plasma_pistol = 13ui8,
		/*nicename("Needler")*/ _response_damage_reporting_type_needler = 14ui8,
		/*nicename("Plasma Rifle")*/ _response_damage_reporting_type_plasma_rifle = 15ui8,
		/*nicename("Plasma Repeater")*/ _response_damage_reporting_type_plasma_repeater = 16ui8,
		/*nicename("Needle Rifle")*/ _response_damage_reporting_type_needle_rifle = 17ui8,
		/*nicename("Spiker")*/ _response_damage_reporting_type_spiker = 18ui8,
		/*nicename("Plasma Launcher")*/ _response_damage_reporting_type_plasma_launcher = 19ui8,
		/*nicename("Gravity Hammer")*/ _response_damage_reporting_type_gravity_hammer = 20ui8,
		/*nicename("Energy Sword")*/ _response_damage_reporting_type_energy_sword = 21ui8,
		/*nicename("Plasma Grenade")*/ _response_damage_reporting_type_plasma_grenade = 22ui8,
		/*nicename("Concussion Rifle")*/ _response_damage_reporting_type_concussion_rifle = 23ui8,
		/*nicename("Ghost")*/ _response_damage_reporting_type_ghost = 24ui8,
		/*nicename("Revenant")*/ _response_damage_reporting_type_revenant = 25ui8,
		/*nicename("Revenant Gunner")*/ _response_damage_reporting_type_revenant_gunner = 26ui8,
		/*nicename("Wraith")*/ _response_damage_reporting_type_wraith = 27ui8,
		/*nicename("Wraith Turret")*/ _response_damage_reporting_type_wraith_turret = 28ui8,
		/*nicename("Banshee")*/ _response_damage_reporting_type_banshee = 29ui8,
		/*nicename("Banshee Bomb")*/ _response_damage_reporting_type_banshee_bomb = 30ui8,
		/*nicename("Seraph")*/ _response_damage_reporting_type_seraph = 31ui8,
		/*nicename("Mongoose")*/ _response_damage_reporting_type_mongoose = 32ui8,
		/*nicename("Warthog")*/ _response_damage_reporting_type_warthog = 33ui8,
		/*nicename("Warthog Chaingun")*/ _response_damage_reporting_type_warthog_chaingun = 34ui8,
		/*nicename("Warthog Gauss")*/ _response_damage_reporting_type_warthog_gauss = 35ui8,
		/*nicename("Warthog Rocket")*/ _response_damage_reporting_type_warthog_rocket = 36ui8,
		/*nicename("Scorpion")*/ _response_damage_reporting_type_scorpion = 37ui8,
		/*nicename("Scorpion Turret")*/ _response_damage_reporting_type_scorpion_turret = 38ui8,
		/*nicename("Falcon")*/ _response_damage_reporting_type_falcon = 39ui8,
		/*nicename("Falcon Gunner")*/ _response_damage_reporting_type_falcon_gunner = 40ui8,
		/*nicename("Falling")*/ _response_damage_reporting_type_falling = 41ui8,
		/*nicename("Collision")*/ _response_damage_reporting_type_collision = 42ui8,
		/*nicename("Melee")*/ _response_damage_reporting_type_melee = 43ui8,
		/*nicename("Explosion")*/ _response_damage_reporting_type_explosion = 44ui8,
		/*nicename("Birthday Explosion")*/ _response_damage_reporting_type_birthday_explosion = 45ui8,
		/*nicename("Flag")*/ _response_damage_reporting_type_flag = 46ui8,
		/*nicename("Bomb")*/ _response_damage_reporting_type_bomb = 47ui8,
		/*nicename("Bomb Explosion")*/ _response_damage_reporting_type_bomb_explosion = 48ui8,
		/*nicename("Ball")*/ _response_damage_reporting_type_ball = 49ui8,
		/*nicename("Teleporter")*/ _response_damage_reporting_type_teleporter = 50ui8,
		/*nicename("Transfer Damage")*/ _response_damage_reporting_type_transfer_damage = 51ui8,
		/*nicename("Armor Lock")*/ _response_damage_reporting_type_armor_lock = 52ui8,
		/*nicename("Target Locator")*/ _response_damage_reporting_type_target_locator = 53ui8,
		/*nicename("Human Turret")*/ _response_damage_reporting_type_human_turret = 54ui8,
		/*nicename("Plasma Cannon")*/ _response_damage_reporting_type_plasma_cannon = 55ui8,
		/*nicename("Plasma Mortar")*/ _response_damage_reporting_type_plasma_mortar = 56ui8,
		/*nicename("Plasma Turret")*/ _response_damage_reporting_type_plasma_turret = 57ui8,
		/*nicename("Shade Turret")*/ _response_damage_reporting_type_shade_turret = 58ui8,
		/*nicename("Sabre")*/ _response_damage_reporting_type_sabre = 59ui8,
		/*nicename("SMG")*/ _response_damage_reporting_type_smg = 60ui8,
		/*nicename("Carbine")*/ _response_damage_reporting_type_carbine = 61ui8,
		/*nicename("Battle Rifle")*/ _response_damage_reporting_type_battle_rifle = 62ui8,
		/*nicename("Focus Rifle")*/ _response_damage_reporting_type_focus_rifle = 63ui8,
		/*nicename("Fuel Rod")*/ _response_damage_reporting_type_fuel_rod = 64ui8,
		/*nicename("Missile Pod")*/ _response_damage_reporting_type_missile_pod = 65ui8,
		/*nicename("Brute Shot")*/ _response_damage_reporting_type_brute_shot = 66ui8,
		/*nicename("Flamethrower")*/ _response_damage_reporting_type_flamethrower = 67ui8,
		/*nicename("Sentinel Gun")*/ _response_damage_reporting_type_sentinel_gun = 68ui8,
		/*nicename("Spike Grenade")*/ _response_damage_reporting_type_spike_grenade = 69ui8,
		/*nicename("Firebomb Grenade")*/ _response_damage_reporting_type_firebomb_grenade = 70ui8,
		/*nicename("Elephant Turret")*/ _response_damage_reporting_type_elephant_turret = 71ui8,
		/*nicename("Spectre")*/ _response_damage_reporting_type_spectre = 72ui8,
		/*nicename("Spectre Gunner")*/ _response_damage_reporting_type_spectre_gunner = 73ui8,
		/*nicename("Tank")*/ _response_damage_reporting_type_tank = 74ui8,
		/*nicename("Chopper")*/ _response_damage_reporting_type_chopper = 75ui8,
		/*nicename("Falcon")*/ _response_damage_reporting_type_falcon1 = 76ui8,
		/*nicename("Mantis")*/ _response_damage_reporting_type_mantis = 77ui8,
		/*nicename("Prowler")*/ _response_damage_reporting_type_prowler = 78ui8,
		/*nicename("Sentinel Beam")*/ _response_damage_reporting_type_sentinel_beam = 79ui8,
		/*nicename("Sentinel RPG")*/ _response_damage_reporting_type_sentinel_rpg = 80ui8,
		/*nicename("Tripmine")*/ _response_damage_reporting_type_tripmine = 81ui8,
	};
	...
	struct nicename("Variants") s_variants_definition
	{
		struct nicename("Regions") s_regions_definition
		{
			...
			{
				/*nicename("No Sorting")*/ _sort_order_no_sorting = 0ui32,
				/*nicename("-5 (Closest)")*/ _sort_order__5_closest = 1ui32,
				/*nicename("-4")*/ _sort_order__4 = 2ui32,
				/*nicename("-3")*/ _sort_order__3 = 3ui32,
				/*nicename("-2")*/ _sort_order__2 = 4ui32,
				/*nicename("-1")*/ _sort_order__1 = 5ui32,
				/*nicename("0 (Same As Model)")*/ _sort_order__0_same_as_model = 6ui32,
				/*nicename("1")*/ _sort_order__11 = 7ui32,
				/*nicename("2")*/ _sort_order__21 = 8ui32,
				/*nicename("3")*/ _sort_order__31 = 9ui32,
				/*nicename("4")*/ _sort_order__41 = 10ui32,
			...
			struct nicename("Permutation") s_permutation_definition
			{
				...
				struct nicename("States") s_states_definition
				{
					...
					{
						/*nicename("Default")*/ _state_default = 0ui16,
						/*nicename("Minor Damage")*/ _state_minor_damage = 1ui16,
						/*nicename("Medium Damage")*/ _state_medium_damage = 2ui16,
						/*nicename("Major Damage")*/ _state_major_damage = 3ui16,
						/*nicename("Destroyed")*/ _state_destroyed = 4ui16,
					};
		...
		struct nicename("Objects") s_objects_definition
		{
			...
			string_id_legacy nicename("Object Variant") object_variant;
	...
	struct nicename("Materials") s_materials_definition
	{
		...
		int16_t __unknown1;
		int16_t __unknown2;
		string_id_legacy nicename("Material Name") material_name1;
	...
	struct nicename("New Damage Info") s_new_damage_info_definition
	{
		...
		struct nicename("Damage Sections") s_damage_sections_definition
		{
			...
			struct nicename("Instant Responses") s_instant_responses_definition
			{
				...
				{
					/*nicename("Recieves All Damage")*/ _response_type_recieves_all_damage = 0ui16,
					/*nicename("Recieves Area Effect Damage")*/ _response_type_recieves_area_effect_damage = 1ui16,
					/*nicename("Recieves Local Damage")*/ _response_type_recieves_local_damage = 2ui16,
				};

				enum nicename("Constraint Damage Type") e_constraint_damage_type : uint16_t
				{
					/*nicename("None")*/ _constraint_damage_type_none = 0ui16,
					/*nicename("Destroy One of Group")*/ _constraint_damage_type_destroy_one_of_group = 1ui16,
					/*nicename("Destroy Entire Group")*/ _constraint_damage_type_destroy_entire_group = 2ui16,
					/*nicename("Loosen One of Group")*/ _constraint_damage_type_loosen_one_of_group = 3ui16,
					/*nicename("Loosen Entire Group")*/ _constraint_damage_type_loosen_entire_group = 4ui16,
				};

				enum nicename("New State") e_new_state : uint16_t
				{
					/*nicename("Default")*/ _new_state_default = 0ui16,
					/*nicename("Minor Damage")*/ _new_state_minor_damage = 1ui16,
					/*nicename("Medium Damage")*/ _new_state_medium_damage = 2ui16,
					/*nicename("Major Damage")*/ _new_state_major_damage = 3ui16,
					/*nicename("Destroyed")*/ _new_state_destroyed = 4ui16,
				};

				enum nicename("Secondary New State") e_secondary_new_state : uint16_t
				{
					/*nicename("Default")*/ _secondary_new_state_default = 0ui16,
					/*nicename("Minor Damage")*/ _secondary_new_state_minor_damage = 1ui16,
					/*nicename("Medium Damage")*/ _secondary_new_state_medium_damage = 2ui16,
					/*nicename("Major Damage")*/ _secondary_new_state_major_damage = 3ui16,
					/*nicename("Destroyed")*/ _secondary_new_state_destroyed = 4ui16,
				};

				enum nicename("Unknown Special Damage") e_unknown_special_damage : uint16_t
				{
					/*nicename("None")*/ _unknown_special_damage_none = 0ui16,
					/*nicename("1")*/ _unknown_special_damage__1 = 1ui16,
					/*nicename("2")*/ _unknown_special_damage__2 = 2ui16,
					/*nicename("3")*/ _unknown_special_damage__3 = 3ui16,
				};
				...
				int32_t __unknown0;
				float __unknown1;
				s_tag_reference_legacy nicename("Primary Transition Effect") primary_transition_effect_reference;
				s_tag_reference_legacy nicename("Secondary Transition Effect") secondary_transition_effect_reference;
				...
				string_id_legacy nicename("Secondary Region") secondary_region;
				...
				string_id_legacy nicename("Effect Marker Name") effect_marker_name;
				string_id_legacy nicename("Damage Effect Marker Name") damage_effect_marker_name;
		...
		struct nicename("Damage Constraints") s_damage_constraints_definition
		{
			...
			string_id_legacy nicename("Physics Model Constraint Name") physics_model_constraint_name;
			string_id_legacy nicename("Damage Constraint Name") damage_constraint_name;
			string_id_legacy nicename("Damage Constraint Group Name") damage_constraint_group_name;
		...
		b_flags nicename("Flags") flags;
		string_id_legacy nicename("Global Indirect Material") global_indirect_material;
		...
		string_id_legacy nicename("Global Shield Material Name") global_shield_material_name;
	...
	struct nicename("Omaha Damage Sections") s_omaha_damage_sections_definition
	{
		...
		struct nicename("Omaha Instant Responses") s_omaha_instant_responses_definition
		{
			...
			float nicename("Damage Threshold") damage_threshold;
			s_tag_reference_legacy nicename("Primary Transition Effect") primary_transition_effect_reference;
			string_id_legacy nicename("Primary Transition Effect Marker Name") primary_transition_effect_marker_name;
			s_tag_reference_legacy nicename("Secondary Transition Effect") secondary_transition_effect_reference;
			string_id_legacy nicename("Secondary Transition Effect Marker Name") secondary_transition_effect_marker_name;
			s_tag_reference_legacy nicename("Transition Damage Effect") transition_damage_effect_reference;
			...
			string_id_legacy nicename("Destroyed Child Object Marker Name") destroyed_child_object_marker_name;
			float nicename("Total Damage Threshold") total_damage_threshold;
			string_id_legacy nicename("Constraint Group Name") constraint_group_name;
			e_constraint_damage_type nicename("Constraint Damage Type") constraint_damage_type;
			int16_t __unknown2;
		};
		...
		b_flags1 nicename("Flags") flags;
		float nicename("Vitality Percentage") vitality_percentage;
		string_id_legacy nicename("Global Material") global_material;
	...
	s_tag_reference_legacy nicename("Collision Model") collision_model_reference;
	s_tag_reference_legacy nicename("Animation") animation_reference;
	s_tag_reference_legacy nicename("Physics Model") physics_model_reference;
	s_tag_reference_legacy nicename("Imposter Model") imposter_model_reference;
	...
	string_id_legacy nicename("Base Global Material") base_global_material;
	int16_t __unknown3;
	int16_t __unknown4;
	e_collision_damage_reporting_type nicename("Collision Damage Reporting Type") collision_damage_reporting_type;
	e_response_damage_reporting_type nicename("Response Damage Reporting Type") response_damage_reporting_type;
	...
	string_id_legacy nicename("Default Dialogue Effect") default_dialogue_effect;
	...
	s_undefined32_legacy nicename("Scenario Load Parameters Block") scenario_load_parameters_block;
	s_undefined32_legacy nicename("Scenario Load Parameters Block") scenario_load_parameters_block1;
	s_undefined32_legacy nicename("Scenario Load Parameters Block") scenario_load_parameters_block2;
	s_undefined32_legacy __unknown8;
	float __unknown9;
	float __unknown10;
	float __unknown11;
