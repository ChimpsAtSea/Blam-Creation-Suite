...
struct nicename("cinematic_transition") tag_group('citr') s_cinematic_transition_definition
{
	...
	int32_t __unknown17;
	s_tag_block_legacy<s_unknown_21_definition> nicename("Unknown 2") unknown_21_block;
	...
	s_tag_block_legacy<s_unknown_51_definition> nicename("Unknown 5") unknown_51_block;
	...
	s_tag_block_legacy<s_unknown_61_definition> nicename("Unknown 6") unknown_61_block;
