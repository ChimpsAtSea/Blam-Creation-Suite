...
struct nicename("instance_imposter_definition") tag_group('iimz') s_instance_imposter_definition_definition_legacy
{
	struct nicename("Imposter Instanced Geometry Instances") s_imposter_instanced_geometry_instances_definition_legacy
	{
	...
	int32_t __unknown0;
	string_id_legacy nicename("Structure BSP Path") structure_bsp_path;
	int32_t nicename("Structure Checksum") structure_checksum;
	string_id_legacy nicename("Build Path") build_path;
	s_tag_block_legacy<s_imposter_instanced_geometry_instances_definition_legacy> nicename("Imposter Instanced Geometry Instances") imposter_instanced_geometry_instances_block;
	s_undefined32_legacy __unknown1;
	s_undefined32_legacy __unknown2;
	s_undefined32_legacy __unknown3;
	s_undefined32_legacy __unknown4;
	s_tag_reference_legacy nicename("Impostor Atlas Map") impostor_atlas_map_reference;
	int32_t __unknown5;
