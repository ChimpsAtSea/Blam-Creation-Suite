...
struct nicename("sound_looping") tag_group('lsnd') s_sound_looping_definition
{
	...
	{
		/*nicename("projectile_impact")*/ _sound_class_projectile_impact = 0ui16,
		/*nicename("projectile_detonation")*/ _sound_class_projectile_detonation = 1ui16,
		/*nicename("projectile_flyby")*/ _sound_class_projectile_flyby = 2ui16,
		/*nicename("projectile_detonation_lod")*/ _sound_class_projectile_detonation_lod = 3ui16,
		/*nicename("weapon_fire")*/ _sound_class_weapon_fire = 4ui16,
		/*nicename("weapon_ready")*/ _sound_class_weapon_ready = 5ui16,
		/*nicename("weapon_reload")*/ _sound_class_weapon_reload = 6ui16,
		/*nicename("weapon_empty")*/ _sound_class_weapon_empty = 7ui16,
		/*nicename("weapon_charge")*/ _sound_class_weapon_charge = 8ui16,
		/*nicename("weapon_overheat")*/ _sound_class_weapon_overheat = 9ui16,
		/*nicename("weapon_idle")*/ _sound_class_weapon_idle = 10ui16,
		/*nicename("weapon_melee")*/ _sound_class_weapon_melee = 11ui16,
		/*nicename("weapon_animation")*/ _sound_class_weapon_animation = 12ui16,
		/*nicename("object_impacts")*/ _sound_class_object_impacts = 13ui16,
		/*nicename("particle_impacts")*/ _sound_class_particle_impacts = 14ui16,
		/*nicename("weapon_fire_lod")*/ _sound_class_weapon_fire_lod = 15ui16,
		/*nicename("water_transitions")*/ _sound_class_water_transitions = 16ui16,
		/*nicename("lowpass_effects")*/ _sound_class_lowpass_effects = 17ui16,
		/*nicename("unit_footsteps")*/ _sound_class_unit_footsteps = 18ui16,
		/*nicename("unit_dialog")*/ _sound_class_unit_dialog = 19ui16,
		/*nicename("unit_animation")*/ _sound_class_unit_animation = 20ui16,
		/*nicename("unit_unused!")*/ _sound_class_unit_unused = 21ui16,
		/*nicename("vehicle_collision")*/ _sound_class_vehicle_collision = 22ui16,
		/*nicename("vehicle_engine")*/ _sound_class_vehicle_engine = 23ui16,
		/*nicename("vehicle_animation")*/ _sound_class_vehicle_animation = 24ui16,
		/*nicename("vehicle_engine_lod")*/ _sound_class_vehicle_engine_lod = 25ui16,
		/*nicename("device_door")*/ _sound_class_device_door = 26ui16,
		/*nicename("device_unused0!")*/ _sound_class_device_unused0 = 27ui16,
		/*nicename("device_machinery")*/ _sound_class_device_machinery = 28ui16,
		/*nicename("device_stationary")*/ _sound_class_device_stationary = 29ui16,
		/*nicename("device_unused1!")*/ _sound_class_device_unused1 = 30ui16,
		/*nicename("device_unused2!")*/ _sound_class_device_unused2 = 31ui16,
		/*nicename("music")*/ _sound_class_music = 32ui16,
		/*nicename("ambient_nature")*/ _sound_class_ambient_nature = 33ui16,
		/*nicename("ambient_machinery")*/ _sound_class_ambient_machinery = 34ui16,
		/*nicename("ambient_stationary")*/ _sound_class_ambient_stationary = 35ui16,
		/*nicename("huge_ass")*/ _sound_class_huge_ass = 36ui16,
		/*nicename("object_looping")*/ _sound_class_object_looping = 37ui16,
		/*nicename("cinematic_music")*/ _sound_class_cinematic_music = 38ui16,
		/*nicename("unknown_unused0!")*/ _sound_class_unknown_unused0 = 39ui16,
		/*nicename("unknown_unused1!")*/ _sound_class_unknown_unused1 = 40ui16,
		/*nicename("ambient_flock")*/ _sound_class_ambient_flock = 41ui16,
		/*nicename("no_pad")*/ _sound_class_no_pad = 42ui16,
		/*nicename("no_pad_stationary")*/ _sound_class_no_pad_stationary = 43ui16,
		/*nicename("equipment_effect")*/ _sound_class_equipment_effect = 44ui16,
		/*nicename("mission_dialog")*/ _sound_class_mission_dialog = 45ui16,
		/*nicename("cinematic_dialog")*/ _sound_class_cinematic_dialog = 46ui16,
		/*nicename("scripted_cinematic_foley")*/ _sound_class_scripted_cinematic_foley = 47ui16,
		/*nicename("game_event")*/ _sound_class_game_event = 48ui16,
		/*nicename("ui")*/ _sound_class_ui = 49ui16,
		/*nicename("test")*/ _sound_class_test = 50ui16,
		/*nicename("multiplayer_dialog")*/ _sound_class_multiplayer_dialog = 51ui16,
		/*nicename("ambient_nature_details")*/ _sound_class_ambient_nature_details = 52ui16,
		/*nicename("ambient_machinery_details")*/ _sound_class_ambient_machinery_details = 53ui16,
		/*nicename("inside_surround_tail")*/ _sound_class_inside_surround_tail = 54ui16,
		/*nicename("outside_surround_tail")*/ _sound_class_outside_surround_tail = 55ui16,
		/*nicename("vehicle_detonation")*/ _sound_class_vehicle_detonation = 56ui16,
		/*nicename("ambient_detonation")*/ _sound_class_ambient_detonation = 57ui16,
		/*nicename("first_person_inside")*/ _sound_class_first_person_inside = 58ui16,
		/*nicename("first_person_outside")*/ _sound_class_first_person_outside = 59ui16,
		/*nicename("first_person_anywhere")*/ _sound_class_first_person_anywhere = 60ui16,
		/*nicename("space_projectile_detonation")*/ _sound_class_space_projectile_detonation = 61ui16,
		/*nicename("space_projectile_flyby")*/ _sound_class_space_projectile_flyby = 62ui16,
		/*nicename("space_vehicle_engine")*/ _sound_class_space_vehicle_engine = 63ui16,
		/*nicename("space_weapon_fire")*/ _sound_class_space_weapon_fire = 64ui16,
		/*nicename("player_voice_team")*/ _sound_class_player_voice_team = 65ui16,
		/*nicename("player_voice_proxy")*/ _sound_class_player_voice_proxy = 66ui16,
		/*nicename("projectile_impact_postpone")*/ _sound_class_projectile_impact_postpone = 67ui16,
		/*nicename("unit_footsteps_postpone")*/ _sound_class_unit_footsteps_postpone = 68ui16,
		/*nicename("weapon_ready_third_person")*/ _sound_class_weapon_ready_third_person = 69ui16,
		/*nicename("ui_music")*/ _sound_class_ui_music = 70ui16,
	};
	...
	struct nicename("Tracks") s_tracks_definition
	{
		...
		{
			/*nicename("None")*/ _output_effect_none = 0ui16,
			/*nicename("Output Front Speakers")*/ _output_effect_output_front_speakers = 1ui16,
			/*nicename("Output Rear Speakers")*/ _output_effect_output_rear_speakers = 2ui16,
			/*nicename("Output Center Speakers")*/ _output_effect_output_center_speakers = 3ui16,
		};
