...
struct nicename("crate") tag_group('bloc') s_crate_definition_legacy
{
	...
	{
		/*nicename("Does Not Block Area Of Effect")*/ _flags1_does_not_block_area_of_effect = 1ui16 << 0ui16,
		/*nicename("Camera")*/ _flags1_camera = 1ui16 << 1ui16,
