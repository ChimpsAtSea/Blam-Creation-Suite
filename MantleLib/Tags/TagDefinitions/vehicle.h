...
struct nicename("vehicle") group('vehi') s_vehicle_definition
{
	...
	{
		/*nicename("None")*/ _player_training_vehicle_type_none = 1ui8,
		/*nicename("Warthog")*/ _player_training_vehicle_type_warthog = 2ui8,
		/*nicename("Warthog Turret")*/ _player_training_vehicle_type_warthog_turret = 3ui8,
		/*nicename("Ghost")*/ _player_training_vehicle_type_ghost = 4ui8,
		/*nicename("Banshee")*/ _player_training_vehicle_type_banshee = 5ui8,
		/*nicename("Tank")*/ _player_training_vehicle_type_tank = 6ui8,
		/*nicename("Wraith")*/ _player_training_vehicle_type_wraith = 7ui8,
	};

	enum nicename("Vehicle Size") e_vehicle_size : uint8_t
	{
		/*nicename("Small")*/ _vehicle_size_small = 1ui8,
		/*nicename("Large")*/ _vehicle_size_large = 2ui8,
	};
	...
	struct nicename("Friction Points") s_friction_points_definition
	{
		...
		{
			/*nicename("Default")*/ _model_state_destroyed_default = 1ui16,
			/*nicename("Minor Damage")*/ _model_state_destroyed_minor_damage = 2ui16,
			/*nicename("Medium Damage")*/ _model_state_destroyed_medium_damage = 3ui16,
			/*nicename("Major Damage")*/ _model_state_destroyed_major_damage = 4ui16,
			/*nicename("Destroyed")*/ _model_state_destroyed_destroyed = 5ui16,
		};
	...
	struct nicename("Tricks") s_tricks_definition
	{
		...
		{
			/*nicename("Left")*/ _initiate_direction_left = 1ui8,
			/*nicename("Right")*/ _initiate_direction_right = 2ui8,
			/*nicename("Up")*/ _initiate_direction_up = 3ui8,
			/*nicename("Down")*/ _initiate_direction_down = 4ui8,
		};
