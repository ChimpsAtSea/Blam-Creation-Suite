...
struct nicename("Multiplayer Globals") group('mulg') s_multiplayer_globals_definition
{
	...
	struct nicename("runtime") s_runtime_block_definition
	{
		...
		signed int nicename("Default Frag Grenade Count") default_frag_grenade_count; 
		signed int nicename("Default Plasma Grenade Count") default_plasma_grenade_count; 
		...
		struct s_unknown_block_definition
		{
			...
			signed int __unknown17; 
			float __unknown18; 
			float __unknown19; 
			float __unknown20; 
			signed int __unknown21; 
			signed int __unknown22; 
			signed int __unknown23; 
		};
