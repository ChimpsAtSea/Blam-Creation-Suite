...
struct nicename("device_machine") tag_group('mach') s_device_machine_definition
{
	...
	{
		/*nicename("Door")*/ _type_door = 1ui16,
		/*nicename("Platform")*/ _type_platform = 2ui16,
		/*nicename("Gear")*/ _type_gear = 3ui16,
	};

	enum nicename("Collision Response") e_collision_response : uint16_t
	{
		/*nicename("Pause Until Crushed")*/ _collision_response_pause_until_crushed = 1ui16,
		/*nicename("Reverse Directions")*/ _collision_response_reverse_directions = 2ui16,
		/*nicename("Discs")*/ _collision_response_discs = 3ui16,
	};

	enum nicename("Pathfinding Policy") e_pathfinding_policy : uint16_t
	{
		/*nicename("Discs")*/ _pathfinding_policy_discs = 1ui16,
