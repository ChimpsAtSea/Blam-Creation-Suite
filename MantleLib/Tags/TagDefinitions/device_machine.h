...
struct nicename("Device Machine") group('mach') s_device_machine_definition
{
	...
	signed int nicename("Lightmap Flags") lightmap_flags; 
	...
	unsigned short nicename("Flags") flags3; 
	...
	signed short nicename("Collision Response") collision_response; 
	signed short nicename("Elevator Node") elevator_node; 
