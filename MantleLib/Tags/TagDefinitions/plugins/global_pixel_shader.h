...
struct s_global_pixel_shader_definition
{
	struct s_unknown_block_definition;
	struct s_pixel_shader_block_definition;

	s_tag_block_definition<s_unknown_block_definition> unknown2;
	unsigned int unknown3;
	s_tag_block_definition<s_pixel_shader_block_definition> pixel_shaders;
	...
	struct s_pixel_shader_definition
	{
