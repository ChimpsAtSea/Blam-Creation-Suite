...
nicename("global_pixel_shader") struct s_global_pixel_shader_definition
{
	nicename("Unknown") struct s_unknown_block_definition;
	nicename("Pixel Shaders") struct s_pixel_shader_block_definition;

	nicename("Unknown") s_tag_block_definition<s_unknown_block_definition> unknown2;
	nicename("Unknown") unsigned int unknown3;
	nicename("Pixel Shaders") s_tag_block_definition<s_pixel_shader_block_definition> pixel_shaders;
