...
nicename("shader_terrain") struct s_shader_terrain_definition
{
	...
	nicename("Material 1") string_id material_1;
	nicename("Material 2") string_id material_2;
	nicename("Material 3") string_id material_3;
	nicename("Material 4") string_id material_4;
	nicename("Global Material Index 1") signed short global_material_index_1;
	nicename("Global Material Index 2") signed short global_material_index_2;
	nicename("Global Material Index 3") signed short global_material_index_3;
	nicename("Global Material Index 4") signed short global_material_index_4;
