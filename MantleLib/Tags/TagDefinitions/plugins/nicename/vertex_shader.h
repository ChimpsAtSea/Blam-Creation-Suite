...
nicename("vertex_shader") struct s_vertex_shader_definition
{
	nicename("Unknown 0") struct s_unknown_0_block_definition;
	nicename("Vertex Shaders") struct s_vertex_shader2_block_definition;
	...
	nicename("Vertex Shaders") s_tag_block_definition<s_vertex_shader2_block_definition> vertex_shaders;
