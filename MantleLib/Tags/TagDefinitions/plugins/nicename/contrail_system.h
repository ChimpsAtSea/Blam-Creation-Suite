...
nicename("contrail_system") struct s_contrail_system_definition
{
	nicename("Contrail System") struct s_contrail_system2_block_definition;

	nicename("Contrail System") s_tag_block_definition<s_contrail_system2_block_definition> contrail_system3;

	nicename("Contrail System") struct s_contrail_system_definition
	{
		nicename("Unknown") struct s_unknown43_block_definition;
		nicename("Shader Properties") struct s_shader_property_block_definition;
		nicename("Unknown") struct s_unknown50_block_definition;
		...
		nicename("Unknown") DataReference unknown13;
		...
		nicename("Unknown") DataReference unknown25;
		...
		nicename("Unknown") DataReference unknown28;
		...
		nicename("Unknown") TagReference unknown42;
		nicename("Unknown") s_tag_block_definition<s_unknown43_block_definition> unknown44;
		...
		nicename("Unknown") s_tag_block_definition<s_unknown50_block_definition> unknown51;
		nicename("Unknown") signed char unknown52;
		nicename("Unknown") signed char unknown53;
		nicename("Unknown") signed char unknown54;
		nicename("Unknown") signed char unknown55;
		nicename("Unknown") unsigned int unknown56;
		nicename("Unknown") signed int unknown57;
		...
		nicename("Unknown") DataReference unknown62;
		...
		nicename("Unknown") DataReference unknown65;
		...
		nicename("Unknown") DataReference unknown68;
		...
		nicename("Unknown") DataReference unknown74;
		...
		nicename("Unknown") DataReference unknown77;
