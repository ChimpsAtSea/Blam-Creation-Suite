...
nicename("light_volume_system") struct s_light_volume_system_definition
{
	nicename("Light Volume System") struct s_light_volume_system2_block_definition;

	nicename("Light Volume System") s_tag_block_definition<s_light_volume_system2_block_definition> light_volume_system3;

	nicename("Light Volume System") struct s_light_volume_system_definition
	{
		...
		nicename("Unknown") DataReference unknown26;
		...
		nicename("Unknown") DataReference unknown41;
		...
		nicename("Unknown") DataReference unknown44;
		...
		nicename("Unknown") DataReference unknown47;
