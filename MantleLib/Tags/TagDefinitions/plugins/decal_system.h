...
struct s_decal_system_definition
{
	struct s_decal_system2_block_definition;
	...
	signed int unknown4;
	float unknown5;
	TagReference successor;
	float unknown6;
	float unknown7;
	s_tag_block_definition<s_decal_system2_block_definition> decal_system3;
	float unknown8;
