...
struct s_shader_terrain_definition
{
	...
	string_id material_1;
	string_id material_2;
	string_id material_3;
	string_id material_4;
	signed short global_material_index_1;
	signed short global_material_index_2;
	signed short global_material_index_3;
	signed short global_material_index_4;
