...
struct nicename("scenario") group('scnr') s_scenario_definition
{
	...
	struct nicename("BSP Groups") s_bsp_groups_definition
	{
		...
		struct nicename("BSPs") s_bsps_definition
		{
			struct nicename("Clusters") s_clusters_definition
			{
				...
				s_tag_block_definition<s_bsps1_definition> nicename("BSPs") bsps_block;
			};
			...
			struct nicename("Clusters") s_clusters1_definition
			{
				...
				s_tag_block_definition<s_bsps2_definition> nicename("BSPs") bsps_block;
			};
			...
			struct nicename("Clusters") s_clusters2_definition
			{
				...
				s_tag_block_definition<s_unknown4_definition> __unknown1;
				s_tag_block_definition<s_unknown5_definition> __unknown2;
			};

			s_tag_block_definition<s_clusters_definition> nicename("Clusters") clusters_block;
			s_tag_block_definition<s_clusters1_definition> nicename("Clusters") clusters1_block;
			s_tag_block_definition<s_cluster_skies_definition> nicename("Cluster Skies") cluster_skies_block;
			s_tag_block_definition<s_cluster_visible_skies_definition> nicename("Cluster Visible Skies") cluster_visible_skies_block;
			s_tag_block_definition<s_unknown2_definition> __unknown0;
			s_tag_block_definition<s_clusters2_definition> nicename("Clusters") clusters2_block;
		};
		...
		struct nicename("BSPs") s_bsps3_definition
		{
			...
			s_tag_block_definition<s_unknown6_definition> __unknown0;
			s_tag_block_definition<s_unknown7_definition> __unknown1;
		...
		int32_t __unknown0;
		s_tag_block_definition<s_bsp_checksums_definition> nicename("BSP Checksums") bsp_checksums_block;
		s_tag_block_definition<s_bsps_definition> nicename("BSPs") bsps_block;
		s_tag_block_definition<s_bsps3_definition> nicename("BSPs") bsps1_block;
	};
	...
	struct nicename("Scenario BSP Audibility") s_scenario_bsp_audibility_definition
	{
		...
		s_tag_block_definition<s_encoded_door_pas_definition> nicename("Encoded Door PAS") encoded_door_pas_block;
		s_tag_block_definition<s_cluster_door_portal_encoded_pas_definition> nicename("Cluster Door Portal Encoded PAS") cluster_door_portal_encoded_pas_block;
		s_tag_block_definition<s_ai_deafening_pas_definition> nicename("AI Deafening PAS") ai_deafening_pas_block;
		s_tag_block_definition<s_cluster_distances_definition> nicename("Cluster Distances") cluster_distances_block;
		s_tag_block_definition<s_bsps4_definition> nicename("BSPs") bsps_block;
		s_tag_block_definition<s_bsp_cluster_list_definition> nicename("BSP Cluster List") bsp_cluster_list_block;
		s_tag_block_definition<s_cluster_mapping_definition> nicename("Cluster Mapping") cluster_mapping_block;
	};
		...
		struct nicename("Unknown 6") s_unknown_6_definition
		{
			struct nicename("BSPs") s_bsps5_definition
			{
				struct nicename("Clusters") s_clusters3_definition
				{
					...
					s_tag_block_definition<s_unknown_61_definition> nicename("Unknown 6") unknown_6_block;
				};

				s_tag_block_definition<s_clusters3_definition> nicename("Clusters") clusters_block;
			};
	...
	struct nicename("Object Names") s_object_names_definition
	{
		...
		{
			/*nicename("Null")*/ _type_null = 1ui16,
			/*nicename("Biped")*/ _type_biped = 2ui16,
			/*nicename("Vehicle")*/ _type_vehicle = 3ui16,
			/*nicename("Weapon")*/ _type_weapon = 4ui16,
			/*nicename("Equipment")*/ _type_equipment = 5ui16,
			/*nicename("Terminal")*/ _type_terminal = 6ui16,
			/*nicename("Projectile")*/ _type_projectile = 7ui16,
			/*nicename("Scenery")*/ _type_scenery = 8ui16,
			/*nicename("Machine")*/ _type_machine = 9ui16,
			/*nicename("Control")*/ _type_control = 10ui16,
			/*nicename("Sound Scenery")*/ _type_sound_scenery = 11ui16,
			/*nicename("Crate")*/ _type_crate = 12ui16,
			/*nicename("Creature")*/ _type_creature = 13ui16,
			/*nicename("Giant")*/ _type_giant = 14ui16,
			/*nicename("Effect Scenery")*/ _type_effect_scenery = 15ui16,
		};
	...
	struct nicename("Scenery") s_scenery_definition
	{
		...
		{
			/*nicename("Default")*/ _bsp_policy_default = 1ui8,
			/*nicename("Always Placed")*/ _bsp_policy_always_placed = 2ui8,
			/*nicename("Manual BSP Index")*/ _bsp_policy_manual_bsp_index = 3ui8,
		};

		enum nicename("Type") e_type : uint8_t
		{
			/*nicename("Biped")*/ _type_biped = 1ui8,
			/*nicename("Vehicle")*/ _type_vehicle = 2ui8,
			/*nicename("Weapon")*/ _type_weapon = 3ui8,
			/*nicename("Equipment")*/ _type_equipment = 4ui8,
			/*nicename("Terminal")*/ _type_terminal = 5ui8,
			/*nicename("Projectile")*/ _type_projectile = 6ui8,
			/*nicename("Scenery")*/ _type_scenery = 7ui8,
			/*nicename("Machine")*/ _type_machine = 8ui8,
			/*nicename("Control")*/ _type_control = 9ui8,
			/*nicename("Sound Scenery")*/ _type_sound_scenery = 10ui8,
			/*nicename("Crate")*/ _type_crate = 11ui8,
			/*nicename("Creature")*/ _type_creature = 12ui8,
			/*nicename("Giant")*/ _type_giant = 13ui8,
			/*nicename("Effect Scenery")*/ _type_effect_scenery = 14ui8,
		};

		enum nicename("Source") e_source : uint8_t
		{
			/*nicename("Structure")*/ _source_structure = 1ui8,
			/*nicename("Editor")*/ _source_editor = 2ui8,
			/*nicename("Dynamic")*/ _source_dynamic = 3ui8,
			/*nicename("Legacy")*/ _source_legacy = 4ui8,
		};

		enum nicename("Pathfinding Policy") e_pathfinding_policy : uint16_t
		{
			/*nicename("Tag Default")*/ _pathfinding_policy_tag_default = 1ui16,
			/*nicename("Dynamic")*/ _pathfinding_policy_dynamic = 2ui16,
			/*nicename("Cut-Out")*/ _pathfinding_policy_cut_out = 3ui16,
			/*nicename("Standard")*/ _pathfinding_policy_standard = 4ui16,
			/*nicename("None")*/ _pathfinding_policy_none = 5ui16,
		};

		enum nicename("Lightmapping Policy") e_lightmapping_policy : uint16_t
		{
			/*nicename("Tag Default")*/ _lightmapping_policy_tag_default = 1ui16,
			/*nicename("Dynamic")*/ _lightmapping_policy_dynamic = 2ui16,
			/*nicename("Per-Vertex")*/ _lightmapping_policy_per_vertex = 3ui16,
		};

		enum nicename("Symmetry") e_symmetry : uint32_t
		{
			/*nicename("Both")*/ _symmetry_both = 1ui32,
			/*nicename("Symmetric")*/ _symmetry_symmetric = 2ui32,
			/*nicename("Asymmetric")*/ _symmetry_asymmetric = 3ui32,
		};

		enum nicename("Team") e_team : uint8_t
		{
			/*nicename("Red")*/ _team_red = 1ui8,
			/*nicename("Blue")*/ _team_blue = 2ui8,
			/*nicename("Green")*/ _team_green = 3ui8,
			/*nicename("Orange")*/ _team_orange = 4ui8,
			/*nicename("Purple")*/ _team_purple = 5ui8,
			/*nicename("Yellow")*/ _team_yellow = 6ui8,
			/*nicename("Brown")*/ _team_brown = 7ui8,
			/*nicename("Pink")*/ _team_pink = 8ui8,
			/*nicename("Neutral")*/ _team_neutral = 9ui8,
		};
		...
		struct nicename("Node Positioning") s_node_positioning_definition
		{
			...
			int16_t __unknown0;
			s_tag_block_definition<s_node_flags_definition> nicename("Node Flags") node_flags_block;
			s_tag_block_definition<s_orientations_definition> nicename("Orientations") orientations_block;
			s_tag_block_definition<s_node_flags_readable_definition> nicename("Node Flags [Readable]") node_flags_readable_block;
			s_tag_block_definition<s_orientations_readable_definition> nicename("Orientations [Readable]") orientations_readable_block;
		};
		...
		s_tag_block_definition<s_node_positioning_definition> nicename("Node Positioning") node_positioning1_block;
		int8_t __unknown0;
		int8_t __unknown1;
		int8_t __unknown2;
		...
		int8_t __unknown9;
		int8_t __unknown10;
		color32 nicename("Primary Color") primary_color;
		color32 nicename("Secondary Color") secondary_color;
		color32 nicename("Tertiary Color") tertiary_color;
		color32 nicename("Quaternary Color") quaternary_color;
		// Scenery Data : 
		...
		s_tag_block_definition<s_pathfinding_references_definition> nicename("Pathfinding References") pathfinding_references_block;
		int16_t __unknown11;
		int16_t __unknown12;
		// Multiplayer Data : 
	...
	struct nicename("Bipeds") s_bipeds_definition
	{
		...
		struct nicename("Node Positioning") s_node_positioning1_definition
		{
			...
			int16_t nicename("Node Count") node_count;
			int16_t __unknown0;
			s_tag_block_definition<s_node_flags1_definition> nicename("Node Flags") node_flags_block;
			s_tag_block_definition<s_orientations1_definition> nicename("Orientations") orientations_block;
			s_tag_block_definition<s_node_flags_readable1_definition> nicename("Node Flags [Readable]") node_flags_readable_block;
			s_tag_block_definition<s_orientations_readable1_definition> nicename("Orientations [Readable]") orientations_readable_block;
		};
		...
		/* Node Positioning : This block allows you to "pose" this objects nodes. Used normally for dead bodies. The orientations block has an entry for each checked node flag, skipping unchecked ones.
		   The blocks labeled [Readable] are modified to make reading/editing the values easier, but as a result the entry counts will be innaccurate, going too far may result in editing the wrong data.
		   DO NOT USE THE BLOCK REALLOCATOR ON THE [READABLE] BLOCKS! */
		s_tag_block_definition<s_node_positioning1_definition> nicename("Node Positioning") node_positioning1_block;
		int8_t __unknown0;
		int8_t __unknown1;
		int8_t __unknown2;
		e_bsp_policy nicename("BSP Policy") bsp_policy;
	...
	struct nicename("Vehicles") s_vehicles_definition
	{
		...
		struct nicename("Node Positioning") s_node_positioning2_definition
		{
			...
			int16_t nicename("Node Count") node_count;
			int16_t __unknown0;
			s_tag_block_definition<s_node_flags2_definition> nicename("Node Flags") node_flags_block;
			s_tag_block_definition<s_orientations2_definition> nicename("Orientations") orientations_block;
			s_tag_block_definition<s_node_flags_readable2_definition> nicename("Node Flags [Readable]") node_flags_readable_block;
			s_tag_block_definition<s_orientations_readable2_definition> nicename("Orientations [Readable]") orientations_readable_block;
		};
		...
		/* Node Positioning : This block allows you to "pose" this objects nodes. Used normally for dead bodies. The orientations block has an entry for each checked node flag, skipping unchecked ones.
		   The blocks labeled [Readable] are modified to make reading/editing the values easier, but as a result the entry counts will be innaccurate, going too far may result in editing the wrong data.
		   DO NOT USE THE BLOCK REALLOCATOR ON THE [READABLE] BLOCKS! */
		s_tag_block_definition<s_node_positioning2_definition> nicename("Node Positioning") node_positioning1_block;
		int8_t __unknown0;
		int8_t __unknown1;
		int8_t __unknown2;
		e_bsp_policy nicename("BSP Policy") bsp_policy;
	...
	struct nicename("Equipment") s_equipment_definition
	{
		...
		struct nicename("Node Positioning") s_node_positioning3_definition
		{
			...
			int16_t nicename("Node Count") node_count;
			int16_t __unknown0;
			s_tag_block_definition<s_node_flags3_definition> nicename("Node Flags") node_flags_block;
			s_tag_block_definition<s_orientations3_definition> nicename("Orientations") orientations_block;
			s_tag_block_definition<s_node_flags_readable3_definition> nicename("Node Flags [Readable]") node_flags_readable_block;
			s_tag_block_definition<s_orientations_readable3_definition> nicename("Orientations [Readable]") orientations_readable_block;
		};
		...
		/* Node Positioning : This block allows you to "pose" this objects nodes. Used normally for dead bodies. The orientations block has an entry for each checked node flag, skipping unchecked ones.
		   The blocks labeled [Readable] are modified to make reading/editing the values easier, but as a result the entry counts will be innaccurate, going too far may result in editing the wrong data.
		   DO NOT USE THE BLOCK REALLOCATOR ON THE [READABLE] BLOCKS! */
		s_tag_block_definition<s_node_positioning3_definition> nicename("Node Positioning") node_positioning1_block;
		int8_t __unknown0;
		int8_t __unknown1;
		int8_t __unknown2;
		e_bsp_policy nicename("BSP Policy") bsp_policy;
	...
	struct nicename("Weapons") s_weapons_definition
	{
		...
		struct nicename("Node Positioning") s_node_positioning4_definition
		{
			...
			int16_t nicename("Node Count") node_count;
			int16_t __unknown0;
			s_tag_block_definition<s_node_flags4_definition> nicename("Node Flags") node_flags_block;
			s_tag_block_definition<s_orientations4_definition> nicename("Orientations") orientations_block;
			s_tag_block_definition<s_node_flags_readable4_definition> nicename("Node Flags [Readable]") node_flags_readable_block;
			s_tag_block_definition<s_orientations_readable4_definition> nicename("Orientations [Readable]") orientations_readable_block;
		};
		...
		/* Node Positioning : This block allows you to "pose" this objects nodes. Used normally for dead bodies. The orientations block has an entry for each checked node flag, skipping unchecked ones.
		   The blocks labeled [Readable] are modified to make reading/editing the values easier, but as a result the entry counts will be innaccurate, going too far may result in editing the wrong data.
		   DO NOT USE THE BLOCK REALLOCATOR ON THE [READABLE] BLOCKS! */
		s_tag_block_definition<s_node_positioning4_definition> nicename("Node Positioning") node_positioning1_block;
		int8_t __unknown0;
		int8_t __unknown1;
		int8_t __unknown2;
		e_bsp_policy nicename("BSP Policy") bsp_policy;
	...
	struct nicename("Machines") s_machines_definition
	{
		...
		enum nicename("Pathfinding Policy") e_pathfinding_policy : uint16_t
		{
			...
			/*nicename("Sectors")*/ _pathfinding_policy_sectors = 3ui16,
			/*nicename("Discs")*/ _pathfinding_policy_discs = 4ui16,
			/*nicename("None")*/ _pathfinding_policy_none = 5ui16,
		};
		...
		struct nicename("Node Positioning") s_node_positioning5_definition
		{
			...
			int16_t nicename("Node Count") node_count;
			int16_t __unknown0;
			s_tag_block_definition<s_node_flags5_definition> nicename("Node Flags") node_flags_block;
			s_tag_block_definition<s_orientations5_definition> nicename("Orientations") orientations_block;
			s_tag_block_definition<s_node_flags_readable5_definition> nicename("Node Flags [Readable]") node_flags_readable_block;
			s_tag_block_definition<s_orientations_readable5_definition> nicename("Orientations [Readable]") orientations_readable_block;
		};
		...
		/* Node Positioning : This block allows you to "pose" this objects nodes. Used normally for dead bodies. The orientations block has an entry for each checked node flag, skipping unchecked ones.
		   The blocks labeled [Readable] are modified to make reading/editing the values easier, but as a result the entry counts will be innaccurate, going too far may result in editing the wrong data.
		   DO NOT USE THE BLOCK REALLOCATOR ON THE [READABLE] BLOCKS! */
		s_tag_block_definition<s_node_positioning5_definition> nicename("Node Positioning") node_positioning1_block;
		int8_t __unknown0;
		int8_t __unknown1;
		int8_t __unknown2;
		e_bsp_policy nicename("BSP Policy") bsp_policy;
		...
		s_tag_block_definition<s_pathfinding_references1_definition> nicename("Pathfinding References") pathfinding_references_block;
		e_pathfinding_policy nicename("Pathfinding Policy") pathfinding_policy;
		int16_t __unknown11;
		// Multiplayer Data : 
		char nicename("Custom Label") custom_label[32];
	...
	struct nicename("Terminals") s_terminals_definition
	{
		...
		struct nicename("Node Positioning") s_node_positioning6_definition
		{
			...
			int16_t nicename("Node Count") node_count;
			int16_t __unknown0;
			s_tag_block_definition<s_node_flags6_definition> nicename("Node Flags") node_flags_block;
			s_tag_block_definition<s_orientations6_definition> nicename("Orientations") orientations_block;
			s_tag_block_definition<s_node_flags_readable6_definition> nicename("Node Flags [Readable]") node_flags_readable_block;
			s_tag_block_definition<s_orientations_readable6_definition> nicename("Orientations [Readable]") orientations_readable_block;
		};
		...
		/* Node Positioning : This block allows you to "pose" this objects nodes. Used normally for dead bodies. The orientations block has an entry for each checked node flag, skipping unchecked ones.
		   The blocks labeled [Readable] are modified to make reading/editing the values easier, but as a result the entry counts will be innaccurate, going too far may result in editing the wrong data.
		   DO NOT USE THE BLOCK REALLOCATOR ON THE [READABLE] BLOCKS! */
		s_tag_block_definition<s_node_positioning6_definition> nicename("Node Positioning") node_positioning1_block;
		int8_t __unknown0;
		int8_t __unknown1;
		int8_t __unknown2;
		e_bsp_policy nicename("BSP Policy") bsp_policy;
	...
	struct nicename("Controls") s_controls_definition
	{
		...
		struct nicename("Node Positioning") s_node_positioning7_definition
		{
			...
			int16_t nicename("Node Count") node_count;
			int16_t __unknown0;
			s_tag_block_definition<s_node_flags7_definition> nicename("Node Flags") node_flags_block;
			s_tag_block_definition<s_orientations7_definition> nicename("Orientations") orientations_block;
			s_tag_block_definition<s_node_flags_readable7_definition> nicename("Node Flags [Readable]") node_flags_readable_block;
			s_tag_block_definition<s_orientations_readable7_definition> nicename("Orientations [Readable]") orientations_readable_block;
		};
		...
		/* Node Positioning : This block allows you to "pose" this objects nodes. Used normally for dead bodies. The orientations block has an entry for each checked node flag, skipping unchecked ones.
		   The blocks labeled [Readable] are modified to make reading/editing the values easier, but as a result the entry counts will be innaccurate, going too far may result in editing the wrong data.
		   DO NOT USE THE BLOCK REALLOCATOR ON THE [READABLE] BLOCKS! */
		s_tag_block_definition<s_node_positioning7_definition> nicename("Node Positioning") node_positioning1_block;
		int8_t __unknown0;
		int8_t __unknown1;
		int8_t __unknown2;
		e_bsp_policy nicename("BSP Policy") bsp_policy;
	...
	struct nicename("Sound Scenery") s_sound_scenery_definition
	{
		...
		struct nicename("Node Positioning") s_node_positioning8_definition
		{
			...
			int16_t nicename("Node Count") node_count;
			int16_t __unknown0;
			s_tag_block_definition<s_node_flags8_definition> nicename("Node Flags") node_flags_block;
			s_tag_block_definition<s_orientations8_definition> nicename("Orientations") orientations_block;
			s_tag_block_definition<s_node_flags_readable8_definition> nicename("Node Flags [Readable]") node_flags_readable_block;
			s_tag_block_definition<s_orientations_readable8_definition> nicename("Orientations [Readable]") orientations_readable_block;
		};
		...
		/* Node Positioning : This block allows you to "pose" this objects nodes. Used normally for dead bodies. The orientations block has an entry for each checked node flag, skipping unchecked ones.
		   The blocks labeled [Readable] are modified to make reading/editing the values easier, but as a result the entry counts will be innaccurate, going too far may result in editing the wrong data.
		   DO NOT USE THE BLOCK REALLOCATOR ON THE [READABLE] BLOCKS! */
		s_tag_block_definition<s_node_positioning8_definition> nicename("Node Positioning") node_positioning1_block;
		int8_t __unknown0;
		int8_t __unknown1;
		int8_t __unknown2;
		e_bsp_policy nicename("BSP Policy") bsp_policy;
	...
	struct nicename("Giants") s_giants_definition
	{
		...
		struct nicename("Node Positioning") s_node_positioning9_definition
		{
			...
			int16_t nicename("Node Count") node_count;
			int16_t __unknown0;
			s_tag_block_definition<s_node_flags9_definition> nicename("Node Flags") node_flags_block;
			s_tag_block_definition<s_orientations9_definition> nicename("Orientations") orientations_block;
			s_tag_block_definition<s_node_flags_readable9_definition> nicename("Node Flags [Readable]") node_flags_readable_block;
			s_tag_block_definition<s_orientations_readable9_definition> nicename("Orientations [Readable]") orientations_readable_block;
		};
		...
		/* Node Positioning : This block allows you to "pose" this objects nodes. Used normally for dead bodies. The orientations block has an entry for each checked node flag, skipping unchecked ones.
		   The blocks labeled [Readable] are modified to make reading/editing the values easier, but as a result the entry counts will be innaccurate, going too far may result in editing the wrong data.
		   DO NOT USE THE BLOCK REALLOCATOR ON THE [READABLE] BLOCKS! */
		s_tag_block_definition<s_node_positioning9_definition> nicename("Node Positioning") node_positioning1_block;
		int8_t __unknown0;
		int8_t __unknown1;
		int8_t __unknown2;
		e_bsp_policy nicename("BSP Policy") bsp_policy;
		...
		int16_t __unknown11;
		int16_t __unknown12;
		s_tag_block_definition<s_pathfinding_references2_definition> nicename("Pathfinding References") pathfinding_references_block;
	};
	...
	struct nicename("Effect Scenery") s_effect_scenery_definition
	{
		...
		struct nicename("Node Positioning") s_node_positioning10_definition
		{
			...
			int16_t nicename("Node Count") node_count;
			int16_t __unknown0;
			s_tag_block_definition<s_node_flags10_definition> nicename("Node Flags") node_flags_block;
			s_tag_block_definition<s_orientations10_definition> nicename("Orientations") orientations_block;
			s_tag_block_definition<s_node_flags_readable10_definition> nicename("Node Flags [Readable]") node_flags_readable_block;
			s_tag_block_definition<s_orientations_readable10_definition> nicename("Orientations [Readable]") orientations_readable_block;
		};
		...
		/* Node Positioning : This block allows you to "pose" this objects nodes. Used normally for dead bodies. The orientations block has an entry for each checked node flag, skipping unchecked ones.
		   The blocks labeled [Readable] are modified to make reading/editing the values easier, but as a result the entry counts will be innaccurate, going too far may result in editing the wrong data.
		   DO NOT USE THE BLOCK REALLOCATOR ON THE [READABLE] BLOCKS! */
		s_tag_block_definition<s_node_positioning10_definition> nicename("Node Positioning") node_positioning1_block;
		int8_t __unknown0;
		int8_t __unknown1;
		int8_t __unknown2;
		e_bsp_policy nicename("BSP Policy") bsp_policy;
	...
	struct nicename("Light Volumes") s_light_volumes_definition
	{
		...
		{
			/*nicename("Sphere")*/ _type1_sphere = 1ui16,
			/*nicename("Projective")*/ _type1_projective = 2ui16,
		};

		enum nicename("Lightmap Type") e_lightmap_type : uint16_t
		{
			/*nicename("Use Light Tag Setting")*/ _lightmap_type_use_light_tag_setting = 1ui16,
			/*nicename("Dynamic Only")*/ _lightmap_type_dynamic_only = 2ui16,
			/*nicename("Dynamic With Lightmaps")*/ _lightmap_type_dynamic_with_lightmaps = 3ui16,
			/*nicename("Lightmaps Only")*/ _lightmap_type_lightmaps_only = 4ui16,
		};
		...
		struct nicename("Node Positioning") s_node_positioning11_definition
		{
			...
			int16_t nicename("Node Count") node_count;
			int16_t __unknown0;
			s_tag_block_definition<s_node_flags11_definition> nicename("Node Flags") node_flags_block;
			s_tag_block_definition<s_orientations11_definition> nicename("Orientations") orientations_block;
			s_tag_block_definition<s_node_flags_readable11_definition> nicename("Node Flags [Readable]") node_flags_readable_block;
			s_tag_block_definition<s_orientations_readable11_definition> nicename("Orientations [Readable]") orientations_readable_block;
		};
		...
		/* Node Positioning : This block allows you to "pose" this objects nodes. Used normally for dead bodies. The orientations block has an entry for each checked node flag, skipping unchecked ones.
		   The blocks labeled [Readable] are modified to make reading/editing the values easier, but as a result the entry counts will be innaccurate, going too far may result in editing the wrong data.
		   DO NOT USE THE BLOCK REALLOCATOR ON THE [READABLE] BLOCKS! */
		s_tag_block_definition<s_node_positioning11_definition> nicename("Node Positioning") node_positioning1_block;
		int8_t __unknown0;
		int8_t __unknown1;
		int8_t __unknown2;
		e_bsp_policy nicename("BSP Policy") bsp_policy;
	...
	struct nicename("Sandbox Palette") s_sandbox_palette_definition
	{
		...
		int8_t nicename("Thorage") thorage;
		int8_t __unknown1;
		s_tag_block_definition<s_entries_definition> nicename("Entries") entries_block;
	};
	...
	struct nicename("Legacy Sandbox Info") s_legacy_sandbox_info_definition
	{
		...
		s_tag_block_definition<s_builds_definition> nicename("Builds") builds_block;
	};
	...
	struct nicename("Trigger Volumes") s_trigger_volumes_definition
	{
		...
		float __unknown9;
		s_tag_block_definition<s_unknown8_definition> __unknown10;
		s_tag_block_definition<s_unknown9_definition> __unknown11;
		float __unknown12;
		float __unknown13;
		float __unknown14;
		float __unknown15;
	...
	struct nicename("Squads") s_squads_definition
	{
		...
		struct nicename("Group Locations") s_group_locations_definition
		{
			...
			int16_t __unknown9;
			int16_t __unknown10;
			s_tag_block_definition<s_multi_state_definition> nicename("Multi-State") multi_state_block;
		};
		...
		struct nicename("Single Locations") s_single_locations_definition
		{
			...
			{
				/*nicename("Default")*/ _seat_type_default = 1ui16,
				/*nicename("Spawn In Passenger")*/ _seat_type_spawn_in_passenger = 2ui16,
				/*nicename("Spawn In Gunner")*/ _seat_type_spawn_in_gunner = 3ui16,
				/*nicename("Spawn In Driver")*/ _seat_type_spawn_in_driver = 4ui16,
				/*nicename("Spawn Out Of Vehicle")*/ _seat_type_spawn_out_of_vehicle = 5ui16,
				/*nicename("Spawn Vehicle Only")*/ _seat_type_spawn_vehicle_only = 6ui16,
				/*nicename("Spawn In Passenger")*/ _seat_type_spawn_in_passenger1 = 7ui16,
			};

			enum nicename("Grenade Type") e_grenade_type : uint16_t
			{
				/*nicename("None")*/ _grenade_type_none = 1ui16,
				/*nicename("Frag")*/ _grenade_type_frag = 2ui16,
				/*nicename("Plasma")*/ _grenade_type_plasma = 3ui16,
			};

			enum nicename("Initial Movement Mode") e_initial_movement_mode : uint16_t
			{
				/*nicename("Default")*/ _initial_movement_mode_default = 1ui16,
				/*nicename("Climbing")*/ _initial_movement_mode_climbing = 2ui16,
				/*nicename("Flying")*/ _initial_movement_mode_flying = 3ui16,
			};
			...
			int16_t __unknown11;
			int16_t __unknown12;
			s_tag_block_definition<s_multi_state1_definition> nicename("Multi-State") multi_state_block;
		};
		...
		struct nicename("Squad A") s_squad_a_definition
		{
			...
			s_tag_block_definition<s_weapons1_definition> nicename("Weapons") weapons_block;
		...
		struct nicename("Squad B") s_squad_b_definition
		{
			...
			int16_t nicename("Count") count;
			int16_t __unknown3;
			s_tag_block_definition<s_actors1_definition> nicename("Actors") actors_block;
			s_tag_block_definition<s_weapons2_definition> nicename("Weapons") weapons_block;
			s_tag_block_definition<s_secondary_weapons1_definition> nicename("Secondary Weapons") secondary_weapons_block;
	...
	struct nicename("Zones") s_zones_definition
	{
		...
		struct nicename("Areas") s_areas_definition
		{
			...
			int16_t __unknown11;
			s_tag_block_definition<s_flight_hints_definition> nicename("Flight Hints") flight_hints_block;
			s_tag_block_definition<s_unknown_50_definition> nicename("Unknown 50") unknown_50_block;
			int16_t __unknown12;
			int16_t __unknown13;
			Undefined32 __unknown14;
			Undefined32 __unknown15;
		...
		int16_t __unknown0;
		int16_t __unknown1;
		s_tag_block_definition<s_firing_positions_definition> nicename("Firing Positions") firing_positions_block;
		s_tag_block_definition<s_areas_definition> nicename("Areas") areas_block;
		int16_t __unknown2;
		int16_t __unknown3;
	};
	...
	struct nicename("AI Cues") s_ai_cues_definition
	{
		...
		float __unknown5;
		float __unknown6;
		s_tag_block_definition<s_unknown_451_definition> nicename("Unknown 45") unknown_45_block;
		s_tag_block_definition<s_unknown_46_definition> nicename("Unknown 46") unknown_46_block;
		s_tag_block_definition<s_unknown_47_definition> nicename("Unknown 47") unknown_47_block;
		s_tag_block_definition<s_unknown_48_definition> nicename("Unknown 48") unknown_48_block;
		s_tag_block_definition<s_unknown_49_definition> nicename("Unknown 49") unknown_49_block;
		s_tag_block_definition<s_unknown_501_definition> nicename("Unknown 50") unknown_50_block;
		Undefined32 __unknown7;
		Undefined32 __unknown8;
		Undefined32 __unknown9;
		Undefined32 __unknown10;
		Undefined32 __unknown11;
		Undefined32 __unknown12;
		s_tag_block_definition<s_actor_stimuli_definition> nicename("Actor Stimuli") actor_stimuli_block;
		Undefined32 __unknown13;
		Undefined32 __unknown14;
		Undefined32 __unknown15;
		Undefined32 __unknown16;
	...
	struct nicename("AI Pathfinding Data") s_ai_pathfinding_data_definition
	{
		...
		struct nicename("Unknown 52") s_unknown_52_definition
		{
			...
			s_tag_block_definition<s_unknown_53_definition> nicename("Unknown 53") unknown_53_block;
		};
		...
		struct nicename("Unknown 54") s_unknown_54_definition
		{
			...
			int16_t __unknown3;
			int16_t __unknown4;
			s_tag_block_definition<s_unknown_56_definition> nicename("Unknown 56") unknown_56_block;
		};
		...
		struct nicename("Unknown 39") s_unknown_39_definition
		{
			...
			s_tag_block_definition<s_unknown_403_definition> nicename("Unknown 40") unknown_40_block;
			float __unknown0;
			float __unknown1;
		};
		...
		struct nicename("Unknown 53") s_unknown_532_definition
		{
			struct nicename("Unknown 54") s_unknown_541_definition
			{
				...
				s_tag_block_definition<s_unknown_551_definition> nicename("Unknown 55") unknown_55_block;
			};

			s_tag_block_definition<s_unknown_541_definition> nicename("Unknown 54") unknown_54_block;
			Undefined32 __unknown0;
			Undefined32 __unknown1;
			Undefined32 __unknown2;
		};
		...
		s_tag_block_definition<s_unknown_36_definition> nicename("Unknown 36") unknown_36_block;
		s_tag_block_definition<s_unknown_37_definition> nicename("Unknown 37") unknown_37_block;
		s_tag_block_definition<s_unknown_38_definition> nicename("Unknown 38") unknown_38_block;
		s_tag_block_definition<s_unknown_381_definition> nicename("Unknown 38") unknown_381_block;
		Undefined32 __unknown0;
		Undefined32 __unknown1;
		Undefined32 __unknown2;
		s_tag_block_definition<s_unknown_52_definition> nicename("Unknown 52") unknown_52_block;
		s_tag_block_definition<s_unknown_531_definition> nicename("Unknown 53") unknown_53_block;
		s_tag_block_definition<s_unknown_54_definition> nicename("Unknown 54") unknown_54_block;
		s_tag_block_definition<s_unknown_39_definition> nicename("Unknown 39") unknown_39_block;
		s_tag_block_definition<s_unknown_532_definition> nicename("Unknown 53") unknown_531_block;
		s_tag_block_definition<s_unknown_411_definition> nicename("Unknown 41") unknown_41_block;
	};
	...
	struct nicename("Scripts") s_scripts_definition
	{
		...
		{
			/*nicename("Startup")*/ _script_type_startup = 1ui16,
			/*nicename("Dormant")*/ _script_type_dormant = 2ui16,
			/*nicename("Continous")*/ _script_type_continous = 3ui16,
			/*nicename("Static")*/ _script_type_static = 4ui16,
			/*nicename("Command Script")*/ _script_type_command_script = 5ui16,
			/*nicename("Stub")*/ _script_type_stub = 6ui16,
		};

		enum nicename("Return Type") e_return_type : uint16_t
		{
			/*nicename("unparsed")*/ _return_type_unparsed = 1ui16,
			/*nicename("special_form")*/ _return_type_special_form = 2ui16,
			/*nicename("function_name")*/ _return_type_function_name = 3ui16,
			/*nicename("passthrough")*/ _return_type_passthrough = 4ui16,
			/*nicename("void")*/ _return_type_void = 5ui16,
			/*nicename("boolean")*/ _return_type_boolean = 6ui16,
			/*nicename("real")*/ _return_type_real = 7ui16,
			/*nicename("short")*/ _return_type_short = 8ui16,
			/*nicename("long")*/ _return_type_long = 9ui16,
			/*nicename("string")*/ _return_type_string = 10ui16,
			/*nicename("script")*/ _return_type_script = 11ui16,
			/*nicename("string_id")*/ _return_type_string_id = 12ui16,
			/*nicename("unit_seat_mapping")*/ _return_type_unit_seat_mapping = 13ui16,
			/*nicename("trigger_volume")*/ _return_type_trigger_volume = 14ui16,
			/*nicename("cutscene_flag")*/ _return_type_cutscene_flag = 15ui16,
			/*nicename("cutscene_camera_point")*/ _return_type_cutscene_camera_point = 16ui16,
			/*nicename("cutscene_title")*/ _return_type_cutscene_title = 17ui16,
			/*nicename("cutscene_recording")*/ _return_type_cutscene_recording = 18ui16,
			/*nicename("device_group")*/ _return_type_device_group = 19ui16,
			/*nicename("ai")*/ _return_type_ai = 20ui16,
			/*nicename("ai_command_list")*/ _return_type_ai_command_list = 21ui16,
			/*nicename("ai_command_script")*/ _return_type_ai_command_script = 22ui16,
			/*nicename("ai_behavior")*/ _return_type_ai_behavior = 23ui16,
			/*nicename("ai_orders")*/ _return_type_ai_orders = 24ui16,
			/*nicename("ai_line")*/ _return_type_ai_line = 25ui16,
			/*nicename("starting_profile")*/ _return_type_starting_profile = 26ui16,
			/*nicename("conversation")*/ _return_type_conversation = 27ui16,
			/*nicename("player")*/ _return_type_player = 28ui16,
			/*nicename("zone_set")*/ _return_type_zone_set = 29ui16,
			/*nicename("designer_zone")*/ _return_type_designer_zone = 30ui16,
			/*nicename("point_reference")*/ _return_type_point_reference = 31ui16,
			/*nicename("style")*/ _return_type_style = 32ui16,
			/*nicename("object_list")*/ _return_type_object_list = 33ui16,
			/*nicename("folder")*/ _return_type_folder = 34ui16,
			/*nicename("sound")*/ _return_type_sound = 35ui16,
			/*nicename("effect")*/ _return_type_effect = 36ui16,
			/*nicename("damage")*/ _return_type_damage = 37ui16,
			/*nicename("looping_sound")*/ _return_type_looping_sound = 38ui16,
			/*nicename("animation_graph")*/ _return_type_animation_graph = 39ui16,
			/*nicename("damage_effect")*/ _return_type_damage_effect = 40ui16,
			/*nicename("object_definition")*/ _return_type_object_definition = 41ui16,
			/*nicename("bitmap")*/ _return_type_bitmap = 42ui16,
			/*nicename("shader")*/ _return_type_shader = 43ui16,
			/*nicename("render_model")*/ _return_type_render_model = 44ui16,
			/*nicename("structure_definition")*/ _return_type_structure_definition = 45ui16,
			/*nicename("lightmap_definition")*/ _return_type_lightmap_definition = 46ui16,
			/*nicename("cinematic_definition")*/ _return_type_cinematic_definition = 47ui16,
			/*nicename("cinematic_scene_definition")*/ _return_type_cinematic_scene_definition = 48ui16,
			/*nicename("cinematic_transition_definition")*/ _return_type_cinematic_transition_definition = 49ui16,
			/*nicename("bink_definition")*/ _return_type_bink_definition = 50ui16,
			/*nicename("cui_screen_definition")*/ _return_type_cui_screen_definition = 51ui16,
			/*nicename("any_tag")*/ _return_type_any_tag = 52ui16,
			/*nicename("any_tag_not_resolving")*/ _return_type_any_tag_not_resolving = 53ui16,
			/*nicename("game_difficulty")*/ _return_type_game_difficulty = 54ui16,
			/*nicename("team")*/ _return_type_team = 55ui16,
			/*nicename("mp_team")*/ _return_type_mp_team = 56ui16,
			/*nicename("controller")*/ _return_type_controller = 57ui16,
			/*nicename("button_preset")*/ _return_type_button_preset = 58ui16,
			/*nicename("joystick_preset")*/ _return_type_joystick_preset = 59ui16,
			/*nicename("player_color")*/ _return_type_player_color = 60ui16,
			/*nicename("player_model_choice")*/ _return_type_player_model_choice = 61ui16,
			/*nicename("voice_output_setting")*/ _return_type_voice_output_setting = 62ui16,
			/*nicename("voice_mask")*/ _return_type_voice_mask = 63ui16,
			/*nicename("subtitle_setting")*/ _return_type_subtitle_setting = 64ui16,
			/*nicename("actor_type")*/ _return_type_actor_type = 65ui16,
			/*nicename("model_state")*/ _return_type_model_state = 66ui16,
			/*nicename("event")*/ _return_type_event = 67ui16,
			/*nicename("character_physics")*/ _return_type_character_physics = 68ui16,
			/*nicename("skull")*/ _return_type_skull = 69ui16,
			/*nicename("firing_point_evaluator")*/ _return_type_firing_point_evaluator = 70ui16,
			/*nicename("damage_region")*/ _return_type_damage_region = 71ui16,
			/*nicename("object")*/ _return_type_object = 72ui16,
			/*nicename("unit")*/ _return_type_unit = 73ui16,
			/*nicename("vehicle")*/ _return_type_vehicle = 74ui16,
			/*nicename("weapon")*/ _return_type_weapon = 75ui16,
			/*nicename("device")*/ _return_type_device = 76ui16,
			/*nicename("scenery")*/ _return_type_scenery = 77ui16,
			/*nicename("effect_scenery")*/ _return_type_effect_scenery = 78ui16,
			/*nicename("object_name")*/ _return_type_object_name = 79ui16,
			/*nicename("unit_name")*/ _return_type_unit_name = 80ui16,
			/*nicename("vehicle_name")*/ _return_type_vehicle_name = 81ui16,
			/*nicename("weapon_name")*/ _return_type_weapon_name = 82ui16,
			/*nicename("device_name")*/ _return_type_device_name = 83ui16,
			/*nicename("scenery_name")*/ _return_type_scenery_name = 84ui16,
			/*nicename("effect_scenery_name")*/ _return_type_effect_scenery_name = 85ui16,
			/*nicename("cinematic_lightprobe")*/ _return_type_cinematic_lightprobe = 86ui16,
			/*nicename("animation_budget_reference")*/ _return_type_animation_budget_reference = 87ui16,
			/*nicename("looping_sound_budget_reference")*/ _return_type_looping_sound_budget_reference = 88ui16,
			/*nicename("sound_budget_reference")*/ _return_type_sound_budget_reference = 89ui16,
		};
		...
		struct nicename("Parameters") s_parameters_definition
		{
			enum nicename("Type") e_type : uint16_t
			{
				/*nicename("unparsed")*/ _type_unparsed = 1ui16,
				/*nicename("special_form")*/ _type_special_form = 2ui16,
				/*nicename("function_name")*/ _type_function_name = 3ui16,
				/*nicename("passthrough")*/ _type_passthrough = 4ui16,
				/*nicename("void")*/ _type_void = 5ui16,
				/*nicename("boolean")*/ _type_boolean = 6ui16,
				/*nicename("real")*/ _type_real = 7ui16,
				/*nicename("short")*/ _type_short = 8ui16,
				/*nicename("long")*/ _type_long = 9ui16,
				/*nicename("string")*/ _type_string = 10ui16,
				/*nicename("script")*/ _type_script = 11ui16,
				/*nicename("string_id")*/ _type_string_id = 12ui16,
				/*nicename("unit_seat_mapping")*/ _type_unit_seat_mapping = 13ui16,
				/*nicename("trigger_volume")*/ _type_trigger_volume = 14ui16,
				/*nicename("cutscene_flag")*/ _type_cutscene_flag = 15ui16,
				/*nicename("cutscene_camera_point")*/ _type_cutscene_camera_point = 16ui16,
				/*nicename("cutscene_title")*/ _type_cutscene_title = 17ui16,
				/*nicename("cutscene_recording")*/ _type_cutscene_recording = 18ui16,
				/*nicename("device_group")*/ _type_device_group = 19ui16,
				/*nicename("ai")*/ _type_ai = 20ui16,
				/*nicename("ai_command_list")*/ _type_ai_command_list = 21ui16,
				/*nicename("ai_command_script")*/ _type_ai_command_script = 22ui16,
				/*nicename("ai_behavior")*/ _type_ai_behavior = 23ui16,
				/*nicename("ai_orders")*/ _type_ai_orders = 24ui16,
				/*nicename("ai_line")*/ _type_ai_line = 25ui16,
				/*nicename("starting_profile")*/ _type_starting_profile = 26ui16,
				/*nicename("conversation")*/ _type_conversation = 27ui16,
				/*nicename("player")*/ _type_player = 28ui16,
				/*nicename("zone_set")*/ _type_zone_set = 29ui16,
				/*nicename("designer_zone")*/ _type_designer_zone = 30ui16,
				/*nicename("point_reference")*/ _type_point_reference = 31ui16,
				/*nicename("style")*/ _type_style = 32ui16,
				/*nicename("object_list")*/ _type_object_list = 33ui16,
				/*nicename("folder")*/ _type_folder = 34ui16,
				/*nicename("sound")*/ _type_sound = 35ui16,
				/*nicename("effect")*/ _type_effect = 36ui16,
				/*nicename("damage")*/ _type_damage = 37ui16,
				/*nicename("looping_sound")*/ _type_looping_sound = 38ui16,
				/*nicename("animation_graph")*/ _type_animation_graph = 39ui16,
				/*nicename("damage_effect")*/ _type_damage_effect = 40ui16,
				/*nicename("object_definition")*/ _type_object_definition = 41ui16,
				/*nicename("bitmap")*/ _type_bitmap = 42ui16,
				/*nicename("shader")*/ _type_shader = 43ui16,
				/*nicename("render_model")*/ _type_render_model = 44ui16,
				/*nicename("structure_definition")*/ _type_structure_definition = 45ui16,
				/*nicename("lightmap_definition")*/ _type_lightmap_definition = 46ui16,
				/*nicename("cinematic_definition")*/ _type_cinematic_definition = 47ui16,
				/*nicename("cinematic_scene_definition")*/ _type_cinematic_scene_definition = 48ui16,
				/*nicename("cinematic_transition_definition")*/ _type_cinematic_transition_definition = 49ui16,
				/*nicename("bink_definition")*/ _type_bink_definition = 50ui16,
				/*nicename("cui_screen_definition")*/ _type_cui_screen_definition = 51ui16,
				/*nicename("any_tag")*/ _type_any_tag = 52ui16,
				/*nicename("any_tag_not_resolving")*/ _type_any_tag_not_resolving = 53ui16,
				/*nicename("game_difficulty")*/ _type_game_difficulty = 54ui16,
				/*nicename("team")*/ _type_team = 55ui16,
				/*nicename("mp_team")*/ _type_mp_team = 56ui16,
				/*nicename("controller")*/ _type_controller = 57ui16,
				/*nicename("button_preset")*/ _type_button_preset = 58ui16,
				/*nicename("joystick_preset")*/ _type_joystick_preset = 59ui16,
				/*nicename("player_color")*/ _type_player_color = 60ui16,
				/*nicename("player_model_choice")*/ _type_player_model_choice = 61ui16,
				/*nicename("voice_output_setting")*/ _type_voice_output_setting = 62ui16,
				/*nicename("voice_mask")*/ _type_voice_mask = 63ui16,
				/*nicename("subtitle_setting")*/ _type_subtitle_setting = 64ui16,
				/*nicename("actor_type")*/ _type_actor_type = 65ui16,
				/*nicename("model_state")*/ _type_model_state = 66ui16,
				/*nicename("event")*/ _type_event = 67ui16,
				/*nicename("character_physics")*/ _type_character_physics = 68ui16,
				/*nicename("skull")*/ _type_skull = 69ui16,
				/*nicename("firing_point_evaluator")*/ _type_firing_point_evaluator = 70ui16,
				/*nicename("damage_region")*/ _type_damage_region = 71ui16,
				/*nicename("object")*/ _type_object = 72ui16,
				/*nicename("unit")*/ _type_unit = 73ui16,
				/*nicename("vehicle")*/ _type_vehicle = 74ui16,
				/*nicename("weapon")*/ _type_weapon = 75ui16,
				/*nicename("device")*/ _type_device = 76ui16,
				/*nicename("scenery")*/ _type_scenery = 77ui16,
				/*nicename("effect_scenery")*/ _type_effect_scenery = 78ui16,
				/*nicename("object_name")*/ _type_object_name = 79ui16,
				/*nicename("unit_name")*/ _type_unit_name = 80ui16,
				/*nicename("vehicle_name")*/ _type_vehicle_name = 81ui16,
				/*nicename("weapon_name")*/ _type_weapon_name = 82ui16,
				/*nicename("device_name")*/ _type_device_name = 83ui16,
				/*nicename("scenery_name")*/ _type_scenery_name = 84ui16,
				/*nicename("effect_scenery_name")*/ _type_effect_scenery_name = 85ui16,
				/*nicename("cinematic_lightprobe")*/ _type_cinematic_lightprobe = 86ui16,
				/*nicename("animation_budget_reference")*/ _type_animation_budget_reference = 87ui16,
				/*nicename("looping_sound_budget_reference")*/ _type_looping_sound_budget_reference = 88ui16,
				/*nicename("sound_budget_reference")*/ _type_sound_budget_reference = 89ui16,
			};
	...
	struct nicename("Scripting Data") s_scripting_data_definition
	{
		struct nicename("Point Sets") s_point_sets_definition
		{
			...
			char nicename("Name") name[32];
			s_tag_block_definition<s_points_definition> nicename("Points") points_block;
			int16_t nicename("BSP Index") bsp_index;
			int16_t nicename("Manual Reference Frame") manual_reference_frame;
			b_flags1 nicename("Flags") flags;
			int16_t nicename("Editor Folder Index") editor_folder_index;
		...
		s_tag_block_definition<s_point_sets_definition> nicename("Point Sets") point_sets_block;
		Undefined32 __unknown0;
		Undefined32 __unknown1;
		Undefined32 __unknown2;
		Undefined32 __unknown3;
	...
	struct nicename("Cutscene Camera Points") s_cutscene_camera_points_definition
	{
		enum nicename("Type") e_type : uint16_t
		{
			/*nicename("Normal")*/ _type_normal = 1ui16,
			/*nicename("Ignore Target Orientation")*/ _type_ignore_target_orientation = 2ui16,
			/*nicename("Dolly")*/ _type_dolly = 3ui16,
			/*nicename("Ignore Target Updates")*/ _type_ignore_target_updates = 4ui16,
		};
	...
	struct nicename("Cutscene Titles") s_cutscene_titles_definition
	{
		...
		{
			/*nicename("Left")*/ _justification_left = 1ui16,
			/*nicename("Right")*/ _justification_right = 2ui16,
			/*nicename("Center")*/ _justification_center = 3ui16,
		};

		enum nicename("Vertical Justification") e_vertical_justification : uint16_t
		{
			/*nicename("Bottom")*/ _vertical_justification_bottom = 1ui16,
			/*nicename("Top")*/ _vertical_justification_top = 2ui16,
			/*nicename("Middle")*/ _vertical_justification_middle = 3ui16,
			/*nicename("Bottom 2")*/ _vertical_justification_bottom_2 = 4ui16,
			/*nicename("Top 2")*/ _vertical_justification_top_2 = 5ui16,
		};
		...
		int16_t __unknown4;
		color32 nicename("Text Color") text_color;
		color32 nicename("Shadow Color") shadow_color;
	...
	struct nicename("Scenario Resources") s_scenario_resources_definition
	{
		...
		int32_t __unknown0;
		s_tag_block_definition<s_script_source_definition> nicename("Script Source") script_source_block;
		s_tag_block_definition<s_ai_resources_definition> nicename("AI Resources") ai_resources_block;
		s_tag_block_definition<s_references_definition> nicename("References") references_block;
	};
	...
	struct nicename("Scenario MOPP Triggers") s_scenario_mopp_triggers_definition
	{
		...
		int32_t __unknown0;
		s_tag_block_definition<s_mopp_codes_definition> nicename("MOPP Codes") mopp_codes_block;
	};
	...
	struct nicename("Script Expressions") s_script_expressions_definition
	{
		...
		{
			/*nicename("INVALID")*/ _value_type_invalid = 1ui16,
			/*nicename("unparsed")*/ _value_type_unparsed = 2ui16,
			/*nicename("special_form")*/ _value_type_special_form = 3ui16,
			/*nicename("function_name")*/ _value_type_function_name = 4ui16,
			/*nicename("passthrough")*/ _value_type_passthrough = 5ui16,
			/*nicename("void")*/ _value_type_void = 6ui16,
			/*nicename("boolean")*/ _value_type_boolean = 7ui16,
			/*nicename("real")*/ _value_type_real = 8ui16,
			/*nicename("short")*/ _value_type_short = 9ui16,
			/*nicename("long")*/ _value_type_long = 10ui16,
			/*nicename("string")*/ _value_type_string = 11ui16,
			/*nicename("script")*/ _value_type_script = 12ui16,
			/*nicename("string_id")*/ _value_type_string_id = 13ui16,
			/*nicename("unit_seat_mapping")*/ _value_type_unit_seat_mapping = 14ui16,
			/*nicename("trigger_volume")*/ _value_type_trigger_volume = 15ui16,
			/*nicename("cutscene_flag")*/ _value_type_cutscene_flag = 16ui16,
			/*nicename("cutscene_camera_point")*/ _value_type_cutscene_camera_point = 17ui16,
			/*nicename("cutscene_title")*/ _value_type_cutscene_title = 18ui16,
			/*nicename("cutscene_recording")*/ _value_type_cutscene_recording = 19ui16,
			/*nicename("device_group")*/ _value_type_device_group = 20ui16,
			/*nicename("ai")*/ _value_type_ai = 21ui16,
			/*nicename("ai_command_list")*/ _value_type_ai_command_list = 22ui16,
			/*nicename("ai_command_script")*/ _value_type_ai_command_script = 23ui16,
			/*nicename("ai_behavior")*/ _value_type_ai_behavior = 24ui16,
			/*nicename("ai_orders")*/ _value_type_ai_orders = 25ui16,
			/*nicename("ai_line")*/ _value_type_ai_line = 26ui16,
			/*nicename("starting_profile")*/ _value_type_starting_profile = 27ui16,
			/*nicename("conversation")*/ _value_type_conversation = 28ui16,
			/*nicename("player")*/ _value_type_player = 29ui16,
			/*nicename("zone_set")*/ _value_type_zone_set = 30ui16,
			/*nicename("designer_zone")*/ _value_type_designer_zone = 31ui16,
			/*nicename("point_reference")*/ _value_type_point_reference = 32ui16,
			/*nicename("style")*/ _value_type_style = 33ui16,
			/*nicename("object_list")*/ _value_type_object_list = 34ui16,
			/*nicename("folder")*/ _value_type_folder = 35ui16,
			/*nicename("sound")*/ _value_type_sound = 36ui16,
			/*nicename("effect")*/ _value_type_effect = 37ui16,
			/*nicename("damage")*/ _value_type_damage = 38ui16,
			/*nicename("looping_sound")*/ _value_type_looping_sound = 39ui16,
			/*nicename("animation_graph")*/ _value_type_animation_graph = 40ui16,
			/*nicename("damage_effect")*/ _value_type_damage_effect = 41ui16,
			/*nicename("object_definition")*/ _value_type_object_definition = 42ui16,
			/*nicename("bitmap")*/ _value_type_bitmap = 43ui16,
			/*nicename("shader")*/ _value_type_shader = 44ui16,
			/*nicename("render_model")*/ _value_type_render_model = 45ui16,
			/*nicename("structure_definition")*/ _value_type_structure_definition = 46ui16,
			/*nicename("lightmap_definition")*/ _value_type_lightmap_definition = 47ui16,
			/*nicename("cinematic_definition")*/ _value_type_cinematic_definition = 48ui16,
			/*nicename("cinematic_scene_definition")*/ _value_type_cinematic_scene_definition = 49ui16,
			/*nicename("cinematic_transition_definition")*/ _value_type_cinematic_transition_definition = 50ui16,
			/*nicename("bink_definition")*/ _value_type_bink_definition = 51ui16,
			/*nicename("cui_screen_definition")*/ _value_type_cui_screen_definition = 52ui16,
			/*nicename("any_tag")*/ _value_type_any_tag = 53ui16,
			/*nicename("any_tag_not_resolving")*/ _value_type_any_tag_not_resolving = 54ui16,
			/*nicename("game_difficulty")*/ _value_type_game_difficulty = 55ui16,
			/*nicename("team")*/ _value_type_team = 56ui16,
			/*nicename("mp_team")*/ _value_type_mp_team = 57ui16,
			/*nicename("controller")*/ _value_type_controller = 58ui16,
			/*nicename("button_preset")*/ _value_type_button_preset = 59ui16,
			/*nicename("joystick_preset")*/ _value_type_joystick_preset = 60ui16,
			/*nicename("player_color")*/ _value_type_player_color = 61ui16,
			/*nicename("player_model_choice")*/ _value_type_player_model_choice = 62ui16,
			/*nicename("voice_output_setting")*/ _value_type_voice_output_setting = 63ui16,
			/*nicename("voice_mask")*/ _value_type_voice_mask = 64ui16,
			/*nicename("subtitle_setting")*/ _value_type_subtitle_setting = 65ui16,
			/*nicename("actor_type")*/ _value_type_actor_type = 66ui16,
			/*nicename("model_state")*/ _value_type_model_state = 67ui16,
			/*nicename("event")*/ _value_type_event = 68ui16,
			/*nicename("character_physics")*/ _value_type_character_physics = 69ui16,
			/*nicename("skull")*/ _value_type_skull = 70ui16,
			/*nicename("firing_point_evaluator")*/ _value_type_firing_point_evaluator = 71ui16,
			/*nicename("damage_region")*/ _value_type_damage_region = 72ui16,
			/*nicename("object")*/ _value_type_object = 73ui16,
			/*nicename("unit")*/ _value_type_unit = 74ui16,
			/*nicename("vehicle")*/ _value_type_vehicle = 75ui16,
			/*nicename("weapon")*/ _value_type_weapon = 76ui16,
			/*nicename("device")*/ _value_type_device = 77ui16,
			/*nicename("scenery")*/ _value_type_scenery = 78ui16,
			/*nicename("effect_scenery")*/ _value_type_effect_scenery = 79ui16,
			/*nicename("object_name")*/ _value_type_object_name = 80ui16,
			/*nicename("unit_name")*/ _value_type_unit_name = 81ui16,
			/*nicename("vehicle_name")*/ _value_type_vehicle_name = 82ui16,
			/*nicename("weapon_name")*/ _value_type_weapon_name = 83ui16,
			/*nicename("device_name")*/ _value_type_device_name = 84ui16,
			/*nicename("scenery_name")*/ _value_type_scenery_name = 85ui16,
			/*nicename("effect_scenery_name")*/ _value_type_effect_scenery_name = 86ui16,
			/*nicename("cinematic_lightprobe")*/ _value_type_cinematic_lightprobe = 87ui16,
			/*nicename("animation_budget_reference")*/ _value_type_animation_budget_reference = 88ui16,
			/*nicename("looping_sound_budget_reference")*/ _value_type_looping_sound_budget_reference = 89ui16,
			/*nicename("sound_budget_reference")*/ _value_type_sound_budget_reference = 90ui16,
		};
	...
	struct nicename("Scenario Cluster Data") s_scenario_cluster_data_definition
	{
		...
		s_tag_block_definition<s_cluster_centroids_definition> nicename("Cluster Centroids") cluster_centroids_block;
		int32_t __unknown0;
		s_tag_block_definition<s_background_sound_environments_definition> nicename("Background Sound Environments") background_sound_environments_block;
		s_tag_block_definition<s_fog1_definition> nicename("Fog") fog_block;
		s_tag_block_definition<s_camera_fx1_definition> nicename("Camera FX") camera_fx_block;
		s_tag_block_definition<s_weather1_definition> nicename("Weather") weather_block;
	};
	...
	struct nicename("Crates") s_crates_definition
	{
		...
		struct nicename("Node Positioning") s_node_positioning12_definition
		{
			...
			int16_t nicename("Node Count") node_count;
			int16_t __unknown0;
			s_tag_block_definition<s_node_flags12_definition> nicename("Node Flags") node_flags_block;
			s_tag_block_definition<s_orientations12_definition> nicename("Orientations") orientations_block;
			s_tag_block_definition<s_node_flags_readable12_definition> nicename("Node Flags [Readable]") node_flags_readable_block;
			s_tag_block_definition<s_orientations_readable12_definition> nicename("Orientations [Readable]") orientations_readable_block;
		};
		...
		/* Node Positioning : This block allows you to "pose" this objects nodes. Used normally for dead bodies. The orientations block has an entry for each checked node flag, skipping unchecked ones.
		   The blocks labeled [Readable] are modified to make reading/editing the values easier, but as a result the entry counts will be innaccurate, going too far may result in editing the wrong data.
		   DO NOT USE THE BLOCK REALLOCATOR ON THE [READABLE] BLOCKS! */
		s_tag_block_definition<s_node_positioning12_definition> nicename("Node Positioning") node_positioning1_block;
		int8_t __unknown0;
		int8_t __unknown1;
		int8_t __unknown2;
		e_bsp_policy nicename("BSP Policy") bsp_policy;
		...
		// Crate Data : 
		Undefined32 __unknown12;
		s_tag_block_definition<s_unknown10_definition> __unknown13;
		// Multiplayer Data : 
		char nicename("Custom Label") custom_label[32];
		e_symmetry nicename("Symmetry") symmetry;
		int8_t __unknown14;
	...
	struct nicename("Flocks") s_flocks_definition
	{
		...
		int16_t __unknown0;
		float __unknown1;
		s_tag_block_definition<s_sources_definition> nicename("Sources") sources_block;
		s_tag_block_definition<s_sinks_definition> nicename("Sinks") sinks_block;
	...
	struct nicename("AI Objectives") s_ai_objectives_definition
	{
		...
		struct nicename("Roles") s_roles_definition
		{
			...
			struct nicename("Point Geometry") s_point_geometry_definition
			{
				...
				s_tag_block_definition<s_points1_definition> nicename("Points") points_block;
			};
			...
			s_tag_block_definition<s_conditions_definition> nicename("Conditions") conditions_block;
			...
			int16_t __unknown20;
			Undefined32 __unknown21;
			s_tag_block_definition<s_unknown_63_definition> nicename("Unknown 63") unknown_63_block;
		...
		int16_t __unknown1;
		int16_t nicename("Editor Folder Index") editor_folder_index;
		s_tag_block_definition<s_roles_definition> nicename("Roles") roles_block;
	};
	...
	struct nicename("Designer Zonesets") s_designer_zonesets_definition
	{
		...
		s_tag_block_definition<s_weapons3_definition> nicename("Weapons") weapons_block;
		s_tag_block_definition<s_equipment3_definition> nicename("Equipment") equipment_block;
		s_tag_block_definition<s_scenery1_definition> nicename("Scenery") scenery_block;
		s_tag_block_definition<s_machines1_definition> nicename("Machines") machines_block;
		s_tag_block_definition<s_terminals1_definition> nicename("Terminals") terminals_block;
		s_tag_block_definition<s_controls1_definition> nicename("Controls") controls_block;
		s_tag_block_definition<s_unknown11_definition> __unknown1;
		s_tag_block_definition<s_crates1_definition> nicename("Crates") crates_block;
		s_tag_block_definition<s_creatures_definition> nicename("Creatures") creatures_block;
		s_tag_block_definition<s_giants1_definition> nicename("Giants") giants_block;
		s_tag_block_definition<s_unknown12_definition> __unknown2;
	...
	struct nicename("Scenario Metagame") s_scenario_metagame_definition
	{
		...
		s_tag_block_definition<s_time_multipliers_definition> nicename("Time Multipliers") time_multipliers_block;
	};
	...
	struct nicename("Unknown 65") s_unknown_65_definition
	{
		...
		int16_t __unknown4;
		int16_t __unknown5;
		s_tag_block_definition<s_unknown_85_definition> nicename("Unknown 85") unknown_85_block;
	};
	...
	struct nicename("Vignettes") s_vignettes_definition
	{
		...
		struct nicename("Unknown 87") s_unknown_87_definition
		{
			...
			struct nicename("Animation") s_animation_definition
			{
				...
				Undefined32 nicename("ZUnknown") zunknown2;
			};
			...
			int16_t __unknown4;
			int32_t __unknown5;
			s_tag_block_definition<s_script_definition> nicename("Script") script_block;
			s_tag_block_definition<s_unknown_89_definition> nicename("Unknown 89") unknown_89_block;
			s_tag_block_definition<s_animation_definition> nicename("Animation") animation_block;
			s_tag_block_definition<s_unknown_88_definition> nicename("Unknown 88") unknown_88_block;
			Undefined32 nicename("ZUnknown") zunknown;
			Undefined32 nicename("ZUnknown") zunknown1;
			Undefined32 nicename("ZUnknown") zunknown2;
			s_tag_block_definition<s_unknown_91_definition> nicename("Unknown 91") unknown_91_block;
			Undefined32 nicename("ZUnknown") zunknown3;
			Undefined32 nicename("ZUnknown") zunknown4;
			Undefined32 nicename("ZUnknown") zunknown5;
		};
		...
		int16_t __unknown5;
		int16_t __unknown6;
		s_tag_block_definition<s_unknown_86_definition> nicename("Unknown 86") unknown_86_block;
		s_tag_block_definition<s_unknown_87_definition> nicename("Unknown 87") unknown_87_block;
		float nicename("X") x;
		float nicename("Y") y;
		float nicename("Z") z;
	...
	s_tag_block_definition<s_sky_references_definition> nicename("Sky References") sky_references_block;
	s_tag_block_definition<s_bsp_groups_definition> nicename("BSP Groups") bsp_groups_block;
	s_tag_block_definition<s_scenario_bsp_audibility_definition> nicename("Scenario BSP Audibility") scenario_bsp_audibility_block;
	...
	Undefined32 __unknown23;
	Undefined32 __unknown24;
	s_tag_block_definition<s_object_names_definition> nicename("Object Names") object_names_block;
	s_tag_block_definition<s_scenery_definition> nicename("Scenery") scenery_block;
	s_tag_block_definition<s_scenery_palette_definition> nicename("Scenery Palette") scenery_palette_block;
	s_tag_block_definition<s_bipeds_definition> nicename("Bipeds") bipeds_block;
	s_tag_block_definition<s_biped_palette_definition> nicename("Biped Palette") biped_palette_block;
	s_tag_block_definition<s_vehicles_definition> nicename("Vehicles") vehicles_block;
	s_tag_block_definition<s_vehicle_palette_definition> nicename("Vehicle Palette") vehicle_palette_block;
	s_tag_block_definition<s_equipment_definition> nicename("Equipment") equipment_block;
	s_tag_block_definition<s_equipment_palette_definition> nicename("Equipment Palette") equipment_palette_block;
	s_tag_block_definition<s_weapons_definition> nicename("Weapons") weapons_block;
	s_tag_block_definition<s_weapon_palette_definition> nicename("Weapon Palette") weapon_palette_block;
	s_tag_block_definition<s_device_groups_definition> nicename("Device Groups") device_groups_block;
	s_tag_block_definition<s_machines_definition> nicename("Machines") machines_block;
	s_tag_block_definition<s_machine_palette_definition> nicename("Machine Palette") machine_palette_block;
	s_tag_block_definition<s_terminals_definition> nicename("Terminals") terminals_block;
	s_tag_block_definition<s_terminal_palette_definition> nicename("Terminal Palette") terminal_palette_block;
	s_tag_block_definition<s_controls_definition> nicename("Controls") controls_block;
	s_tag_block_definition<s_control_palette_definition> nicename("Control Palette") control_palette_block;
	s_tag_block_definition<s_sound_scenery_definition> nicename("Sound Scenery") sound_scenery_block;
	s_tag_block_definition<s_sound_scenery_palette_definition> nicename("Sound Scenery Palette") sound_scenery_palette_block;
	s_tag_block_definition<s_giants_definition> nicename("Giants") giants_block;
	s_tag_block_definition<s_giant_palette_definition> nicename("Giant Palette") giant_palette_block;
	s_tag_block_definition<s_effect_scenery_definition> nicename("Effect Scenery") effect_scenery_block;
	s_tag_block_definition<s_effect_scenery_palette_definition> nicename("Effect Scenery Palette") effect_scenery_palette_block;
	s_tag_block_definition<s_light_volumes_definition> nicename("Light Volumes") light_volumes_block;
	s_tag_block_definition<s_light_volumes_palette_definition> nicename("Light Volumes Palette") light_volumes_palette_block;
	s_tag_block_definition<s_sandbox_palette_definition> nicename("Sandbox Palette") sandbox_palette_block;
	s_tag_block_definition<s_legacy_sandbox_info_definition> nicename("Legacy Sandbox Info") legacy_sandbox_info_block;
	TagReference __unknown25;
	Undefined32 __unknown26;
	Undefined32 __unknown27;
	Undefined32 __unknown28;
	s_tag_block_definition<s_soft_ceilings_definition> nicename("Soft Ceilings") soft_ceilings_block;
	s_tag_block_definition<s_player_starting_profile_definition> nicename("Player Starting Profile") player_starting_profile_block;
	s_tag_block_definition<s_player_starting_locations_definition> nicename("Player Starting Locations") player_starting_locations_block;
	s_tag_block_definition<s_trigger_volumes_definition> nicename("Trigger Volumes") trigger_volumes_block;
	s_tag_block_definition<s_unknown_22_definition> nicename("Unknown 22") unknown_22_block;
	s_tag_block_definition<s_unknown_231_definition> nicename("Unknown 23") unknown_23_block;
	...
	s_tag_block_definition<s_zoneset_switch_trigger_volumes_definition> nicename("Zoneset Switch Trigger Volumes") zoneset_switch_trigger_volumes_block;
	s_tag_block_definition<s_location_name_callouts_definition> nicename("Location Name Callouts") location_name_callouts_block;
	...
	s_tag_block_definition<s_unknown_40_definition> nicename("Unknown 40") unknown_40_block;
	s_tag_block_definition<s_unknown_401_definition> nicename("Unknown 40") unknown_401_block;
	s_tag_block_definition<s_unknown_402_definition> nicename("Unknown 40") unknown_402_block;
	s_tag_block_definition<s_unknown_41_definition> nicename("Unknown 41") unknown_41_block;
	...
	s_tag_block_definition<s_decal_palette_definition> nicename("Decal Palette") decal_palette_block;
	...
	s_tag_block_definition<s_squad_groups_definition> nicename("Squad Groups") squad_groups_block;
	s_tag_block_definition<s_squads_definition> nicename("Squads") squads_block;
	s_tag_block_definition<s_zones_definition> nicename("Zones") zones_block;
	s_tag_block_definition<s_unknown_43_definition> nicename("Unknown 43") unknown_43_block;
	s_tag_block_definition<s_ai_cues_definition> nicename("AI Cues") ai_cues_block;
	...
	s_tag_block_definition<s_character_palette_definition> nicename("Character Palette") character_palette_block;
	Undefined32 __unknown68;
	Undefined32 __unknown69;
	Undefined32 __unknown70;
	s_tag_block_definition<s_ai_pathfinding_data_definition> nicename("AI Pathfinding Data") ai_pathfinding_data_block;
	...
	s_tag_block_definition<s_scripts_definition> nicename("Scripts") scripts_block;
	s_tag_block_definition<s_globals_definition> nicename("Globals") globals_block;
	s_tag_block_definition<s_script_references_definition> nicename("Script References") script_references_block;
	Undefined32 __unknown74;
	Undefined32 __unknown75;
	Undefined32 __unknown76;
	s_tag_block_definition<s_scripting_data_definition> nicename("Scripting Data") scripting_data_block;
	s_tag_block_definition<s_cutscene_flags_definition> nicename("Cutscene Flags") cutscene_flags_block;
	s_tag_block_definition<s_cutscene_camera_points_definition> nicename("Cutscene Camera Points") cutscene_camera_points_block;
	s_tag_block_definition<s_cutscene_titles_definition> nicename("Cutscene Titles") cutscene_titles_block;
	...
	s_tag_block_definition<s_scenario_resources_definition> nicename("Scenario Resources") scenario_resources_block;
	s_tag_block_definition<s_unit_seats_mapping_definition> nicename("Unit Seats Mapping") unit_seats_mapping_block;
	s_tag_block_definition<s_scenario_kill_triggers_definition> nicename("Scenario Kill Triggers") scenario_kill_triggers_block;
	s_tag_block_definition<s_scenario_safe_triggers_definition> nicename("Scenario Safe Triggers") scenario_safe_triggers_block;
	s_tag_block_definition<s_scenario_mopp_triggers_definition> nicename("Scenario MOPP Triggers") scenario_mopp_triggers_block;
	...
	s_tag_block_definition<s_script_expressions_definition> nicename("Script Expressions") script_expressions_block;
	...
	s_tag_block_definition<s_fog_definition> nicename("Fog") fog_block;
	s_tag_block_definition<s_camera_fx_definition> nicename("Camera FX") camera_fx_block;
	s_tag_block_definition<s_weather_definition> nicename("Weather") weather_block;
	s_tag_block_definition<s_scenario_cluster_data_definition> nicename("Scenario Cluster Data") scenario_cluster_data_block;
	...
	s_tag_block_definition<s_spawn_data_definition> nicename("Spawn Data") spawn_data_block;
	TagReference nicename("Sound Effects Collection") sound_effects_collection_reference;
	s_tag_block_definition<s_crates_definition> nicename("Crates") crates_block;
	s_tag_block_definition<s_crate_palette_definition> nicename("Crate Palette") crate_palette_block;
	s_tag_block_definition<s_flock_palette_definition> nicename("Flock Palette") flock_palette_block;
	s_tag_block_definition<s_flocks_definition> nicename("Flocks") flocks_block;
	...
	s_tag_block_definition<s_creature_palette_definition> nicename("Creature Palette") creature_palette_block;
	s_tag_block_definition<s_big_battle_creatures_definition> nicename("Big Battle Creatures") big_battle_creatures_block;
	s_tag_block_definition<s_editor_folders_definition> nicename("Editor Folders") editor_folders_block;
	...
	s_tag_block_definition<s_mission_dialogue_definition> nicename("Mission Dialogue") mission_dialogue_block;
	...
	s_tag_block_definition<s_unknown_59_definition> nicename("Unknown 59") unknown_59_block;
	s_tag_block_definition<s_ai_objectives_definition> nicename("AI Objectives") ai_objectives_block;
	s_tag_block_definition<s_designer_zonesets_definition> nicename("Designer Zonesets") designer_zonesets_block;
	s_tag_block_definition<s_unknown_61_definition> nicename("Unknown 61") unknown_61_block;
	Undefined32 __unknown97;
	Undefined32 __unknown98;
	Undefined32 __unknown99;
	s_tag_block_definition<s_particle_emitters_definition> nicename("Particle Emitters") particle_emitters_block;
	s_tag_block_definition<s_unknown13_definition> __unknown100;
	s_tag_block_definition<s_cinematics_definition> nicename("Cinematics") cinematics_block;
	s_tag_block_definition<s_cinematic_lights_definition> nicename("Cinematic Lights") cinematic_lights_block;
	Undefined32 __unknown101;
	Undefined32 __unknown102;
	Undefined32 __unknown103;
	s_tag_block_definition<s_scenario_metagame_definition> nicename("Scenario Metagame") scenario_metagame_block;
	s_tag_block_definition<s_unknown_64_definition> nicename("Unknown 64") unknown_64_block;
	s_tag_block_definition<s_unknown_65_definition> nicename("Unknown 65") unknown_65_block;
	...
	s_tag_block_definition<s_vignettes_definition> nicename("Vignettes") vignettes_block;
	TagReference nicename("Map Location Globals") map_location_globals_reference;
	s_tag_block_definition<s_unknown_66_definition> nicename("Unknown 66") unknown_66_block;
	...
	s_tag_block_definition<s_compiled_data_definition> nicename("Compiled Data") compiled_data_block;
};
