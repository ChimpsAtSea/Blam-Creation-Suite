...
struct nicename("model_animation_graph") tag_group('jmad') s_model_animation_graph_definition
{
	...
	struct nicename("Legs") s_legs_definition
	{
		...
		{
			/*nicename("False")*/ _anchors_false = 1ui16,
			/*nicename("True")*/ _anchors_true = 2ui16,
		};
	...
	struct nicename("Trigger Animations") s_trigger_animations_definition
	{
		...
		int32_t __unknown0;
		string_id nicename("Function") function;
		string_id nicename("Function") function1;
	...
	struct nicename("Vehicle Suspension") s_vehicle_suspension_definition
	{
		...
		string_id nicename("Function") function;
		string_id nicename("Marker Name") marker_name;
		string_id nicename("Unknown Marker Name") unknown_marker_name;
	...
	struct nicename("Object Overlays") s_object_overlays_definition
	{
		...
		{
			/*nicename("Frame")*/ _function_controls_frame = 1ui16,
			/*nicename("Scale")*/ _function_controls_scale = 2ui16,
		};
