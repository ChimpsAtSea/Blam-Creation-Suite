...
struct nicename("Shader Terrain") group('rmtr') s_shader_terrain_definition
{
	...
	signed short nicename("Global Material Index 1") global_material_index_1; 
	signed short nicename("Global Material Index 2") global_material_index_2; 
	signed short nicename("Global Material Index 3") global_material_index_3; 
	signed short nicename("Global Material Index 4") global_material_index_4; 
