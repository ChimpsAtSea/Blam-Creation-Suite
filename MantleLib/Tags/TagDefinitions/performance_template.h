...
struct nicename("performance_template") tag_group('pfmc') s_performance_template_definition
{
	...
	struct nicename("Unknown 1") s_unknown_1_definition
	{
		...
		s_tag_block_definition<s_unknown1_definition> __unknown5;
		s_tag_block_definition<s_unknown2_definition> __unknown6;
		s_tag_block_definition<s_unknown3_definition> __unknown7;
		Undefined32 __unknown8;
		Undefined32 __unknown9;
		Undefined32 __unknown10;
		Undefined32 __unknown11;
