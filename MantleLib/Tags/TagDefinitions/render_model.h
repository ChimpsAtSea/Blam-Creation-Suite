...
struct nicename("render_model") group('mode') s_render_model_definition
{
	enum nicename("Flags") b_flags : uint16_t /* bitfield */
	{
		...
		/*nicename("Force Node Maps")*/ _flags_force_node_maps = 1ui16 << 2ui16,
	...
	struct nicename("Meshes") s_meshes_definition
	{
		...
		{
			/*nicename("Has Vertex Colors")*/ _flags1_has_vertex_colors = 1ui16 << 0ui16,
	...
	s_tag_block_definition<s_instances_definition> nicename("Instances") instances_block;
	Undefined32 __unknown2;
	s_tag_block_definition<s_nodes_definition> nicename("Nodes") nodes_block;
	s_tag_block_definition<s_marker_groups_definition> nicename("Marker Groups") marker_groups_block;
	...
	s_tag_block_definition<s_unknown_nodes_definition> nicename("Unknown Nodes") unknown_nodes_block;
	s_tag_block_definition<s_unknown_11_definition> nicename("Unknown 11") unknown_11_block;
	Undefined32 nicename("Unknown A") unknown_a;
	Undefined32 nicename("Unknown A") unknown_a1;
	Undefined32 nicename("Unknown A") unknown_a2;
	Undefined32 nicename("Unknown A") unknown_a3;
	Undefined32 nicename("Unknown A") unknown_a4;
	Undefined32 nicename("Unknown A") unknown_a5;
	Undefined32 nicename("Unknown A") unknown_a6;
	Undefined32 nicename("Unknown A") unknown_a7;
	Undefined32 nicename("Unknown A") unknown_a8;
	Undefined32 nicename("Unknown A") unknown_a9;
	Undefined32 nicename("Unknown A") unknown_a10;
	Undefined32 nicename("Unknown A") unknown_a11;
	Undefined32 nicename("Unknown A") unknown_a12;
	Undefined32 nicename("Unknown A") unknown_a13;
	Undefined32 nicename("Unknown A") unknown_a14;
	Undefined32 nicename("Unknown A") unknown_a15;
	Undefined32 nicename("Unknown B") unknown_b;
	Undefined32 nicename("Unknown B") unknown_b1;
	Undefined32 nicename("Unknown B") unknown_b2;
	Undefined32 nicename("Unknown B") unknown_b3;
	Undefined32 nicename("Unknown B") unknown_b4;
	Undefined32 nicename("Unknown B") unknown_b5;
	Undefined32 nicename("Unknown B") unknown_b6;
	Undefined32 nicename("Unknown B") unknown_b7;
	Undefined32 nicename("Unknown B") unknown_b8;
	Undefined32 nicename("Unknown B") unknown_b9;
	Undefined32 nicename("Unknown B") unknown_b10;
	Undefined32 nicename("Unknown B") unknown_b11;
	Undefined32 nicename("Unknown B") unknown_b12;
	Undefined32 nicename("Unknown B") unknown_b13;
	Undefined32 nicename("Unknown B") unknown_b14;
	Undefined32 nicename("Unknown B") unknown_b15;
	Undefined32 nicename("Unknown C") unknown_c;
	Undefined32 nicename("Unknown C") unknown_c1;
	Undefined32 nicename("Unknown C") unknown_c2;
	Undefined32 nicename("Unknown C") unknown_c3;
	Undefined32 nicename("Unknown C") unknown_c4;
	Undefined32 nicename("Unknown C") unknown_c5;
	Undefined32 nicename("Unknown C") unknown_c6;
	Undefined32 nicename("Unknown C") unknown_c7;
	Undefined32 nicename("Unknown C") unknown_c8;
	Undefined32 nicename("Unknown C") unknown_c9;
	Undefined32 nicename("Unknown C") unknown_c10;
	Undefined32 nicename("Unknown C") unknown_c11;
	Undefined32 nicename("Unknown C") unknown_c12;
	Undefined32 nicename("Unknown C") unknown_c13;
	Undefined32 nicename("Unknown C") unknown_c14;
	Undefined32 nicename("Unknown C") unknown_c15;
	Undefined32 __unknown23;
	Undefined32 __unknown24;
	Undefined32 __unknown25;
	Undefined32 __unknown26;
	...
	s_tag_block_definition<s_runtime_nodes_definition> nicename("Runtime Nodes") runtime_nodes_block;
};
