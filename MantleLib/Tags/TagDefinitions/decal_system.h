...
struct nicename("Decal System") group('decs') s_decal_system_definition
{
	struct nicename("Decal System") s_decal_system2_block_definition;
	...
	float __unknown6; 
	float __unknown7; 
	s_tag_block_definition<s_decal_system2_block_definition> nicename("Decal System") decal_system_block; 
	float __unknown8; 

	struct nicename("decal_system2") s_decal_system2_block_definition
	{
