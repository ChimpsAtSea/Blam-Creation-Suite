...
struct nicename("Beam System") group('beam') s_beam_system_definition
{
	struct nicename("Beam System") s_beam_system2_block_definition;

	s_tag_block_definition<s_beam_system2_block_definition> nicename("Beam System") beam_system_block; 

	struct nicename("beam_system2") s_beam_system2_block_definition
	{
		...
		DataReference __unknown49_data_reference; 
		...
		DataReference __unknown52_data_reference; 
		...
		DataReference __unknown55_data_reference; 
		...
		DataReference __unknown58_data_reference; 
		...
		DataReference __unknown61_data_reference; 
