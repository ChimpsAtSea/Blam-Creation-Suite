...
struct nicename("scenery") group('scen') s_scenery_definition
{
	...
	enum nicename("Pathfinding Policy") e_pathfinding_policy : uint16_t
	{
		...
		/*nicename("Static")*/ _pathfinding_policy_static = 2ui16,
		/*nicename("Dynamic")*/ _pathfinding_policy_dynamic = 3ui16,
		/*nicename("None")*/ _pathfinding_policy_none = 4ui16,
	};

	enum nicename("Lightmapping Policy") e_lightmapping_policy : uint16_t
	{
		/*nicename("Per-Vertex")*/ _lightmapping_policy_per_vertex = 1ui16,
		/*nicename("Per-Pixel (Not Implemented)")*/ _lightmapping_policy_per_pixel_not_implemented = 2ui16,
		/*nicename("Dynamic")*/ _lightmapping_policy_dynamic = 3ui16,
	};
