...
c_mantle_bitmap_gui_tab::c_mantle_bitmap_gui_tab(c_cache_file& cache_file, c_mantle_gui_tab* parent_tag, v_tag_interface_legacy<s_bitmap_definition_legacy>& bitmap_tag_interface) :
...
void c_mantle_bitmap_gui_tab::render_tab_contents_gui()
{
	...
	//	s_cache_file_resource_layout_table_definition::s_segments_definition& segment_block = play_tag->segments_block[tag_resource.play_segment_index];
