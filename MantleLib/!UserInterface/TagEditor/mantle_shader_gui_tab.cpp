...
c_mantle_shader_gui_tab::c_mantle_shader_gui_tab(c_cache_file& cache_file, c_mantle_gui_tab* parent_tag, v_tag_interface_legacy<s_shader_definition_legacy>& shader_tag_interface) :
...
#undef auto
						...
						c_virtual_tag_block<s_shader_definition_legacy::s_shader_properties_definition_legacy::s_shader_maps_definition_legacy> shader_map_block(cache_file, shader_tag_interface, shader_properties.shader_maps_block);
