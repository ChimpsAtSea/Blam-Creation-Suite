...
template<typename T>
const v_tag_interface<T>* tag_cast(const TagReference* tag_interface);

template<typename T>
v_tag_interface<T>* tag_cast(TagReference* tag_interface);

#endif

template<typename T>
v_tag_interface<T>* tag_cast(c_virtual_tag_interface* virtual_tag_interface)
{
...
template<typename T>
const v_tag_interface<T>* tag_cast(const c_virtual_tag_interface* virtual_tag_interface)
{
	ASSERT(virtual_tag_interface != nullptr);
