...
s_cache_file_tag_instance*& tag_instances = reference_symbol<s_cache_file_tag_instance*>("tag_instances", Engine::HaloReach, Build::MCC_1_1305_0_0, 0x180CF8FC0);
uint32_t* (&tag_address_table)[] = reference_symbol<uint32_t * []>("tag_address_table", Engine::HaloReach, Build::MCC_1_1305_0_0, 0x183887CA0);
char* & g_cache_file = reference_symbol<char*>("g_cache_file", Engine::HaloReach, Build::MCC_1_1305_0_0, 0x1825B6D90);
