...
c_h5_tag_layout::c_h5_tag_layout(const char* halo5_forge_data, const s_h5_tag_layout_header* layout_header)
{
	...
	const s_h5_tag_block_definition* tag_block_definition_header = reinterpret_cast<const s_h5_tag_block_definition*>(h5_aa_to_pointer(halo5_forge_data, layout_header->definition_address));
